...
`,
  ...
  docsPath: [
    '**/*.mdx', // Find all Markdown files in docsRoot
  ],
  ...
  pattern: [
    'getting-started/**/*.mdx', // All files in getting-started directory
    'guides/*.mdx', // All files directly in guides directory
    'reference/api/*.mdx', // All API reference docs
  ],
  ...
  copyPath: [
    'reference/changelog.mdx', // Copy changelog without translation
    'assets/**', // Copy asset files without translation
    '**/*.example.mdx', // Copy example files without translation
  ],
};
