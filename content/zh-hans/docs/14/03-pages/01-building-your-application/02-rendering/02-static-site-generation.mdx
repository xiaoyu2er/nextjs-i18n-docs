...
要了解更多关于 `getStaticProps` 的工作原理，请查阅 [数据获取文档](/docs/pages/building-your-application/data-fetching/get-static-props)。
...
要了解更多关于 `getStaticPaths` 的工作原理，请查阅 [数据获取文档](/docs/pages/building-your-application/data-fetching/get-static-paths)。
...
- 使用 **客户端数据获取** 的静态生成：你可以跳过预渲染页面的某些部分，然后使用客户端 JavaScript 填充它们。要了解更多关于这种方法的信息，请查阅 [数据获取文档](/docs/pages/building-your-application/data-fetching/client-side)。
