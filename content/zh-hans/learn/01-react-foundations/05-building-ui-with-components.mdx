...
![Example of a Media Component made up of 3 smaller components: image, text, and button](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/learn-components.png)![Example of a Media Component made up of 3 smaller components: image, text, and button](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-components.png&w=3840&q=75)
...
![Component tree showing how components can be nested inside each other](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/learn-component-tree.png)![Component tree showing how components can be nested inside each other](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-component-tree.png&w=3840&q=75)
