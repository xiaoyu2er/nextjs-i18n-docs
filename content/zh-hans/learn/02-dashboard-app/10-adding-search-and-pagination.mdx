---
title: 添加搜索 (Search) 和分页 (Pagination)
headline: 'App Router: Adding Search and Pagination'
description: 使用 Next.js API 为您的仪表盘应用添加搜索 (Search) 和分页 (Pagination)。
image: >-
...
为什么使用 URL 搜索参数？[](#why-use-url-search-params)
--------------------------------------------------------
...
### 最佳实践：防抖 [](#best-practice-debouncing)
