...
translation-updated-at: 2025-06-06T18:13:39.663Z
...
- [Verwendung von Code zur Icon-Generierung (.js, .ts, .tsx)](#icons-mit-code-generieren-js-ts-tsx)
...
> - Favicons können nur im Root-`/app`-Segment gesetzt werden. Wenn Sie mehr Granularität benötigen, können Sie [`icon`](#icon) verwenden.
...
Der einfachste Weg, ein Icon zu generieren, ist die Verwendung der [`ImageResponse`](/docs/app/api-reference/functions/image-response)-API aus `next/server`.
