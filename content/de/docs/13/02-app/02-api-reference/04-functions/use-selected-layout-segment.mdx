...
translation-updated-at: 2025-06-06T17:59:09.286Z
...
`useSelectedLayoutSegment` akzeptiert optional einen [`parallelRoutesKey`](/docs/app/building-your-application/routing/parallel-routes#useselectedlayoutsegments), der das Lesen des aktiven Routensegments innerhalb dieses Slots ermöglicht.
