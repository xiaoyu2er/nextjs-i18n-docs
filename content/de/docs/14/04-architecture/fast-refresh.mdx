...
- Anonyme Pfeilfunktionen wie `export default () => <div />;` führen dazu, dass Fast Refresh den lokalen Komponentenzustand nicht erhält. Für große Codebasen können Sie unseren [`name-default-component`-Codemod](/docs/pages/building-your-application/upgrading/codemods#name-default-component) verwenden.
