...
>   - `usePathname` kann `null` zurückgeben, wenn eine [Fallback-Route](/docs/pages/api-reference/functions/get-static-paths#fallback-true) gerendert wird oder wenn eine `pages`-Verzeichnisseite durch Next.js [automatisch statisch optimiert](/docs/pages/building-your-application/rendering/automatic-static-optimization) wurde und der Router noch nicht bereit ist.
