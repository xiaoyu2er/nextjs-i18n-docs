...
Aber im [Routing-Abschnitt](/docs/app/building-your-application/routing) sind die Dateien mit einer zweistelligen Zahl versehen, sortiert in der Reihenfolge, in der Entwickler diese Konzepte lernen sollten:
...
- Links werden automatisch für Seiten generiert, die Unterseiten haben. Beispielsweise hat der Abschnitt [Optimierung](/docs/app/building-your-application/optimizing) Links zu all seinen Unterseiten.
