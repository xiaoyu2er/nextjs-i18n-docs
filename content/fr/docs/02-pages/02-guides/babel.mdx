...
translation-updated-at: 2025-06-02T19:56:30.164Z
title: Comment configurer Babel dans Next.js
nav_title: Babel
description: Étendez le préréglage Babel ajouté par Next.js avec vos propres configurations.
---
...
Pour commencer, vous devez simplement définir un fichier `.babelrc` (ou `babel.config.js`) à la racine de votre projet. Si un tel fichier est trouvé, il sera considéré comme la _source de vérité_, et doit donc également inclure ce dont Next.js a besoin, à savoir le préréglage `next/babel`.
...
Pour en savoir plus sur les options disponibles pour chaque configuration, consultez le site de [documentation](https://babeljs.io/docs/) de Babel.
