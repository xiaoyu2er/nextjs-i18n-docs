...
translation-updated-at: 2025-06-02T20:05:17.135Z
title: Comment mettre à jour vers la version 11
...
Le répertoire de sortie de construction (par défaut `.next`) est maintenant vidé par défaut, à l'exception des caches Next.js. Vous pouvez vous référer au [RFC sur le nettoyage de `distDir`](https://github.com/vercel/next.js/discussions/6009) pour plus d'informations.
