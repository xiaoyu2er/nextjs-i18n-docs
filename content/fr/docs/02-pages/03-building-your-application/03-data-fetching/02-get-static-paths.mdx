...
translation-updated-at: 2025-06-02T20:03:45.763Z
...
`getStaticPaths` vous permet de contrôler quelles pages sont générées pendant la construction plutôt qu'à la demande avec [`fallback`](/docs/pages/api-reference/functions/get-static-paths#fallback-blocking). Générer plus de pages pendant la construction ralentira les builds.
