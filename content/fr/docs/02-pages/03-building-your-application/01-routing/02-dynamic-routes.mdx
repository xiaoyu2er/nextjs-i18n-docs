...
translation-updated-at: 2025-06-02T20:04:22.234Z
title: Routes dynamiques
description: Les routes dynamiques sont des pages qui vous permettent d'ajouter des paramètres personnalisés à vos URL. Commencez à créer des routes dynamiques et apprenez-en plus ici.
related:
...
Les segments dynamiques peuvent être accessibles via [`useRouter`](/docs/pages/api-reference/functions/use-router).
...
Les segments dynamiques peuvent être étendus pour **attraper tous** les segments suivants en ajoutant des points de suspension entre les crochets `[...nomDuSegment]`.
...
Les segments attrape-tout peuvent être rendus **optionnels** en incluant le paramètre entre doubles crochets : `[[...nomDuSegment]]`.
...
La différence entre les segments **attrape-tout** et **attrape-tout optionnels** est qu'avec les optionnels, la route sans paramètre est également prise en compte (`/shop` dans l'exemple ci-dessus).
