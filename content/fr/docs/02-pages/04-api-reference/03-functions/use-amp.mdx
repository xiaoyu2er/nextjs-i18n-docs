...
translation-updated-at: 2025-06-02T20:02:22.951Z
title: useAmp
...
> La prise en charge d'AMP est l'une de nos fonctionnalités avancées, vous pouvez [en savoir plus sur AMP ici](/docs/pages/guides/amp).
...
La page utilise `useAmp` pour différencier les modes. C'est un [Hook React](https://react.dev/reference/react) qui renvoie `true` si la page utilise AMP, et `false` sinon.