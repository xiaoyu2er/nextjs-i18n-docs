...
translation-updated-at: 2025-06-06T17:22:34.556Z
...
> **Bon à savoir** :
>
> - [Certains navigateurs](https://bugs.webkit.org/show_bug.cgi?id=252413) mettent en mémoire tampon une réponse en streaming. Vous ne verrez peut-être pas la réponse diffusée tant qu'elle ne dépasse pas 1024 octets. Cela affecte généralement seulement les applications "hello world", pas les applications réelles.
