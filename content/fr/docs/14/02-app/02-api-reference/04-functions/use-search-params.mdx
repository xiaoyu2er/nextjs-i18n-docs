...
> **Bon à savoir** :
>
> - `useSearchParams` est un hook de [Composant Client](/docs/app/building-your-application/rendering/client-components) et **n'est pas supporté** dans les [Composants Serveur](/docs/app/building-your-application/rendering/server-components) pour éviter des valeurs obsolètes pendant le [rendu partiel](/docs/app/building-your-application/routing/linking-and-navigating#4-partial-rendering).
...
Si une route est [rendue statiquement](/docs/app/building-your-application/rendering/server-components#static-rendering-default), l'appel à `useSearchParams` entraînera le rendu côté client de l'arborescence des composants jusqu'à la limite [`Suspense`](/docs/app/building-your-application/routing/loading-ui-and-streaming#example) la plus proche.
...
> **Bon à savoir** : Définir l'option [`dynamic` de configuration des segments de route](/docs/app/api-reference/file-conventions/route-segment-config#dynamic) à `force-dynamic` peut être utilisé pour forcer le rendu dynamique.
