...
- Les fonctions fléchées anonymes comme `export default () => <div />;` empêchent Fast Refresh de préserver l'état local du composant. Pour les grandes bases de code, vous pouvez utiliser notre [codemod `name-default-component`](/docs/pages/building-your-application/upgrading/codemods#name-default-component).
