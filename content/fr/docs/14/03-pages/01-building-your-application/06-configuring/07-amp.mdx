...
Pour activer le support AMP pour une page et en savoir plus sur les différentes configurations AMP, consultez la [documentation de l'API `next/amp`](/docs/pages/building-your-application/configuring/amp).
...
Les pages sont également validées lors de l'[export HTML statique](/docs/pages/building-your-application/deploying/static-exports) et tous les avertissements/erreurs seront affichés dans le terminal. Toute erreur AMP entraînera la sortie de l'export avec le code d'état `1` car l'export n'est pas un AMP valide.
...
Lors de l'utilisation de l'[export HTML statique](/docs/pages/building-your-application/deploying/static-exports) pour pré-rendre statiquement les pages, Next.js détectera si la page prend en charge AMP et modifiera le comportement d'export en conséquence.
...
Lorsque [`trailingSlash`](/docs/pages/api-reference/next-config-js/trailingSlash) est activé, les pages exportées pour `pages/about.js` seraient :
