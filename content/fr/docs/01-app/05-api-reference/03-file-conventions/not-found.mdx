...
translation-updated-at: 2025-06-02T20:05:48.799Z
title: not-found.js
description: Référence API pour le fichier not-found.js.
---

Le fichier **not-found** est utilisé pour afficher une interface utilisateur lorsque la fonction [`notFound`](/docs/app/api-reference/functions/not-found) est appelée dans un segment de route. En plus de servir une interface personnalisée, Next.js renverra un code d'état HTTP `200` pour les réponses streamées et `404` pour les réponses non streamées.
