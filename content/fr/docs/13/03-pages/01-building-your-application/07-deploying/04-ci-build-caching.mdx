...
translation-updated-at: 2025-06-06T17:26:02.399Z
...
Si vous n'avez pas de clé `save_cache`, veuillez suivre la [documentation de CircleCI sur la configuration du cache de build](https://circleci.com/docs/2.0/caching/).
...
En utilisant le [cache personnalisé](https://devcenter.heroku.com/articles/nodejs-support#custom-caching) de Heroku, ajoutez un tableau `cacheDirectories` dans votre package.json au niveau supérieur :
