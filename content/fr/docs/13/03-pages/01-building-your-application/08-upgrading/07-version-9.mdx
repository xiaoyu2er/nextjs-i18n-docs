...
translation-updated-at: 2025-06-06T17:25:44.314Z
title: Mise à niveau vers la version 9
nav_title: Version 9
description: Guide pour mettre à niveau votre application Next.js de la version 8 à la version 9.
---
...
Si vous aviez configuré des `routes` dans votre fichier `vercel.json` pour des routes dynamiques, ces règles peuvent être supprimées en profitant de la nouvelle [fonctionnalité de routage dynamique](/docs/pages/building-your-application/routing/dynamic-routes) de Next.js 9.
...
Vous pouvez en apprendre plus sur le [routage dynamique ici](/docs/pages/building-your-application/routing/dynamic-routes).

## Vérifiez votre fichier d'application personnalisée (`pages/_app.js`)

Si vous aviez précédemment copié l'exemple de [l'application personnalisée `<App>`](/docs/pages/building-your-application/routing/custom-app), vous pourrez peut-être supprimer votre `getInitialProps`.
