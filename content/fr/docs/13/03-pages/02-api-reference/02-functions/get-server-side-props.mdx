...
translation-updated-at: 2025-06-06T17:24:45.093Z
...
| `req`           | [L'objet `HTTP` IncomingMessage](https://nodejs.org/api/http.html#http_class_http_incomingmessage), avec une propriété supplémentaire `cookies`, qui est un objet avec des clés de type string mappant vers des valeurs de type string des cookies.    |
...
L'objet `props` est une paire clé-valeur, où chaque valeur est reçue par le composant de la page. Il doit s'agir d'un [objet sérialisable](https://developer.mozilla.org/docs/Glossary/Serialization) afin que toutes les propriétés passées puissent être sérialisées avec [`JSON.stringify`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/JSON/stringify).
