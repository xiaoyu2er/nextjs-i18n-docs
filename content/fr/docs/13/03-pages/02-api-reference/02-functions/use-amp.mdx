...
translation-updated-at: 2025-06-06T17:24:04.688Z
title: useAmp
...
- `true` - La page sera uniquement en AMP
...
- La page est rendue en HTML traditionnel (par défaut) et en HTML AMP (en ajoutant `?amp=1` à l'URL)
