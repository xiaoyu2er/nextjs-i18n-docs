...
translation-updated-at: 2025-06-06T17:31:19.309Z
title: TypeScript
...
Si cette option est désactivée, assurez-vous d'exécuter des vérifications de type dans le cadre de votre processus de build ou de déploiement, sinon cela peut être très risqué.
...
module.exports = {
  typescript: {
    // !! ATTENTION !!
    // Autorise dangereusement les builds de production à se terminer avec succès même si
