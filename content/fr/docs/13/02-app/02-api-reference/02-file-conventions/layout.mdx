...
translation-updated-at: 2025-06-06T17:36:15.464Z
title: layout.js
...
Les composants de layout doivent accepter et utiliser une prop `children`. Pendant le rendu, `children` sera rempli avec les segments de route que le layout englobe. Il s'agira principalement du composant d'un [Layout](/docs/app/building-your-application/routing/pages-and-layouts#pages) enfant (s'il existe) ou d'une [Page](/docs/app/building-your-application/routing/pages-and-layouts#pages), mais peut aussi inclure d'autres fichiers spéciaux comme [Loading](/docs/app/building-your-application/routing/loading-ui-and-streaming) ou [Error](/docs/app/building-your-application/routing/error-handling) le cas échéant.
...
- Utilisez plutôt la prop [`searchParams`](/docs/app/api-reference/file-conventions/page#searchparams-optional) de la Page ou le hook [`useSearchParams`](/docs/app/api-reference/functions/use-search-params) dans un composant client, qui est re-rendu côté client avec les derniers `searchParams`.
