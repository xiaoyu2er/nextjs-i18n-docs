...
translation-updated-at: 2025-06-06T17:33:42.989Z
...
> **Bon à savoir** :
>
> - Comme `useSelectedLayoutSegment` est un hook de [Client Component](/docs/app/building-your-application/rendering/client-components), et que les Layouts sont par défaut des [Server Components](/docs/app/building-your-application/rendering/server-components), `useSelectedLayoutSegment` est généralement appelé via un Client Component importé dans un Layout.
> - `useSelectedLayoutSegment` ne retourne que le segment un niveau en dessous. Pour obtenir tous les segments actifs, voir [`useSelectedLayoutSegments`](/docs/app/api-reference/functions/use-selected-layout-segments)
