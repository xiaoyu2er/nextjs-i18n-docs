...
translation-updated-at: 2025-06-06T16:46:31.617Z
title: userAgent
description: userAgent ヘルパーは Web Request API を拡張し、リクエストからユーザーエージェントオブジェクトと相互作用するための追加プロパティとメソッドを提供します。
---
...
`userAgent` ヘルパーは [Web Request API](https://developer.mozilla.org/docs/Web/API/Request) を拡張し、リクエストからユーザーエージェントオブジェクトと相互作用するための追加プロパティとメソッドを提供します。
