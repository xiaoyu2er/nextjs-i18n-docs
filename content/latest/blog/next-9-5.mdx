...
The Webpack 5 beta has already been rolled out to [nextjs.org](https://nextjs.org) and [vercel.com](https://vercel.com) in production. We encourage you to try it out in a progressive manner and report back your findings on [GitHub](https://github.com/vercel/next.js/issues/13341).
