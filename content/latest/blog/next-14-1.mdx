...
We have continued dogfooding `next dev --turbo` on all Vercel's Next.js applications, including [vercel.com](https://vercel.com) and [v0.app](https://v0.app). All engineers working on these applications are using Turbopack daily.
...
In [v0.app](https://v0.app), we identified an opportunity to optimize the way React Client Components are discovered and bundled in Turbopack - resulting in **up to 61.5%** faster initial compile time. This performance improvement was also observed in [vercel.com](https://vercel.com).
