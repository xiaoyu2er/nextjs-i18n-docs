...
image: >-
  https://nextjs.org/api/learn-og?title=API%20Routes%20Details&amp;chapter=40&amp;sig=e6c3dddbf3e08a28
---
...
Next.js has a feature called **Preview Mode** to solve the problem above, and it utilizes [API Routes](/docs/pages/building-your-application/routing/api-routes). To learn more about it take a look at our [Preview Mode](/docs/pages/guides/preview-mode) documentation.

### Dynamic API Routes[](#dynamic-api-routes)

API Routes can be dynamic, just like regular pages. Take a look at our [API Routes](/docs/pages/building-your-application/routing/api-routes) documentation to learn more.
