...
image: >-
  https://nextjs.org/api/learn-og?title=Styling%20Tips&amp;chapter=18&amp;sig=0911c58994fc1910
---
...
To customize PostCSS config, you can create a top-level file called [`postcss.config.js`](/docs/pages/guides/post-css). This is useful if you're using libraries like [Tailwind CSS](https://tailwindcss.com/).
...
Then, create a [`postcss.config.js`](/docs/pages/guides/post-css):
...
> To learn more about custom PostCSS configuration, check out the [documentation for PostCSS](/docs/pages/guides/post-css).
