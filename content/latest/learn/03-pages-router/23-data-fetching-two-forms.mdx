...
image: >-
  https://nextjs.org/api/learn-og?title=Two%20Forms%20of%20Pre-rendering&amp;chapter=23&amp;sig=7c2bb3ddbd7d9d72
---
...
### When to Use [Static Generation](/docs/basic-features/pages#static-generation-recommended) v.s. [Server-side Rendering](/docs/basic-features/pages#server-side-rendering)[](#when-to-use-static-generation-vs-server-side-rendering)
