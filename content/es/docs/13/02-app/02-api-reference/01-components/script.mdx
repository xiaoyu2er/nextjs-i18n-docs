...
translation-updated-at: 2025-06-06T17:20:06.625Z
...
Esta referencia de API te ayudará a entender cómo usar las [props](#props) disponibles para el componente Script. Para características y uso, consulta la página [Optimización de Scripts](/docs/app/building-your-application/optimizing/scripts).
...
Los scripts que se cargan con la estrategia `beforeInteractive` se inyectan en el HTML inicial desde el servidor, se descargan antes de cualquier módulo Next.js y se ejecutan en el orden en que se colocan antes de que ocurra _cualquier_ hidratación en la página.
...
> **Advertencia:** La estrategia `worker` aún no es estable y aún no funciona con el directorio [`app`](/docs/app/building-your-application/routing/defining-routes). Úsala con precaución.
