...
translation-updated-at: 2025-06-02T20:05:32.258Z
title: Páginas y Layouts
description: Crea tu primera página y diseño compartido con el Enrutador de Páginas.
---
...
Si solo tienes un diseño para toda tu aplicación, puedes crear una [App Personalizada](/docs/pages/building-your-application/routing/custom-app) y envolver tu aplicación con el layout. Como el componente `<Layout />` se reutiliza al cambiar de página, su estado se conservará (ej. valores de inputs).
...
Si necesitas múltiples layouts, puedes añadir una propiedad `getLayout` a tu página, permitiendo devolver un componente React para el layout. Esto te permite definir el diseño _por página_. Como estamos devolviendo una función, podemos tener layouts anidados complejos si se desea.
