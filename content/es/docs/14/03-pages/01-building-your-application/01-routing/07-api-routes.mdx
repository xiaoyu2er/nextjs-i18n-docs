...
> **Es bueno saberlo**: Si está utilizando el App Router, puede usar [Componentes del Servidor](/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating) o [Manejadores de Ruta](/docs/app/building-your-application/routing/route-handlers) en lugar de Rutas API.
...
Las Rutas API admiten [rutas dinámicas](/docs/pages/building-your-application/routing/dynamic-routes) y siguen las mismas reglas de nomenclatura de archivos que se usan para `pages/`.
...
Si desea utilizar Rutas API con el Edge Runtime, recomendamos adoptar incrementalmente el App Router y usar [Manejadores de Ruta](/docs/app/building-your-application/routing/route-handlers) en su lugar.
