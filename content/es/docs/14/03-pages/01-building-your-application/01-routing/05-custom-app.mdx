...
`pageProps` es un objeto con las propiedades iniciales precargadas para tu página mediante uno de nuestros [métodos de obtención de datos](/docs/pages/building-your-application/data-fetching), de lo contrario será un objeto vacío.
...
**No recomendamos este patrón.** En su lugar, considera [adoptar gradualmente](/docs/app/building-your-application/upgrading/app-router-migration) el App Router, que te permite obtener datos más fácilmente para [páginas y diseños](/docs/app/building-your-application/routing/pages-and-layouts).
