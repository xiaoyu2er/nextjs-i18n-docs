...
| Nombre           | Descripción                                                                                                                                                                                                           |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `params`        | Si esta página usa una [ruta dinámica](/docs/pages/building-your-application/routing/dynamic-routes), `params` contiene los parámetros de la ruta. Si el nombre de la página es `[id].js`, entonces `params` tendrá la forma `{ id: ... }`. |
