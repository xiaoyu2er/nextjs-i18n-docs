...
- Usa `className` o `style`, no `styled-jsx`.
  - En la mayoría de los casos, recomendamos usar la propiedad `className`. Esto puede ser un [CSS Module](/docs/app/building-your-application/styling/css-modules) importado, una [hoja de estilos global](/docs/app/building-your-application/styling/css-modules#global-styles), etc.
