...
> Desde el lanzamiento de [Next.js 9.4](https://nextjs.org/blog/next-9-4) ahora tenemos una experiencia más intuitiva y ergonómica para [agregar variables de entorno](/docs/app/building-your-application/configuring/environment-variables). ¡Pruébelo!

</AppOnly>

<PagesOnly>

> Desde el lanzamiento de [Next.js 9.4](https://nextjs.org/blog/next-9-4) ahora tenemos una experiencia más intuitiva y ergonómica para [agregar variables de entorno](/docs/pages/building-your-application/configuring/environment-variables). ¡Pruébelo!
