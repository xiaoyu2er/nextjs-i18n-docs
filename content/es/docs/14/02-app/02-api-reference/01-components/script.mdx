...
> **Advertencia:** La estrategia `worker` aún no es estable y aún no funciona con el directorio [`app`](/docs/app/building-your-application/routing/defining-routes). Usar con precaución.
