...
> **Nota importante**
>
> - Por defecto, las imágenes generadas están [**optimizadas estáticamente**](/docs/app/building-your-application/rendering/server-components#static-rendering-default) (generadas en tiempo de compilación y almacenadas en caché) a menos que usen [funciones dinámicas](/docs/app/building-your-application/rendering/server-components#server-rendering-strategies#dynamic-functions) o datos no cacheados.
...
> **Nota importante**:
> Por defecto, esta imagen generada estará [optimizada estáticamente](/docs/app/building-your-application/rendering/server-components#static-rendering-default). Puede configurar las [`opciones`](/docs/app/api-reference/functions/fetch) individuales de `fetch` o las [opciones](/docs/app/api-reference/file-conventions/route-segment-config#revalidate) de segmentos de ruta para cambiar este comportamiento.
