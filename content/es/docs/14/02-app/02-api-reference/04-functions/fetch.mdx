...
> **Importante**:
>
> - Si una solicitud `fetch()` individual establece un número `revalidate` menor que el [`revalidate` por defecto](/docs/app/api-reference/file-conventions/route-segment-config#revalidate) de una ruta, se reducirá todo el intervalo de revalidación de la ruta.
