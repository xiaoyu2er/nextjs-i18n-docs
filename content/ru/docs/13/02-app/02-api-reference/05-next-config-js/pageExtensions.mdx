...
translation-updated-at: 2025-06-06T17:21:43.748Z
...
Например, если вы измените расширение `.ts` на `.page.ts`, вам потребуется переименовать страницы, такие как `middleware.page.ts`, `instrumentation.page.ts`, `_app.page.ts`.

## Включение нестраничных файлов в директорию `pages`
