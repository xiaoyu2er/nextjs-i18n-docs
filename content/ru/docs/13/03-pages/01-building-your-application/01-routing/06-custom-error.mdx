...
translation-updated-at: 2025-06-06T17:19:45.667Z
...
> **Полезно знать**: Вы можете использовать [`getStaticProps`](/docs/pages/building-your-application/data-fetching/get-static-props) внутри этой страницы, если вам нужно получить данные во время сборки.
...
- `_error`, как и `_app`, является зарезервированным именем пути. `_error` используется для определения пользовательских макетов и поведения страниц ошибок. `/_error` будет отображать 404 при прямом обращении через [роутинг](/docs/pages/building-your-application/routing) или рендеринг на [кастомном сервере](/docs/pages/building-your-application/configuring/custom-server).