...
translation-updated-at: 2025-06-06T16:41:03.499Z
title: Доступность
...
Next.js предоставляет [интегрированный опыт работы с ESLint](/docs/pages/building-your-application/configuring/eslint) из коробки, включая специальные правила для Next.js. По умолчанию Next.js включает `eslint-plugin-jsx-a11y` для раннего выявления проблем с доступностью, в том числе предупреждений о:
