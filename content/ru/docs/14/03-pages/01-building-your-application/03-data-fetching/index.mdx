...
translation-updated-at: 2025-06-06T16:49:33.450Z
title: Получение данных
description: Next.js предоставляет несколько способов получения данных, включая предварительный рендеринг, рендеринг на стороне сервера (SSR), генерацию статических сайтов (SSG) и инкрементальную статическую регенерацию (ISR). Узнайте, как управлять данными в приложении на Next.js.
---
