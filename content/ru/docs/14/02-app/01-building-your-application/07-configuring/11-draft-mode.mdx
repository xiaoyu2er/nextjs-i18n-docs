...
translation-updated-at: 2025-06-06T17:02:37.961Z
...
Затем отправьте запрос к `/api/disable-draft` для вызова обработчика. Если вы вызываете этот маршрут с помощью [`next/link`](/docs/app/api-reference/components/link), передайте `prefetch={false}`, чтобы случайно не удалить cookie при предзагрузке.
