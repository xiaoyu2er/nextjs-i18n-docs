...
image: >-
  https://nextjs.org/api/learn-og?title=Dynamic%20Imports%20for%20Components&amp;chapter=26&amp;sig=6ea4168528504ebe
---
...
*   Next.js: [Dynamic Imports Documentation](/docs/app/guides/lazy-loading#importing-client-components)
