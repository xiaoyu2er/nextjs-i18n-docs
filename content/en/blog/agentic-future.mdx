...
description: >-
  How we built and sunset an in-browser agent, shipped MCP integration, and
  learned that better AI agent support means thinking from the agent&apos;s
  perspective.
author:
  - name: Jiachi Liu
...
### Agents couldn't see the browser[](#agents-couldnt-see-the-browser)
...
### Experimenting with an in-browser agent[](#experimenting-with-an-in-browser-agent)
...
![Vector's interface showing error detection and suggested fixes.](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/static/blog/agentic-future/vector-both-theme.png)
...
### MCP made Next.js state visible to agents[](#mcp-made-nextjs-state-visible-to-agents)
...
![The Next.js MCP responding to 'whats use cache?' with documentation and context.](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/static/blog/agentic-future/answer-dark.png)

_Subtitle: The Next.js MCP responding to "whats use cache?" with documentation and context._

The MCP also packages prompts and tools to help with upgrades and cache component migrations. There's a [detailed talk about the MCP integration](https://www.youtube.com/watch?v=WT7_TJS0tFE) if you want to learn more.

### The answer is to think like an agent[](#the-answer-is-to-think-like-an-agent)
