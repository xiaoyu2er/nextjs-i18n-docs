...
يستخدم هذا المثال كائن `params` وبيانات خارجية لإنشاء صور متعددة [Open Graph images](/docs/app/api-reference/file-conventions/metadata/opengraph-image) لقطاع مسار.
