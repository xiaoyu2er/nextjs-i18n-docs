...
تتيح لك وظيفة `headers` قراءة رؤوس طلب HTTP الواردة من [مكون الخادم (Server Component)](/docs/app/building-your-application/rendering/server-components).
