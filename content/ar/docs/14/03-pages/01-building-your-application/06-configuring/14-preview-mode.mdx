...
> **من الجيد معرفة**: أثناء العرض، يعرض `next/router` علامة `isPreview`، راجع [توثيق كائن الموجه](/docs/pages/api-reference/functions/use-router#router-object) لمزيد من المعلومات.
...
> **من الجيد معرفة**: لا يجب عليك تعيين رأس `Cache-Control` عند استخدام وضع المعاينة لأنه لا يمكن تجاوزه. بدلاً من ذلك، نوصي باستخدام [ISR](/docs/pages/building-your-application/data-fetching/incremental-static-regeneration).
