...
> - ستتأثر مسارات API بـ[إعدادات `pageExtensions`](/docs/pages/api-reference/next-config-js/pageExtensions) في `next.config.js`.
...
إذا كنت ترغب في استخدام مسارات API مع Edge Runtime، نوصي بتبني App Router تدريجيًا واستخدام [معالجات المسار (Route Handlers)](/docs/app/building-your-application/routing/route-handlers) بدلاً من مسارات API.
