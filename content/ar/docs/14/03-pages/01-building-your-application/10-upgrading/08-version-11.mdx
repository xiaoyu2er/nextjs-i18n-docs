...
أدخل React 17 [تحويل JSX جديد](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html) الذي يجلب ميزة طويلة الأمد لـ Next.js إلى نظام React الأوسع: عدم الحاجة إلى `import React from 'react'` عند استخدام JSX. عند استخدام React 17 سيقوم Next.js تلقائيًا باستخدام التحويل الجديد. هذا التحويل لا يجعل المتغير `React` عامًا، والذي كان تأثيرًا جانبيًا غير مقصود للتنفيذ السابق لـ Next.js. يتوفر [أداة تحويل أكواد](/docs/pages/building-your-application/upgrading/codemods#add-missing-react-import) لإصلاح الحالات التي استخدمت فيها `React` دون استيراده عن طريق الخطأ.
