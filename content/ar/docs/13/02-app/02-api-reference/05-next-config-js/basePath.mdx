...
translation-updated-at: 2025-06-06T18:00:33.218Z
title: basePath
...
> **معلومة مفيدة**: يجب تعيين هذه القيمة أثناء عملية البناء ولا يمكن تغييرها دون إعادة البناء لأن القيمة مضمنة في حزم جانب العميل.
...
هذا يضمن أنك لست مضطرًا لتغيير جميع الروابط في تطبيقك عند تغيير قيمة `basePath`.
...
على سبيل المثال، استخدام `/docs/me.png` سيقدم صورتك بشكل صحيح عندما يتم تعيين `basePath` إلى `/docs`.
