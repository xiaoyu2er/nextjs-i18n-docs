...
translation-updated-at: 2025-06-06T17:57:25.233Z
title: revalidateTag
description: مرجع API لوظيفة `revalidateTag`.
---

تتيح لك `revalidateTag` إبطال [البيانات المخزنة مؤقتًا](/docs/app/building-your-application/caching) عند الطلب لعلامة تخزين مؤقت محددة.
...
- `tag`: سلسلة تمثل علامة التخزين المؤقت المرتبطة بالبيانات التي تريد إبطالها. يجب أن تكون أقل من أو تساوي 256 حرفًا.
