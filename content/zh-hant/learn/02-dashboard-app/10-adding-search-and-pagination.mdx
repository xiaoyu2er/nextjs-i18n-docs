...
description: 使用 Next.js API 為您的儀表板應用程式實作搜尋與分頁功能
image: >-
  https://nextjs.org/api/learn-og?title=Adding%20Search%20and%20Pagination&amp;chapter=10&amp;sig=34d621edb300a7fd
---
...
為什麼要使用 URL 搜尋參數？[](#why-use-url-search-params)
--------------------------------------------------------
...
實作搜尋功能 [](#adding-the-search-functionality)
-------------------------------------------------------------------
...
### 1\. 取得使用者的輸入 [](#1-capture-the-users-input)
...
### 最佳實作：防抖 [](#best-practice-debouncing)
