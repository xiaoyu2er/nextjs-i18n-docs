...
透過[特殊檔案](/docs/app/building-your-application/routing#file-conventions)建立的 React 元件會以[特定的嵌套層級結構](/docs/app/building-your-application/routing#component-hierarchy)渲染。
