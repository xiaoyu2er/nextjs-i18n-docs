...
translation-updated-at: 2025-06-06T17:57:55.661Z
...
`exportPathMap` ermöglicht es Ihnen, eine Zuordnung von Anfragepfaden zu Seitenzielen anzugeben, die während des Exports verwendet werden soll. Pfade, die in `exportPathMap` definiert sind, sind auch verfügbar, wenn [`next dev`](/docs/app/api-reference/next-cli#development) verwendet wird.
