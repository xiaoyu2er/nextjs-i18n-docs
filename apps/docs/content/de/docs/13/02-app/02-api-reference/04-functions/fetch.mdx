...
translation-updated-at: 2025-06-06T18:00:58.622Z
title: fetch
...
Im Browser gibt die `cache`-Option an, wie eine Fetch-Anfrage mit dem _Browser_-HTTP-Cache interagiert. Mit dieser Erweiterung gibt `cache` an, wie eine _server-seitige_ Fetch-Anfrage mit dem persistenten HTTP-Cache des Frameworks interagiert.
...
Legt die Cache-Tags einer Ressource fest. Daten können dann bedarfsgesteuert mit [`revalidateTag`](https://nextjs.org/docs/app/api-reference/functions/revalidateTag) revalidiert werden. Die maximale Länge für einen benutzerdefinierten Tag beträgt 256 Zeichen.
