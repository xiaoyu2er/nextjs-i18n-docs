...
translation-updated-at: 2025-06-06T17:52:39.951Z
title: PostCSS
...
CSS-Variablen werden nicht kompiliert, da dies [nicht sicher möglich ist](https://github.com/MadLittleMods/postcss-css-variables#caveats). Wenn Sie Variablen verwenden müssen, sollten Sie stattdessen [Sass-Variablen](https://sass-lang.com/documentation/variables) verwenden, die von [Sass](https://sass-lang.com/) kompiliert werden.
...
Mehr über die [CSS-Module-Unterstützung von Next.js erfahren Sie hier](/docs/pages/building-your-application/styling).
