...
translation-updated-at: 2025-06-06T17:56:35.368Z
...
Jeder `<Link />` im Viewport (initial oder durch Scrollen) wird standardmäßig vorab geladen (inklusive der entsprechenden Daten) für Seiten, die [Statische Generierung](/docs/pages/building-your-application/data-fetching/get-static-props) verwenden. Die entsprechenden Daten für [server-seitig gerenderte](/docs/pages/building-your-application/data-fetching/get-server-side-props) Routen werden _nur dann_ abgerufen, wenn auf den `<Link />` geklickt wird.

## Verlinkung zu dynamischen Pfaden

Sie können auch Interpolation verwenden, um den Pfad zu erstellen, was bei [dynamischen Routensegmenten](/docs/pages/building-your-application/routing/dynamic-routes) nützlich ist. Zum Beispiel, um eine Liste von Beiträgen anzuzeigen, die der Komponente als Prop übergeben wurden:
...
Hier verwenden wir anstelle von Interpolation ein URL-Objekt in `href`, wobei:
...
- [Dynamisches Routing](https://github.com/vercel/next.js/tree/canary/examples/dynamic-routing)
...
Das folgende Beispiel zeigt grundlegende Seitennavigationen mit [`useRouter`](/docs/pages/api-reference/functions/use-router):
...
Sie können URL-Änderungen auch über [`componentDidUpdate`](https://react.dev/reference/react/Component#componentdidupdate) beobachten, wie unten gezeigt:
