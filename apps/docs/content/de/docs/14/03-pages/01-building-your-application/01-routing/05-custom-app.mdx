...
- [Globales CSS hinzufügen](/docs/pages/building-your-application/styling)
...
**Wir empfehlen dieses Muster nicht.** Erwägen Sie stattdessen die [schrittweise Einführung](/docs/app/building-your-application/upgrading/app-router-migration) des App-Routers, der das Abrufen von Daten für [Seiten und Layouts](/docs/app/building-your-application/routing/pages-and-layouts) einfacher ermöglicht.
