...
1. Verwendung des React `useEffect()`-Hooks in Ihren Seiten anstelle der serverseitigen Rendering-Methoden ([`getStaticProps`](/docs/pages/building-your-application/data-fetching/get-static-props) und [`getServerSideProps`](/docs/pages/building-your-application/data-fetching/get-server-side-props)).
