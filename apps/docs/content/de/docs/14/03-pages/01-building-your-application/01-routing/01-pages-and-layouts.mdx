...
In Ihrem Layout können Sie clientseitig Daten mit `useEffect` oder einer Bibliothek wie [SWR](https://swr.vercel.app/) abrufen. Da diese Datei keine [Seite](/docs/pages/building-your-application/routing/pages-and-layouts) ist, können Sie derzeit `getStaticProps` oder `getServerSideProps` nicht verwenden.
