...
translation-updated-at: 2025-06-06T17:30:48.537Z
title: userAgent
...
{/* Der Inhalt dieses Dokuments wird sowohl vom App- als auch vom Pages-Router genutzt. Sie können die Komponente `<PagesOnly>Inhalt</PagesOnly>` verwenden, um Inhalte hinzuzufügen, die spezifisch für den Pages Router sind. Gemeinsam genutzte Inhalte sollten nicht in eine Komponente eingeschlossen werden. */}
