...
translation-updated-at: 2025-06-02T19:57:27.087Z
...
Wenn Sie bestimmte Browser oder Funktionen ansprechen möchten, unterstützt Next.js die [Browserslist](https://browsersl.ist)-Konfiguration in Ihrer `package.json`-Datei. Next.js verwendet standardmäßig folgende Browserslist-Konfiguration:
...
Wir integrieren [weit verbreitete Polyfills](https://github.com/vercel/next.js/blob/canary/packages/next-polyfill-nomodule/src/index.js), darunter:
...
Next.js bietet integrierte TypeScript-Unterstützung. [Mehr erfahren](/docs/pages/api-reference/config/typescript).

### Anpassung der Babel-Konfiguration (Fortgeschritten)

Sie können die Babel-Konfiguration anpassen. [Mehr erfahren](/docs/pages/guides/babel).