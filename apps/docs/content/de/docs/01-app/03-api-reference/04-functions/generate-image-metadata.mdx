...
Ein Objekt, das die [dynamischen Routenparameter](/docs/app/api-reference/file-conventions/dynamic-routes) vom Wurzelsegment bis zu dem Segment enthält, aus dem `generateImageMetadata` aufgerufen wird.
