...
> **須知**：自訂圖片載入器檔案（接受函式）需要使用 [客戶端元件 (Client Components)](/docs/app/building-your-application/rendering/client-components) 來序列化提供的函式。

若要進一步了解如何設定內建 [圖片優化 API](/docs/app/building-your-application/optimizing/images) 和 [圖片元件 (Image Component)](/docs/app/api-reference/components/image) 的行為，請參閱 [圖片配置選項](/docs/app/api-reference/components/image#configuration-options) 以查看可用選項。
...
若要進一步了解如何設定內建 [圖片優化 API](/docs/pages/building-your-application/optimizing/images) 和 [圖片元件 (Image Component)](/docs/pages/api-reference/components/image) 的行為，請參閱 [圖片配置選項](/docs/pages/api-reference/components/image#configuration-options) 以查看可用選項。
