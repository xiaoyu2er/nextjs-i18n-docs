...
title: Edge Runtime 邊緣運行時
description: Edge Runtime 的 API 參考文檔。
---

{/* 此文件內容在應用程式路由和頁面路由之間共享。您可以使用 `<PagesOnly>內容</PagesOnly>` 元件來添加特定於頁面路由的內容。任何共享內容不應包裹在元件中。 */}

Next.js 提供兩種伺服器運行時供您在應用程式中使用：

- **Node.js 運行時**（預設），可訪問所有 Node.js API，用於渲染您的應用程式。
- **Edge 運行時**，包含較[有限的 API 集合](#reference)，用於[中介軟體](/docs/app/api-reference/file-conventions/middleware)。

## 注意事項

- Edge 運行時不支援所有 Node.js API。某些套件可能無法按預期工作。
- Edge 運行時不支援增量靜態再生 (ISR)。
- 兩種運行時都可以支援[串流](/docs/app/api-reference/file-conventions/loading)，具體取決於您的部署適配器。
...
| [`File`](https://developer.mozilla.org/docs/Web/API/File)                       | 表示一個檔案               |
| [`FormData`](https://developer.mozilla.org/docs/Web/API/FormData)               | 表示表單數據               |
...
| [`Response`](https://developer.mozilla.org/docs/Web/API/Response)               | 表示一個 HTTP 響應         |
| [`URLSearchParams`](https://developer.mozilla.org/docs/Web/API/URLSearchParams) | 表示 URL 搜尋參數          |
| [`WebSocket`](https://developer.mozilla.org/docs/Web/API/WebSocket)             | 表示一個 WebSocket 連接    |

### 編碼 API

| API                                                                                 | 描述                        |
| ----------------------------------------------------------------------------------- | -------------------------- |
| [`atob`](https://developer.mozilla.org/en-US/docs/Web/API/atob)                     | 解碼 base-64 編碼的字串    |
...
| API                                                                       | 描述                                                                                         |
| ------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [`crypto`](https://developer.mozilla.org/docs/Web/API/Window/crypto)      | 提供對平台加密功能的訪問                                                                     |
| [`CryptoKey`](https://developer.mozilla.org/docs/Web/API/CryptoKey)       | 表示一個加密金鑰                                                                            |
| [`SubtleCrypto`](https://developer.mozilla.org/docs/Web/API/SubtleCrypto) | 提供對常見加密原語的訪問，如雜湊、簽名、加密或解密                                          |
...
| [`BigInt64Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/BigInt64Array)           | 表示 64 位元有號整數的型別陣列                                                                                                                                                   |
| [`BigUint64Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/BigUint64Array)         | 表示 64 位元無號整數的型別陣列                                                                                                                                                 |
| [`Boolean`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Boolean)                       | 表示邏輯實體，可以有兩個值：`true` 和 `false`                                                                                                                              |
...
| [`Float32Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Float32Array)             | 表示 32 位元浮點數的型別陣列                                                                                                                                            |
| [`Float64Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Float64Array)             | 表示 64 位元浮點數的型別陣列                                                                                                                                            |
| [`Function`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)                     | 表示函式                                                                                                                                                                                |
| [`Infinity`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Infinity)                     | 表示數學上的無限大值                                                                                                                                                           |
| [`Int8Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Int8Array)                   | 表示 8 位元有號整數的型別陣列                                                                                                                                                    |
| [`Int16Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Int16Array)                 | 表示 16 位元有號整數的型別陣列                                                                                                                                                   |
| [`Int32Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Int32Array)                 | 表示 32 位元有號整數的型別陣列                                                                                                                                                   |
| [`Intl`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Intl)                             | 提供國際化和本地化功能的存取                                                                                                                               |
...
| [`JSON`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/JSON)                             | 提供將 JavaScript 值與 JSON 格式相互轉換的功能                                                                                                                      |
| [`Map`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Map)                               | 表示值的集合，其中每個值只能出現一次                                                                                                                              |
| [`Math`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Math)                             | 提供對數學函式和常數的存取                                                                                                                                              |
| [`Number`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Number)                         | 表示數值                                                                                                                                                                           |
...
| [`Proxy`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Proxy)                           | 表示用於為基本操作 (例如屬性查找、賦值、枚舉、函式調用等) 定義自訂行為的物件                                     |
| [`queueMicrotask`](https://developer.mozilla.org/docs/Web/API/queueMicrotask)                                         | 將微任務排入佇列以執行                                                                                                                                                                    |
| [`RangeError`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RangeError)                 | 表示值不在允許的集合或範圍內時發生的錯誤                                                                                                                        |
...
| [`Set`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Set)                               | 表示值的集合，其中每個值只能出現一次                                                                                                                              |
| [`setInterval`](https://developer.mozilla.org/docs/Web/API/setInterval)                                               | 重複呼叫函式，每次呼叫之間有固定的時間延遲                                                                                                                               |
| [`setTimeout`](https://developer.mozilla.org/docs/Web/API/setTimeout)                                                 | 在指定的毫秒數後呼叫函式或評估表達式                                                                                                                 |
| [`SharedArrayBuffer`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/SharedArrayBuffer)   | 表示通用的、固定長度的原始二進位資料緩衝區                                                                                                                                            |
| [`String`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)                         | 表示字元序列                                                                                                                                                                  |
| [`structuredClone`](https://developer.mozilla.org/docs/Web/API/Web_Workers_API/Structured_clone_algorithm)            | 建立值的深拷貝                                                                                                                                                                       |
| [`Symbol`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Symbol)                         | 表示唯一且不可變的資料類型，用作物件屬性的鍵                                                                                                            |
| [`SyntaxError`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/SyntaxError)               | 表示嘗試解析語法無效的程式碼時發生的錯誤                                                                                                                              |
| [`TypeError`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/TypeError)                   | 表示值不是預期類型時發生的錯誤                                                                                                                                         |
| [`Uint8Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array)                 | 表示 8 位元無號整數的型別陣列                                                                                                                                                  |
| [`Uint8ClampedArray`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Uint8ClampedArray)   | 表示限制在 0-255 範圍內的 8 位元無號整數型別陣列                                                                                                                                 |
| [`Uint32Array`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Uint32Array)               | 表示 32 位元無號整數的型別陣列                                                                                                                                                 |
| [`URIError`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/URIError)                     | 表示全域 URI 處理函式使用不當時發生的錯誤                                                                                                                      |
...
| [`new Function(evalString)`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)               | 使用提供的程式碼作為參數建立新函式                                   |
...
在極少數情況下，你的程式碼可能包含（或匯入）一些動態程式碼評估語句，這些語句在執行時**無法被執行到**且無法透過 tree shaking 移除。你可以透過 Middleware 配置放寬檢查，允許特定檔案：
...
`unstable_allowDynamic` 是一個 [glob](https://github.com/micromatch/micromatch#matching-features) 或 glob 陣列，用於忽略特定檔案的動態程式碼評估檢查。這些 glob 路徑是相對於你的應用程式根目錄。

請注意，如果這些語句在 Edge 環境中執行，**將會拋出錯誤並導致執行時錯誤**。
