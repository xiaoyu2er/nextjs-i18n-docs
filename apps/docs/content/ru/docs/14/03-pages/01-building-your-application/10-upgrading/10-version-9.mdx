...
translation-updated-at: 2025-06-06T16:47:03.242Z
...
Если вы ранее настраивали `routes` в файле `vercel.json` для динамических маршрутов, эти правила можно удалить при использовании новой [функции динамической маршрутизации](/docs/pages/building-your-application/routing/dynamic-routes) в Next.js 9.
