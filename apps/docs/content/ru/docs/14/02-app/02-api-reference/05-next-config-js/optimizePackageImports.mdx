...
translation-updated-at: 2025-06-06T16:52:29.200Z
...
Добавление пакета в `experimental.optimizePackageImports` приведёт к загрузке только тех модулей, которые вы действительно используете, сохраняя при этом удобство написания импортов с множеством именованных экспортов.
