...
translation-updated-at: 2025-06-06T16:55:28.634Z
title: useRouter
description: Справочник API для хука useRouter.
---
...
> **Рекомендация:** Используйте [компонент `<Link>`](/docs/app/building-your-application/routing/linking-and-navigating#link-component) для навигации, если у вас нет специальных требований для использования `useRouter`.
...
- `router.prefetch(href: string)`: [Предзагружает (Prefetch)](/docs/app/building-your-application/routing/linking-and-navigating#2-prefetching) указанный маршрут для более быстрых клиентских переходов.
