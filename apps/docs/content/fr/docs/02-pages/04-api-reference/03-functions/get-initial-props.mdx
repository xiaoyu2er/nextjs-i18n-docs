...
translation-updated-at: 2025-06-02T20:02:49.086Z
...
- `getInitialProps` ne peut être utilisé que dans les fichiers de premier niveau de `pages/`, et non dans les composants imbriqués. Pour avoir une récupération de données imbriquée au niveau du composant, envisagez d'explorer le [Routeur App](/docs/app/building-your-application/data-fetching).
