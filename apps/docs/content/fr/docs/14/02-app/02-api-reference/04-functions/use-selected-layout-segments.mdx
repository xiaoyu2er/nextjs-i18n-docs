...
`useSelectedLayoutSegments` accepte _optionnellement_ une clé [`parallelRoutesKey`](/docs/app/building-your-application/routing/parallel-routes#useselectedlayoutsegments), qui permet de lire le segment de route actif dans cet emplacement.
