...
**Cet en-tête a été remplacé par l'option `frame-ancestors` de CSP**, qui a un meilleur support dans les navigateurs modernes (voir [Content Security Policy](/docs/app/building-your-application/configuring/content-security-policy) pour les détails de configuration).
...
Apprenez-en plus sur l'ajout d'une [Content Security Policy](/docs/app/building-your-application/configuring/content-security-policy) à votre application.
