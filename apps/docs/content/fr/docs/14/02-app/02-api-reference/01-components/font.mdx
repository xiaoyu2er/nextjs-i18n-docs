...
Cette référence API vous aidera à comprendre comment utiliser [`next/font/google`](/docs/app/building-your-application/optimizing/fonts#google-fonts) et [`next/font/local`](/docs/app/building-your-application/optimizing/fonts#local-fonts). Pour les fonctionnalités et l'utilisation, veuillez consulter la page [Optimisation des polices](/docs/app/building-your-application/optimizing/fonts).

### Arguments de la fonction de police

Pour l'utilisation, consultez [Google Fonts](/docs/app/building-your-application/optimizing/fonts#google-fonts) et [Polices locales](/docs/app/building-your-application/optimizing/fonts#local-fonts).
