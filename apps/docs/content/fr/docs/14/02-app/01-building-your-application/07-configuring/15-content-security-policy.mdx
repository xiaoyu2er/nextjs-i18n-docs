...
translation-updated-at: 2025-06-06T17:12:45.956Z
...
Pour les applications qui ne nécessitent pas de nonces, vous pouvez définir l'en-tête CSP directement dans votre fichier [`next.config.js`](/docs/app/api-reference/next-config-js) :
