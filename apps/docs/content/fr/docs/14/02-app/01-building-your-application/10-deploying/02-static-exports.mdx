...
translation-updated-at: 2025-06-06T17:11:02.878Z
...
L'[Optimisation des images](/docs/app/building-your-application/optimizing/images) via `next/image` peut être utilisée avec une exportation statique en définissant un chargeur d'image personnalisé dans `next.config.js`. Par exemple, vous pouvez optimiser les images avec un service comme Cloudinary :
