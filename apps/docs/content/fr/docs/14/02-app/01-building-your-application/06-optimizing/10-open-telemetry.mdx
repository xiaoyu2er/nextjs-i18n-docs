...
translation-updated-at: 2025-06-06T17:16:24.709Z
title: OpenTelemetry
...
Ensuite, créez un fichier personnalisé [`instrumentation.ts`](/docs/app/building-your-application/optimizing/instrumentation) (ou `.js`) dans le **répertoire racine** du projet (ou dans le dossier `src` si vous en utilisez un) :

</AppOnly>

<PagesOnly>

Ensuite, créez un fichier personnalisé [`instrumentation.ts`](/docs/pages/building-your-application/optimizing/instrumentation) (ou `.js`) dans le **répertoire racine** du projet (ou dans le dossier `src` si vous en utilisez un) :
...
OpenTelemetry Collector n'est pas obligatoire. Vous pouvez utiliser un exportateur OpenTelemetry personnalisé avec [`@vercel/otel`](#using-vercelotel) ou [la configuration manuelle d'OpenTelemetry](/docs/pages/building-your-application/optimizing/open-telemetry#manual-opentelemetry-configuration).
