...
| Nom             | Description                                                                                                                                                                                                           |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `params`        | Si cette page utilise une [route dynamique](/docs/pages/building-your-application/routing/dynamic-routes), `params` contient les paramètres de route. Si le nom de la page est `[id].js`, alors `params` ressemblera à `{ id: ... }`. |
