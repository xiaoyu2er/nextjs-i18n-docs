...
translation-updated-at: 2025-06-06T16:56:43.550Z
title: Babel
...
Pour commencer, vous devez simplement définir un fichier `.babelrc` (ou `babel.config.js`) à la racine de votre projet. Si un tel fichier est trouvé, il sera considéré comme la _source de vérité_, et devra donc également inclure ce dont Next.js a besoin, à savoir le préréglage `next/babel`.
