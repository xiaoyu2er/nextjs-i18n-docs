...
Si vous utilisez actuellement l'option `target` définie sur `serverless`, consultez la [documentation sur l'utilisation de la nouvelle sortie](/docs/pages/api-reference/next-config-js/output).