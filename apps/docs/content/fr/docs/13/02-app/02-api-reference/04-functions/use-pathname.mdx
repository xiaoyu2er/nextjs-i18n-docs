...
translation-updated-at: 2025-06-06T17:33:38.533Z
title: usePathname
description: Référence API pour le hook usePathname.
---

`usePathname` est un hook pour les **Composants Client** qui permet de lire le **pathname** (chemin) de l'URL actuelle.
