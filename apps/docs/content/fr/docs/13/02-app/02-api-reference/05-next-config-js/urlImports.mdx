...
translation-updated-at: 2025-06-06T17:31:15.906Z
title: Importations depuis des URL
description: Configurer Next.js pour autoriser l'importation de modules depuis des URL externes (expérimental).
---
...
> **Avertissement** : Cette fonctionnalité est expérimentale. N'utilisez que des domaines de confiance pour télécharger et exécuter du code sur votre machine. Veuillez faire preuve
> de discernement et de prudence jusqu'à ce que la fonctionnalité soit marquée comme stable.
...
Les importations depuis des URL peuvent être utilisées partout où les imports de packages normaux peuvent l'être.
...
Lorsque vous utilisez des importations depuis des URL, Next.js créera un répertoire `next.lock` contenant un fichier de verrouillage et les ressources téléchargées.
...
- Lors de l'exécution de `next build`, Next.js utilisera uniquement le fichier de verrouillage pour construire l'application pour la production

En général, aucune requête réseau n'est nécessaire et tout fichier de verrouillage obsolète fera échouer la construction.
