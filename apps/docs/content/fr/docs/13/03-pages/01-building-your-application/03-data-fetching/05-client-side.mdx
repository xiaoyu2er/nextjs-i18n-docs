...
translation-updated-at: 2025-06-06T17:28:17.041Z
...
Il est important de noter que l'utilisation de la récupération de données côté client peut affecter les performances de votre application et la vitesse de chargement de vos pages. Cela est dû au fait que la récupération des données se fait au moment du montage des composants ou des pages, et que les données ne sont pas mises en cache.
...
Pour plus d'informations sur l'utilisation de SWR, consultez la [documentation de SWR](https://swr.vercel.app/docs/getting-started).
