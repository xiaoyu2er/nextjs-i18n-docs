...
translation-updated-at: 2025-06-02T20:15:19.656Z
title: Link
...
> **Bon à savoir** :
>
> - Next.js défiera vers la [Page](/docs/app/api-reference/file-conventions/page) si elle n'est pas visible dans la fenêtre d'affichage lors de la navigation.
...
Vous pouvez utiliser toutes les propriétés définies dans la [documentation du module URL de Node.js](https://nodejs.org/api/url.html#url_url_strings_and_url_objects).
