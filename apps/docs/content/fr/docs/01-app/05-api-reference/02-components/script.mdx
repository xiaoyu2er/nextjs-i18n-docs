...
translation-updated-at: 2025-06-02T20:10:17.875Z
title: Script
...
Cette référence d'API vous aidera à comprendre comment utiliser les [props](#props) disponibles pour le composant Script. Pour les fonctionnalités et l'utilisation, veuillez consulter la page [Optimisation des scripts](/docs/app/guides/scripts).
...
| `v12.2.2` | Autorisation de `next/script` avec `beforeInteractive` dans `_document`.      |
