...
translation-updated-at: 2025-06-02T20:07:55.491Z
title: Routes parallèles
description: Affichez simultanément une ou plusieurs pages dans la même vue pouvant être naviguées indépendamment. Un modèle pour les applications hautement dynamiques.
related:
  links:
...
Les Routes parallèles peuvent être utilisées avec les [Routes d'interception](/docs/app/api-reference/file-conventions/intercepting-routes) pour créer des modales qui prennent en charge le lien profond. Cela vous permet de résoudre les défis courants lors de la création de modales, tels que :
...
> **Bon à savoir :**
>
> - La convention utilisée pour intercepter la route, par exemple `(.)`, dépend de la structure de votre système de fichiers. Voir [Convention des Routes d'interception](/docs/app/api-reference/file-conventions/intercepting-routes#convention).
...
Voir la documentation [UI de chargement](/docs/app/building-your-application/routing/loading-ui-and-streaming) et [Gestion des erreurs](/docs/app/getting-started/error-handling) pour plus d'informations.