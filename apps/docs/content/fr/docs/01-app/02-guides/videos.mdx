...
translation-updated-at: 2025-06-02T19:59:36.267Z
...
La balise HTML [`<video>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video) permet d'intégrer du contenu vidéo auto-hébergé ou servi directement, offrant un contrôle total sur la lecture et l'apparence.
...
Pour une liste complète des attributs vidéo, consultez la [documentation MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/video#attributes).
...
- **Sous-titres ou légendes** : Incluez des sous-titres ou des légendes pour les utilisateurs sourds ou malentendants. Utilisez la balise [`<track>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/track) avec vos éléments `<video>` pour spécifier les sources des fichiers de sous-titres.
...
Pour une liste complète des attributs iframe, consultez la [documentation MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/iframe#attributes).
...
> - Mettez en œuvre des [stratégies de chargement des vidéos](https://yoast.com/site-speed-tips-for-faster-video/) en fonction des conditions réseau, en particulier pour les utilisateurs avec des forfaits de données limités.
...
- **Compréhension des formats et codecs vidéo** : Choisissez le bon format et codec, comme MP4 pour la compatibilité ou WebM pour l'optimisation web, pour vos besoins vidéo. Pour plus de détails, voir le [guide Mozilla sur les codecs vidéo](https://developer.mozilla.org/en-US/docs/Web/Media/Formats/Video_codecs).
...
- **Ajustement de la résolution et du débit binaire** : Ajustez la [résolution et le débit binaire](https://www.dacast.com/blog/bitrate-vs-resolution/#:~:text=The%20two%20measure%20different%20aspects,yield%20different%20qualities%20of%20video) en fonction de la plateforme de visualisation, avec des paramètres plus bas pour les appareils mobiles.
...
- Documentation officielle et [guide d'intégration](https://next.cloudinary.dev/) pour utiliser Cloudinary avec Next.js.
...
- Trouvez des [exemples](https://github.com/cloudinary-community/cloudinary-examples/?tab=readme-ov-file#nextjs) d'intégration de Cloudinary avec Next.js, y compris la [diffusion adaptative en fonction du débit](https://github.com/cloudinary-community/cloudinary-examples/tree/main/examples/nextjs-cldvideoplayer-abr).
- D'autres [bibliothèques Cloudinary](https://cloudinary.com/documentation), y compris un SDK Node.js, sont également disponibles.
...
- Découvrez les recommandations de Mux pour intégrer des [vidéos haute performance dans votre application Next.js](https://www.mux.com/for/nextjs).
- Explorez un [projet exemple](https://with-mux-video.vercel.app/) démontrant Mux avec Next.js.

### Fastly

- En savoir plus sur l'intégration des solutions de Fastly pour la [vidéo à la demande](https://www.fastly.com/products/streaming-media/video-on-demand) et le streaming média dans Next.js.
...
- L'intégration fournit un composant `<IKVideo>`, offrant une [prise en charge transparente des vidéos](https://imagekit.io/docs/integration/nextjs#rendering-videos).
