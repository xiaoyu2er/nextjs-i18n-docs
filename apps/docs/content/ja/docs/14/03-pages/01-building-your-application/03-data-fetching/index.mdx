...
translation-updated-at: 2025-06-06T16:41:49.310Z
title: データフェッチ
description: Next.jsでは、プリレンダリング、サーバーサイドレンダリング (SSR) または静的サイト生成 (SSG)、そしてインクリメンタルスタティックリジェネレーション (ISR) といった複数の方法でデータを取得できます。Next.jsでアプリケーションデータを管理する方法を学びましょう。
---
