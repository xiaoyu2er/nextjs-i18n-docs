...
translation-updated-at: 2025-06-06T17:30:59.255Z
title: robots.txt
description: robots.txt ファイルの API リファレンス
---

検索エンジンのクローラーに対して、サイト内のどの URL にアクセスできるかを指示するには、`app` ディレクトリの**ルート**に [Robots Exclusion Standard](https://en.wikipedia.org/wiki/Robots.txt#Standard) に準拠した `robots.txt` ファイルを追加または生成します。
