...
translation-updated-at: 2025-06-06T17:09:38.323Z
title: クライアントサイドフェッチ
description: クライアントサイドでのデータ取得について学び、キャッシュ、再検証、フォーカストラッキング、インターバルでの再取得などを処理するデータフェッチ用ReactフックライブラリSWRの使用方法を習得します。
---
...
Next.jsの開発チームは、データ取得用のReactフックライブラリ[**SWR**](https://swr.vercel.app/)を作成しました。クライアントサイドでデータを取得する場合、**強く推奨**されます。SWRはキャッシュ、再検証、フォーカストラッキング、インターバルでの再取得などを処理します。
