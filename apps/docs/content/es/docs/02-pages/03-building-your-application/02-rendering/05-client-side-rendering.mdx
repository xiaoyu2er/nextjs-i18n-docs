...
translation-updated-at: 2025-06-02T20:04:39.122Z
title: Renderizado del lado del cliente (CSR)
description: Aprenda a implementar el renderizado del lado del cliente en el enrutador de páginas (Pages Router).
related:
  description: Conozca los métodos alternativos de renderizado en Next.js.
  links:
...
Aunque la obtención de datos en un `useEffect` es un patrón que puede verse en aplicaciones antiguas de React, recomendamos usar una biblioteca de obtención de datos para un mejor rendimiento, caché, actualizaciones optimistas y más. Aquí hay un ejemplo mínimo usando [SWR](https://swr.vercel.app/) para obtener datos en el cliente:
