...
| ---------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `basePath`       | `string`                  | La [ruta base](/docs/pages/api-reference/next-config-js/basePath) de la URL.                                                  |
| `buildId`        | `string` \| `undefined`   | El identificador de compilación de la aplicación Next.js. Puede [personalizarse](/docs/pages/api-reference/next-config-js/generateBuildId). |
| `defaultLocale`  | `string` \| `undefined`   | La configuración regional predeterminada para [internacionalización](/docs/pages/building-your-application/routing/internationalization).              |
| `domainLocale`   |                           |                                                                                                                                 |
...
| Propiedad      | Tipo                    | Descripción                                                                                                                   |
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `basePath`     | `string`                | La [ruta base](/docs/app/api-reference/next-config-js/basePath) de la URL.                                                  |
| `buildId`      | `string` \| `undefined` | El identificador de compilación de la aplicación Next.js. Puede [personalizarse](/docs/app/api-reference/next-config-js/generateBuildId). |
| `pathname`     | `string`                | El pathname de la URL.                                                                                                      |
| `searchParams` | `Object`                | Los parámetros de búsqueda de la URL.                                                                                             |

> **Nota:** Las propiedades de internacionalización del Enrutador de Páginas no están disponibles para usar en el Enrutador de Aplicaciones. Más información sobre [internacionalización con el Enrutador de Aplicaciones](/docs/app/building-your-application/routing/internationalization).
