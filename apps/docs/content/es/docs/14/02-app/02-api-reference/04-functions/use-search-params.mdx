...
> **Importante**:
>
> - `useSearchParams` es un hook de [Componente Cliente](/docs/app/building-your-application/rendering/client-components) y **no es compatible** con [Componentes Servidor](/docs/app/building-your-application/rendering/server-components) para evitar valores obsoletos durante el [renderizado parcial](/docs/app/building-your-application/routing/linking-and-navigating#4-partial-rendering).
...
Si una ruta se renderiza [estáticamente](/docs/app/building-your-application/rendering/server-components#static-rendering-default), llamar a `useSearchParams` hará que el árbol de componentes cliente hasta el límite [`Suspense`](/docs/app/building-your-application/routing/loading-ui-and-streaming#example) más cercano se renderice en el cliente.
...
Si una ruta se renderiza [dinámicamente](/docs/app/building-your-application/rendering/server-components#dynamic-rendering), `useSearchParams` estará disponible en el servidor durante el renderizado inicial del Componente Cliente.
