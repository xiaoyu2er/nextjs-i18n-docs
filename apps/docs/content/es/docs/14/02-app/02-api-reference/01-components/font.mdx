...
Para su uso, revisa [Fuentes de Google](/docs/app/building-your-application/optimizing/fonts#google-fonts) y [Fuentes Locales](/docs/app/building-your-application/optimizing/fonts#local-fonts).
...
Los [`subconjuntos`](https://fonts.google.com/knowledge/glossary/subsetting) de la fuente definidos por un array de strings con los nombres de cada subconjunto que deseas que sean [precargados](/docs/app/building-your-application/optimizing/fonts#specifying-a-subset). Las fuentes especificadas mediante `subsets` tendrán una etiqueta de precarga inyectada en el head cuando la opción [`preload`](#preload) sea true, que es el valor predeterminado.
