...
- Advertencia si se pasan valores inválidos para [opciones de configuración de segmentos](/docs/app/api-reference/file-conventions/route-segment-config).
...
Puedes aprender más sobre esta característica en la [documentación de Alias de Módulos](/docs/app/building-your-application/configuring/absolute-imports-and-module-aliases).

</AppOnly>

<PagesOnly>

Puedes aprender más sobre esta característica en la [documentación de Alias de Módulos](/docs/pages/building-your-application/configuring/absolute-imports-and-module-aliases).
