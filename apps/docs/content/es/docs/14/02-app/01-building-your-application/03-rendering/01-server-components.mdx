...
>
> Obtenga más información sobre la [caché de ruta completa](/docs/app/building-your-application/caching#full-route-cache) y [Caché de Datos](/docs/app/building-your-application/caching#data-cache).
...
- **[`cookies()`](/docs/app/api-reference/functions/cookies) y [`headers()`](/docs/app/api-reference/functions/headers)**: Usar estas en un Componente del Servidor hará que toda la ruta opte por el renderizado dinámico en el momento de la solicitud.
- **[`searchParams`](/docs/app/api-reference/file-conventions/page#searchparams-optional)**: Usar la prop `searchParams` en una [Página](/docs/app/api-reference/file-conventions/page) hará que la página opte por el renderizado dinámico en el momento de la solicitud.
...
Puede comenzar a transmitir segmentos de ruta usando `loading.js` y componentes de UI con [React Suspense](/docs/app/building-your-application/routing/loading-ui-and-streaming). Consulte la sección [UI de Carga y Streaming](/docs/app/building-your-application/routing/loading-ui-and-streaming) para obtener más información.