...
Si deseas estilizar Componentes del Servidor, recomendamos usar [Módulos CSS](/docs/app/building-your-application/styling/css-modules) u otras soluciones que generen archivos CSS, como PostCSS o [Tailwind CSS](/docs/app/building-your-application/styling/tailwind-css).
...
Luego, envuelve tu [layout raíz](/docs/app/building-your-application/routing/pages-and-layouts#root-layout-required) con el registro:
