...
Comprender estas diferencias es clave para usar React y Next.js efectivamente. Cubriremos las diferencias y casos de uso con más detalle en las páginas de [Componentes del Servidor](/docs/app/building-your-application/rendering/server-components) y [Componentes del Cliente](/docs/app/building-your-application/rendering/client-components). Por ahora, continuemos construyendo nuestra base.
