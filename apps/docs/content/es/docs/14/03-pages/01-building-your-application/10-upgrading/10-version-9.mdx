...
Si anteriormente configuraste `routes` en tu archivo `vercel.json` para rutas dinámicas, estas reglas pueden eliminarse al aprovechar la nueva [función de Enrutamiento Dinámico](/docs/pages/building-your-application/routing/dynamic-routes) de Next.js 9.
