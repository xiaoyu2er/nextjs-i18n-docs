...
translation-updated-at: 2025-06-06T17:16:49.260Z
title: useSelectedLayoutSegment
description: Referencia de API para el hook useSelectedLayoutSegment.
---

`useSelectedLayoutSegment` es un hook de **Componente Cliente** que te permite leer el segmento de ruta activo **un nivel por debajo** del Layout desde donde se llama.
...
> - `useSelectedLayoutSegment` solo devuelve el segmento un nivel por debajo. Para obtener todos los segmentos activos, consulta [`useSelectedLayoutSegments`](/docs/app/api-reference/functions/use-selected-layout-segments)
...
`useSelectedLayoutSegment` acepta _opcionalmente_ una [`parallelRoutesKey`](/docs/app/building-your-application/routing/parallel-routes#useselectedlayoutsegments), que permite leer el segmento de ruta activo dentro de ese espacio.
...
### Creando un componente de enlace activo
