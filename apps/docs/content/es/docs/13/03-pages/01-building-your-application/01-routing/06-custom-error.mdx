...
translation-updated-at: 2025-06-06T17:12:19.457Z
...
Para crear una página 404 personalizada puedes crear un archivo `pages/404.js`. Este archivo se genera estáticamente durante el tiempo de construcción.
...
> **Es bueno saber**: Puedes usar [`getStaticProps`](/docs/pages/building-your-application/data-fetching/get-static-props) dentro de esta página si necesitas obtener datos en el tiempo de construcción.
...
Para personalizar la página 500 puedes crear un archivo `pages/500.js`. Este archivo se genera estáticamente durante el tiempo de construcción.
...
Los errores 500 son manejados tanto en el lado del cliente como del servidor por el componente `Error`. Si deseas sobrescribirlo, define el archivo `pages/_error.js` y agrega el siguiente código:
...
> `pages/_error.js` solo se usa en producción. En desarrollo obtendrás un error con la pila de llamadas para saber de dónde se originó el error.
