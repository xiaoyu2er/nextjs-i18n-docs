...
Un objeto que contiene los [parámetros de ruta dinámica](/docs/app/api-reference/file-conventions/dynamic-routes) desde el segmento raíz hasta el segmento desde donde se llama a `generateImageMetadata`.
