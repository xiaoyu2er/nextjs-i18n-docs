...
translation-updated-at: 2025-06-02T20:09:36.346Z
...
related:
  ...
  description: Aprende cómo crear modales con Rutas Interceptadas y Rutas Paralelas.
  links:
...
Las Rutas de Intercepción pueden usarse junto con [Rutas Paralelas](/docs/app/api-reference/file-conventions/parallel-routes) para crear modales. Esto te permite resolver desafíos comunes al construir modales, como:
...
Consulta la documentación de [Rutas Paralelas](/docs/app/api-reference/file-conventions/parallel-routes#modals) para ver un ejemplo paso a paso, o revisa nuestro [ejemplo de galería de imágenes](https://github.com/vercel-labs/nextgram).
