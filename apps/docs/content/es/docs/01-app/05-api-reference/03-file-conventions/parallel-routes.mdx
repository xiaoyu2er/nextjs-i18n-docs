...
translation-updated-at: 2025-06-02T20:11:06.564Z
...
<Image
  alt="Rutas no coincidentes en Rutas Paralelas"
...
Las Rutas Paralelas pueden usarse junto con [Rutas de Interceptación](/docs/app/api-reference/file-conventions/intercepting-routes) para crear modales que admitan enlaces profundos. Esto te permite resolver desafíos comunes al construir modales, como:
...
> **Nota importante:**
>
> - La convención usada para interceptar la ruta, ej. `(.)`, depende de tu estructura de archivos. Ver [Convención de Rutas de Interceptación](/docs/app/api-reference/file-conventions/intercepting-routes#convention).
> - Al separar la funcionalidad del `<Modal>` del contenido del modal (`<Login>`), puedes asegurar que cualquier contenido dentro del modal, ej. [formularios](/docs/app/guides/forms), sean Componentes del Servidor. Ver [Intercalado de Componentes del Cliente y Servidor](/docs/app/getting-started/server-and-client-components#examples#supported-pattern-passing-server-components-to-client-components-as-props) para más información.
...
Consulta la documentación de [UI de Carga](/docs/app/building-your-application/routing/loading-ui-and-streaming) y [Manejo de Errores](/docs/app/getting-started/error-handling) para más información.