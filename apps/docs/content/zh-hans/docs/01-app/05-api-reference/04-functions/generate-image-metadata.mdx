...
translation-updated-at: 2025-05-20T22:25:26.769Z
...
一个包含 [动态路由参数](/docs/app/building-your-application/routing/dynamic-routes) 的对象，从根段到调用 `generateImageMetadata` 的段。
