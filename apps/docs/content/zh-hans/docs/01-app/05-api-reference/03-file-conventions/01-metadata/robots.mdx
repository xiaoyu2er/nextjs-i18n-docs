...
translation-updated-at: 2025-05-20T22:59:43.381Z
title: robots.txt
...
> **须知**：`robots.js` 是一种特殊的路由处理器 (Route Handlers)，默认会被缓存，除非它使用了 [动态 API](/docs/app/deep-dive/caching#dynamic-apis) 或 [动态配置](/docs/app/deep-dive/caching#segment-config-options) 选项。
