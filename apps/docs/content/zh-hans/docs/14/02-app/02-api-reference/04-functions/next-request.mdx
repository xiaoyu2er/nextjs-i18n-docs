...
| `buildId`        | `string` \| `undefined`   | Next.js 应用的构建标识符。可[自定义](/docs/pages/api-reference/next-config-js/generateBuildId)。                              |
...
| `buildId`     | `string` \| `undefined` | Next.js 应用的构建标识符。可[自定义](/docs/app/api-reference/next-config-js/generateBuildId)。                              |
