...
translation-updated-at: 2025-05-21T20:52:45.450Z
title: 客户端数据获取
description: 了解客户端数据获取，以及如何使用 SWR —— 一个能够处理缓存、重新验证、焦点追踪、定时重新获取等功能的 React 数据请求钩子库。
---
...
Next.js 团队创建了一个名为 [**SWR**](https://swr.vercel.app/) 的 React 数据请求钩子库。如果您需要在客户端获取数据，**强烈推荐**使用该库。它能够处理缓存、重新验证、焦点追踪、定时重新获取等功能。
