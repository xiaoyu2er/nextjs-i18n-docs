...
translation-updated-at: 2025-06-06T17:57:14.357Z
title: useRouter
...
- `router.prefetch(href: string)`: [جلب مسبق (Prefetch)](/docs/app/building-your-application/routing/linking-and-navigating#1-prefetching) للمسار المحدد لتحقيق انتقالات أسرع من جانب العميل.
...
> **معلومة مفيدة**: تم تغليف `<NavigationEvents>` في [حدود `Suspense`](/docs/app/building-your-application/routing/loading-ui-and-streaming#example) لأن [`useSearchParams()`](/docs/app/api-reference/functions/use-search-params) يتسبب في عرض من جانب العميل حتى حدود `Suspense` الأقرب أثناء [العرض الثابت (static rendering)](/docs/app/building-your-application/rendering/server-components#static-rendering-default). [معرفة المزيد](/docs/app/api-reference/functions/use-search-params#behavior).
