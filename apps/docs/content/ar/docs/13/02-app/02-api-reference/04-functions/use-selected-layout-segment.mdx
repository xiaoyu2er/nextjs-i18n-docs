...
translation-updated-at: 2025-06-06T17:57:03.495Z
...
يقبل `useSelectedLayoutSegment` اختياريًا [`parallelRoutesKey`](/docs/app/building-your-application/routing/parallel-routes#useselectedlayoutsegments)، مما يسمح لك بقراءة مقطع المسار النشط ضمن تلك الفتحة.
