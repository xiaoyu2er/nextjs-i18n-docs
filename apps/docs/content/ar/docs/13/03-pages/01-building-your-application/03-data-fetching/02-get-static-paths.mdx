...
translation-updated-at: 2025-06-06T17:54:40.704Z
...
سيتم تشغيل `getStaticPaths` فقط أثناء البناء في بيئة الإنتاج، ولن يتم استدعاؤه أثناء وقت التشغيل. يمكنك التحقق من إزالة الكود الموجود داخل `getStaticPaths` من حزمة العميل [باستخدام هذه الأداة](https://next-code-elimination.vercel.app/).
...
- يمكن تصدير `getStaticPaths` من [مسار ديناميكي](/docs/pages/building-your-application/routing/dynamic-routes) يستخدم أيضًا `getStaticProps`
