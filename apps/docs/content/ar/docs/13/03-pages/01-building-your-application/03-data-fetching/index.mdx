...
translation-updated-at: 2025-06-06T17:54:19.416Z
title: جلب البيانات
description: يسمح لك Next.js بجلب البيانات بطرق متعددة، مع التصيير المسبق، التصيير من جانب الخادم أو إنشاء الموقع الثابت، والتجديد الثابت التدريجي. تعلم كيفية إدارة بيانات تطبيقك في Next.js.
---
