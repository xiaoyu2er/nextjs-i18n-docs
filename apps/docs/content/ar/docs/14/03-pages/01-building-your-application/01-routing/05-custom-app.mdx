...
`pageProps` هو كائن يحتوي على الخصائص الأولية التي تم تحميلها مسبقًا لصفحتك باستخدام إحدى [طرق جلب البيانات](/docs/pages/building-your-application/data-fetching)، وإلا سيكون كائنًا فارغًا.
...
**لا نوصي باستخدام هذا النمط.** بدلاً من ذلك، فكر في [التبني التدريجي](/docs/app/building-your-application/upgrading/app-router-migration) لموجه التطبيق (App Router)، الذي يسمح لك بجلب البيانات بسهولة أكبر لـ [الصفحات والتخطيطات](/docs/app/building-your-application/routing/pages-and-layouts).
