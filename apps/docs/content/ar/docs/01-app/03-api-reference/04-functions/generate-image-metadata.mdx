...
كائن يحتوي على [معاملات المسار الديناميكي](/docs/app/api-reference/file-conventions/dynamic-routes) من القطاع الجذري وصولًا إلى القطاع الذي يتم استدعاء `generateImageMetadata` منه.
...
يستخدم هذا المثال كائن `params` وبيانات خارجية لإنشاء صور متعددة [لـ Open Graph](/docs/app/api-reference/file-conventions/metadata/opengraph-image) لقطاع مسار.
