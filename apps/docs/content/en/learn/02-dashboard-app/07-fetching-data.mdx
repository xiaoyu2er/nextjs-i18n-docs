...
3.  Check `localhost:3000/dashboard` and you should see a chart that uses `revenue` data.

![Revenue chart showing the total revenue for the last 12 months](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/recent-revenue.png)![Revenue chart showing the total revenue for the last 12 months](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Frecent-revenue.png&w=1920&q=75)
...
![Latest invoices component alongside the revenue chart](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/latest-invoices.png)![Latest invoices component alongside the revenue chart](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flatest-invoices.png&w=1920&q=75)
...
![Dashboard page with all the data fetched](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/complete-dashboard.png)![Dashboard page with all the data fetched](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Fcomplete-dashboard.png&w=1920&q=75)
...
![Diagram showing time with sequential data fetching and parallel data fetching](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/sequential-parallel-data-fetching.png)![Diagram showing time with sequential data fetching and parallel data fetching](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Fsequential-parallel-data-fetching.png&w=3840&q=75)
