...
This configuration uses `eslint-config-next/core-web-vitals`, which includes the [`eslint-plugin-jsx-a11y`](https://www.npmjs.com/package/eslint-plugin-jsx-a11y) plugin for catching accessibility issues.
...
![Create invoice form showing error messages for each field.](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/form-validation-page.png)![Create invoice form showing error messages for each field.](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Fform-validation-page.png&w=1920&q=75)
