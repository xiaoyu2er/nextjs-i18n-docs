...
![Styled page with the logo 'Acme', a description, and login link.](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/home-page-with-tailwind.png)![Styled page with the logo 'Acme', a description, and login link.](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Fhome-page-with-tailwind.png&w=1920&q=75)
...
[CSS Modules](/docs/app/getting-started/css#css-modules) allow you to scope CSS to a component by automatically creating unique class names, so you don't have to worry about style collisions as well.
