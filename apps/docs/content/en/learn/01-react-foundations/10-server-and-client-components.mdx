...
![Diagram showing a browser on the left and a server on the right, separated by a network boundary.](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/learn-client-and-server-environments.png)![Diagram showing a browser on the left and a server on the right, separated by a network boundary.](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-client-and-server-environments.png&w=3840&q=75)
