...
> **Note**: To use Next.js, you will need to have Node.js version **20.9** or above installed on your machine ([see minimum version requirement](/docs/getting-started/installation)), you can [download it here](https://nodejs.org/en/).
...
![Next.js Error Message: You're importing a component that needs useState. It only works in a Client component...](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/learn-usestate-rsc-error.png)![Next.js Error Message: You're importing a component that needs useState. It only works in a Client component...](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-usestate-rsc-error.png&w=3840&q=75)
