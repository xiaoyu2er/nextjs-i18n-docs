...
![Two side-by-side diagrams showing the differences between the rendered DOM elements and Source Code (HTML)](https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/light/learn-dom-and-source.png)![Two side-by-side diagrams showing the differences between the rendered DOM elements and Source Code (HTML)](/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Flearn%2Fdark%2Flearn-dom-and-source.png&w=3840&q=75)
