...
The `redirect` function allows you to redirect the user to another URL. You can call `redirect` in [Server Components](/docs/15/app/getting-started/server-and-client-components), [Route Handlers](/docs/15/app/api-reference/file-conventions/route), and [Server Actions](/docs/15/app/getting-started/updating-data).
...
See the [`redirect` API reference](/docs/15/app/api-reference/functions/redirect) for more information.

## `permanentRedirect` function

The `permanentRedirect` function allows you to **permanently** redirect the user to another URL. You can call `permanentRedirect` in [Server Components](/docs/15/app/getting-started/server-and-client-components), [Route Handlers](/docs/15/app/api-reference/file-conventions/route), and [Server Actions](/docs/15/app/getting-started/updating-data).
...
See the [`permanentRedirect` API reference](/docs/15/app/api-reference/functions/permanentRedirect) for more information.
...
See the [`useRouter` API reference](/docs/15/app/api-reference/functions/use-router) for more information.
