...
- If it's a [unique page](/docs/15/app/api-reference/file-conventions/page), it is preloaded on the unique route for that page.
- If it's a [layout](/docs/15/app/api-reference/file-conventions/layout), it is preloaded on all the routes wrapped by the layout.
- If it's the [root layout](/docs/15/app/api-reference/file-conventions/layout#root-layout), it is preloaded on all routes.
