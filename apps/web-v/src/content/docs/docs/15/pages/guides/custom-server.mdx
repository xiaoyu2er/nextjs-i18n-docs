...
> You may also wish to configure the client-side router to disallow client-side redirects to filename routes; for that refer to [`router.beforePopState`](/docs/15/pages/api-reference/functions/use-router#routerbeforepopstate).
