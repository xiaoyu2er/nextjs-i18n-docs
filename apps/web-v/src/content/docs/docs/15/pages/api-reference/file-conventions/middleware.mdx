...
1. `rewrite` to a route ([Page](/docs/15/app/api-reference/file-conventions/page) or [Route Handler](/docs/15/app/api-reference/file-conventions/route)) that produces a response
...
> **Good to know:** You can configure CORS headers for individual routes in [Route Handlers](/docs/15/app/api-reference/file-conventions/route#cors).
