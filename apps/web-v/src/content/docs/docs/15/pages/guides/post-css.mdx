...
Next.js compiles CSS for its [built-in CSS support](/docs/15/app/getting-started/css) using PostCSS.
...
You can learn more about [Next.js' CSS Module support here](/docs/15/app/getting-started/css).
