...
`revalidatePath` allows you to invalidate [cached data](/docs/15/app/guides/caching) on-demand for a specific path.
...
`revalidatePath` and [`revalidateTag`](/docs/15/app/api-reference/functions/revalidateTag) serve different purposes:
