...
Dependencies used inside [Server Components](/docs/15/app/getting-started/server-and-client-components) and [Route Handlers](/docs/15/app/api-reference/file-conventions/route) will automatically be bundled by Next.js.
