...
- [Prefetching](/docs/15/app/getting-started/linking-and-navigating#prefetching) is disabled or in progress meaning navigation is blocked.
- The destination route is dynamic **and** doesn't include a [`loading.js`](/docs/15/app/api-reference/file-conventions/loading) file that would allow an instant navigation.
