...
> **Good to know:** If you need broader browser support for very old browsers, see the [Tailwind CSS v3 setup instructions](/docs/15/app/guides/tailwind-v3-css).
...
Due to the global nature of stylesheets, and to avoid conflicts, you should import them inside [`pages/_app.js`](/docs/15/pages/building-your-application/routing/custom-app).
...
- You can use the [`cssChunking`](/docs/15/app/api-reference/config/next-config-js/cssChunking) option in `next.config.js` to control how CSS is chunked.
