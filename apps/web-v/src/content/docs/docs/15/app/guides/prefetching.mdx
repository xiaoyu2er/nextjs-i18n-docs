...
When navigating to the new page, there's no full page reload or browser loading spinner. Instead, Next.js performs a [client-side transition](/docs/15/app/getting-started/linking-and-navigating#client-side-transitions), making the page navigation feel instant.

## Prefetching static vs. dynamic routes

|                                                                   | **Static page** | **Dynamic page**                                                                                               |
| ----------------------------------------------------------------- | --------------- | -------------------------------------------------------------------------------------------------------------- |
| **Prefetched**                                                    | Yes, full route | No, unless [`loading.js`](/docs/15/app/api-reference/file-conventions/loading)                                    |
| [**Client Cache TTL**](/docs/15/app/guides/caching#full-route-cache) | 5 min (default) | Off, unless [enabled](/docs/15/app/api-reference/config/next-config-js/staleTimes)                                |
| **Server roundtrip on click**                                     | No              | Yes, streamed after [shell](/docs/15/app/getting-started/partial-prerendering#how-does-partial-prerendering-work) |
...
| With `loading.js` | Layout to first loading boundary | 30s ([configurable](/docs/15/app/api-reference/config/next-config-js/staleTimes)) |
...
Alternatively, you can use [`useRouter`](/docs/15/app/api-reference/functions/use-router) to recreate some of the native `<Link>` behavior. However, be aware this opts you into maintaining prefetching and cache invalidation.
...
[`onInvalidate`](/docs/15/app/api-reference/functions/use-router#userouter) is invoked when Next.js suspects cached data is stale, allowing you to refresh the prefetch.
