...
> Good to know: `manifest.js` is special Route Handlers that is cached by default unless it uses a [Dynamic API](/docs/15/app/guides/caching#dynamic-apis) or [dynamic config](/docs/15/app/guides/caching#segment-config-options) option.
