...
With Static Rendering, HTML is generated ahead of time—either at build time or through [revalidation](/docs/15/app/guides/incremental-static-regeneration). The result is cached and shared across users and requests.
...
- [`connection`](/docs/15/app/api-reference/functions/connection)
- [`draftMode`](/docs/15/app/api-reference/functions/draft-mode)
- [`searchParams` prop](/docs/15/app/api-reference/file-conventions/page#searchparams-optional)
- [`unstable_noStore`](/docs/15/app/api-reference/functions/unstable_noStore)
- [`fetch`](/docs/15/app/api-reference/functions/fetch) with `{ cache: 'no-store' }`
