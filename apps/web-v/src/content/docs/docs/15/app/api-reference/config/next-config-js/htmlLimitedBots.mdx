...
The `htmlLimitedBots` config allows you to specify a list of user agents that should receive blocking metadata instead of [streaming metadata](/docs/15/app/api-reference/functions/generate-metadata#streaming-metadata).
