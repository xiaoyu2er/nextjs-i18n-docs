...
View the [API Reference](/docs/15/pages/api-reference/functions/use-report-web-vitals) for more information.
...
View the [API Reference](/docs/15/app/api-reference/functions/use-report-web-vitals) for more information.
