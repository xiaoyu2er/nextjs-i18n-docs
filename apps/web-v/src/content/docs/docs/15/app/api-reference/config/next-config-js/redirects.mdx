...
For dynamic or per-request locale handling, use [dynamic route segments and middleware](/docs/15/app/guides/internationalization), which can redirect based on the user's preferred language.
