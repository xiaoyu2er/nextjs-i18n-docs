...
> **Warning:** This API will be replaced by [`use cache`](/docs/15/app/api-reference/directives/use-cache) when it reaches stability.
...
> - This API uses Next.js' built-in [Data Cache](/docs/15/app/guides/caching#data-cache) to persist the result across requests and deployments.
