...
View an example of a [custom cache handler](/docs/15/app/guides/self-hosting#configuring-caching) and learn more about the implementation.
...
Returns `Promise<void>`. Learn more about [revalidating data](/docs/15/app/guides/incremental-static-regeneration) or the [`revalidateTag()`](/docs/15/app/api-reference/functions/revalidateTag) function.
