...
- [Route Handlers](/docs/15/app/api-reference/file-conventions/route)
- [`middleware`](/docs/15/app/api-reference/file-conventions/middleware)
- In Pages Router, [API Routes](/docs/15/pages/building-your-application/routing/api-routes)
...
To restrict access, implement authentication and authorization. See [Authentication](/docs/15/app/guides/authentication).
...
- [`sitemap.xml`](/docs/15/app/api-reference/file-conventions/metadata/sitemap)
- [`opengraph-image.jpg`, `twitter-image`](/docs/15/app/api-reference/file-conventions/metadata/opengraph-image)
- [favicon, app icon, and apple-icon](/docs/15/app/api-reference/file-conventions/metadata/app-icons)
- [`manifest.json`](/docs/15/app/api-reference/file-conventions/metadata/manifest)
- [`robots.txt`](/docs/15/app/api-reference/file-conventions/metadata/robots)
...
- [`rewrites`](/docs/15/app/api-reference/config/next-config-js/rewrites) in `next.config.js`.
...
`NextRequest` includes the [`nextUrl`](/docs/15/app/api-reference/functions/next-request#nexturl) property, which exposes parsed values from the incoming request, for example, it makes it easier to access request pathname and search params.
...
Learn more about [`NextRequest`](/docs/15/app/api-reference/functions/next-request) and [`NextResponse`](/docs/15/app/api-reference/functions/next-response).
...
Learn more about redirects in [`redirect`](/docs/15/app/api-reference/functions/redirect) and [`permanentRedirect`](/docs/15/app/api-reference/functions/permanentRedirect)

## Middleware

Only one middleware file is allowed per project. Use `config.matcher` to target specific paths. Learn more about [middleware](/docs/15/app/api-reference/file-conventions/middleware).
...
- [CORS](/docs/15/app/api-reference/file-conventions/route#cors)
...
See more examples on using [Router Handlers](/docs/15/app/api-reference/file-conventions/route#examples) and the [`middleware`](/docs/15/app/api-reference/file-conventions/middleware#examples) API references.

These examples include, working with [Cookies](/docs/15/app/api-reference/file-conventions/route#cookies), [Headers](/docs/15/app/api-reference/file-conventions/route#headers), [Streaming](/docs/15/app/api-reference/file-conventions/route#streaming), Middleware [negative matching](/docs/15/app/api-reference/file-conventions/middleware#negative-matching), and other useful code snippets.
...
`export` mode outputs a static site without a runtime server. Features that require the Next.js runtime are [not supported](/docs/15/app/guides/static-exports#unsupported-features), because this mode produces a static site, and no runtime server.

In `export mode`, only `GET` Route Handlers are supported, in combination with the [`dynamic`](/docs/15/app/api-reference/file-conventions/route-segment-config#dynamic) route segment config, set to `'force-static'`.
