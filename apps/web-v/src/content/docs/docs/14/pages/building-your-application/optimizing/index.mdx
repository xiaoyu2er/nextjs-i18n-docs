...
For large applications, Next.js integrates with popular analytics and monitoring tools to help you understand how your application is performing. Learn more in the <PagesOnly>[Analytics](/docs/14/app/building-your-application/optimizing/analytics), </PagesOnly> [OpenTelemetry](/docs/14/pages/building-your-application/optimizing/open-telemetry)<PagesOnly>,</PagesOnly> and [Instrumentation](/docs/14/pages/building-your-application/optimizing/instrumentation) guides.
