...
Create a [`pages/_app.js` file](/docs/14/pages/building-your-application/routing/custom-app) if not already present.
...
Due to the global nature of stylesheets, and to avoid conflicts, you may **only import them inside [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app)**.
