...
translation-updated-at: 2025-06-06T16:57:31.965Z
title: CSS-in-JS
...
Si vous souhaitez styliser des composants serveur, nous recommandons d'utiliser [les modules CSS](/docs/14/app/building-your-application/styling/css-modules) ou d'autres solutions produisant des fichiers CSS, comme PostCSS ou [Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css).
...
Ensuite, encapsulez votre [layout racine](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required) avec le registre :
...
L'objectif est de supporter du "shadow CSS" similaire aux Web Components, qui malheureusement [ne supportent pas le rendu côté serveur et sont JS uniquement](https://github.com/w3c/webcomponents/issues/71).
...
Veuillez consulter la [documentation styled-jsx](https://github.com/vercel/styled-jsx) pour plus d'exemples.
