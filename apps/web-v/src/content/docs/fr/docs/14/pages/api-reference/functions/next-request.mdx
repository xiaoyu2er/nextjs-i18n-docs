...
translation-updated-at: 2025-06-06T16:53:49.045Z
title: NextRequest
...
| ---------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `basePath`       | `string`                  | Le [chemin de base](/docs/14/pages/api-reference/next-config-js/basePath) de l'URL.                                                |
| `buildId`        | `string` \| `undefined`   | L'identifiant de build de l'application Next.js. Peut être [personnalisé](/docs/14/pages/api-reference/next-config-js/generateBuildId). |
| `defaultLocale`  | `string` \| `undefined`   | La locale par défaut pour [l'internationalisation](/docs/14/pages/building-your-application/routing/internationalization).         |
| `domainLocale`   |                           |                                                                                                                                 |
...
| Propriété      | Type                    | Description                                                                                                                   |
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `basePath`     | `string`                | Le [chemin de base](/docs/14/app/api-reference/next-config-js/basePath) de l'URL.                                                |
| `buildId`      | `string` \| `undefined` | L'identifiant de build de l'application Next.js. Peut être [personnalisé](/docs/14/app/api-reference/next-config-js/generateBuildId). |
| `pathname`     | `string`                | Le chemin de l'URL.                                                                                                           |
| `searchParams` | `Object`                | Les paramètres de recherche de l'URL.                                                                                         |

> **Note :** Les propriétés d'internationalisation du routeur Pages ne sont pas disponibles pour une utilisation dans le routeur App. Apprenez-en plus sur [l'internationalisation avec le routeur App](/docs/14/app/building-your-application/routing/internationalization).
