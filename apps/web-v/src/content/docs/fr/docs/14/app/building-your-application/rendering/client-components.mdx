...
Vous pouvez garder du code côté serveur même s'il est théoriquement imbriqué dans des Composants Client en entrelaçant des Composants Client et Serveur et des [Actions Serveur](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations). Consultez la page [Modèles de Composition](/docs/14/app/building-your-application/rendering/composition-patterns) pour plus d'informations.