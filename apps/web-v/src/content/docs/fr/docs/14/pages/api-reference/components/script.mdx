...
translation-updated-at: 2025-06-06T16:54:00.166Z
title: <Script>
...
Cette référence API vous aidera à comprendre comment utiliser les [props](#props) disponibles pour le composant Script. Pour les fonctionnalités et l'utilisation, veuillez consulter la page [Optimisation des scripts](/docs/14/app/building-your-application/optimizing/scripts).
