...
translation-updated-at: 2025-06-06T16:57:35.234Z
title: Modules CSS
...
Créez un fichier [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) s'il n'existe pas déjà.
...
En raison de la nature globale des feuilles de style, et pour éviter les conflits, vous ne pouvez **les importer que dans [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app)**.
...
- Si vous utilisez [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css), importez la feuille de style en haut du fichier, de préférence dans la [Mise en page racine](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required).
