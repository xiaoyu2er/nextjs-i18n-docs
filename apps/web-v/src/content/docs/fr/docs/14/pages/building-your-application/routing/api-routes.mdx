...
> **Bon à savoir** : Si vous utilisez le routeur App, vous pouvez utiliser [les Composants Serveur](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating) ou [les Gestionnaires de Route](/docs/14/app/building-your-application/routing/route-handlers) à la place des Routes API.
...
> - Les Routes API ne peuvent pas être utilisées avec [les exports statiques](/docs/14/pages/building-your-application/deploying/static-exports). Cependant, [les Gestionnaires de Route](/docs/14/app/building-your-application/routing/route-handlers) dans le routeur App le peuvent.
> - Les Routes API seront affectées par la configuration [`pageExtensions`](/docs/14/pages/api-reference/next-config-js/pageExtensions) dans `next.config.js`.
...
- `res.revalidate(urlPath)` - [Révalider une page à la demande](/docs/14/pages/building-your-application/data-fetching/incremental-static-regeneration#on-demand-revalidation) en utilisant `getStaticProps`. `urlPath` doit être une `string`.
...
Les Routes API prennent en charge [les routes dynamiques](/docs/14/pages/building-your-application/routing/dynamic-routes), et suivent les mêmes règles de nommage de fichiers que celles utilisées pour `pages/`.
...
Si vous souhaitez utiliser les Routes API avec le Runtime Edge, nous recommandons d'adopter progressivement le routeur App et d'utiliser [les Gestionnaires de Route](/docs/14/app/building-your-application/routing/route-handlers) à la place.
