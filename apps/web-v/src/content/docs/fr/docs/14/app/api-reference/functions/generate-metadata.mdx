...
- `props` - Un objet contenant les paramètres de la route actuelle :
  ...
  - `params` - Un objet contenant les [paramètres de route dynamique](/docs/14/app/building-your-application/routing/dynamic-routes) depuis le segment racine jusqu'au segment où `generateMetadata` est appelée. Exemples :
...
> - Les requêtes `fetch` sont automatiquement [mémoïsées](/docs/14/app/building-your-application/caching#request-memoization) pour les mêmes données entre `generateMetadata`, `generateStaticParams`, les Layouts, les Pages et les composants serveur. Le [`cache` de React peut être utilisé](/docs/14/app/building-your-application/caching#request-memoization) si `fetch` n'est pas disponible.
> - `searchParams` n'est disponible que dans les segments `page.js`.
> - Les méthodes Next.js [`redirect()`](/docs/14/app/api-reference/functions/redirect) et [`notFound()`](/docs/14/app/api-reference/functions/not-found) peuvent aussi être utilisées dans `generateMetadata`.
...
> **Déprécié** : L'option `themeColor` dans `metadata` est dépréciée depuis Next.js 14. Veuillez utiliser la [configuration `viewport`](/docs/14/app/api-reference/functions/generate-viewport) à la place.
...
> **Déprécié** : L'option `viewport` dans `metadata` est dépréciée depuis Next.js 14. Veuillez utiliser la [configuration `viewport`](/docs/14/app/api-reference/functions/generate-viewport) à la place.
...
| ----------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<meta http-equiv="...">`     | Utilisez les en-têtes HTTP appropriés via [`redirect()`](/docs/14/app/api-reference/functions/redirect), [Middleware](/docs/14/app/building-your-application/routing/middleware#nextresponse), [En-têtes de sécurité](/docs/14/app/api-reference/next-config-js/headers) |
...
| `<style>`                     | En savoir plus sur [le style dans Next.js](/docs/14/app/building-your-application/styling/css-modules).                                                                                                                                                    |
| `<script>`                    | En savoir plus sur [l'utilisation des scripts](/docs/14/app/building-your-application/optimizing/scripts).                                                                                                                                                          |
...
| --------- | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v13.2.0` | `viewport`, `themeColor` et `colorScheme` dépréciés en faveur de la [configuration `viewport`](/docs/14/app/api-reference/functions/generate-viewport). |
