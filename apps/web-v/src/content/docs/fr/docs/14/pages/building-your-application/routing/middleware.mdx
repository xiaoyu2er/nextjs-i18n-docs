...
1. `rewrite` vers une route ([Page](/docs/14/app/building-your-application/routing/pages-and-layouts) ou [Route Handler](/docs/14/app/building-your-application/routing/route-handlers)) qui produit une réponse
...
1. `rewrite` vers une route ([Page](/docs/14/pages/building-your-application/routing/pages-and-layouts) ou [Edge API Route](/docs/14/pages/building-your-application/routing/api-routes)) qui produit une réponse
2. retourner une `NextResponse` directement. Voir [Produire une réponse](#producing-a-response)
...
> **Bon à savoir :** Vous pouvez configurer les en-têtes CORS pour des routes individuelles dans les [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers#cors).
...
Le Middleware ne prend actuellement en charge que le [runtime Edge](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes). Le runtime Node.js ne peut pas être utilisé.
