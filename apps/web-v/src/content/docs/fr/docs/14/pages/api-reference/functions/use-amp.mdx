...
> La prise en charge d'AMP est l'une de nos fonctionnalités avancées, vous pouvez [en savoir plus sur AMP ici](/docs/14/pages/building-your-application/configuring/amp).
