...
- En utilisant la fonction [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps).
...
Consultez la [référence API de `generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) pour plus d'informations.
