...
translation-updated-at: 2025-06-06T16:57:11.982Z
title: PostCSS
...
Next.js compile le CSS pour sa [prise en charge intégrée du CSS](/docs/14/pages/building-your-application/styling) en utilisant PostCSS.
...
Les variables CSS ne sont pas compilées car il est [impossible de le faire en toute sécurité](https://github.com/MadLittleMods/postcss-css-variables#caveats).
...
Vous pouvez en apprendre plus sur [la prise en charge des Modules CSS par Next.js ici](/docs/14/pages/building-your-application/styling).
