...
Nous recommandons d'utiliser [`next/script`](/docs/14/pages/building-your-application/optimizing/scripts) dans votre composant plutôt que de créer manuellement une balise `<script>` dans `next/head`.
