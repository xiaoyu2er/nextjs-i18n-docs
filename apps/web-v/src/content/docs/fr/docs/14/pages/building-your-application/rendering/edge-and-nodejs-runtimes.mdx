...
- Le **Runtime Edge** est basé sur les [API Web](/docs/14/app/api-reference/edge).
...
| [Streaming HTTP](/docs/14/app/building-your-application/routing/loading-ui-and-streaming)                                                | Oui    | Oui        | Oui              |
...
| [Rendu statique](/docs/14/app/building-your-application/rendering/server-components#static-rendering-default)                            | Oui    | Oui        | Non              |
| [Rendu dynamique](/docs/14/app/building-your-application/rendering/server-components#dynamic-rendering)                                  | Oui    | Oui        | Oui              |
| [Révalidation des données avec `fetch`](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating#revalidating-data) | Oui    | Oui        | Oui              |
...
> Consultez la [documentation Node.js](https://nodejs.org/docs/latest/api/) et la [documentation Edge](/docs/14/app/api-reference/edge) pour la liste complète des API disponibles. Les deux runtimes peuvent également prendre en charge le [streaming](/docs/14/app/building-your-application/routing/loading-ui-and-streaming) selon votre infrastructure de déploiement.