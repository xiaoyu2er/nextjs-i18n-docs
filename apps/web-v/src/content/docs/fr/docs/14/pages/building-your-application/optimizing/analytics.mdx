...
Consultez la [Référence API](/docs/14/pages/api-reference/functions/use-report-web-vitals) pour plus d'informations.
...
Consultez la [Référence API](/docs/14/app/api-reference/functions/use-report-web-vitals) pour plus d'informations.
