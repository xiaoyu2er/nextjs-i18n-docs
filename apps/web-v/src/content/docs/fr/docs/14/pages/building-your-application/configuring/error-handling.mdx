...
Next.js fournit par défaut une page 500 statique pour gérer les erreurs côté serveur dans votre application. Vous pouvez également [personnaliser cette page](/docs/14/pages/building-your-application/routing/custom-error#customizing-the-500-page) en créant un fichier `pages/500.js`.

Avoir une page 500 dans votre application n'affiche pas les erreurs spécifiques à l'utilisateur.

Vous pouvez aussi utiliser une [page 404](/docs/14/pages/building-your-application/routing/custom-error#404-page) pour gérer des erreurs d'exécution spécifiques comme `fichier non trouvé`.
