...
Pour en savoir plus sur le fonctionnement de `getServerSideProps`, consultez notre [documentation sur la récupération de données](/docs/14/pages/building-your-application/data-fetching/get-server-side-props).