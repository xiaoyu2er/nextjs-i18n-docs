...
`revalidateTag` vous permet de purger les [données en cache](/docs/14/app/building-your-application/caching) à la demande pour un tag de cache spécifique.

> **Bon à savoir** :
>
> - `revalidateTag` est disponible dans les deux [environnements d'exécution Node.js et Edge](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes).
