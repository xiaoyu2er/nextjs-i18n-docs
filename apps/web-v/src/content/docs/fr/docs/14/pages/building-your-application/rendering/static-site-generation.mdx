...
Pour en savoir plus sur le fonctionnement de `getStaticProps`, consultez la [documentation sur la récupération de données](/docs/14/pages/building-your-application/data-fetching/get-static-props).
...
Pour en savoir plus sur le fonctionnement de `getStaticPaths`, consultez la [documentation sur la récupération de données](/docs/14/pages/building-your-application/data-fetching/get-static-paths).
...
- Utiliser la génération statique avec **récupération de données côté client** : Vous pouvez ignorer le pré-rendu de certaines parties d'une page et utiliser ensuite JavaScript côté client pour les remplir. Pour en savoir plus sur cette approche, consultez la [documentation sur la récupération de données](/docs/14/pages/building-your-application/data-fetching/client-side).
