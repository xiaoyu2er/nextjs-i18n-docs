...
| -------------- | ------------------ | ------------------------------------------------------------------------------------------------------------- |
| `conf`         | `Object`           | Le même objet que vous utiliseriez dans [next.config.js](/docs/14/pages/api-reference/next-config-js). Par défaut `{}` |
...
> Vous pouvez également configurer le routeur côté client pour interdire les redirections côté client vers les routes basées sur les noms de fichiers ; pour cela, référez-vous à [`router.beforePopState`](/docs/14/pages/api-reference/functions/use-router#routerbeforepopstate).