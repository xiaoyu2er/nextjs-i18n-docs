...
translation-updated-at: 2025-06-06T16:57:07.025Z
...
Cela charge automatiquement `process.env.DB_HOST`, `process.env.DB_USER`, et `process.env.DB_PASS` dans l'environnement Node.js, vous permettant de les utiliser dans les [méthodes de récupération de données Next.js](/docs/14/pages/building-your-application/data-fetching) et les [routes API](/docs/14/pages/building-your-application/routing/api-routes).

Par exemple, avec [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) :
...
> Cela charge automatiquement `process.env.DB_HOST`, `process.env.DB_USER`, et `process.env.DB_PASS` dans l'environnement Node.js, vous permettant de les utiliser dans les [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers).
...
- Si vous utilisez un [dossier `/src`](/docs/14/app/building-your-application/configuring/src-directory), les fichiers `.env.*` doivent rester à la racine de votre projet.
