...
> - Si vous migrez depuis les exports `metadata`, vous pouvez utiliser le [codemod metadata-to-viewport-export](/docs/14/app/building-your-application/upgrading/codemods#metadata-to-viewport-export) pour mettre à jour vos changements.
