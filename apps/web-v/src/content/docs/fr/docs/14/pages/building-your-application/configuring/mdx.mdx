...
Pour partager une mise en page entre les pages MDX, vous pouvez utiliser la [prise en charge intégrée des mises en page](/docs/14/app/building-your-application/routing/pages-and-layouts#layouts) avec App Router.
