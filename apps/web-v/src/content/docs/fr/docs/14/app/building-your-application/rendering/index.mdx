...
Comprendre ces différences est essentiel pour utiliser efficacement React et Next.js. Nous couvrirons ces différences et cas d'utilisation plus en détail dans les pages [Composants Serveur](/docs/14/app/building-your-application/rendering/server-components) et [Composants Client](/docs/14/app/building-your-application/rendering/client-components). Pour l'instant, continuons à construire nos bases.
...
Ce concept deviendra plus clair lorsque nous examinerons comment [entrelacer des composants client et serveur](/docs/14/app/building-your-application/rendering/composition-patterns) dans le même arbre de composants.