...
`revalidateTag` ermöglicht es Ihnen, [zwischengespeicherte Daten](/docs/14/app/building-your-application/caching) bei Bedarf für einen bestimmten Cache-Tag zu löschen.

> **Wissenswert**:
>
> - `revalidateTag` ist in beiden [Node.js- und Edge-Runtimes](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes) verfügbar.
