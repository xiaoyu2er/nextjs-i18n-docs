...
Um AMP-Unterstützung für eine Seite zu aktivieren und mehr über die verschiedenen AMP-Konfigurationen zu erfahren, lesen Sie die [API-Dokumentation für `next/amp`](/docs/14/pages/building-your-application/configuring/amp).

## Einschränkungen

- Nur CSS-in-JS wird unterstützt. [CSS-Module](/docs/14/pages/building-your-application/styling) werden derzeit von AMP-Seiten nicht unterstützt. Sie können [Unterstützung für CSS-Module zu Next.js beitragen](https://github.com/vercel/next.js/issues/10549).
...
Seiten werden auch während des [statischen HTML-Exports](/docs/14/pages/building-your-application/deploying/static-exports) validiert, und alle Warnungen/Fehler werden im Terminal ausgegeben. AMP-Fehler führen dazu, dass der Export mit dem Statuscode `1` beendet wird, da der Export kein gültiges AMP ist.
...
Bei Verwendung des [statischen HTML-Exports](/docs/14/pages/building-your-application/deploying/static-exports) werden Seiten statisch vorgerendert. Next.js erkennt, ob die Seite AMP unterstützt, und passt das Exportverhalten entsprechend an.
...
Wenn [`trailingSlash`](/docs/14/pages/api-reference/next-config-js/trailingSlash) aktiviert ist, würden die exportierten Seiten für `pages/about.js` folgendes sein:
