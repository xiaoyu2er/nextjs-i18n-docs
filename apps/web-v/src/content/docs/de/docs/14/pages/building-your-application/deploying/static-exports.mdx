...
Sie können [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) und [`getStaticPaths`](/docs/14/pages/building-your-application/data-fetching/get-static-paths) verwenden, um für jede Seite in Ihrem `pages`-Verzeichnis eine HTML-Datei zu generieren (oder mehrere für [dynamische Routen](/docs/14/app/building-your-application/routing/dynamic-routes)).
...
- [Dynamische Routen mit `getStaticPaths`](/docs/14/app/building-your-application/routing/dynamic-routes)
- Prefetching mit `next/link`
- Preloading von JavaScript
- [Dynamische Imports](/docs/14/pages/building-your-application/optimizing/lazy-loading)
- Alle Styling-Optionen (z.B. CSS Modules, styled-jsx)
- [Client-seitiges Data Fetching](/docs/14/pages/building-your-application/data-fetching/client-side)
...
[Bildoptimierung](/docs/14/app/building-your-application/optimizing/images) via `next/image` kann mit einem statischen Export verwendet werden, indem ein benutzerdefinierter Image Loader in `next.config.js` definiert wird. Beispielsweise können Bilder mit einem Dienst wie Cloudinary optimiert werden:
...
- [Dynamische Routen](/docs/14/app/building-your-application/routing/dynamic-routes) mit `dynamicParams: true`
- [Dynamische Routen](/docs/14/app/building-your-application/routing/dynamic-routes) ohne `generateStaticParams()`
- [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers) die auf Request angewiesen sind
...
- [Bildoptimierung](/docs/14/app/building-your-application/optimizing/images) mit dem Standard-`loader`
- [Draft Mode](/docs/14/app/building-your-application/configuring/draft-mode)

Der Versuch, diese Features mit `next dev` zu verwenden, führt zu einem Fehler, ähnlich wie das Setzen der [`dynamic`](/docs/14/app/api-reference/file-conventions/route-segment-config#dynamic)-Option auf `error` im Root-Layout.
...
- [Bildoptimierung](/docs/14/pages/building-your-application/optimizing/images) mit dem Standard-`loader`
- [Draft Mode](/docs/14/pages/building-your-application/configuring/draft-mode)
- [`getStaticPaths` mit `fallback: true`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-true)
- [`getStaticPaths` mit `fallback: 'blocking'`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-blocking)
