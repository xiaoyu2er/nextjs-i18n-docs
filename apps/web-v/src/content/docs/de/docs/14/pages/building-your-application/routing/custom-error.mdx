...
translation-updated-at: 2025-06-06T17:26:47.463Z
...
> **Wichtig**: Sie können [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) in dieser Seite verwenden, wenn Sie Daten während des Builds abrufen müssen.
