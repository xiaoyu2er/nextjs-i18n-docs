...
Das Verständnis dieser Unterschiede ist entscheidend für die effektive Nutzung von React und Next.js. Wir werden die Unterschiede und Anwendungsfälle auf den Seiten [Server](/docs/14/app/building-your-application/rendering/server-components) und [Client](/docs/14/app/building-your-application/rendering/client-components) Komponenten ausführlicher behandeln. Lassen Sie uns zunächst unsere Grundlagen weiter ausbauen.
...
Dieses Konzept wird klarer, wenn wir uns ansehen, wie Sie [Client- und Serverkomponenten](/docs/14/app/building-your-application/rendering/composition-patterns) im gleichen Komponentenbaum verschachteln können.