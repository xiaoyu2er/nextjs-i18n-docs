...
Zusätzlich können Sie dynamische Open-Graph-Bilder mit JSX und CSS mithilfe des [imageResponse](/docs/14/app/api-reference/functions/image-response)-Konstruktors erstellen.

</AppOnly>

<PagesOnly>

Die Head-Komponente in Next.js ermöglicht es Ihnen, den `<head>` einer Seite zu modifizieren. Erfahren Sie mehr in der [Head-Komponenten](/docs/14/pages/api-reference/components/head)-Dokumentation.
...
Für große Anwendungen integriert Next.js beliebte Analyse- und Monitoring-Tools, um Ihnen zu helfen, die Leistung Ihrer Anwendung zu verstehen. Erfahren Sie mehr in den Anleitungen zu <PagesOnly>[Analytics](/docs/14/app/building-your-application/optimizing/analytics), </PagesOnly> [OpenTelemetry](/docs/14/pages/building-your-application/optimizing/open-telemetry)<PagesOnly>,</PagesOnly> und [Instrumentation](/docs/14/pages/building-your-application/optimizing/instrumentation).