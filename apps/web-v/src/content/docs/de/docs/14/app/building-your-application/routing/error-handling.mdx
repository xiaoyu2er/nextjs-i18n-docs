...
Die `error.js`-Dateikonvention ermöglicht die elegante Behandlung unerwarteter Laufzeitfehler in [verschachtelten Routen](/docs/14/app/building-your-application/routing#nested-routes).
...
React-Komponenten, die durch [spezielle Dateien](/docs/14/app/building-your-application/routing#file-conventions) erstellt werden, werden in einer [spezifischen verschachtelten Hierarchie](/docs/14/app/building-your-application/routing#component-hierarchy) gerendert.
