...
Next.js kompiliert CSS für seine [integrierte CSS-Unterstützung](/docs/14/pages/building-your-application/styling) mit PostCSS.
...
Mehr über die [CSS Module-Unterstützung in Next.js erfahren Sie hier](/docs/14/pages/building-your-application/styling).
