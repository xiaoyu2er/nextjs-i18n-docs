...
translation-updated-at: 2025-06-06T17:22:28.740Z
title: Version 11
description: Upgrade Ihrer Next.js-Anwendung von Version 10 auf Version 11.
sidebar:
  order: 3011008
---
...
Falls Ihre `pages/_app.js` `Container` aus `next/app` importiert, können Sie `Container` entfernen, da es nicht mehr vorhanden ist. Weitere Informationen finden Sie in der [Dokumentation](/docs/messages/app-container-deprecated).
...
React 17 führte eine neue [JSX-Transformation](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html) ein, die eine langjährige Next.js-Funktion in das React-Ökosystem bringt: Das Fehlen von `import React from 'react'` bei der Verwendung von JSX. Bei Verwendung von React 17 verwendet Next.js automatisch die neue Transformation. Diese Transformation macht die `React`-Variable nicht global, was ein unbeabsichtigter Nebeneffekt der vorherigen Next.js-Implementierung war. Ein [Codemod ist verfügbar](/docs/14/pages/building-your-application/upgrading/codemods#add-missing-react-import), um Fälle automatisch zu korrigieren, in denen Sie versehentlich `React` ohne Import verwendet haben.
