...
[**`next/font`**](/docs/14/app/api-reference/components/font) optimiert Ihre Schriftarten (einschließlich benutzerdefinierter Schriftarten) automatisch und entfernt externe Netzwerkanfragen für verbesserten Datenschutz und bessere Leistung.
...
Um die Schriftart auf allen Seiten zu verwenden, fügen Sie sie der [`_app.js`-Datei](/docs/14/pages/building-your-application/routing/custom-app) unter `/pages` wie folgt hinzu:
...
Weitere Informationen finden Sie in der [Font-API-Referenz](/docs/14/app/api-reference/components/font).
...
Alternativ können Sie eine [CSS-Variable](/docs/14/app/api-reference/components/font#variable) erstellen und mit Ihrer bevorzugten CSS-Lösung verwenden:
...
`next/font` kann mit [Tailwind CSS](https://tailwindcss.com/) über eine [CSS-Variable](/docs/14/app/api-reference/components/font#css-variables) verwendet werden.
...
Fügen Sie abschließend die CSS-Variable Ihrer [Tailwind CSS-Konfiguration](/docs/14/app/building-your-application/styling/tailwind-css#configuring-tailwind) hinzu:
...
- Wenn es sich um eine [einzelne Seite](/docs/14/app/building-your-application/routing/pages-and-layouts#pages) handelt, wird sie auf der eindeutigen Route für diese Seite vorab geladen.
- Wenn es sich um ein [Layout](/docs/14/app/building-your-application/routing/pages-and-layouts#layouts) handelt, wird sie auf allen Routen vorab geladen, die von dem Layout umschlossen werden.
- Wenn es sich um das [Root-Layout](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required) handelt, wird sie auf allen Routen vorab geladen.
...
- Wenn es sich um eine [einzelne Seite](/docs/14/pages/building-your-application/routing/pages-and-layouts) handelt, wird sie auf der eindeutigen Route für diese Seite vorab geladen.
- Wenn sie in der [benutzerdefinierten App](/docs/14/pages/building-your-application/routing/custom-app) enthalten ist, wird sie auf allen Routen der Website unter `/pages` vorab geladen.
