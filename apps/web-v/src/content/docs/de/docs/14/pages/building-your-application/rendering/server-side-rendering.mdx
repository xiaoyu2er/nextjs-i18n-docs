...
Weitere Informationen zur Funktionsweise von `getServerSideProps` finden Sie in unserer [Dokumentation zur Datenabfrage](/docs/14/pages/building-your-application/data-fetching/get-server-side-props).