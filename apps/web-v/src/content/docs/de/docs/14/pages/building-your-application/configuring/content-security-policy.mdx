...
translation-updated-at: 2025-06-06T17:22:47.711Z
...
[Middleware](/docs/14/app/building-your-application/routing/middleware) ermöglicht es Ihnen, Header hinzuzufügen und Nonces zu generieren, bevor die Seite gerendert wird.
...
Standardmäßig wird Middleware bei allen Anfragen ausgeführt. Sie können Middleware mit einem [`matcher`](/docs/14/app/building-your-application/routing/middleware#matcher) auf bestimmte Pfade filtern.
...
Sie können das Nonce nun aus einer [Server-Komponente](/docs/14/app/building-your-application/rendering/server-components) mit [`headers`](/docs/14/app/api-reference/functions/headers) auslesen:
...
Für Anwendungen, die keine Nonces benötigen, können Sie den CSP-Header direkt in Ihrer [`next.config.js`](/docs/14/app/api-reference/next-config-js)-Datei festlegen:
