...
Um mehr darüber zu erfahren, wie `getStaticProps` funktioniert, lesen Sie die [Datenabruf-Dokumentation](/docs/14/pages/building-your-application/data-fetching/get-static-props).
...
> Um mehr über dynamisches Routing zu erfahren, lesen Sie die [Dynamisches Routing-Dokumentation](/docs/14/pages/building-your-application/routing/dynamic-routes).
...
Um mehr darüber zu erfahren, wie `getStaticPaths` funktioniert, lesen Sie die [Datenabruf-Dokumentation](/docs/14/pages/building-your-application/data-fetching/get-static-paths).
