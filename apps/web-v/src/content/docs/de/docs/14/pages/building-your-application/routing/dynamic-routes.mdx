...
Wenn Sie die genauen Segmentnamen im Voraus nicht kennen und Routen aus dynamischen Daten erstellen möchten, können Sie Dynamische Segmente verwenden, die zur Laufzeit gefüllt oder beim [Prerendering](/docs/14/pages/building-your-application/data-fetching/get-static-paths) zur Build-Zeit vorgerendert werden.
...
Auf dynamische Segmente kann über [`useRouter`](/docs/14/pages/api-reference/functions/use-router) zugegriffen werden.
