...
translation-updated-at: 2025-06-06T17:24:16.170Z
title: Analytics
...
Weitere Informationen finden Sie in der [API-Referenz](/docs/14/pages/api-reference/functions/use-report-web-vitals).
...
Weitere Informationen finden Sie in der [API-Referenz](/docs/14/app/api-reference/functions/use-report-web-vitals).
