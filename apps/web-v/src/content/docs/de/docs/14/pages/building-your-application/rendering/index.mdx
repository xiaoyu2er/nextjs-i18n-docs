...
Sie können auch clientseitiges Data Fetching in Kombination mit Static Generation oder Server-side Rendering verwenden. Das bedeutet, dass einige Teile einer Seite vollständig clientseitig mit JavaScript gerendert werden können. Weitere Informationen finden Sie in der [Data Fetching](/docs/14/pages/building-your-application/data-fetching/client-side)-Dokumentation.