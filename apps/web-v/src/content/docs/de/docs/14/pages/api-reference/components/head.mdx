...
Wir empfehlen die Verwendung von [`next/script`](/docs/14/pages/building-your-application/optimizing/scripts) in Ihrer Komponente anstelle der manuellen Erstellung eines `<script>`-Tags in `next/head`.
