...
translation-updated-at: 2025-06-06T17:33:00.563Z
title: generateViewport
description: API-Referenz für die `generateViewport`-Funktion.
related:
...
> - Wenn Sie von der Migration der `metadata`-Exports kommen, können Sie den [metadata-to-viewport-export Codemod](/docs/14/app/building-your-application/upgrading/codemods#metadata-to-viewport-export) verwenden, um Ihre Änderungen zu aktualisieren.
...
> **Gut zu wissen**:
>
> - Wenn der Viewport nicht von Laufzeitinformationen abhängt, sollte er mit dem statischen [`viewport`-Objekt](#das-viewport-objekt) definiert werden, nicht mit `generateMetadata`.
...
Sie können Ihrem Viewport-Objekt Typsicherheit hinzufügen, indem Sie den `Viewport`-Typ verwenden. Wenn Sie das [integrierte TypeScript-Plugin](/docs/14/app/building-your-application/configuring/typescript) in Ihrer IDE verwenden, müssen Sie den Typ nicht manuell hinzufügen, aber Sie können ihn dennoch explizit angeben, wenn Sie möchten.
