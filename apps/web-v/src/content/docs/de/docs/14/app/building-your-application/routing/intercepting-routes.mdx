...
Intercepting Routes (Abfangende Routen) können zusammen mit [Parallel Routes (Parallelen Routen)](/docs/14/app/building-your-application/routing/parallel-routes) verwendet werden, um Modals zu erstellen. Dies ermöglicht es Ihnen, häufige Herausforderungen beim Erstellen von Modals zu lösen, wie z.B.:
...
Siehe die Dokumentation zu [Parallel Routes (Parallele Routen)](/docs/14/app/building-your-application/routing/parallel-routes#modals) für ein schrittweises Beispiel oder unser [Beispiel für eine Bildergalerie](https://github.com/vercel-labs/nextgram).
