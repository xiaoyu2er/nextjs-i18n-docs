...
Standardmäßig verwendet Next.js Server Components. Dadurch können Sie Server-Rendering ohne zusätzliche Konfiguration implementieren und bei Bedarf auf [Client Components](/docs/14/app/building-your-application/rendering/client-components) zurückgreifen.
...
>
> Erfahren Sie mehr über den [Full-Route Cache](/docs/14/app/building-your-application/caching#full-route-cache) und [Data Cache](/docs/14/app/building-your-application/caching#data-cache).

#### Wechsel zu dynamischem Rendering

Während des Renderings wechselt Next.js zum dynamischen Rendering der gesamten Route, wenn eine [dynamische Funktion](#dynamic-functions) oder [nicht zwischengespeicherte Datenanfrage](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating#opting-out-of-data-caching) erkannt wird. Diese Tabelle zeigt, wie dynamische Funktionen und Daten-Caching das Rendering beeinflussen:
...
- **[`cookies()`](/docs/14/app/api-reference/functions/cookies) und [`headers()`](/docs/14/app/api-reference/functions/headers)**: Die Verwendung in einer Server Component führt zum dynamischen Rendering der gesamten Route.
- **[`searchParams`](/docs/14/app/api-reference/file-conventions/page#searchparams-optional)**: Die Verwendung der `searchParams`-Prop auf einer [Page](/docs/14/app/api-reference/file-conventions/page) führt zum dynamischen Rendering der Seite.
...
Sie können das Streaming von Routensegmenten mit `loading.js` und UI-Komponenten über [React Suspense](/docs/14/app/building-your-application/routing/loading-ui-and-streaming) starten. Weitere Informationen finden Sie im Abschnitt [Loading UI und Streaming](/docs/14/app/building-your-application/routing/loading-ui-and-streaming).