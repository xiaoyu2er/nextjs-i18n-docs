...
- Durch Verwendung der [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps)-Funktion.
...
Weitere Informationen finden Sie in der [`generateSitemaps` API-Referenz](/docs/14/app/api-reference/functions/generate-sitemaps).
