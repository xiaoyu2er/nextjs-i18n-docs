...
translation-updated-at: 2025-06-06T17:20:08.018Z
title: <Script>
description: Optimierung von Drittanbieter-Skripten in Ihrer Next.js-Anwendung mit der integrierten `next/script`-Komponente.
...
Diese API-Referenz hilft Ihnen zu verstehen, wie Sie die verfügbaren [Props](#props) für die Script-Komponente verwenden können. Informationen zu Funktionen und Verwendung finden Sie auf der Seite [Optimierung von Skripten](/docs/14/app/building-your-application/optimizing/scripts).
