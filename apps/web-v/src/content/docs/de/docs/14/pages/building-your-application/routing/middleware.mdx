...
1. Eine Route ([Page](/docs/14/app/building-your-application/routing/pages-and-layouts) oder [Route Handler](/docs/14/app/building-your-application/routing/route-handlers)) `rewrite`, die eine Antwort erzeugt
...
1. Eine Route ([Page](/docs/14/pages/building-your-application/routing/pages-and-layouts) oder [Edge API Route](/docs/14/pages/building-your-application/routing/api-routes)) `rewrite`, die eine Antwort erzeugt
2. Direkt eine `NextResponse` zurückgeben. Siehe [Antwort erzeugen](#producing-a-response)
...
> **Gut zu wissen:** Sie können CORS-Header für einzelne Routen in [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers#cors) konfigurieren.
...
Middleware unterstützt derzeit nur die [Edge-Laufzeitumgebung](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes). Die Node.js-Laufzeitumgebung kann nicht verwendet werden.
