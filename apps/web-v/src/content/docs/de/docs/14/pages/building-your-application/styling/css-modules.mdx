...
translation-updated-at: 2025-06-06T17:24:46.238Z
title: CSS-Module
description: Gestaltung Ihrer Next.js-Anwendung mit CSS-Modulen.
...
Erstellen Sie eine [`pages/_app.js`-Datei](/docs/14/pages/building-your-application/routing/custom-app), falls noch nicht vorhanden.
...
Aufgrund des globalen Charakters von Stylesheets und um Konflikte zu vermeiden, dürfen Sie sie **nur innerhalb von [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) importieren**.
...
- Bei Verwendung von [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css) importieren Sie das Stylesheet am Anfang der Datei, vorzugsweise im [Root Layout](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required).
