...
translation-updated-at: 2025-06-06T17:19:56.630Z
title: NextRequest
...
| ----------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `basePath`        | `string`                  | Der [Basis-Pfad](/docs/14/pages/api-reference/next-config-js/basePath) der URL.                                                  |
| `buildId`         | `string` \| `undefined`   | Die Build-Kennung der Next.js-Anwendung. Kann [angepasst](/docs/14/pages/api-reference/next-config-js/generateBuildId) werden. |
| `defaultLocale`   | `string` \| `undefined`   | Die Standard-Sprache für [Internationalisierung](/docs/14/pages/building-your-application/routing/internationalization).              |
| `domainLocale`    |                           |                                                                                                                                 |
...
| Eigenschaft    | Typ                    | Beschreibung                                                                                                                   |
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `basePath`     | `string`                | Der [Basis-Pfad](/docs/14/app/api-reference/next-config-js/basePath) der URL.                                                  |
| `buildId`      | `string` \| `undefined` | Die Build-Kennung der Next.js-Anwendung. Kann [angepasst](/docs/14/app/api-reference/next-config-js/generateBuildId) werden. |
| `pathname`     | `string`                | Der Pfadname der URL.                                                                                                      |
| `searchParams` | `Object`                | Die Suchparameter der URL.                                                                                             |

> **Hinweis:** Die Internationalisierungseigenschaften des Pages-Routers sind im App-Router nicht verfügbar. Erfahren Sie mehr über [Internationalisierung mit dem App-Router](/docs/14/app/building-your-application/routing/internationalization).
