...
Wenn Sie [die Portnummer ändern](/docs/14/pages/api-reference/cli/next#next-dev-options), auf der Ihre Anwendung startet, ersetzen Sie `3000` in `http://localhost:3000` durch den von Ihnen verwendeten Port.
