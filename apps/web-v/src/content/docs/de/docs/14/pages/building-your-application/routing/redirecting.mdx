...
translation-updated-at: 2025-06-06T17:26:16.354Z
...
Die `redirect`-Funktion ermöglicht es, Benutzer auf eine andere URL umzuleiten. Sie können `redirect` in [Server Components](/docs/14/app/building-your-application/rendering/server-components), [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers) und [Server Actions](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) aufrufen.
...
Die `permanentRedirect`-Funktion ermöglicht es, Benutzer **dauerhaft** auf eine andere URL umzuleiten. Sie können `permanentRedirect` in [Server Components](/docs/14/app/building-your-application/rendering/server-components), [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers) und [Server Actions](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) aufrufen.
...
Weitere Informationen finden Sie in der [`permanentRedirect`-API-Referenz](/docs/14/app/api-reference/functions/permanentRedirect).
...
> **Gut zu wissen**:
>
> - Für nicht-programmatische Navigation sollten Sie eine [`<Link>`](/docs/14/app/api-reference/components/link)-Komponente verwenden.

<AppOnly>

Weitere Informationen finden Sie in der [`useRouter`-API-Referenz](/docs/14/app/api-reference/functions/use-router).

</AppOnly>

<PagesOnly>

Weitere Informationen finden Sie in der [`useRouter`-API-Referenz](/docs/14/pages/api-reference/functions/use-router).
...
`redirects` unterstützt [Pfad](/docs/14/app/api-reference/next-config-js/redirects#path-matching), [Header-, Cookie- und Query-Matching](/docs/14/app/api-reference/next-config-js/redirects#header-cookie-and-query-matching) für flexible Weiterleitungsregeln.
...
Weitere Informationen finden Sie in der [`redirects`-API-Referenz](/docs/14/app/api-reference/next-config-js/redirects).

> **Gut zu wissen**:
>
> - `redirects` kann 307 (Temporary Redirect) oder 308 (Permanent Redirect) Statuscodes zurückgeben.
> - Auf einigen Plattformen gibt es Limits (z.B. 1.024 Weiterleitungen auf Vercel). Für große Mengen (1000+) sollten Sie [Middleware](/docs/14/app/building-your-application/routing/middleware) verwenden. Siehe [Weiterleitungen im großen Stil](#managing-redirects-at-scale-advanced).
...
Weitere Informationen finden Sie in der [Middleware-Dokumentation](/docs/14/app/building-your-application/routing/middleware).
