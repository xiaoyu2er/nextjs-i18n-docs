...
translation-updated-at: 2025-06-06T17:20:53.055Z
title: Font-Modul
nav_title: Font
...
Diese API-Referenz hilft Ihnen zu verstehen, wie Sie [`next/font/google`](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) und [`next/font/local`](/docs/14/app/building-your-application/optimizing/fonts#local-fonts) verwenden können. Für Funktionen und Anwendungsbeispiele lesen Sie bitte die Seite [Optimierung von Fonts](/docs/14/app/building-your-application/optimizing/fonts).

### Argumente der Font-Funktion

Für die Verwendung siehe [Google Fonts](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) und [Lokale Fonts](/docs/14/app/building-your-application/optimizing/fonts#local-fonts).
...
Die Font-[`subsets`](https://fonts.google.com/knowledge/glossary/subsetting), definiert durch ein Array von String-Werten mit den Namen der einzelnen Subsets, die Sie [preloaden](/docs/14/app/building-your-application/optimizing/fonts#specifying-a-subset) möchten. Fonts, die über `subsets` angegeben werden, erhalten einen Link-Preload-Tag im Head, wenn die [`preload`](#preload)-Option aktiviert ist (Standard).
...
Ein boolescher Wert, der angibt, ob der Font [preloaded](/docs/14/app/building-your-application/optimizing/fonts#preloading) werden soll oder nicht. Standard ist `true`.
