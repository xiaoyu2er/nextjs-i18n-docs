...
Der [Bundle Analyzer](/docs/14/app/building-your-application/optimizing/package-bundling#analyzing-javascript-bundles) kann Ihnen helfen, große Abhängigkeiten in Ihrer Anwendung zu identifizieren, die möglicherweise entfernt werden können, um die Leistung und Speichernutzung zu verbessern.
...
Sie können dieses Verhalten deaktivieren, indem Sie Ihrer Anwendung eine [benutzerdefinierte Webpack-Konfiguration](/docs/14/app/api-reference/next-config-js/webpack) hinzufügen:
