...
Die `cookies`-Funktion ermöglicht das Lesen von eingehenden HTTP-Request-Cookies in einer [Server-Komponente (Server Component)](/docs/14/app/building-your-application/rendering/server-components) oder das Schreiben von ausgehenden Request-Cookies in einer [Server-Aktion (Server Action)](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) oder einem [Route-Handler (Route Handler)](/docs/14/app/building-your-application/routing/route-handlers).

> **Gut zu wissen**: `cookies()` ist eine [dynamische Funktion (Dynamic Function)](/docs/14/app/building-your-application/rendering/server-components#server-rendering-strategies#dynamic-functions), deren Rückgabewerte nicht im Voraus bekannt sind. Die Verwendung in einem Layout oder einer Seite aktiviert [dynamisches Rendering (dynamic rendering)](/docs/14/app/building-your-application/rendering/server-components#dynamic-rendering) zur Laufzeit.
...
> **Gut zu wissen**: HTTP erlaubt kein Setzen von Cookies nach Beginn des Streamings, daher muss `.set()` in einer [Server-Aktion (Server Action)](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) oder einem [Route-Handler (Route Handler)](/docs/14/app/building-your-application/routing/route-handlers) verwendet werden.
...
> **Gut zu wissen**: Cookies können nur in einer [Server-Aktion (Server Action)](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) oder einem [Route-Handler (Route Handler)](/docs/14/app/building-your-application/routing/route-handlers) gelöscht werden.
...
> **Gut zu wissen**: `.set()` ist nur in einer [Server-Aktion (Server Action)](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) oder einem [Route-Handler (Route Handler)](/docs/14/app/building-your-application/routing/route-handlers) verfügbar.
