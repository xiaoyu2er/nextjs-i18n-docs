...
Next.js bietet standardmäßig eine statische 500-Seite zur Behandlung von Server-seitigen Fehlern in Ihrer Anwendung. Sie können diese Seite auch [anpassen](/docs/14/pages/building-your-application/routing/custom-error#customizing-the-500-page), indem Sie eine `pages/500.js`-Datei erstellen.

Eine 500-Seite in Ihrer Anwendung zeigt dem Benutzer keine spezifischen Fehler an.

Sie können auch eine [404-Seite](/docs/14/pages/building-your-application/routing/custom-error#404-page) verwenden, um bestimmte Laufzeitfehler wie `Datei nicht gefunden` zu behandeln.
