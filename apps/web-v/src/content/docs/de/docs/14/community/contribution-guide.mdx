...
translation-updated-at: 2025-06-06T17:17:28.909Z
title: Dokumentations-Beitragsleitfaden
nav_title: Beitragsleitfaden
description: Erfahren Sie, wie Sie zur Next.js-Dokumentation beitragen können
sidebar:
  order: 501
  label: "Beitragsleitfaden"
---
...
Wenn Sie neu bei GitHub sind, empfehlen wir die Lektüre des [GitHub Open Source Guide](https://opensource.guide/how-to-contribute/#opening-a-pull-request), um zu lernen, wie man ein Repository forkt, einen Branch erstellt und einen Pull Request einreicht.

> **Gut zu wissen**: Der zugrunde liegende Dokumentationscode befindet sich in einer privaten Codebasis, die mit dem öffentlichen Next.js-Repo synchronisiert wird. Das bedeutet, dass Sie die Dokumentation nicht lokal in der Vorschau anzeigen können. Sie sehen Ihre Änderungen jedoch auf [nextjs.org](https://nextjs.org/docs), nachdem ein Pull Request gemergt wurde.

### MDX schreiben

Die Dokumentation ist in [MDX](https://mdxjs.com/) geschrieben, einem Markdown-Format, das JSX-Syntax unterstützt. Dadurch können wir React-Komponenten in die Dokumentation einbetten. Siehe den [GitHub Markdown Guide](https://docs.github.com/de/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax) für eine schnelle Übersicht über die Markdown-Syntax.
...
Die Dokumentation verwendet **File-System Routing**. Jeder Ordner und jede Datei innerhalb von [`/docs`](https://github.com/vercel/next.js/tree/canary/docs) stellt ein Routensegment dar. Diese Segmente werden verwendet, um die URL-Pfade, die Navigation und die Breadcrumbs zu generieren.
...
Beispielsweise sind in der [Functions API Reference](/docs/14/app/api-reference/functions) die Seiten alphabetisch sortiert, weil es Entwicklern so leichter fällt, eine bestimmte Funktion zu finden:
...
Aber im [Routing-Abschnitt](/docs/14/app/building-your-application/routing) sind die Dateien mit einer zweistelligen Zahl versehen, sortiert in der Reihenfolge, in der Entwickler diese Konzepte lernen sollten:
...
| Feld         | Beschreibung                                                                  |
| ------------- | ---------------------------------------------------------------------------- |
| `title`       | Der `<h1>`-Titel der Seite, verwendet für SEO und OG Images.                |
| `description` | Die Beschreibung der Seite, verwendet im `<meta name="description">`-Tag für SEO. |
...
| Feld       | Beschreibung                                                                                                                                        |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| `nav_title` | Überschreibt den Titel der Seite in der Navigation. Dies ist nützlich, wenn der Seitentitel zu lang ist. Wenn nicht angegeben, wird das `title`-Feld verwendet. |
...
- Links werden automatisch für Seiten generiert, die Unterseiten haben. Beispielsweise hat der Abschnitt [Optimierung](/docs/14/app/building-your-application/optimizing) Links zu all seinen Unterseiten.
...
| `links`       | Erforderlich  | Eine Liste von Links zu anderen Dokumentationsseiten. Jedes Listenelement sollte ein relativer URL-Pfad sein (ohne führenden Schrägstrich), z.B. `app/api-reference/file-conventions/page` |

## Diagramme

Diagramme sind eine großartige Möglichkeit, komplexe Konzepte zu erklären. Wir verwenden [Figma](https://www.figma.com/), um Diagramme nach dem Vercel-Design-Leitfaden zu erstellen.
...
- Verwenden Sie eine aktive statt einer passiven Stimme. Ein aktiver Satz ist leichter zu lesen.
  - Zum Beispiel: _Next.js verwendet React_ statt _React wird von Next.js verwendet_. Wenn Sie Wörter wie _wurde_ und _von_ verwenden, verwenden Sie möglicherweise eine passive Stimme.
...
- Verwenden Sie eine geschlechtsneutrale Sprache. Verwenden Sie _Entwickler_, _Benutzer_ oder _Leser_, wenn Sie sich auf das Publikum beziehen.
- Wenn Sie Codebeispiele hinzufügen, stellen Sie sicher, dass sie korrekt formatiert und funktionsfähig sind.

Diese Richtlinien sind zwar nicht vollständig, sollten Ihnen aber den Einstieg erleichtern. Wenn Sie tiefer in das technische Schreiben einsteigen möchten, lesen Sie den [Google Technical Writing Course](https://developers.google.com/tech-writing/overview) (Google-Kurs zum technischen Schreiben).
