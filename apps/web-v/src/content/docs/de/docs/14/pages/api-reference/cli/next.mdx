...
Beide Werte sind [**mit gzip komprimiert**](/docs/14/app/api-reference/next-config-js/compress). Der First Load wird durch grün, gelb oder rot angezeigt. Streben Sie grün für leistungsfähige Anwendungen an.
