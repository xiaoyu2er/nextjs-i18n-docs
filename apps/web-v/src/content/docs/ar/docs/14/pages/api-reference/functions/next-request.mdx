...
translation-updated-at: 2025-06-06T17:19:54.948Z
title: NextRequest
...
| الخاصية          | النوع                      | الوصف                                                                                                                     |
| ----------------- | ------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| `basePath`        | `string`                  | [المسار الأساسي](/docs/14/pages/api-reference/next-config-js/basePath) لـ URL.                                                  |
| `buildId`         | `string` \| `undefined`   | معرف بناء تطبيق Next.js. يمكن [تخصيصه](/docs/14/pages/api-reference/next-config-js/generateBuildId). |
| `defaultLocale`   | `string` \| `undefined`   | اللغة الافتراضية لـ [التدويل](/docs/14/pages/building-your-application/routing/internationalization).              |
| `domainLocale`    |                           |                                                                                                                                 |
...
| الخاصية       | النوع                    | الوصف                                                                                                                   |
| -------------- | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| `basePath`     | `string`                | [المسار الأساسي](/docs/14/app/api-reference/next-config-js/basePath) لـ URL.                                                  |
| `buildId`      | `string` \| `undefined` | معرف بناء تطبيق Next.js. يمكن [تخصيصه](/docs/14/app/api-reference/next-config-js/generateBuildId). |
| `pathname`     | `string`                | مسار URL.                                                                                                      |
| `searchParams` | `Object`                | معلمات البحث لـ URL.                                                                                             |

> **ملاحظة:** خصائص التدويل من موجه الصفحات غير متاحة للاستخدام في موجه التطبيق. تعلم المزيد عن [التدويل مع موجه التطبيق](/docs/14/app/building-your-application/routing/internationalization).
