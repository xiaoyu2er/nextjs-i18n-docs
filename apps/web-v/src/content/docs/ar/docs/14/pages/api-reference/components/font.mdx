...
translation-updated-at: 2025-06-06T17:20:46.633Z
title: وحدة الخطوط
nav_title: الخط
...
سيساعدك مرجع API هذا على فهم كيفية استخدام [`next/font/google`](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) و [`next/font/local`](/docs/14/app/building-your-application/optimizing/fonts#local-fonts). لميزات الاستخدام، يرجى الاطلاع على صفحة [تحسين الخطوط](/docs/14/app/building-your-application/optimizing/fonts).

### وسائط دالة الخط

للاستخدام، راجع [خطوط جوجل](/docs/14/app/building-your-application/optimizing/fonts#google-fonts) و [الخطوط المحلية](/docs/14/app/building-your-application/optimizing/fonts#local-fonts).
...
[`مجموعات فرعية`](https://fonts.google.com/knowledge/glossary/subsetting) الخط المحددة بمصفوفة من قيم السلسلة بأسماء كل مجموعة فرعية ترغب في [تحميلها مسبقًا](/docs/14/app/building-your-application/optimizing/fonts#specifying-a-subset). سيتم حقق علامة تحميل مسبق للرابط في الرأس عند تعيين خيار [`preload`](#preload) على `true`، وهو الإعداد الافتراضي.
...
قيمة منطقية تحدد ما إذا كان يجب [تحميل الخط مسبقًا](/docs/14/app/building-your-application/optimizing/fonts#preloading) أم لا. القيمة الافتراضية هي `true`.
