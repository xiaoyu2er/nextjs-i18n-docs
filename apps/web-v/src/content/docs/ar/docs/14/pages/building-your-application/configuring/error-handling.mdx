...
يوفر Next.js صفحة 500 افتراضية ثابتة لمعالجة الأخطاء التي تحدث في جانب الخادم لتطبيقك. يمكنك أيضًا [تخصيص هذه الصفحة](/docs/14/pages/building-your-application/routing/custom-error#customizing-the-500-page) عن طريق إنشاء ملف `pages/500.js`.

وجود صفحة 500 في تطبيقك لا يعرض أخطاء محددة لمستخدم التطبيق.

يمكنك أيضًا استخدام [صفحة 404](/docs/14/pages/building-your-application/routing/custom-error#404-page) لمعالجة أخطاء وقت التشغيل المحددة مثل `الملف غير موجود`.
