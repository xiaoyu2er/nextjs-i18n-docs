...
بخلاف [اتفاقيات مجلدات وملفات التوجيه](/docs/14/getting-started/project-structure#app-routing-conventions)، فإن Next.js **غير متحيز** بشأن كيفية تنظيم ووضع ملفات مشروعك معًا.
...
في دليل `app`، تحدد [التسلسل الهرمي للمجلدات المتداخلة](/docs/14/app/building-your-application/routing#route-segments) بنية المسار.
...
> - إذا لم تستخدم المجلدات الخاصة، سيكون من المفهم معرفة [اتفاقيات الملفات الخاصة](/docs/14/getting-started/project-structure#routing-files) في Next.js لتجنب التعارضات غير المتوقعة في التسمية.
...
- [تنظيم المسارات في مجموعات](/docs/14/app/building-your-application/routing/route-groups#organize-routes-without-affecting-the-url-path) مثل القسم في الموقع، الغرض، أو الفريق.
- تمكين التخطيطات المتداخلة في نفس مستوى جزء المسار:
  - [إنشاء تخطيطات متداخلة متعددة في نفس الجزء، بما في ذلك تخطيطات الجذر المتعددة](/docs/14/app/building-your-application/routing/route-groups#creating-multiple-root-layouts)
  - [إضافة تخطيط إلى مجموعة فرعية من المسارات في جزء مشترك](/docs/14/app/building-your-application/routing/route-groups#opting-specific-segments-into-a-layout)

### دليل `src`

يدعم Next.js تخزين كود التطبيق (بما في ذلك `app`) داخل دليل [`src` اختياري](/docs/14/app/building-your-application/configuring/src-directory). هذا يفصل كود التطبيق عن ملفات تكوين المشروع التي تعيش في الغالب في جذر المشروع.
...
يدعم Next.js [أسماء مسارات الوحدات](/docs/14/app/building-your-application/configuring/absolute-imports-and-module-aliases) التي تجعل قراءة وصيانة الاستيرادات عبر ملفات المشروع المتداخلة بعمق أسهل.
