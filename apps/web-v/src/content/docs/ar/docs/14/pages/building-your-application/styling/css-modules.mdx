...
translation-updated-at: 2025-06-06T17:24:35.393Z
...
قم بإنشاء ملف [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) إذا لم يكن موجودًا بالفعل.
...
بسبب الطبيعة العامة لملفات الأنماط، ولتجنب التصادمات، يمكنك **فقط استيرادها داخل [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app)**.
...
- إذا كنت تستخدم [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css)، قم باستيراد ملف الأنماط في أعلى الملف، ويفضل في [التخطيط الجذري](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required).
