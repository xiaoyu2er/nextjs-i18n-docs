...
تتيح لك `revalidateTag` إبطال [البيانات المخزنة مؤقتًا](/docs/14/app/building-your-application/caching) عند الطلب لعلامة تخزين مؤقت معينة.

> **معلومة مفيدة**:
>
> - `revalidateTag` متاحة في كل من [بيئات تشغيل Node.js و Edge](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes).
