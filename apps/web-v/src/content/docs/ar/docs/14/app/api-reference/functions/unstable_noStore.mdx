...
- استخدام `unstable_noStore` داخل [`unstable_cache`](/docs/14/app/api-reference/functions/unstable_cache) لن يلغي التصيير الثابت. بدلاً من ذلك، سيعتمد على تكوين التخزين المؤقت لتحديد ما إذا كان سيتم تخزين النتيجة مؤقتًا أم لا.
