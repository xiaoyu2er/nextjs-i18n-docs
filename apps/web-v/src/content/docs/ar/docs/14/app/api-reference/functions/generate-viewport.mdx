...
> - إذا كنت تقوم بالترقية من تصديرات `metadata`، يمكنك استخدام [أداة metadata-to-viewport-export codemod](/docs/14/app/building-your-application/upgrading/codemods#metadata-to-viewport-export) لتحديث التغييرات.
...
يمكنك إضافة أمان النوع لكائن منفذ العرض باستخدام نوع `Viewport`. إذا كنت تستخدم [إضافة TypeScript المدمجة](/docs/14/app/building-your-application/configuring/typescript) في بيئة التطوير الخاصة بك، فلن تحتاج إلى إضافة النوع يدويًا، ولكن لا يزال بإمكانك إضافته صراحةً إذا أردت.
