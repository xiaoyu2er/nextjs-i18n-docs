...
translation-updated-at: 2025-06-06T17:22:46.444Z
...
[البرمجية الوسيطة (Middleware)](/docs/14/app/building-your-application/routing/middleware) تمكنك من إضافة رؤوس وتوليد قيم عشوائية لمرة واحدة قبل عرض الصفحة.
...
بشكل افتراضي، تعمل البرمجية الوسيطة على جميع الطلبات. يمكنك تصفية البرمجية الوسيطة لتشغيلها على مسارات محددة باستخدام [`matcher`](/docs/14/app/building-your-application/routing/middleware#matcher).
...
يمكنك الآن قراءة القيمة العشوائية لمرة واحدة من [مكون الخادم (Server Component)](/docs/14/app/building-your-application/rendering/server-components) باستخدام [`headers`](/docs/14/app/api-reference/functions/headers):
...
للتطبيقات التي لا تتطلب قيم عشوائية لمرة واحدة، يمكنك تعيين رأس CSP مباشرة في ملف [`next.config.js`](/docs/14/app/api-reference/next-config-js):
