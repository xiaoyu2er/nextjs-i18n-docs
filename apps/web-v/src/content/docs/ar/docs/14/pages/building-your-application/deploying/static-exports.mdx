...
يمكنك استخدام [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) و [`getStaticPaths`](/docs/14/pages/building-your-application/data-fetching/get-static-paths) لإنشاء ملف HTML لكل صفحة في دليل `pages` الخاص بك (أو أكثر لـ [المسارات الديناميكية](/docs/14/app/building-your-application/routing/dynamic-routes)).
...
- [المسارات الديناميكية عند استخدام `getStaticPaths`](/docs/14/app/building-your-application/routing/dynamic-routes)
- الجلب المسبق مع `next/link`
- التحميل المسبق لـ JavaScript
- [الاستيراد الديناميكي](/docs/14/pages/building-your-application/optimizing/lazy-loading)
- أي خيارات للتنسيق (مثل وحدات CSS، styled-jsx)
- [جلب البيانات من جانب العميل](/docs/14/pages/building-your-application/data-fetching/client-side)
...
يمكن استخدام [تحسين الصور](/docs/14/app/building-your-application/optimizing/images) عبر `next/image` مع التصدير الثابت عن طريق تعريف محمل صور مخصص في `next.config.js`. على سبيل المثال، يمكنك تحسين الصور باستخدام خدمة مثل Cloudinary:
...
- [المسارات الديناميكية](/docs/14/app/building-your-application/routing/dynamic-routes) مع `dynamicParams: true`
- [المسارات الديناميكية](/docs/14/app/building-your-application/routing/dynamic-routes) بدون `generateStaticParams()`
- [معالجات المسار](/docs/14/app/building-your-application/routing/route-handlers) التي تعتمد على Request
- [الكوكيز](/docs/14/app/api-reference/functions/cookies)
- [إعادة الكتابة](/docs/14/app/api-reference/next-config-js/rewrites)
- [إعادة التوجيه](/docs/14/app/api-reference/next-config-js/redirects)
- [الرؤوس](/docs/14/app/api-reference/next-config-js/headers)
- [الوسيط](/docs/14/app/building-your-application/routing/middleware)
- [التجديد الثابت التدريجي](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating)
- [تحسين الصور](/docs/14/app/building-your-application/optimizing/images) مع المحمل الافتراضي `loader`
- [وضع المسودة](/docs/14/app/building-your-application/configuring/draft-mode)

سيؤدي محاولة استخدام أي من هذه الميزات مع `next dev` إلى حدوث خطأ، مشابهًا لتعيين الخيار [`dynamic`](/docs/14/app/api-reference/file-conventions/route-segment-config#dynamic) إلى `error` في تخطيط الجذر.
...
- [التوجيه الدولي](/docs/14/pages/building-your-application/routing/internationalization)
- [مسارات API](/docs/14/pages/building-your-application/routing/api-routes)
- [إعادة الكتابة](/docs/14/pages/api-reference/next-config-js/rewrites)
- [إعادة التوجيه](/docs/14/pages/api-reference/next-config-js/redirects)
- [الرؤوس](/docs/14/pages/api-reference/next-config-js/headers)
- [الوسيط](/docs/14/pages/building-your-application/routing/middleware)
- [التجديد الثابت التدريجي](/docs/14/pages/building-your-application/data-fetching/incremental-static-regeneration)
- [تحسين الصور](/docs/14/pages/building-your-application/optimizing/images) مع المحمل الافتراضي `loader`
- [وضع المسودة](/docs/14/pages/building-your-application/configuring/draft-mode)
- [`getStaticPaths` مع `fallback: true`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-true)
- [`getStaticPaths` مع `fallback: 'blocking'`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-blocking)
