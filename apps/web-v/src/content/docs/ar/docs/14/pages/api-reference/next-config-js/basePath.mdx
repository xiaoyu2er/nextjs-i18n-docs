...
translation-updated-at: 2025-06-06T17:19:42.393Z
title: basePath
description: استخدام `basePath` لنشر تطبيق Next.js ضمن مسار فرعي من نطاق.
...
عند استخدام مكون [`next/image`](/docs/14/app/api-reference/components/image)، ستحتاج إلى إضافة `basePath` قبل `src`.

</AppOnly>

<PagesOnly>

عند استخدام مكون [`next/image`](/docs/14/pages/api-reference/components/image)، ستحتاج إلى إضافة `basePath` قبل `src`.
