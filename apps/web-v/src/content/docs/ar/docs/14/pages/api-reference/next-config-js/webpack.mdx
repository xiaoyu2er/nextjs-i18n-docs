...
translation-updated-at: 2025-06-06T17:18:43.876Z
...
- [استيراد CSS](/docs/14/app/building-your-application/styling)
- [وحدات CSS](/docs/14/app/building-your-application/styling/css-modules)
- [استيراد Sass/SCSS](/docs/14/app/building-your-application/styling/sass)
- [وحدات Sass/SCSS](/docs/14/app/building-your-application/styling/sass)

</AppOnly>

<PagesOnly>

- [استيراد CSS](/docs/14/pages/building-your-application/styling)
- [وحدات CSS](/docs/14/pages/building-your-application/styling/css-modules)
- [استيراد Sass/SCSS](/docs/14/pages/building-your-application/styling/sass)
- [وحدات Sass/SCSS](/docs/14/pages/building-your-application/styling/sass)
- [تخصيص تهيئة babel](/docs/14/pages/building-your-application/configuring/babel)
