...
إذا كنت [تغير رقم المنفذ](/docs/14/pages/api-reference/cli/next#next-dev-options) الذي يبدأ منه التطبيق، فاستبدل `3000` في `http://localhost:3000` بالمنفذ الذي تستخدمه.
