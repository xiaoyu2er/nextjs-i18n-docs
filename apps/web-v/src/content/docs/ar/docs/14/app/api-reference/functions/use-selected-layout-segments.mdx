...
يقبل `useSelectedLayoutSegments` اختياريًا مفتاح [`parallelRoutesKey`](/docs/14/app/building-your-application/routing/parallel-routes#useselectedlayoutsegments)، والذي يسمح لك بقراءة مقطع المسار النشط ضمن تلك الفتحة.
