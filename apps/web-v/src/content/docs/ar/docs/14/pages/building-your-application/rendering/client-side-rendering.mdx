...
1. استخدام خطاف React `useEffect()` داخل صفحاتك بدلاً من طرق التصيير من جانب الخادم ([`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) و [`getServerSideProps`](/docs/14/pages/building-your-application/data-fetching/get-server-side-props)).
