...
تم استبدال هذا الخيار بـ [`optimizePackageImports`](/docs/14/app/api-reference/next-config-js/optimizePackageImports) في Next.js 13.5. نوصي بالترقية لاستخدام الخيار الجديد الذي لا يتطلب تكوينًا يدويًا لمسارات الاستيراد.
