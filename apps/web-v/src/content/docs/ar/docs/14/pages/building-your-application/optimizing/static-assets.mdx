...
translation-updated-at: 2025-06-06T17:24:23.585Z
...
بالنسبة لملفات البيانات الوصفية الثابتة مثل `robots.txt`، `favicon.ico` وغيرها، يجب عليك استخدام [ملفات بيانات وصفية خاصة](/docs/14/app/api-reference/file-conventions/metadata) داخل مجلد `app`.
