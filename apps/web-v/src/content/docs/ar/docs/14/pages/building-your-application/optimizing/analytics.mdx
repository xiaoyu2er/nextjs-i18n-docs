...
translation-updated-at: 2025-06-06T17:24:22.112Z
title: التحليلات
...
اطلع على [مرجع API](/docs/14/pages/api-reference/functions/use-report-web-vitals) لمزيد من المعلومات.
...
اطلع على [مرجع API](/docs/14/app/api-reference/functions/use-report-web-vitals) لمزيد من المعلومات.
