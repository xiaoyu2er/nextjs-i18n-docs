...
- باستخدام دالة [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps).
...
راجع [مرجع API لـ `generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) لمزيد من المعلومات.
