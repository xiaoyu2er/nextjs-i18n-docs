...
راجع [الوثائق](/docs/14/pages/building-your-application/optimizing/images#styling) لمزيد من المعلومات.
...
إذا كنت تستخدم حاليًا خيار `target` مضبوطًا على `serverless`، يرجى قراءة [الوثائق حول كيفية الاستفادة من المخرجات الجديدة](/docs/14/pages/api-reference/next-config-js/output).