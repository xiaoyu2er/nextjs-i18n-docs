...
لتمكين دعم AMP لصفحة ما، ولمعرفة المزيد عن إعدادات AMP المختلفة، اقرأ [وثائق API لـ `next/amp`](/docs/14/pages/building-your-application/configuring/amp).

## محاذير

- فقط CSS-in-JS مدعوم. [وحدات CSS](/docs/14/pages/building-your-application/styling) غير مدعومة حاليًا في صفحات AMP. يمكنك [المساهمة في دعم وحدات CSS لـ Next.js](https://github.com/vercel/next.js/issues/10549).
...
يتم أيضًا التحقق من الصفحات أثناء [تصدير HTML ثابت](/docs/14/pages/building-your-application/deploying/static-exports) وسيتم طباعة أي تحذيرات/أخطاء في الطرفية. أي أخطاء في AMP ستؤدي إلى خروج التصدير برمز حالة `1` لأن التصدير ليس AMP صالحًا.
...
عند استخدام [تصدير HTML ثابت](/docs/14/pages/building-your-application/deploying/static-exports) لتصيير الصفحات مسبقًا بشكل ثابت، سيكتشف Next.js ما إذا كانت الصفحة تدعم AMP وسيغير سلوك التصدير بناءً على ذلك.
...
عند تمكين [`trailingSlash`](/docs/14/pages/api-reference/next-config-js/trailingSlash) ستكون الصفحات المصدرة لـ `pages/about.js`:
