...
1. `rewrite` إلى مسار ([صفحة](/docs/14/app/building-your-application/routing/pages-and-layouts) أو [Route Handler](/docs/14/app/building-your-application/routing/route-handlers)) ينتج استجابة
...
1. `rewrite` إلى مسار ([صفحة](/docs/14/pages/building-your-application/routing/pages-and-layouts) أو [Edge API Route](/docs/14/pages/building-your-application/routing/api-routes)) ينتج استجابة
2. إرجاع `NextResponse` مباشرة. راجع [إنتاج استجابة](#producing-a-response)
...
> **معلومة مفيدة:** يمكنك تكوين رؤوس CORS لمسارات فردية في [معالجات المسار (Route Handlers)](/docs/14/app/building-your-application/routing/route-handlers#cors).
...
يدعم Middleware حاليًا فقط [وقت تشغيل Edge](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes). لا يمكن استخدام وقت تشغيل Node.js.
