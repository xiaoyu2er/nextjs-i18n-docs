...
> **معلومة مفيدة**: يمكنك استخدام [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) داخل هذه الصفحة إذا كنت بحاجة لجلب البيانات أثناء عملية البناء.
...
- لا يدعم مكون `Error` حاليًا [طرق جلب البيانات](/docs/14/pages/building-your-application/data-fetching) في Next.js مثل [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) أو [`getServerSideProps`](/docs/14/pages/building-your-application/data-fetching/get-server-side-props).
- `_error`، مثل `_app`، هو اسم مسار محجوز. `_error` يستخدم لتعريف التخطيطات والسلوكيات المخصصة لصفحات الأخطاء. `/_error` سيعرض 404 عند الوصول إليه مباشرة عبر [التوجيه](/docs/14/pages/building-your-application/routing) أو العرض في [خادم مخصص](/docs/14/pages/building-your-application/configuring/custom-server).