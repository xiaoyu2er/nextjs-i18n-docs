...
translation-updated-at: 2025-06-06T17:27:33.538Z
title: توليد المواقع الثابتة (SSG)
description: استخدام توليد المواقع الثابتة (SSG) لتقديم الصفحات مسبقًا في وقت البناء.
sidebar:
  order: 3010202
---
...
- [مثال ووردبريس](https://github.com/vercel/next.js/tree/canary/examples/cms-wordpress)([عرض تجريبي](https://next-blog-wordpress.vercel.app))
...
- [تغريدة ثابتة (عرض تجريبي)](https://static-tweet.vercel.app/)
...
لمعرفة المزيد حول كيفية عمل `getStaticProps`، راجع [توثيق جلب البيانات](/docs/14/pages/building-your-application/data-fetching/get-static-props).
...
> لمعرفة المزيد حول التوجيه الديناميكي، راجع [توثيق التوجيه الديناميكي](/docs/14/pages/building-your-application/routing/dynamic-routes).
...
لمعرفة المزيد حول كيفية عمل `getStaticPaths`، راجع [توثيق جلب البيانات](/docs/14/pages/building-your-application/data-fetching/get-static-paths).
...
- استخدام التوليد الثابت مع **جلب البيانات من جانب العميل**: يمكنك تخطي التقديم المسبق لبعض أجزاء الصفحة ثم استخدام JavaScript من جانب العميل لملئها. لمعرفة المزيد حول هذا النهج، راجع [توثيق جلب البيانات](/docs/14/pages/building-your-application/data-fetching/client-side).
