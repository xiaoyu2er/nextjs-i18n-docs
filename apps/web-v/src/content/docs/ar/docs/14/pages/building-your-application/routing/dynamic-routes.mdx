...
عندما لا تعرف أسماء الأجزاء مسبقًا وتريد إنشاء مسارات من بيانات ديناميكية، يمكنك استخدام أجزاء ديناميكية يتم تعبئتها وقت الطلب أو [تتم معالجتها مسبقًا](/docs/14/pages/building-your-application/data-fetching/get-static-paths) وقت البناء.

## الاصطلاح

يمكن إنشاء جزء ديناميكي عن طريق لف اسم ملف أو مجلد بين أقواس مربعة: `[segmentName]`. على سبيل المثال، `[id]` أو `[slug]`.

يمكن الوصول إلى الأجزاء الديناميكية من [`useRouter`](/docs/14/pages/api-reference/functions/use-router).
