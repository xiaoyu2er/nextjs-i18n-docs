...
سيساعدك مرجع API هذا على فهم كيفية استخدام [الخصائص](#props) المتاحة لمكون Script. لميزاته واستخدامه، يرجى زيارة صفحة [تحسين البرامج النصية](/docs/14/app/building-your-application/optimizing/scripts).
...
> **تحذير:** إستراتيجية `worker` ليست مستقرة بعد ولا تعمل مع دليل [`app`](/docs/14/app/building-your-application/routing/defining-routes). استخدم بحذر.
