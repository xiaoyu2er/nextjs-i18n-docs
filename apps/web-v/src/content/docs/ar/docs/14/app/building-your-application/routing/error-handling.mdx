...
تسمح لك اتفاقية ملف `error.js` بالتعامل مع أخطاء وقت التشغيل غير المتوقعة بطريقة أنيقة في [المسارات المتداخلة](/docs/14/app/building-your-application/routing#nested-routes).
...
يتم عرض مكونات React التي تم إنشاؤها من خلال [ملفات خاصة](/docs/14/app/building-your-application/routing#file-conventions) في [تسلسل هرمي متداخل محدد](/docs/14/app/building-your-application/routing#component-hierarchy).
