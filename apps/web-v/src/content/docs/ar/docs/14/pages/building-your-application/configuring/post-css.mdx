...
يقوم Next.js بتحويل CSS لدعم [ميزات CSS المدمجة](/docs/14/pages/building-your-application/styling) باستخدام PostCSS.
...
يمكنك معرفة المزيد حول [دعم Next.js لوحدات CSS هنا](/docs/14/pages/building-your-application/styling).
