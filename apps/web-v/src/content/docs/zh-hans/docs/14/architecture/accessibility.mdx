...
Next.js 默认提供[集成的 ESLint 体验](/docs/14/pages/building-your-application/configuring/eslint)，包含针对 Next.js 的定制规则。默认情况下，Next.js 集成了 `eslint-plugin-jsx-a11y` 来帮助及早发现无障碍问题，包括对以下情况的警告：
