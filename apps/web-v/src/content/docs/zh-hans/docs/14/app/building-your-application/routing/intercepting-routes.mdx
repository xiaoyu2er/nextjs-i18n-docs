...
拦截路由可与[并行路由](/docs/14/app/building-your-application/routing/parallel-routes)结合实现模态框，解决以下常见问题：
- 通过 URL 实现模态内容**可分享**
- 页面刷新时**保留上下文**而非关闭模态框
...
查看[并行路由](/docs/14/app/building-your-application/routing/parallel-routes#modals)文档获取分步示例，或参考我们的[图片库示例](https://github.com/vercel-labs/nextgram)。
