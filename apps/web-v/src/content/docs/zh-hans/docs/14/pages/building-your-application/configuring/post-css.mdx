...
Next.js 使用 PostCSS 编译其[内置 CSS 支持](/docs/14/pages/building-your-application/styling)的样式文件。
...
了解更多关于 [Next.js 的 CSS 模块支持](/docs/14/pages/building-your-application/styling)。
