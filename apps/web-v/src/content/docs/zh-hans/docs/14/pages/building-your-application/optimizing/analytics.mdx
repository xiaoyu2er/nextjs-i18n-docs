...
查看 [API 参考文档](/docs/14/pages/api-reference/functions/use-report-web-vitals) 获取更多信息。
...
查看 [API 参考文档](/docs/14/app/api-reference/functions/use-report-web-vitals) 获取更多信息。
