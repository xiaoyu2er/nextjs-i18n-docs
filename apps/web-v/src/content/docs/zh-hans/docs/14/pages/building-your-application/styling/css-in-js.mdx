...
如需为服务端组件添加样式，建议使用 [CSS 模块](/docs/14/app/building-your-application/styling/css-modules) 或其他生成 CSS 文件的方案，如 PostCSS 或 [Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css)。
...
然后用该注册表包裹你的 [根布局](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required)：
