...
translation-updated-at: 2025-05-21T20:29:46.659Z
title: Sass
description: 了解如何在 Next.js 应用中使用 Sass。
...
> `.scss` 扩展要求使用 [SCSS 语法](https://sass-lang.com/documentation/syntax#scss)，
> 而 `.sass` 扩展要求使用 [缩进语法（"Sass"）](https://sass-lang.com/documentation/syntax#the-indented-syntax)。
>
