...
您可以使用 [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) 和 [`getStaticPaths`](/docs/14/pages/building-your-application/data-fetching/get-static-paths) 为 `pages` 目录中的每个页面（或更多 [动态路由](/docs/14/app/building-your-application/routing/dynamic-routes)）生成 HTML 文件。
...
- [使用 `getStaticPaths` 时的动态路由](/docs/14/app/building-your-application/routing/dynamic-routes)
- 使用 `next/link` 进行预取
- 预加载 JavaScript
- [动态导入](/docs/14/pages/building-your-application/optimizing/lazy-loading)
- 任何样式选项（如 CSS 模块、styled-jsx）
- [客户端数据获取](/docs/14/pages/building-your-application/data-fetching/client-side)
...
通过 `next/image` 实现的 [图片优化](/docs/14/app/building-your-application/optimizing/images) 可以在静态导出中使用，只需在 `next.config.js` 中定义自定义图片加载器。例如，您可以使用 Cloudinary 等服务优化图片：
...
- 使用 `dynamicParams: true` 的 [动态路由](/docs/14/app/building-your-application/routing/dynamic-routes)
- 未使用 `generateStaticParams()` 的 [动态路由](/docs/14/app/building-your-application/routing/dynamic-routes)
- 依赖 Request 的 [路由处理器](/docs/14/app/building-your-application/routing/route-handlers)
- [Cookies](/docs/14/app/api-reference/functions/cookies)
- [重写](/docs/14/app/api-reference/next-config-js/rewrites)
- [重定向](/docs/14/app/api-reference/next-config-js/redirects)
- [标头](/docs/14/app/api-reference/next-config-js/headers)
- [中间件](/docs/14/app/building-your-application/routing/middleware)
- [增量静态再生](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating)
- 使用默认 `loader` 的 [图片优化](/docs/14/app/building-your-application/optimizing/images)
- [草稿模式](/docs/14/app/building-your-application/configuring/draft-mode)

尝试在 `next dev` 中使用这些功能将导致错误，类似于在根布局中将 [`dynamic`](/docs/14/app/api-reference/file-conventions/route-segment-config#dynamic) 选项设置为 `error`。
...
- [国际化路由](/docs/14/pages/building-your-application/routing/internationalization)
- [API 路由](/docs/14/pages/building-your-application/routing/api-routes)
- [重写](/docs/14/pages/api-reference/next-config-js/rewrites)
- [重定向](/docs/14/pages/api-reference/next-config-js/redirects)
- [标头](/docs/14/pages/api-reference/next-config-js/headers)
- [中间件](/docs/14/pages/building-your-application/routing/middleware)
- [增量静态再生](/docs/14/pages/building-your-application/data-fetching/incremental-static-regeneration)
- 使用默认 `loader` 的 [图片优化](/docs/14/pages/building-your-application/optimizing/images)
- [草稿模式](/docs/14/pages/building-your-application/configuring/draft-mode)
- [使用 `fallback: true` 的 `getStaticPaths`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-true)
- [使用 `fallback: 'blocking'` 的 `getStaticPaths`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-blocking)
