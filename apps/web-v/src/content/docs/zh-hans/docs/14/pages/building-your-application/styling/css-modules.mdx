...
如果尚未存在，请创建 [`pages/_app.js` 文件](/docs/14/pages/building-your-application/routing/custom-app)。
...
由于样式表的全局性质，为避免冲突，您**只能在 [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) 中导入它们**。
...
- 将共享样式提取到单独的共享组件中。
- 如果使用 [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css)，在文件顶部导入样式表，最好在 [根布局](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required) 中。
