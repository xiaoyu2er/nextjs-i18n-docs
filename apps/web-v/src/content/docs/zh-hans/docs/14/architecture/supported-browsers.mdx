...
这种情况下，您应该在[自定义 `<App>`](/docs/14/pages/building-your-application/routing/custom-app) 或具体组件中为**所需特定 polyfill** 添加顶层导入。
...
Next.js 内置 TypeScript 支持。[了解更多](/docs/14/pages/building-your-application/configuring/typescript)。

### 自定义 Babel 配置（高级）

您可以自定义 Babel 配置。[了解更多](/docs/14/pages/building-your-application/configuring/babel)。