...
本 API 参考将帮助您理解如何使用 Script 组件提供的 [props](#props)。关于功能和用法，请参阅 [优化脚本](/docs/14/app/building-your-application/optimizing/scripts) 页面。
...
> **警告**：`worker` 策略尚未稳定，且尚不适用于 [`app`](/docs/14/app/building-your-application/routing/defining-routes) 目录。请谨慎使用。
