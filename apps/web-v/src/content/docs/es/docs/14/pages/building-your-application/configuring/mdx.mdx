...
Para compartir un diseño entre páginas MDX, puedes usar el [soporte de diseños integrado](/docs/14/app/building-your-application/routing/pages-and-layouts#layouts) con App Router.
