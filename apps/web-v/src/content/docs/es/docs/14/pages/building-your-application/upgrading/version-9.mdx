...
translation-updated-at: 2025-06-06T16:41:56.145Z
...
Si anteriormente configuraste `routes` en tu archivo `vercel.json` para rutas dinámicas, estas reglas pueden eliminarse al aprovechar la nueva [función de Enrutamiento Dinámico](/docs/14/pages/building-your-application/routing/dynamic-routes) de Next.js 9.
...
Puedes leer más sobre [Enrutamiento Dinámico aquí](/docs/14/pages/building-your-application/routing/dynamic-routes).

## Revisa tu archivo de App personalizada (`pages/_app.js`)

Si anteriormente copiaste el ejemplo de [App personalizada (`<App>`)](/docs/14/pages/building-your-application/routing/custom-app), es posible que puedas eliminar tu `getInitialProps`.
