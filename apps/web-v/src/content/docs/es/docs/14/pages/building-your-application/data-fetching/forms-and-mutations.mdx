...
sidebar:
  order: 3010303
  label: "Formularios y Mutaciones"
---
...
> **Es bueno saber:**
>
> - Pronto recomendaremos [adoptar incrementalmente](/docs/14/app/building-your-application/upgrading/app-router-migration) el App Router y usar [Acciones de Servidor (Server Actions)](/docs/14/app/building-your-application/data-fetching/server-actions-and-mutations) para manejar envíos de formularios y mutaciones de datos. Las Acciones de Servidor permiten definir funciones asíncronas en el servidor que pueden ser llamadas directamente desde tus componentes, sin necesidad de crear manualmente una Ruta de API.
...
> - Dado que las Rutas de API se ejecutan en el servidor, podemos usar valores sensibles (como claves de API) a través de [Variables de Entorno](/docs/14/pages/building-your-application/configuring/environment-variables) sin exponerlos al cliente. Esto es crítico para la seguridad de tu aplicación.
...
Si deseas redirigir al usuario a una ruta diferente después de una mutación, puedes usar [`redirect`](/docs/14/pages/building-your-application/routing/api-routes#response-helpers) a cualquier URL absoluta o relativa:
...
Puedes leer cookies dentro de una Ruta de API usando el ayudante de solicitud [`cookies`](/docs/14/pages/building-your-application/routing/api-routes#request-helpers):
