...
Para aprender más sobre cómo funciona `getStaticProps`, consulta la [documentación de Obtención de Datos](/docs/14/pages/building-your-application/data-fetching/get-static-props).
...
> Para aprender más sobre rutas dinámicas, consulta la [documentación de Enrutamiento Dinámico](/docs/14/pages/building-your-application/routing/dynamic-routes).
...
Para aprender más sobre cómo funciona `getStaticPaths`, consulta la [documentación de Obtención de Datos](/docs/14/pages/building-your-application/data-fetching/get-static-paths).
