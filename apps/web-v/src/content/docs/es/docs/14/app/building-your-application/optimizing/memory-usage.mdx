...
El [Analizador de paquetes (Bundle Analyzer)](/docs/14/app/building-your-application/optimizing/package-bundling#analyzing-javascript-bundles) puede ayudarte a investigar dependencias grandes en tu aplicación que podrían eliminarse para mejorar el rendimiento y el uso de memoria.
...
Puedes deshabilitar este comportamiento agregando una [configuración personalizada de Webpack](/docs/14/app/api-reference/next-config-js/webpack) a tu aplicación:
