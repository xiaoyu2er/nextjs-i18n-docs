...
Para archivos de metadatos estáticos, como `robots.txt`, `favicon.ico`, etc., debe usar [archivos de metadatos especiales](/docs/14/app/api-reference/file-conventions/metadata) dentro de la carpeta `app`.
