...
Para obtener más información sobre cómo funciona `getServerSideProps`, consulte nuestra [documentación de Obtención de datos](/docs/14/pages/building-your-application/data-fetching/get-server-side-props).