...
translation-updated-at: 2025-06-06T16:41:38.439Z
...
Puedes utilizar [`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) y [`getStaticPaths`](/docs/14/pages/building-your-application/data-fetching/get-static-paths) para generar un archivo HTML por cada página en tu directorio `pages` (o más para [rutas dinámicas](/docs/14/app/building-your-application/routing/dynamic-routes)).
...
- [Rutas dinámicas con `getStaticPaths`](/docs/14/app/building-your-application/routing/dynamic-routes)
- Prefetching con `next/link`
- Precarga de JavaScript
- [Importaciones dinámicas](/docs/14/pages/building-your-application/optimizing/lazy-loading)
- Cualquier opción de estilos (ej. CSS Modules, styled-jsx)
- [Obtención de datos en el cliente](/docs/14/pages/building-your-application/data-fetching/client-side)
...
La [Optimización de imágenes](/docs/14/app/building-your-application/optimizing/images) a través de `next/image` puede usarse con una exportación estática definiendo un cargador personalizado en `next.config.js`. Por ejemplo, puedes optimizar imágenes con un servicio como Cloudinary:
...
- [Rutas dinámicas](/docs/14/app/building-your-application/routing/dynamic-routes) con `dynamicParams: true`
- [Rutas dinámicas](/docs/14/app/building-your-application/routing/dynamic-routes) sin `generateStaticParams()`
- [Manejadores de ruta](/docs/14/app/building-your-application/routing/route-handlers) que dependen de Request
...
- [Regeneración estática incremental](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating)
- [Optimización de imágenes](/docs/14/app/building-your-application/optimizing/images) con el `loader` predeterminado
- [Modo borrador](/docs/14/app/building-your-application/configuring/draft-mode)

Intentar usar cualquiera de estas funciones con `next dev` resultará en un error, similar a establecer la opción [`dynamic`](/docs/14/app/api-reference/file-conventions/route-segment-config#dynamic) como `error` en el diseño raíz.
...
- [Enrutamiento internacionalizado](/docs/14/pages/building-your-application/routing/internationalization)
- [Rutas API](/docs/14/pages/building-your-application/routing/api-routes)
...
- [Regeneración estática incremental](/docs/14/pages/building-your-application/data-fetching/incremental-static-regeneration)
- [Optimización de imágenes](/docs/14/pages/building-your-application/optimizing/images) con el `loader` predeterminado
- [Modo borrador](/docs/14/pages/building-your-application/configuring/draft-mode)
- [`getStaticPaths` con `fallback: true`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-true)
- [`getStaticPaths` con `fallback: 'blocking'`](/docs/14/pages/api-reference/functions/get-static-paths#fallback-blocking)
