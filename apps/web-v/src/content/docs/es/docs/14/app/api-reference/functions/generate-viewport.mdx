...
> - Si estás migrando desde exportaciones de `metadata`, puedes usar el [codemod metadata-to-viewport-export](/docs/14/app/building-your-application/upgrading/codemods#metadata-to-viewport-export) para actualizar tus cambios.
...
Puedes añadir seguridad de tipos a tu objeto viewport usando el tipo `Viewport`. Si estás usando el [plugin de TypeScript integrado](/docs/14/app/building-your-application/configuring/typescript) en tu IDE, no necesitas añadir manualmente el tipo, pero aún puedes hacerlo explícitamente si lo deseas.
