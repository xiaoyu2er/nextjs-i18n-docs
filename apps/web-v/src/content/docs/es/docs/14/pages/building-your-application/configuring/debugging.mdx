...
Si está [cambiando el número de puerto](/docs/14/pages/api-reference/cli/next#next-dev-options) en el que inicia su aplicación, reemplace el `3000` en `http://localhost:3000` con el puerto que esté usando.
