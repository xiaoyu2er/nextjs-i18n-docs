...
Las Rutas de Intercepción se pueden usar junto con [Rutas Paralelas](/docs/14/app/building-your-application/routing/parallel-routes) para crear modales. Esto te permite resolver desafíos comunes al construir modales, como:
...
Consulta la documentación de [Rutas Paralelas](/docs/14/app/building-your-application/routing/parallel-routes#modals) para ver un ejemplo paso a paso, o revisa nuestro [ejemplo de galería de imágenes](https://github.com/vercel-labs/nextgram).
