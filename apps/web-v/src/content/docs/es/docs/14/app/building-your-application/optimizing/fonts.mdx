...
[**`next/font`**](/docs/14/app/api-reference/components/font) optimizará automáticamente tus fuentes (incluyendo fuentes personalizadas) y eliminará las solicitudes de red externas para mejorar la privacidad y el rendimiento.
...
Para usar la fuente en todas tus páginas, agrégala al archivo [`_app.js`](/docs/14/pages/building-your-application/routing/custom-app) bajo `/pages` como se muestra a continuación:
...
Consulta la [Referencia de API de Fuentes](/docs/14/app/api-reference/components/font) para más información.
...
Alternativamente, puedes crear una [variable CSS](/docs/14/app/api-reference/components/font#variable) y usarla con tu solución CSS preferida:
...
`next/font` se puede usar con [Tailwind CSS](https://tailwindcss.com/) a través de una [variable CSS](/docs/14/app/api-reference/components/font#css-variables).
...
Finalmente, agrega la variable CSS a tu [configuración de Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css#configuring-tailwind):
...
- Si es una [página única](/docs/14/app/building-your-application/routing/pages-and-layouts#pages), se precarga en la ruta única de esa página.
- Si es un [layout](/docs/14/app/building-your-application/routing/pages-and-layouts#layouts), se precarga en todas las rutas envueltas por el layout.
- Si es el [layout raíz](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required), se precarga en todas las rutas.
...
- si es una [página única](/docs/14/pages/building-your-application/routing/pages-and-layouts), se precarga en la ruta única de esa página
- si está en la [App personalizada](/docs/14/pages/building-your-application/routing/custom-app), se precarga en todas las rutas del sitio bajo `/pages`
