...
- El **Entorno Edge** está basado en [APIs Web](/docs/14/app/api-reference/edge).
...
| [Streaming HTTP](/docs/14/app/building-your-application/routing/loading-ui-and-streaming)                                                | Sí      | Sí         | Sí               |
...
| [Renderizado estático](/docs/14/app/building-your-application/rendering/server-components#static-rendering-default)                       | Sí      | Sí         | No               |
| [Renderizado dinámico](/docs/14/app/building-your-application/rendering/server-components#dynamic-rendering)                             | Sí      | Sí         | Sí               |
| [Revalidación de datos con `fetch`](/docs/14/app/building-your-application/data-fetching/fetching-caching-and-revalidating#revalidating-data) | Sí      | Sí         | Sí               |
...
Puedes especificar un entorno de ejecución para segmentos de ruta individuales en tu aplicación Next.js. Para hacerlo, [declara una variable llamada `runtime` y expórtala](/docs/14/app/api-reference/file-conventions/route-segment-config). La variable debe ser un string y tener un valor de `'nodejs'` o `'edge'`.
...
> Consulta la [documentación de Node.js](https://nodejs.org/docs/latest/api/) y la [documentación Edge](/docs/14/app/api-reference/edge) para ver la lista completa de APIs disponibles. Ambos entornos también pueden soportar [streaming](/docs/14/app/building-your-application/routing/loading-ui-and-streaming) dependiendo de tu infraestructura de despliegue.