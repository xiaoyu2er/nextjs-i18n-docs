...
Por ejemplo, en la [Referencia de API de funciones](/docs/14/app/api-reference/functions), las páginas se ordenan alfabéticamente porque facilita a los desarrolladores encontrar una función específica:
...
Pero, en la [sección de enrutamiento](/docs/14/app/building-your-application/routing), los archivos tienen prefijos con números de dos dígitos, ordenados en el orden en que los desarrolladores deberían aprender estos conceptos:
...
- Los enlaces se generarán automáticamente para páginas que tienen páginas hijas. Por ejemplo, la sección [Optimización](/docs/14/app/building-your-application/optimizing) tiene enlaces a todas sus páginas hijas.
