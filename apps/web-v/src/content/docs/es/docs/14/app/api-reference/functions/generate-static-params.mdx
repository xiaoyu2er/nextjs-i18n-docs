...
> **Dato importante**
>
> - Puedes usar la opción de configuración de segmento [`dynamicParams`](/docs/14/app/api-reference/file-conventions/route-segment-config#dynamicparams) para controlar qué sucede cuando se visita un segmento dinámico que no fue generado con `generateStaticParams`.
...
> - `generateStaticParams` reemplaza la función [`getStaticPaths`](/docs/14/pages/api-reference/functions/get-static-paths) en el Enrutador de Páginas.
