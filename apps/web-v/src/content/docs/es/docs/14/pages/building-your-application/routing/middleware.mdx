...
1. `rewrite` a una ruta ([Página](/docs/14/app/building-your-application/routing/pages-and-layouts) o [Route Handler](/docs/14/app/building-your-application/routing/route-handlers)) que produzca una respuesta
...
1. `rewrite` a una ruta ([Página](/docs/14/pages/building-your-application/routing/pages-and-layouts) o [Edge API Route](/docs/14/pages/building-your-application/routing/api-routes)) que produzca una respuesta
2. devolver un `NextResponse` directamente. Consulta [Produciendo una Respuesta](#producing-a-response)
...
> **Nota importante:** Puede configurar encabezados CORS para rutas individuales en [Route Handlers](/docs/14/app/building-your-application/routing/route-handlers#cors).
...
Middleware actualmente solo soporta el [Edge runtime](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes). No se puede utilizar el entorno de ejecución Node.js.
