...
sidebar:
  order: 2010108
  label: "Organización de proyectos"
---


Además de las [convenciones de carpetas y archivos para enrutamiento](/docs/14/getting-started/project-structure#app-routing-conventions), Next.js es **flexible** respecto a cómo organiza y coloca los archivos de su proyecto.
...
En el directorio `app`, la [jerarquía de carpetas anidadas](/docs/14/app/building-your-application/routing#route-segments) define la estructura de rutas.
...
> - Si no usa carpetas privadas, sería útil conocer las [convenciones de archivos especiales](/docs/14/getting-started/project-structure#routing-files) de Next.js para evitar conflictos de nombres inesperados.
...
- [Organizar rutas en grupos](/docs/14/app/building-your-application/routing/route-groups#organize-routes-without-affecting-the-url-path) p.ej. por sección del sitio, intención o equipo.
- Habilitar diseños anidados en el mismo nivel de segmento de ruta:
  - [Crear múltiples diseños anidados en el mismo segmento, incluyendo múltiples diseños raíz](/docs/14/app/building-your-application/routing/route-groups#creating-multiple-root-layouts)
  - [Agregar un diseño a un subconjunto de rutas en un segmento común](/docs/14/app/building-your-application/routing/route-groups#opting-specific-segments-into-a-layout)

### Directorio `src`

Next.js admite almacenar el código de la aplicación (incluyendo `app`) dentro de un directorio [`src` opcional](/docs/14/app/building-your-application/configuring/src-directory). Esto separa el código de la aplicación de los archivos de configuración del proyecto que principalmente residen en la raíz del proyecto.
...
Next.js admite [Alias de módulos](/docs/14/app/building-your-application/configuring/absolute-imports-and-module-aliases) que facilitan la lectura y mantenimiento de importaciones entre archivos de proyecto profundamente anidados.
