...
translation-updated-at: 2025-06-06T16:51:17.511Z
title: error.js
...
> **Importante**:
>
> - Los límites `error.js` deben ser **[Componentes de Cliente](/docs/14/app/building-your-application/rendering/client-components)**.
...
> - Al diseñar la UI de errores, puede ser útil usar las [React Developer Tools](https://react.dev/learn/react-developer-tools) para activar manualmente los límites de error.
