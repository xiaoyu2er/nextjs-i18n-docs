...
Cuando use el componente [`next/image`](/docs/14/app/api-reference/components/image), deberá agregar el `basePath` delante de `src`.

</AppOnly>

<PagesOnly>

Cuando use el componente [`next/image`](/docs/14/pages/api-reference/components/image), deberá agregar el `basePath` delante de `src`.
