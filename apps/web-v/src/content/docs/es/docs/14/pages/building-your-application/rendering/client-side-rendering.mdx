...
1. Usando el hook `useEffect()` de React dentro de tus páginas en lugar de los métodos de renderizado del lado del servidor ([`getStaticProps`](/docs/14/pages/building-your-application/data-fetching/get-static-props) y [`getServerSideProps`](/docs/14/pages/building-your-application/data-fetching/get-server-side-props)).
