...
translation-updated-at: 2025-06-06T16:41:25.079Z
title: Codemods
...
Este codemod mueve las importaciones de `next/server` a `next/og` para usar la [Generación dinámica de imágenes OG](/docs/14/app/building-your-application/optimizing/metadata#dynamic-image-generation).
...
Elimina las etiquetas `<a>` dentro de [Componentes Link](/docs/14/app/api-reference/components/link), o añade un prop `legacyBehavior` a los Links que no se pueden corregir automáticamente.

</AppOnly>

<PagesOnly>

Elimina las etiquetas `<a>` dentro de [Componentes Link](/docs/14/pages/api-reference/components/link), o añade un prop `legacyBehavior` a los Links que no se pueden corregir automáticamente.
