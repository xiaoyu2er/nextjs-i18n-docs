...
- Habilitar [diseños anidados](/docs/14/app/building-your-application/routing/pages-and-layouts) en el mismo nivel de segmento de ruta:
...
Para crear múltiples [diseños raíz](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required), elimine el archivo `layout.js` de nivel superior y añada un archivo `layout.js` dentro de cada grupo de rutas. Esto es útil para dividir una aplicación en secciones que tienen una interfaz o experiencia completamente diferente. Las etiquetas `<html>` y `<body>` deben añadirse a cada diseño raíz.
