...
Recomendamos usar [`next/script`](/docs/14/pages/building-your-application/optimizing/scripts) en su componente en lugar de crear manualmente un `<script>` en `next/head`.
