...
Por defecto, los Componentes del Servidor se dividen automáticamente en [código (code splitting)](https://developer.mozilla.org/docs/Glossary/Code_splitting), y puede usar [streaming](/docs/14/app/building-your-application/routing/loading-ui-and-streaming) para enviar progresivamente partes de la interfaz de usuario desde el servidor al cliente. La carga diferida aplica a Componentes del Cliente.
