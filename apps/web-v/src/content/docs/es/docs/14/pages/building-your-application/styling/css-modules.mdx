...
translation-updated-at: 2025-06-06T16:43:26.917Z
title: Módulos CSS
...
Crea un archivo [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) si aún no está presente.
...
Debido a la naturaleza global de las hojas de estilo, y para evitar conflictos, solo puedes **importarlas dentro de [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app)**.
...
- Si usas [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css), importa la hoja de estilo al principio del archivo, preferiblemente en el [Diseño Raíz](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required).
