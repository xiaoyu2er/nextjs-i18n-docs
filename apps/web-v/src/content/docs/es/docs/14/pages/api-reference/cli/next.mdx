...
Ambos valores están [**comprimidos con gzip**](/docs/14/app/api-reference/next-config-js/compress). La primera carga se indica con verde, amarillo o rojo. Apunte a verde para aplicaciones con buen rendimiento.
