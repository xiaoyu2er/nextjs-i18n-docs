...
translation-updated-at: 2025-06-06T16:40:39.359Z
...
> Desde el lanzamiento de [Next.js 9.4](https://nextjs.org/blog/next-9-4) ahora tenemos una experiencia más intuitiva y ergonómica para [agregar variables de entorno](/docs/14/app/building-your-application/configuring/environment-variables). ¡Pruébelo!

</AppOnly>

<PagesOnly>

> Desde el lanzamiento de [Next.js 9.4](https://nextjs.org/blog/next-9-4) ahora tenemos una experiencia más intuitiva y ergonómica para [agregar variables de entorno](/docs/14/pages/building-your-application/configuring/environment-variables). ¡Pruébelo!
