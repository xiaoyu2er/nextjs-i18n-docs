...
Consulta la [Referencia de API](/docs/14/pages/api-reference/functions/use-report-web-vitals) para más información.
...
Consulta la [Referencia de API](/docs/14/app/api-reference/functions/use-report-web-vitals) para más información.
