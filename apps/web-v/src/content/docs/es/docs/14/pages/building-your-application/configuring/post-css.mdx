...
Next.js compila CSS para su [soporte CSS integrado](/docs/14/pages/building-your-application/styling) utilizando PostCSS.
...
Puedes aprender más sobre [el soporte de Módulos CSS en Next.js aquí](/docs/14/pages/building-your-application/styling).
