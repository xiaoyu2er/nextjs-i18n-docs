...
- Usando la función [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps).
...
Consulta la [referencia de API de `generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) para más información.
