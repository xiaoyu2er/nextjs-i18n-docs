...
`revalidateTag` permite purgar [datos en caché](/docs/14/app/building-your-application/caching) bajo demanda para una etiqueta de caché específica.

> **Es bueno saber**:
>
> - `revalidateTag` está disponible tanto en [entornos de ejecución Node.js como Edge](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes).
