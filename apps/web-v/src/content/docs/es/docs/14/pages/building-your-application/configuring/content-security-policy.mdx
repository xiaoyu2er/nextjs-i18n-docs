...
translation-updated-at: 2025-06-06T16:42:04.974Z
...
[Middleware](/docs/14/app/building-your-application/routing/middleware) le permite agregar encabezados y generar nonces antes de que la página se renderice.
...
Por defecto, Middleware se ejecuta en todas las solicitudes. Puede filtrar Middleware para que se ejecute en rutas específicas usando un [`matcher`](/docs/14/app/building-your-application/routing/middleware#matcher).
...
Ahora puede leer el nonce desde un [Componente de Servidor](/docs/14/app/building-your-application/rendering/server-components) usando [`headers`](/docs/14/app/api-reference/functions/headers):
...
Para aplicaciones que no requieren nonces, puede configurar el encabezado CSP directamente en su archivo [`next.config.js`](/docs/14/app/api-reference/next-config-js):
