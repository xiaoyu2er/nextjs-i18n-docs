...
- [CSS インポート](/docs/14/app/building-your-application/styling)
- [CSS モジュール](/docs/14/app/building-your-application/styling/css-modules)
- [Sass/SCSS インポート](/docs/14/app/building-your-application/styling/sass)
- [Sass/SCSS モジュール](/docs/14/app/building-your-application/styling/sass)

</AppOnly>

<PagesOnly>

- [CSS インポート](/docs/14/pages/building-your-application/styling)
- [CSS モジュール](/docs/14/pages/building-your-application/styling/css-modules)
- [Sass/SCSS インポート](/docs/14/pages/building-your-application/styling/sass)
- [Sass/SCSS モジュール](/docs/14/pages/building-your-application/styling/sass)
- [Babel 設定のカスタマイズ](/docs/14/pages/building-your-application/configuring/babel)
