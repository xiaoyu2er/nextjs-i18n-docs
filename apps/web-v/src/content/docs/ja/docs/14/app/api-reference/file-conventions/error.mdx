...
translation-updated-at: 2025-06-06T16:49:39.990Z
title: error.js
...
> **知っておくと良いこと**:
>
> - `error.js` 境界は必ず**[クライアントコンポーネント](/docs/14/app/building-your-application/rendering/client-components)**でなければなりません。
...
> **知っておくと良いこと**:
>
> - `global-error.js` はアクティブ時にルート `layout.js` を置き換えるため、独自の `<html>` タグと `<body>` タグを**定義する必要があります**。
