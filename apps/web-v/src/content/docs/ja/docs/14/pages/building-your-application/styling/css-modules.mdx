...
translation-updated-at: 2025-06-06T16:41:20.579Z
title: CSS モジュール
...
まだ存在しない場合は、[`pages/_app.js`ファイル](/docs/14/pages/building-your-application/routing/custom-app)を作成してください。
...
スタイルシートのグローバルな性質と衝突を避けるため、**スタイルシートは[`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app)内でのみインポートできます**。
...
- [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css)を使用する場合、ファイルの先頭、できれば[ルートレイアウト](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required)でスタイルシートをインポートする
