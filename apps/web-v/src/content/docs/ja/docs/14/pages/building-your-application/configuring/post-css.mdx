...
Next.js は [組み込みのCSSサポート](/docs/14/pages/building-your-application/styling) のために PostCSS を使用して CSS をコンパイルします。
...
[Next.js の CSS モジュールサポートについて詳しくはこちら](/docs/14/pages/building-your-application/styling) をご覧ください。
