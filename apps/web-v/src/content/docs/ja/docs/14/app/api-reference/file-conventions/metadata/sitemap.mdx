...
- [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) 関数を使用する
...
詳細については [`generateSitemaps` API リファレンス](/docs/14/app/api-reference/functions/generate-sitemaps) を参照してください。
