...
Next.jsは[統合ESLint体験](/docs/14/pages/building-your-application/configuring/eslint)をデフォルトで提供しており、Next.js向けのカスタムルールを含んでいます。デフォルトで、Next.jsには`eslint-plugin-jsx-a11y`が含まれており、以下のようなアクセシビリティ問題を早期に検出するのに役立ちます:
