...
サーバーコンポーネントのスタイリングには、[CSS Modules](/docs/14/app/building-your-application/styling/css-modules)やPostCSS、[Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css)など、CSSファイルを出力するソリューションの使用を推奨します。
...
次に、[ルートレイアウト](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required)をレジストリでラップします:
