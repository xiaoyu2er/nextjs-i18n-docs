...
詳細については[APIリファレンス](/docs/14/pages/api-reference/functions/use-report-web-vitals)を参照してください。
...
詳細については[APIリファレンス](/docs/14/app/api-reference/functions/use-report-web-vitals)を参照してください。
