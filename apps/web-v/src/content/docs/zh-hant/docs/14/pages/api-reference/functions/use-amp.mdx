...
translation-updated-at: 2025-05-25T21:04:37.293Z
title: useAmp
description: 在頁面中啟用 AMP，並透過 AMP 配置控制 Next.js 將 AMP 加入頁面的方式。
sidebar:
  order: 30202
---
...
> AMP 支援是我們的高級功能之一，您可以[在此閱讀更多關於 AMP 的資訊](/docs/14/pages/building-your-application/configuring/amp)。
...
該頁面使用 `useAmp` 來區分模式，這是一個 [React Hook](https://react.dev/reference/react)，如果頁面使用 AMP 則返回 `true`，否則返回 `false`。