...
translation-updated-at: 2025-05-25T21:08:31.767Z
...
如果尚未存在，請建立 [`pages/_app.js` 檔案](/docs/14/pages/building-your-application/routing/custom-app)。
...
由於樣式表的全域性質，且為了避免衝突，您**只能在 [`pages/_app.js`](/docs/14/pages/building-your-application/routing/custom-app) 中導入它們**。
...
- 將共享樣式提取到單獨的共享元件中。
- 如果使用 [Tailwind](/docs/14/app/building-your-application/styling/tailwind-css)，請在檔案頂部導入樣式表，最好是在 [根布局](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required) 中。
