...
translation-updated-at: 2025-05-25T21:08:28.402Z
title: CSS-in-JS
...
如果您想為伺服器元件添加樣式，建議使用 [CSS 模組 (CSS Modules)](/docs/14/app/building-your-application/styling/css-modules) 或其他輸出 CSS 檔案的解決方案，如 PostCSS 或 [Tailwind CSS](/docs/14/app/building-your-application/styling/tailwind-css)。
...
然後，用註冊表包裹您的 [根佈局 (root layout)](/docs/14/app/building-your-application/routing/pages-and-layouts#root-layout-required)：
