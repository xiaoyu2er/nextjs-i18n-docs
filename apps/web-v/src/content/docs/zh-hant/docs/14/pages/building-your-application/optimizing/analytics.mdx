...
查看 [API 參考文件](/docs/14/pages/api-reference/functions/use-report-web-vitals) 以取得更多資訊。
...
查看 [API 參考文件](/docs/14/app/api-reference/functions/use-report-web-vitals) 以取得更多資訊。
