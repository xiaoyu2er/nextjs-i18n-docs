...
[套件分析工具 (Bundle Analyzer)](/docs/14/app/building-your-application/optimizing/package-bundling#analyzing-javascript-bundles) 可協助您找出應用程式中可能移除的大型依賴項，以提升效能並減少記憶體使用。
...
您可透過新增 [自訂 Webpack 設定](/docs/14/app/api-reference/next-config-js/webpack) 來停用此行為：
