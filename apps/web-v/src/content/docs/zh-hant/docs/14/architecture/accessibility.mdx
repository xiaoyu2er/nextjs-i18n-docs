...
Next.js 提供了[整合的 ESLint 體驗](/docs/14/pages/building-your-application/configuring/eslint)，包括針對 Next.js 的自訂規則。預設情況下，Next.js 包含 `eslint-plugin-jsx-a11y`，幫助及早發現無障礙問題，包括以下警告：
