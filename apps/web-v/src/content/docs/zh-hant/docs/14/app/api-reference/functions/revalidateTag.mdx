...
`revalidateTag` 允許您針對特定的快取標籤，按需清除[快取資料](/docs/14/app/building-your-application/caching)。

> **須知事項**:
>
> - `revalidateTag` 可在 [Node.js 和 Edge 執行環境](/docs/14/app/building-your-application/rendering/edge-and-nodejs-runtimes)中使用。
