...
translation-updated-at: 2025-05-25T21:04:27.463Z
title: <Script>
...
本 API 參考將幫助您了解如何使用 Script 元件可用的 [屬性 (props)](#props)。關於功能和用法，請參閱 [腳本優化](/docs/14/app/building-your-application/optimizing/scripts) 頁面。
