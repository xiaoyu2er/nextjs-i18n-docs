...
攔截式路由可與[平行路由](/docs/14/app/building-your-application/routing/parallel-routes)結合使用來建立模態框。這讓您能解決建置模態框時的常見挑戰，例如：
...
請參閱[平行路由](/docs/14/app/building-your-application/routing/parallel-routes#modals)文件以獲取逐步範例，或查看我們的[圖片庫範例](https://github.com/vercel-labs/nextgram)。
