...
- 使用 [`generateSitemaps`](/docs/14/app/api-reference/functions/generate-sitemaps) 函式。
...
更多資訊請參閱 [`generateSitemaps` API 參考文件](/docs/14/app/api-reference/functions/generate-sitemaps)。
