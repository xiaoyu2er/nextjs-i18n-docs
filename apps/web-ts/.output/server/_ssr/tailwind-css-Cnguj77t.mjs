...
//#region node_modules/.nitro/vite/services/ssr/assets/tailwind-css-Cnguj77t.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var tailwind_css_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Tailwind CSS is a utility-first CSS framework that is fully compatible with Next.js. This guide will walk you through how to install Tailwind CSS in your Next.js application."
		},
		{
			"heading": "installing-tailwind",
			"content": "Install the necessary Tailwind CSS packages:"
		},
		{
			"heading": "installing-tailwind",
			"content": "> **Good to know**: If you're using the `create-next-app` CLI to create your project, Next.js will prompt if you'd like to install Tailwind and automatically configure the project."
		},
		{
			"heading": "configuring-tailwind",
			"content": "Create a `postcss.config.mjs` file in the root of your project and add the `@tailwindcss/postcss` plugin to your PostCSS configuration:"
		},
		{
			"heading": "configuring-tailwind",
			"content": "As of Tailwind v4, there is zero configuration required by default. If you do need to configure Tailwind, you can follow the official documentation for configuring the global CSS file."
		},
		{
			"heading": "configuring-tailwind",
			"content": "There is also an upgrade CLI and guide if you have an existing Tailwind v3 project."
		},
		{
			"heading": "importing-styles",
			"content": "Add the Tailwind CSS directives that Tailwind will use to inject its generated styles to a Global Stylesheet in your application, for example:"
		},
		{
			"heading": "importing-styles",
			"content": "Inside the root layout (`app/layout.tsx`), import the `globals.css` stylesheet to apply the styles to every route in your application."
		},
		{
			"heading": "using-classes",
			"content": "After installing Tailwind CSS and adding the global styles, you can use Tailwind's utility classes in your application."
		},
		{
			"heading": "importing-styles-1",
			"content": "Add the Tailwind CSS directives that Tailwind will use to inject its generated styles to a Global Stylesheet in your application, for example:"
		},
		{
			"heading": "importing-styles-1",
			"content": "Inside the custom app file (`pages/_app.js`), import the `globals.css` stylesheet to apply the styles to every route in your application."
		},
		{
			"heading": "using-classes-1",
			"content": "After installing Tailwind CSS and adding the global styles, you can use Tailwind's utility classes in your application."
		},
		{
			"heading": "usage-with-turbopack",
			"content": "As of Next.js 13.1, Tailwind CSS and PostCSS are supported with Turbopack."
		}
	],
	"headings": [
		{
			"id": "installing-tailwind",
			"content": "Installing Tailwind"
		},
		{
			"id": "configuring-tailwind",
			"content": "Configuring Tailwind"
		},
		{
			"id": "importing-styles",
			"content": "Importing Styles"
		},
		{
			"id": "using-classes",
...
var toc = [
	{
		depth: 2,
		url: "#installing-tailwind",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Installing Tailwind" })
	},
	{
		depth: 2,
		url: "#configuring-tailwind",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Configuring Tailwind" })
	},
	{
		depth: 2,
		url: "#importing-styles",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Importing Styles" })
	},
	{
		depth: 2,
		url: "#using-classes",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Using Classes" })
	},
	{
		depth: 2,
		url: "#importing-styles-1",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Importing Styles" })
	},
	{
		depth: 2,
	...
	{
		depth: 2,
		url: "#usage-with-turbopack",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Usage with Turbopack" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "installing-tailwind",
			children: "Installing Tailwind"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Install the necessary Tailwind CSS packages:" }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "@tailwindcss/postcss" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://tailwindcss.com/blog/tailwindcss-v4#css-first-configuration",
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			(0, import_jsx_runtime.jsx)(_components.h2, {
				id: "importing-styles",
				children: "Importing Styles"
			}),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"Add the ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://tailwindcss.com/docs/functions-and-directives#directives",
					children: "Tailwind CSS directives"
				}),
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				"), import the ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "globals.css" }),
			...
			(0, import_jsx_runtime.jsx)(_components.h2, {
				id: "using-classes",
				children: "Using Classes"
			}),
			(0, import_jsx_runtime.jsx)(_components.p, { children: "After installing Tailwind CSS and adding the global styles, you can use Tailwind's utility classes in your application." }),
			(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
								...
								(0, import_jsx_runtime.jsxs)(_components.span, {
									...
									children: [
										...
										(0, import_jsx_runtime.jsx)(_components.span, {
											...
											children: "\"text-3xl font-bold underline\""
										}),
										(0, import_jsx_runtime.jsx)(_components.span, {
											style: {
												"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "usage-with-turbopack",
			children: "Usage with Turbopack"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"As of Next.js 13.1, Tailwind CSS and PostCSS are supported with ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://turbo.build/pack/docs/features/css#tailwind-css",
				children: "Turbopack"
			}),
			"."
		] })
...
//#endregion
export { toc as a, tailwind_css_exports as i, frontmatter as n, structuredData as r, MDXContent as t };
