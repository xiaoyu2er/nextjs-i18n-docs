...
//#region node_modules/.nitro/vite/services/ssr/assets/13-fonts-CIpQGr4t.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _13_fonts_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `next/font` module automatically optimizes your fonts and removes external network requests for improved privacy and performance."
		},
		{
			"heading": void 0,
			"content": "It includes **built-in self-hosting** for any font file. This means you can optimally load web fonts with no layout shift."
		},
		{
			"heading": void 0,
			"content": "To start using `next/font`, import it from `next/font/local` or `next/font/google`, call it as a function with the appropriate options, and set the `className` of the element you want to apply the font to. For example:"
		},
		{
			"heading": void 0,
			"content": "Fonts are scoped to the component they're used in. To apply a font to your entire application, add it to the Root Layout."
		},
		{
			"heading": "google-fonts",
			"content": "You can automatically self-host any Google Font. Fonts are included stored as static assets and served from the same domain as your deployment, meaning no requests are sent to Google by the browser when the user visits your site."
		},
		{
			"heading": "google-fonts",
			"content": "To start using a Google Font, import your chosen font from `next/font/google`:"
		},
		{
			"heading": "google-fonts",
			"content": "We recommend using variable fonts for the best performance and flexibility. But if you can't use a variable font, you will need to specify a weight:"
		},
		{
			"heading": "local-fonts",
			"content": "To use a local font, import your font from `next/font/local` and specify the `src` of your local font file. Fonts can be stored in the `public` folder or co-located inside the `app` folder. For example:"
		},
		{
			"heading": "local-fonts",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"It includes ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "built-in self-hosting" }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can automatically self-host any Google Font. Fonts are included stored as static assets and served from the same domain as your deployment, meaning no requests are sent to Google by the browser when the user visits your site." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" and specify the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/components/font#src",
...
//#endregion
export { toc as a, structuredData as i, _13_fonts_exports as n, frontmatter as r, MDXContent as t };
