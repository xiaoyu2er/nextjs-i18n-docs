...
//#region node_modules/.nitro/vite/services/ssr/assets/08-updating-data-DItdEhiM.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _08_updating_data_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "what-are-server-functions",
			"content": "A **Server Function** is an asynchronous function that runs on the server. They can be called from client through a network request, which is why they must be asynchronous."
		},
		{
			"heading": "what-are-server-functions",
			"content": "In an `action` or mutation context, they are also called **Server Actions**."
		},
		{
			"heading": "what-are-server-functions",
			"content": "By convention, a Server Action is an async function used with `startTransition`. This happens automatically when the function is:"
		},
		{
			"heading": "what-are-server-functions",
			"content": "Passed to a `<form>` using the `action` prop."
		},
		{
			"heading": "what-are-server-functions",
			"content": "Passed to a `<button>` using the `formAction` prop."
		},
		{
			"heading": "what-are-server-functions",
			"content": "In Next.js, Server Actions integrate with the framework's caching architecture. When an action is invoked, Next.js can return both the updated UI and new data in a single server roundtrip."
		},
		{
			"heading": "what-are-server-functions",
		...
		{
			"heading": "creating-server-functions",
			"content": "A Server Function can be defined by using the `use server` directive. You can place the directive at the top of an **asynchronous** function to mark the function as a Server Function, or at the top of a separate file to mark all exports of that file."
		},
		{
			"heading": "server-components",
			"content": "Server Functions can be inlined in Server Components by adding the `\"use server\"` directive to the top of the function body:"
		},
		{
			"heading": "server-components",
			"content": "> **Good to know:** Server Components support progressive enhancement by default, meaning forms that call Server Actions will be submitted even if JavaScript hasn't loaded yet or is disabled."
		},
		{
			"heading": "client-components",
			"content": "It's not possible to define Server Functions in Client Components. However, you can invoke them in Client Components by importing them from a file that has the `\"use server\"` directive at the top of it:"
		},
		{
			"heading": "client-components",
			"content": "> **Good to know:** In Client Components, forms invoking Server Actions will queue submissions if JavaScript isn't loaded yet, and will be prioritized for hydration. After hydration, the browser does not refresh on form submission."
		},
		{
			"heading": "passing-actions-as-props",
			"content": "You can also pass an action to a Client Component as a prop:"
		},
		{
			"heading": "invoking-server-functions",
			"content": "There are two main ways you can invoke a Server Function:"
		},
		{
			"heading": "invoking-server-functions",
			"content": "Forms in Server and Client Components"
		},
		{
			"heading": "invoking-server-functions",
			"content": "Event Handlers and useEffect in Client Components"
		},
		{
			"heading": "invoking-server-functions",
			"content": "> **Good to know:** Server Functions are designed for server-side mutations. The client currently dispatches and awaits them one at a time. This is an implementation detail and may change. If you need parallel data fetching, use data fetching in Server Components, or perform parallel work inside a single Server Function or Route Handler."
		},
		{
			"heading": "forms",
			"content": "React extends the HTML `<form>` element to allow Server Function to be invoked with the HTML `action` prop."
		},
		{
			"heading": "forms",
			"content": "When invoked in a form, the function automatically receives the `FormData` object. You can extract the data using the native `FormData` methods:"
		},
		{
			"heading": "event-handlers",
			"content": "You can invoke a Server Function in a Client Component by using event handlers such as `onClick`."
		},
		{
			"heading": "showing-a-pending-state",
			"content": "While executing a Server Function, you can show a loading indicator with React's `useActionState` hook. This hook returns a `pending` boolean:"
		},
		{
			"heading": "revalidating",
			"content": "After performing an update, you can revalidate the Next.js cache and show the updated data by calling `revalidatePath` or `revalidateTag` within the Server Function:"
		},
		{
			"heading": "redirecting",
			"content": "You may want to redirect the user to a different page after performing an update. You can do this by calling `redirect` within the Server Function."
		},
		{
			"heading": "redirecting",
			"content": "Calling `redirect` throws a framework handled control-flow exception. Any code after it won't execute. If you need fresh data, call `revalidatePath` or `revalidateTag` beforehand."
		},
		{
			"heading": "cookies",
		...
		{
			"heading": "cookies",
			"content": "When you set or delete a cookie in a Server Action, Next.js re-renders the current page and its layouts on the server so the **UI reflects the new cookie value**."
		},
		{
			"heading": "cookies",
			"content": "> **Good to know**: The server update applies to the current React tree, re-rendering, mounting, or unmounting components, as needed. Client state is preserved for re-rendered components, and effects re-run if their dependencies changed."
		},
		{
			"heading": "useeffect",
	...
	"headings": [
		...
		},
		{
			...
			"content": "Showing a pending state"
		},
		{
			"id": "revalidating",
...
var toc = [
	{
		depth: 2,
		url: "#what-are-server-functions",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "What are Server Functions?" })
	},
	{
		depth: 2,
		url: "#creating-server-functions",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating Server Functions" })
	},
	{
		depth: 3,
	...
	{
		depth: 3,
		url: "#passing-actions-as-props",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Passing actions as props" })
	},
	{
		depth: 2,
		url: "#invoking-server-functions",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Invoking Server Functions" })
	},
	{
		depth: 3,
		url: "#forms",
	...
	{
		depth: 3,
		url: "#showing-a-pending-state",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Showing a pending state" })
	},
	{
		depth: 3,
		url: "#revalidating",
	...
	},
	{
		depth: 3,
		url: "#useeffect",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "useEffect" })
	},
	{
		depth: 2,
		url: "#api-reference",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "#creating-server-functions",
				children: "create"
			}),
			" and ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "#invoking-server-functions",
				children: "invoke"
			}),
			" Server Functions."
		] }),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "what-are-server-functions",
			children: "What are Server Functions?"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"A ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "Server Function" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "startTransition" })
			}),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "creating-server-functions",
			children: "Creating Server Functions"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know:" }), " Server Components support progressive enhancement by default, meaning forms that call Server Actions will be submitted even if JavaScript hasn't loaded yet or is disabled."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know:" }), " In Client Components, forms invoking Server Actions will queue submissions if JavaScript isn't loaded yet, and will be prioritized for hydration. After hydration, the browser does not refresh on form submission."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "passing-actions-as-props",
			children: "Passing actions as props"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can also pass an action to a Client Component as a prop:" }),
		"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "invoking-server-functions",
			children: "Invoking Server Functions"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "There are two main ways you can invoke a Server Function:" }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/getting-started/fetching-data#server-components",
					children: "data fetching"
				}),
				" in Server Components, or perform parallel work inside a single Server Function or ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/guides/backend-for-frontend#manipulating-data",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/ui/form.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/form.tsx",
						children: "app/ui/form.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/form.js",
						children: "app/ui/form.js"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/actions.ts",
						children: "app/actions.ts"
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "showing-a-pending-state",
			children: "Showing a pending state"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "useActionState" })
			}),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/ui/button.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/ui/button.tsx",
					children: "app/ui/button.tsx"
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " { useActionState, startTransition } "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " '@/app/ui/loading-spinner'"
									})
								]
							}),
							"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/functions/redirect#behavior",
				children: "throws"
			}),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"When you ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/functions/cookies#understanding-cookie-behavior-in-server-actions",
				children: "set or delete"
			}),
			" a cookie in a Server Action, Next.js re-renders the current page and its layouts on the server so the ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "UI reflects the new cookie value" }),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }), ": The server update applies to the current React tree, re-rendering, mounting, or unmounting components, as needed. Client state is preserved for re-rendered components, and effects re-run if their dependencies changed."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " { useState, useEffect, useTransition } "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // You can use `isPending` to give users feedback"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, _08_updating_data_exports as n, frontmatter as r, MDXContent as t };
