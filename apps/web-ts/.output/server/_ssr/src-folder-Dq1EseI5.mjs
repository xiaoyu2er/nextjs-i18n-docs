...
//#region node_modules/.nitro/vite/services/ssr/assets/src-folder-Dq1EseI5.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var src_folder_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"nav_title": "src",
	"related": { "links": ["app/getting-started/project-structure"] }
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "As an alternative to having the special Next.js `app` or `pages` directories in the root of your project, Next.js also supports the common pattern of placing application code under the `src` folder."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "To use the `src` folder, move the `app` Router folder or `pages` Router folder to `src/app` or `src/pages` respectively."
		},
		{
			"heading": void 0,
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, src_folder_exports as r, MDXContent as t };
