...
//#region node_modules/.nitro/vite/services/ssr/assets/05-client-side-rendering-C4cYJLE6.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _05_client_side_rendering_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "After the page has been loaded for the first time, navigating to other pages on the same website is typically faster, as only necessary data needs to be fetched, and JavaScript can re-render parts of the page without requiring a full page refresh."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Using React's `useEffect()` hook inside your pages instead of the server-side rendering methods (`getStaticProps` and `getServerSideProps`)."
		},
		{
			"heading": void 0,
			"content": "Using a data fetching library like SWR or TanStack Query to fetch data on the client (recommended)."
		},
		{
			"heading": void 0,
			"content": "Here's an example of using `useEffect()` inside a Next.js page:"
		},
		{
			"heading": void 0,
			"content": "In the example above, the component starts by rendering `Loading...`. Then, once the data is fetched, it re-renders and displays the data."
		},
		{
			"heading": void 0,
			"content": "Although fetching data in a `useEffect` is a pattern you may see in older React Applications, we recommend using a data-fetching library for better performance, caching, optimistic updates, and more. Here's a minimum example using SWR to fetch data on the client:"
		},
		{
			"heading": void 0,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.p, { children: "In Client-Side Rendering (CSR) with React, the browser downloads a minimal HTML page and the JavaScript needed for the page. The JavaScript is then used to update the DOM and render the page. When the application is first loaded, the user may notice a slight delay before they can see the full page, this is because the page isn't fully rendered until all the JavaScript is downloaded, parsed, and executed." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "After the page has been loaded for the first time, navigating to other pages on the same website is typically faster, as only necessary data needs to be fetched, and JavaScript can re-render parts of the page without requiring a full page refresh." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "In Next.js, there are two ways you can implement client-side rendering:" }),
		"\n",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "      // handle the error as needed"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'An error occurred while fetching the data: '"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "depending on the needs of each page" }),
				" in your application. In the App Router, you can also use ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/file-conventions/loading",
					children: "Loading UI with Suspense"
				}),
...
//#endregion
export { toc as a, structuredData as i, _05_client_side_rendering_exports as n, frontmatter as r, MDXContent as t };
