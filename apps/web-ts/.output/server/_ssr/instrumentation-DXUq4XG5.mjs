...
//#region node_modules/.nitro/vite/services/ssr/assets/instrumentation-DXUq4XG5.js
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["app/guides/instrumentation"]
	}
};
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "To use it, place the file in the **root** of your application or inside a `src` folder if using one."
		},
		{
			"heading": "register-optional",
			"content": "The file exports a `register` function that is called **once** when a new Next.js server instance is initiated. `register` can be an async function."
		},
		{
			"heading": "onrequesterror-optional",
			"content": "You can optionally export an `onRequestError` function to track **server** errors to any custom observability provider."
		},
		{
			"heading": "onrequesterror-optional",
			"content": "If you're running any async tasks in `onRequestError`, make sure they're awaited. `onRequestError` will be triggered when the Next.js server captures the error."
		},
		{
			"heading": "onrequesterror-optional",
			"content": "The `error` instance might not be the original error instance thrown, as it may be processed by React if encountered during Server Components rendering. If this happens, you can use `digest` property on an error to identify the actual error type."
		},
		{
			"heading": "parameters",
			"content": "The function accepts three parameters: `error`, `request`, and `context`."
		},
		{
			"heading": "parameters",
			"content": "`error`: The caught error itself (type is always `Error`), and a `digest` property which is the unique ID of the error."
		},
		{
			"heading": "parameters",
			"content": "`request`: Read-only request information associated with the error."
		},
		{
			"heading": "parameters",
			"content": "`context`: The context in which the error occurred. This can be the type of router (App or Pages Router), and/or (Server Components (`'render'`), Route Handlers (`'route'`), Server Actions (`'action'`), or Middleware (`'middleware'`))."
		},
		{
			"heading": "specifying-the-runtime",
			"content": "The `instrumentation.js` file works in both the Node.js and Edge runtime, however, you can use `process.env.NEXT_RUNTIME` to target a specific runtime."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`onRequestError` introduced, `instrumentation` stable"
		},
		{
			"heading": "version-history",
			"content": "`v14.0.4`"
		...
		{
			"heading": "version-history",
			"content": "Turbopack support for `instrumentation`"
		},
		{
			"heading": "version-history",
			"content": "`v13.2.0`"
		...
		{
			"heading": "version-history",
			"content": "`instrumentation` introduced as an experimental feature"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#register-optional",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("code", { children: "register" }), " (optional)"] })
	},
	{
		depth: 3,
		url: "#onrequesterror-optional",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("code", { children: "onRequestError" }), " (optional)"] })
	},
	{
		depth: 4,
		url: "#parameters",
	...
	{
		depth: 3,
		url: "#specifying-the-runtime",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Specifying the runtime" })
	},
	{
		depth: 2,
		url: "#version-history",
	...
	{
		depth: 2,
		url: "#learn-more-about-instrumentation",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Learn more about Instrumentation" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "instrumentation.js|ts" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			id: "register-optional",
			children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "register" }), " (optional)"]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The file exports a ",
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "once" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			id: "onrequesterror-optional",
			children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "onRequestError" }), " (optional)"]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // resource path, e.g. /blog?name=foo"
						})
					]
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // request method. e.g. GET, POST, etc"
						})
					]
				}),
				"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // the route file path, e.g. /app/blog/[dynamic]"
						})
					]
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // the context in which the error occurred"
						})
					]
				}),
				"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: " 'react-server-components-payload'"
					})]
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // undefined is a normal request without revalidation"
						})
					]
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // 'dynamic-resume' for PPR"
						})
					]
				}),
				"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "request" }), ": Read-only request information associated with the error."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "context" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "specifying-the-runtime",
			children: "Specifying the runtime"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'./on-request-error.edge'"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'./on-request-error.node'"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Version" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Changes" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v14.0.4" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: ["Turbopack support for ", (0, import_jsx_runtime.jsx)(_components.code, { children: "instrumentation" })] })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v13.2.0" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "instrumentation" }), " introduced as an experimental feature"] })] })
		] })] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "learn-more-about-instrumentation",
			children: "Learn more about Instrumentation"
		})
	] });
}
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, instrumentation_exports as r, MDXContent as t };
