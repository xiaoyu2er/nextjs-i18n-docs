...
//#region node_modules/.nitro/vite/services/ssr/assets/forbidden-ykMiilyZ.js
...
var frontmatter = {
	...
	"related": { "links": ["app/api-reference/functions/forbidden"] }
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The **forbidden** file is used to render UI when the `forbidden` function is invoked during authentication. Along with allowing you to customize the UI, Next.js will return a `403` status code."
		},
		{
			"heading": "props",
			"content": "`forbidden.js` components do not accept any props."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`forbidden.js` introduced."
		}
	],
	"headings": [
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "forbidden" }),
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "403" }),
			" status code."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/forbidden.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/forbidden.tsx",
					children: "app/forbidden.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/forbidden.jsx",
					children: "app/forbidden.jsx"
				})] }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "forbidden.js" }), " components do not accept any props."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "version-history",
