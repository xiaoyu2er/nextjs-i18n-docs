...
//#region node_modules/.nitro/vite/services/ssr/assets/03-environment-variables-Dg5yZ7dS.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_environment_variables_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "Use `.env.local` to load environment variables"
		},
		{
			"heading": void 0,
		...
		},
		{
			...
			"content": "Next.js has built-in support for loading environment variables from `.env.local` into `process.env`."
		},
		{
			"heading": "loading-environment-variables",
		...
		{
			"heading": "referencing-other-variables",
			"content": "In the above example, `process.env.TWITTER_URL` would be set to `https://twitter.com/nextjs`."
		},
		{
			"heading": "referencing-other-variables",
		...
		{
			"heading": "runtime-environment-variables",
			"content": "We do not recommend using the runtimeConfig option, as this does not work with the standalone output mode. Instead, we recommend incrementally adopting the App Router."
		},
		{
			"heading": "default-environment-variables",
			"content": "In general only one `.env.local` file is needed. However, sometimes you might want to add some defaults for the `development` (`next dev`) or `production` (`next start`) environment."
		},
		{
			"heading": "default-environment-variables",
			"content": "Next.js allows you to set defaults in `.env` (all environments), `.env.development` (development environment), and `.env.production` (production environment)."
		},
		{
			"heading": "default-environment-variables",
			"content": "`.env.local` always overrides the defaults set."
		},
		{
			"heading": "default-environment-variables",
			"content": "> **Good to know**: `.env`, `.env.development`, and `.env.production&#x60; files should be included in your repository as they define defaults. &#x2A;*`.env*.local` should be added to `.gitignore`**, as those files are intended to be ignored. `.env.local` is where secrets can be stored."
		},
		{
			"heading": "environment-variables-on-vercel",
			"content": "When deploying your Next.js application to Vercel, Environment Variables can be configured in the Project Settings."
		},
		{
			"heading": "environment-variables-on-vercel",
			"content": "All types of Environment Variables should be configured there. Even Environment Variables used in Development – which can be downloaded onto your local device afterwards."
		},
		{
			"heading": "environment-variables-on-vercel",
			"content": "If you've configured Development Environment Variables you can pull them into a `.env.local` for usage on your local machine using the following command:"
		},
		{
			"heading": "environment-variables-on-vercel",
			"content": "> **Good to know**: When deploying your Next.js application to Vercel, your environment variables in `.env*` files will not be made available to Edge Runtime, unless their name are prefixed with `NEXT_PUBLIC_`. We strongly recommend managing your environment variables in Project Settings instead, from where all environment variables are available."
		},
		{
	...
	"headings": [
		...
		},
		{
			...
			"content": "Default Environment Variables"
		},
		{
			"id": "environment-variables-on-vercel",
			"content": "Environment Variables on Vercel"
		},
		{
...
var toc = [
	...
	{
		depth: 2,
		url: "#default-environment-variables",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Default Environment Variables" })
	},
	{
		depth: 2,
		url: "#environment-variables-on-vercel",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Environment Variables on Vercel" })
	},
	{
		depth: 2,
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "TWITTER_URL=https://twitter.com/$TWITTER_USER" })
				})
			] })
		}) }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" would be set to ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "https://twitter.com/nextjs" }),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: ".env.local" }), " always overrides the defaults set."] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "environment-variables-on-vercel",
			children: "Environment Variables on Vercel"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/docs/projects/environment-variables?utm_medium=docs&utm_source=next-site&utm_campaign=next-website",
				children: "in the Project Settings"
			}),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/docs/concepts/projects/environment-variables#development-environment-variables?utm_source=next-site&utm_medium=docs&utm_campaign=next-website",
				children: "downloaded onto your local device"
			}),
			" afterwards."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/docs/concepts/projects/environment-variables#development-environment-variables?utm_source=next-site&utm_medium=docs&utm_campaign=next-website",
				children: "Development Environment Variables"
			}),
...
//#endregion
export { toc as a, structuredData as i, _03_environment_variables_exports as n, frontmatter as r, MDXContent as t };
