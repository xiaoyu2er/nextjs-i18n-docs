...
//#region node_modules/.nitro/vite/services/ssr/assets/redirect-B1JJEAQm.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var redirect_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"related": { "links": ["app/api-reference/functions/permanentRedirect"] }
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `redirect` function allows you to redirect the user to another URL. `redirect` can be used while rendering in Server and Client Components, Route Handlers, and Server Actions."
		},
		{
			"heading": void 0,
			"content": "When used in a streaming context, this will insert a meta tag to emit the redirect on the client side. When used in a server action, it will serve a 303 HTTP redirect response to the caller. Otherwise, it will serve a 307 HTTP redirect response to the caller."
		},
		{
			"heading": void 0,
		...
		{
			"heading": "parameters",
			"content": "The `redirect` function accepts two arguments:"
		},
		{
			"heading": "parameters",
			"content": "Parameter"
		...
		{
			"heading": "parameters",
			"content": "By default, `redirect` will use `push` (adding a new entry to the browser history stack) in Server Actions and `replace` (replacing the current URL in the browser history stack) everywhere else. You can override this behavior by specifying the `type` parameter."
		},
		{
			"heading": "parameters",
			"content": "The `RedirectType` object contains the available options for the `type` parameter."
		},
		{
			"heading": "parameters",
		...
		{
			"heading": "returns",
			"content": "`redirect` does not return a value."
		},
		{
			"heading": "behavior",
			"content": "In Server Actions and Route Handlers, redirect should be called **outside** the `try` block when using `try/catch` statements."
		},
		{
			"heading": "behavior",
			"content": "If you prefer to return a 308 (Permanent) HTTP redirect instead of 307 (Temporary), you can use the `permanentRedirect` function instead."
		},
		{
			"heading": "behavior",
			"content": "`redirect` throws an error so it should be called **outside** the `try` block when using `try/catch` statements."
		},
		{
			"heading": "behavior",
			"content": "`redirect` can be called in Client Components during the rendering process but not in event handlers. You can use the `useRouter` hook instead."
		},
		{
			"heading": "behavior",
			"content": "`redirect` also accepts absolute URLs and can be used to redirect to external links."
		},
		{
			"heading": "behavior",
			"content": "If you'd like to redirect before the render process, use `next.config.js` or Middleware."
		},
		{
			"heading": "server-component",
			"content": "Invoking the `redirect()` function throws a `NEXT_REDIRECT` error and terminates rendering of the route segment in which it was thrown."
		},
		{
			"heading": "server-component",
			"content": "> **Good to know**: `redirect` does not require you to use `return redirect()` as it uses the TypeScript `never` type."
		},
		{
			"heading": "client-component",
			"content": "`redirect` can be directly used in a Client Component."
		},
		{
			"heading": "client-component",
			"content": "> **Good to know**: When using `redirect` in a Client Component on initial page load during Server-Side Rendering (SSR), it will perform a server-side redirect."
		},
		{
			"heading": "client-component",
			"content": "`redirect` can be used in a Client Component through a Server Action. If you need to use an event handler to redirect the user, you can use the `useRouter` hook."
		},
		{
...
var toc = [
	...
	},
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Server Component" })
	},
	{
		depth: 3,
		url: "#client-component",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Client Component" })
	},
	{
		depth: 2,
		url: "#faq",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "redirect" }),
			" can be used while rendering in ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" object contains the available options for the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "type" }),
			" parameter."
		] }),
		"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " { redirect, RedirectType } "
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#D73A49",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "redirect" }), " does not return a value."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "behavior",
			children: "Behavior"
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/guides/redirecting#redirects-in-nextconfigjs",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" })
				}),
				" or ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/guides/redirecting#nextresponseredirect-in-middleware",
					children: "Middleware"
				}),
				"."
			] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "return redirect()" }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "redirect" }), " can be directly used in a Client Component."] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "components/client-redirect.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "components/client-redirect.tsx",
					children: "components/client-redirect.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "components/client-redirect.jsx",
					children: "components/client-redirect.jsx"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "components/client-redirect.tsx",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/client-redirect.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/client-redirect.tsx",
						children: "app/client-redirect.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/client-redirect.jsx",
						children: "app/client-redirect.jsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, redirect_exports as r, MDXContent as t };
