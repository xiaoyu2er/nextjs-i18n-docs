...
//#region node_modules/.nitro/vite/services/ssr/assets/09-instrumentation-CLi8MpAE.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "If you export a function named `register` from a `instrumentation.ts` (or `.js`) file in the **root directory** of your project (or inside the `src` folder if using one), we will call that function whenever a new Next.js server instance is bootstrapped."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "When your `register` function is deployed, it will be called on each cold boot (but exactly once in each environment)."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "You can import files with side effects in `instrumentation.ts`, which you might want to use in your `register` function as demonstrated in the following example:"
		},
		{
			"heading": void 0,
			"content": "However, we recommend importing files with side effects using `import` from within your `register` function instead. The following example demonstrates a basic usage of `import` in a `register` function:"
		},
		{
			"heading": void 0,
			"content": "By doing this, you can colocate all of your side effects in one place in your code, and avoid any unintended consequences from importing files."
		},
		{
			"heading": void 0,
			"content": "We call `register` in all environments, so it's necessary to conditionally import any code that doesn't support both `edge` and `nodejs`. You can use the environment variable `NEXT_RUNTIME` to get the current environment. Importing an environment-specific code would look like this:"
		}
	],
	"headings": []
};
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "By doing this, you can colocate all of your side effects in one place in your code, and avoid any unintended consequences from importing files." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"We call ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "register" }),
