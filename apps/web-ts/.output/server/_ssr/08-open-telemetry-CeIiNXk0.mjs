...
//#region node_modules/.nitro/vite/services/ssr/assets/08-open-telemetry-CeIiNXk0.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _08_open_telemetry_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> **Good to know**: This feature is **experimental**, you need to explicitly opt-in by providing `experimental.instrumentationHook = true;` in your `next.config.js`."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "> **Good to know**: We currently support OpenTelemetry bindings only in serverless functions.\n> We don't provide any for `edge` or client side code."
		},
		{
		...
		},
		{
			...
			"content": "To get started, you must install `@vercel/otel`:"
		},
		{
			"heading": "using-vercelotel",
		...
		},
		{
			...
			"content": "If our wrapper `@vercel/otel` doesn't suit your needs, you can configure OpenTelemetry manually."
		},
		{
			"heading": "manual-opentelemetry-configuration",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "experimental.instrumentationHook = true;" }),
				" in your ",
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " { SemanticResourceAttributes } "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "@opentelemetry/exporter-trace-otlp-grpc" }),
			" instead of ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "@opentelemetry/exporter-trace-otlp-http" }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: ["We recommend using OpenTelemetry Collector.\nIf that is not possible on your platform, you can use a custom OpenTelemetry exporter with ", (0, import_jsx_runtime.jsx)(_components.a, {
			href: "/docs/pages/building-your-application/optimizing/open-telemetry#manual-opentelemetry-configuration",
			children: "manual OpenTelemetry configuration"
		})] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
...
//#endregion
export { toc as a, structuredData as i, _08_open_telemetry_exports as n, frontmatter as r, MDXContent as t };
