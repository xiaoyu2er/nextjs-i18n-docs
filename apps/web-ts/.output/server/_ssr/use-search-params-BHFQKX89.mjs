...
//#region node_modules/.nitro/vite/services/ssr/assets/use-search-params-BHFQKX89.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var use_search_params_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "`useSearchParams` returns a **read-only** version of the `URLSearchParams` interface."
		},
		{
			"heading": "parameters",
			"content": "`useSearchParams` does not take any parameters."
		},
		{
			"heading": "returns",
			"content": "`useSearchParams` returns a **read-only** version of the `URLSearchParams` interface, which includes utility methods for reading the URL's query string:"
		},
		{
			"heading": "returns",
			"content": "`URLSearchParams.get()`: Returns the first value associated with the search parameter. For example:"
		},
		{
			"heading": "returns",
			"content": "URL"
		...
		{
			"heading": "returns",
			"content": "`searchParams.get(\"a\")`"
		},
		{
			"heading": "returns",
			"content": "`/dashboard?a=1`"
		},
		{
			"heading": "returns",
			"content": "`'1'`"
		...
		{
			"heading": "returns",
			"content": "`/dashboard?a=1&a=2`"
		},
		{
			"heading": "returns",
			"content": "`'1'&#x60; *- use `getAll()` to get all values*"
		},
		{
			"heading": "returns",
			"content": "`URLSearchParams.has()`: Returns a boolean value indicating if the given parameter exists. For example:"
		},
		{
			"heading": "returns",
			"content": "URL"
		...
		{
			"heading": "returns",
			"content": "Learn more about other **read-only** methods of `URLSearchParams`, including the `getAll()`, `keys()`, `values()`, `entries()`, `forEach()`, and `toString()`."
		},
		{
			"heading": "returns",
		...
		},
		{
			...
			"content": "If a route is statically rendered, calling `useSearchParams` will cause the Client Component tree up to the closest `Suspense` boundary to be client-side rendered."
		},
		{
			"heading": "static-rendering",
			"content": "This allows a part of the route to be statically rendered while the dynamic part that uses `useSearchParams` is client-side rendered."
		},
		{
			"heading": "static-rendering",
			"content": "We recommend wrapping the Client Component that uses `useSearchParams` in a `<Suspense/>` boundary. This will allow any Client Components above it to be statically rendered and sent as part of initial HTML. Example."
		},
		{
			"heading": "static-rendering",
			"content": "For example:"
		},
		{
			...
			"content": "If a route is dynamically rendered, `useSearchParams` will be available on the server during the initial server render of the Client Component."
		},
		{
			"heading": "dynamic-rendering",
			"content": "For example:"
		...
		{
			"heading": "dynamic-rendering",
			"content": "> **Good to know**: Setting the `dynamic` route segment config option to `force-dynamic` can be used to force dynamic rendering."
		},
		{
			"heading": "pages",
			"content": "To access search params in Pages (Server Components), use the `searchParams` prop."
		},
		{
			"heading": "layouts",
			"content": "Unlike Pages, Layouts (Server Components) **do not** receive the `searchParams` prop. This is because a shared layout is not re-rendered during navigation which could lead to stale `searchParams` between navigations. View detailed explanation."
		},
		{
			"heading": "layouts",
		...
		{
			"heading": "updating-searchparams",
			"content": "You can use `useRouter` or `Link` to set new `searchParams`. After a navigation is performed, the current `page.js` will receive an updated `searchParams` prop."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`useSearchParams` introduced."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		depth: 4,
		url: "#pages",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Pages" })
	},
	{
		depth: 4,
		url: "#layouts",
	...
	{
		depth: 3,
		url: "#updating-searchparams",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Updating ", (0, import_jsx_runtime.jsx)("code", { children: "searchParams" })] })
	},
	{
		depth: 2,
		url: "#version-history",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "query string" }),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "useSearchParams" }),
			" returns a ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "read-only" }),
			" version of the ",
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/dashboard/search-bar.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/search-bar.tsx",
					children: "app/dashboard/search-bar.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/search-bar.js",
					children: "app/dashboard/search-bar.js"
				})] }),
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // URL -> `/dashboard?search=my-project`"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "useSearchParams" }), " does not take any parameters."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "returns",
			children: "Returns"
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/get",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "URLSearchParams.get()" })
				}), ": Returns the first value associated with the search parameter. For example:"] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "URL" }), (0, import_jsx_runtime.jsx)(_components.th, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "searchParams.get(\"a\")" }) })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
					(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?a=1" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "'1'" }) })] }),
					(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?a=" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "''" }) })] }),
					(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?b=3" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "null" }) })] }),
					(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?a=1&a=2" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [
						(0, import_jsx_runtime.jsx)(_components.code, { children: "'1'" }),
						" ",
						(0, import_jsx_runtime.jsxs)(_components.em, { children: [
							"- use ",
							(0, import_jsx_runtime.jsx)(_components.a, {
								href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/getAll",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/has",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "URLSearchParams.has()" })
				}), ": Returns a boolean value indicating if the given parameter exists. For example:"] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "URL" }), (0, import_jsx_runtime.jsx)(_components.th, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "searchParams.has(\"a\")" }) })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?a=1" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "true" }) })] }), (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?b=3" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "false" }) })] })] })] }),
				"\n"
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [
					...
					", ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/keys",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "keys()" })
					}),
					", ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/values",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "values()" })
					}),
					", ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/entries",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "entries()" })
					}),
					", ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/forEach",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "forEach()" })
					}),
					", and ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/API/URLSearchParams/toString",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "toString()" })
					}),
					"."
				] }),
				"\n"
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					" hook and is ",
					(0, import_jsx_runtime.jsx)(_components.strong, { children: "not supported" }),
					" in ",
					(0, import_jsx_runtime.jsx)(_components.a, {
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "useSearchParams" }),
					" will return ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "ReadonlyURLSearchParams | null" }),
					". The ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "statically rendered"
			}),
			", calling ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "useSearchParams" }),
			" will cause the Client Component tree up to the closest ",
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/building-your-application/routing/loading-ui-and-streaming#example",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/functions/use-search-params#static-rendering",
				children: "Example"
			}),
			"."
		] }),
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // This will not be logged on the server when using static rendering"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// This component passed as a fallback to the Suspense boundary"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// will be rendered in place of the search bar in the initial HTML."
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// When the value is available during React hydration the fallback"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// will be replaced with the `<SearchBar>` component."
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // This will be logged on the server during the initial render"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // and on the client on subsequent navigations."
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.a, {
					...
					children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "dynamic" }), " route segment config option"]
				}),
				" to ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/file-conventions/layout#layouts-do-not-receive-searchparams",
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			id: "updating-searchparams",
			children: ["Updating ", (0, import_jsx_runtime.jsx)(_components.code, { children: "searchParams" })]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can use ",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Get a new searchParams string by merging the current"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // searchParams with a provided key/value pair"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { use_search_params_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
