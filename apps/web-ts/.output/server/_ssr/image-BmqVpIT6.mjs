...
//#region node_modules/.nitro/vite/services/ssr/assets/image-BmqVpIT6.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "This API reference will help you understand how to use props and configuration options available for the Image Component. For features and usage, please see the Image Component page."
		},
		{
			"heading": "props",
			"content": "Here's a summary of the props available for the Image Component:"
		},
		{
			"heading": "props",
			"content": "Prop"
		...
		},
		{
			...
			"content": "The Image Component requires the following properties: `src`, `width`, `height`, and `alt`."
		},
		{
			"heading": "src",
		...
		{
			"heading": "src",
			"content": "A path string. This can be either an absolute external URL, or an internal path depending on the loader prop."
		},
		{
			"heading": "src",
			"content": "When using an external URL, you must add it to remotePatterns in `next.config.js`."
		},
		{
			"heading": "width",
			"content": "The `width` property represents the *rendered* width in pixels, so it will affect how large the image appears."
		},
		{
			"heading": "width",
			"content": "Required, except for statically imported images or images with the `fill` property."
		},
		{
			"heading": "height",
			"content": "The `height` property represents the *rendered* height in pixels, so it will affect how large the image appears."
		},
		{
			"heading": "height",
			"content": "Required, except for statically imported images or images with the `fill` property."
		...
		{
			"heading": "loader",
			"content": "A custom function used to resolve image URLs."
		},
		{
			"heading": "loader",
		...
		{
			"heading": "loader",
			"content": "> **Good to know**: Using props like `loader`, which accept a function, requires using Client Components to serialize the provided function."
		},
		{
			"heading": "loader",
		...
		{
			"heading": "fill",
			"content": "A boolean that causes the image to fill the parent element, which is useful when the `width` and `height` are unknown."
		},
		{
			"heading": "fill",
			"content": "The parent element *must* assign `position: \"relative\"`, `position: \"fixed\"`, or `position: \"absolute\"` style."
		},
		{
			"heading": "fill",
			"content": "By default, the img element will automatically be assigned the `position: \"absolute\"` style."
		},
		{
			"heading": "fill",
			"content": "If no styles are applied to the image, the image will stretch to fit the container. You may prefer to set `object-fit: \"contain\"` for an image which is letterboxed to fit the container and preserve aspect ratio."
		},
		{
			"heading": "fill",
			"content": "Alternatively, `object-fit: \"cover\"` will cause the image to fill the entire container and be cropped to preserve aspect ratio. For this to look correct, the `overflow: \"hidden\"` style should be assigned to the parent element."
		},
		{
			"heading": "fill",
			"content": "For more information, see also:"
		},
		{
			"heading": "fill",
			"content": "`position`"
		...
		{
			"heading": "sizes",
			"content": "A string, similar to a media query, that provides information about how wide the image will be at different breakpoints. The value of `sizes` will greatly affect performance for images using `fill` or which are styled to have a responsive size."
		},
		{
			"heading": "sizes",
		...
		{
			"heading": "quality",
			"content": "The quality of the optimized image, an integer between `1` and `100`, where `100` is the best quality and therefore largest file size. Defaults to `75`."
		},
		{
			"heading": "quality",
			"content": "If the `qualities` configuration is defined in `next.config.js`, the `quality` prop must match one of the values defined in the configuration."
		},
		{
			"heading": "quality",
			"content": "> **Good to know**: If the original source image was already low quality, setting the quality prop too high could cause the resulting optimized image to be larger than the original source image."
		},
		{
			"heading": "priority",
		...
		{
			"heading": "placeholder",
			"content": "A placeholder to use while the image is loading. Possible values are `blur`, `empty`, or `data:image/...`. Defaults to `empty`."
		},
		{
			"heading": "placeholder",
			"content": "When `blur`, the `blurDataURL` property will be used as the placeholder. If `src` is an object from a static import and the imported image is `.jpg`, `.png`, `.webp`, or `.avif`, then `blurDataURL` will be automatically populated, except when the image is detected to be animated."
		},
		{
			"heading": "placeholder",
		...
		{
			"heading": "placeholder",
			"content": "When `data:image/...`, the Data URL will be used as the placeholder while the image is loading."
		},
		{
			"heading": "placeholder",
		...
		{
			"heading": "placeholder",
			"content": "Demo the shimmer effect with data URL `placeholder` prop"
		},
		{
			"heading": "placeholder",
		...
		{
			"heading": "style",
			"content": "Remember that the required width and height props can interact with your styling. If you use styling to modify an image's width, you should also style its height to `auto` to preserve its intrinsic aspect ratio, or your image will be distorted."
		},
		{
			"heading": "onloadingcomplete",
			"content": "> **Warning**: Deprecated since Next.js 14 in favor of `onLoad`."
		},
		{
			"heading": "onloadingcomplete",
		...
		{
			"heading": "loading",
			"content": "> **Recommendation**: This property is only meant for advanced use cases. Switching an image to load with `eager` will normally **hurt performance**. We recommend using the `priority` property instead, which will eagerly preload the image."
		},
		{
			"heading": "loading",
		...
		{
			"heading": "unoptimized",
			"content": "When true, the source image will be served as-is instead of changing quality,\nsize, or format. Defaults to `false`."
		},
		{
			"heading": "unoptimized",
		...
		{
			"heading": "decoding",
			"content": "A hint to the browser indicating if it should wait for the image to be decoded before presenting other content updates or not. Defaults to `async`."
		},
		{
			"heading": "decoding",
			"content": "Possible values are the following:"
		},
		{
			"heading": "decoding",
		...
		{
			"heading": "decoding",
			"content": "`auto` - No preference for the decoding mode; the browser decides what's best."
		},
		{
			"heading": "decoding",
		...
		},
		{
			...
			"content": "In addition to props, you can configure the Image Component in `next.config.js`. The following options are available:"
		},
		{
			"heading": "localpatterns",
			"content": "You can optionally configure `localPatterns` in your `next.config.js` file in order to allow specific paths to be optimized and block all others paths."
		},
		{
			"heading": "localpatterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/image` must start with `/assets/images/` and must not have a query string. Attempting to optimize any other path will respond with 400 Bad Request."
		},
		{
		...
		{
			"heading": "remotepatterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/image` must start with `https://example.com/account123/` and must not have a query string. Any other protocol, hostname, port, or unmatched path will respond with 400 Bad Request."
		},
		{
			"heading": "remotepatterns",
		...
		{
			"heading": "remotepatterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/image` must start with `https://img1.example.com` or `https://me.avatar.example.com` or any number of subdomains. It cannot have a port or query string. Any other protocol or unmatched hostname will respond with 400 Bad Request."
		},
		{
			"heading": "remotepatterns",
		...
		{
			"heading": "remotepatterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/image` must start with `https://assets.example.com` and must have the exact query string `?v=1727111025337`. Any other protocol or query string will respond with 400 Bad Request."
		},
		{
			"heading": "domains",
		...
		{
			"heading": "loaderfile",
			"content": "If you want to use a cloud provider to optimize images instead of using the Next.js built-in Image Optimization API, you can configure the `loaderFile` in your `next.config.js` like the following:"
		},
		{
			"heading": "loaderfile",
			"content": "This must point to a file relative to the root of your Next.js application. The file must export a default function that returns a string, for example:"
		},
		{
			"heading": "loaderfile",
		...
		{
			"heading": "loaderfile",
			"content": "> **Good to know**: Customizing the image loader file, which accepts a function, requires using Client Components to serialize the provided function."
		},
		{
			"heading": "advanced",
		...
		{
			"heading": "devicesizes",
			"content": "If you know the expected device widths of your users, you can specify a list of device width breakpoints using the `deviceSizes` property in `next.config.js`. These widths are used when the `next/image` component uses `sizes` prop to ensure the correct image is served for user's device."
		},
		{
			"heading": "devicesizes",
		...
		{
			"heading": "qualities",
			"content": "The default Image Optimization API will automatically allow all qualities from 1 to 100. If you wish to restrict the allowed qualities, you can add configuration to `next.config.js`."
		},
		{
			"heading": "qualities",
			"content": "In this example above, only three qualities are allowed: 25, 50, and 75. If the `quality` prop does not match a value in this array, the image will fail with 400 Bad Request."
		},
		{
			"heading": "formats",
			"content": "The default Image Optimization API will automatically detect the browser's supported image formats via the request's `Accept` header."
		},
		{
			"heading": "formats",
			"content": "If the `Accept` head matches more than one of the configured formats, the first match in the array is used. Therefore, the array order matters. If there is no match (or the source image is animated), the Image Optimization API will fallback to the original image's format."
		},
		{
			"heading": "formats",
			"content": "If no configuration is provided, the default below is used."
		...
		{
			"heading": "formats",
			"content": "You can enable AVIF support with the following configuration."
		},
		{
			"heading": "formats",
		...
		{
			"heading": "caching-behavior",
			"content": "The cache status of an image can be determined by reading the value of the `x-nextjs-cache` response header. The possible values are the following:"
		},
		{
			"heading": "caching-behavior",
		...
		},
		{
			...
			"content": "The default generated `srcset` contains `1x` and `2x` images in order to support different device pixel ratios. However, you may wish to render a responsive image that stretches with the viewport. In that case, you'll need to set `sizes` as well as `style` (or `className`)."
		},
		{
			"heading": "responsive-images",
			"content": "You can render a responsive image using one of the following methods below."
		},
		{
			"heading": "responsive-image-using-a-static-import",
			"content": "If the source image is not dynamic, you can statically import to create a responsive image:"
		},
		{
			"heading": "responsive-image-using-a-static-import",
			"content": "Try it out:"
		...
		{
			"heading": "responsive-image-with-aspect-ratio",
			"content": "If the source image is a dynamic or a remote url, you will also need to provide `width` and `height` to set the correct aspect ratio of the responsive image:"
		},
		{
			"heading": "responsive-image-with-aspect-ratio",
			"content": "Try it out:"
		...
		},
		{
			...
			"content": "If you don't know the aspect ratio, you will need to set the `fill` prop and set `position: relative` on the parent. Optionally, you can set `object-fit` style depending on the desired stretch vs crop behavior:"
		},
		{
			"heading": "responsive-image-with-fill",
			"content": "Try it out:"
		...
		{
			"heading": "responsive-image-with-fill",
			"content": "Demo the `fill` prop"
		},
		{
			"heading": "theme-detection-css",
		...
		},
		{
			...
			"content": "For more advanced use cases, you can call `getImageProps()` to get the props that would be passed to the underlying `<img>` element, and instead pass to them to another component, style, canvas, etc."
		},
		{
			"heading": "getimageprops",
		...
		{
			"heading": "theme-detection-picture",
			"content": "If you want to display a different image for light and dark mode, you can use the `<picture>` element to display a different image based on the user's preferred color scheme."
		},
		{
	...
	"headings": [
		...
		{
			"id": "responsive-image-using-a-static-import",
			"content": "Responsive image using a static import"
		},
		{
			"id": "responsive-image-with-aspect-ratio",
			"content": "Responsive image with aspect ratio"
		},
		{
		...
		{
			"id": "theme-detection-css",
			"content": "Theme Detection CSS"
		},
		{
			"id": "getimageprops",
		...
		{
			"id": "theme-detection-picture",
			"content": "Theme Detection Picture"
		},
		{
			"id": "art-direction",
...
var toc = [
	...
	},
	{
		depth: 3,
		url: "#width",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)("code", { children: "width" }) })
	},
	{
		depth: 3,
		url: "#height",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)("code", { children: "height" }) })
	},
	{
		depth: 3,
		url: "#alt",
	...
	},
	{
		depth: 3,
		url: "#decoding",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "decoding" })
	},
	{
		depth: 3,
		url: "#other-props",
	...
	},
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Responsive Images" })
	},
	{
		depth: 3,
		url: "#responsive-image-using-a-static-import",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Responsive image using a static import" })
	},
	{
		depth: 3,
		url: "#responsive-image-with-aspect-ratio",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Responsive image with aspect ratio" })
	},
	{
		depth: 3,
	...
	{
		depth: 2,
		url: "#theme-detection-css",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Theme Detection CSS" })
	},
	{
		depth: 2,
		url: "#getimageprops",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "getImageProps" })
	},
	{
		depth: 3,
		url: "#theme-detection-picture",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Theme Detection Picture" })
	},
	{
		depth: 3,
		url: "#art-direction",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Here's a summary of the props available for the Image Component:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "A custom function used to resolve image URLs." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"A ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The parent element ",
			(0, import_jsx_runtime.jsx)(_components.em, { children: "must" }),
			" assign ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "position: \"relative\"" }),
			", ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "position: \"fixed\"" }),
			", or ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "object-fit: \"contain\"" }),
			" for an image which is letterboxed to fit the container and preserve aspect ratio."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Alternatively, ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "object-fit: \"cover\"" }),
			" will cause the image to fill the entire container and be cropped to preserve aspect ratio. For this to look correct, the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "overflow: \"hidden\"" }),
			" style should be assigned to the parent element."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For more information, see also:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "object-position" })
			}) }),
			"\n"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "styled to have a responsive size"
			}),
			"."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }), ": If the original source image was already low quality, setting the quality prop too high could cause the resulting optimized image to be larger than the original source image."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: " // \"empty\" | \"blur\" | \"data:image/...\""
					})
				]
			}) })
		}) }),
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			tabIndex: "0",
			title: "components/ProfileImage.js",
			icon: "<svg viewBox=\"0 0 24 24\"><path d=\"M14.23 12.004a2.236 2.236 0 0 1-2.235 2.236 2.236 2.236 0 0 1-2.236-2.236 2.236 2.236 0 0 1 2.235-2.236 2.236 2.236 0 0 1 2.236 2.236zm2.648-10.69c-1.346 0-3.107.96-4.888 2.622-1.78-1.653-3.542-2.602-4.887-2.602-.41 0-.783.093-1.106.278-1.375.793-1.683 3.264-.973 6.365C1.98 8.917 0 10.42 0 12.004c0 1.59 1.99 3.097 5.043 4.03-.704 3.113-.39 5.588.988 6.38.32.187.69.275 1.102.275 1.345 0 3.107-.96 4.888-2.624 1.78 1.654 3.542 2.603 4.887 2.603.41 0 .783-.09 1.106-.275 1.374-.792 1.683-3.263.973-6.365C22.02 15.096 24 13.59 24 12.004c0-1.59-1.99-3.097-5.043-4.032.704-3.11.39-5.587-.988-6.38-.318-.184-.688-.277-1.092-.278zm-.005 1.09v.006c.225 0 .406.044.558.127.666.382.955 1.835.73 3.704-.054.46-.142.945-.25 1.44-.96-.236-2.006-.417-3.107-.534-.66-.905-1.345-1.727-2.035-2.447 1.592-1.48 3.087-2.292 4.105-2.295zm-9.77.02c1.012 0 2.514.808 4.11 2.28-.686.72-1.37 1.537-2.02 2.442-1.107.117-2.154.298-3.113.538-.112-.49-.195-.964-.254-1.42-.23-1.868.054-3.32.714-3.707.19-.09.4-.127.563-.132zm4.882 3.05c.455.468.91.992 1.36 1.564-.44-.02-.89-.034-1.345-.034-.46 0-.915.01-1.36.034.44-.572.895-1.096 1.345-1.565zM12 8.1c.74 0 1.477.034 2.202.093.406.582.802 1.203 1.183 1.86.372.64.71 1.29 1.018 1.946-.308.655-.646 1.31-1.013 1.95-.38.66-.773 1.288-1.18 1.87-.728.063-1.466.098-2.21.098-.74 0-1.477-.035-2.202-.093-.406-.582-.802-1.204-1.183-1.86-.372-.64-.71-1.29-1.018-1.946.303-.657.646-1.313 1.013-1.954.38-.66.773-1.286 1.18-1.868.728-.064 1.466-.098 2.21-.098zm-3.635.254c-.24.377-.48.763-.704 1.16-.225.39-.435.782-.635 1.174-.265-.656-.49-1.31-.676-1.947.64-.15 1.315-.283 2.015-.386zm7.26 0c.695.103 1.365.23 2.006.387-.18.632-.405 1.282-.66 1.933-.2-.39-.41-.783-.64-1.174-.225-.392-.465-.774-.705-1.146zm3.063.675c.484.15.944.317 1.375.498 1.732.74 2.852 1.708 2.852 2.476-.005.768-1.125 1.74-2.857 2.475-.42.18-.88.342-1.355.493-.28-.958-.646-1.956-1.1-2.98.45-1.017.81-2.01 1.085-2.964zm-13.395.004c.278.96.645 1.957 1.1 2.98-.45 1.017-.812 2.01-1.086 2.964-.484-.15-.944-.318-1.37-.5-1.732-.737-2.852-1.706-2.852-2.474 0-.768 1.12-1.742 2.852-2.476.42-.18.88-.342 1.356-.494zm11.678 4.28c.265.657.49 1.312.676 1.948-.64.157-1.316.29-2.016.39.24-.375.48-.762.705-1.158.225-.39.435-.788.636-1.18zm-9.945.02c.2.392.41.783.64 1.175.23.39.465.772.705 1.143-.695-.102-1.365-.23-2.006-.386.18-.63.406-1.282.66-1.933zM17.92 16.32c.112.493.2.968.254 1.423.23 1.868-.054 3.32-.714 3.708-.147.09-.338.128-.563.128-1.012 0-2.514-.807-4.11-2.28.686-.72 1.37-1.536 2.02-2.44 1.107-.118 2.154-.3 3.113-.54zm-11.83.01c.96.234 2.006.415 3.107.532.66.905 1.345 1.727 2.035 2.446-1.595 1.483-3.092 2.295-4.11 2.295-.22-.005-.406-.05-.553-.132-.666-.38-.955-1.834-.73-3.703.054-.46.142-.944.25-1.438zm4.56.64c.44.02.89.034 1.345.034.46 0 .915-.01 1.36-.034-.44.572-.895 1.095-1.345 1.565-.455-.47-.91-.993-1.36-1.565z\" fill=\"currentColor\" /></svg>",
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsxs)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				" will normally ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "hurt performance" }),
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "    /_next/image?url=%2Fme.jpg&w=640&q=75 1x,"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "    /_next/image?url=%2Fme.jpg&w=828&q=75 2x"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "\"/_next/image?url=%2Fme.jpg&w=828&q=75\""
						})
					]
				}),
				"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"A hint to the browser indicating if it should wait for the image to be decoded before presenting other content updates or not. Defaults to ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "async" }),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Possible values are the following:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "auto" }), " - No preference for the decoding mode; the browser decides what's best."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "loaderFile" }),
			" in your ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" }),
			" like the following:"
		] }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This must point to a file relative to the root of your Next.js application. The file must export a default function that returns a string, for example:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Examples:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/next-config-js/images#example-loader-configuration",
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }),
				": Customizing the image loader file, which accepts a function, requires using ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/rendering/client-components",
					children: "Client Components"
				}),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" will automatically allow all qualities from 1 to 100. If you wish to restrict the allowed qualities, you can add configuration to ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" }),
			"."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In this example above, only three qualities are allowed: 25, 50, and 75. If the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "#quality",
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "quality" })
			}),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can enable AVIF support with the following configuration." }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "AVIF generally takes 20% longer to encode but it compresses 20% smaller compared to WebP. This means that the first time an image is requested, it will typically be slower and then subsequent requests that are cached will be faster." }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/next-config-js/headers#content-security-policy",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can render a responsive image using one of the following methods below." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "responsive-image-using-a-static-import",
			children: "Responsive image using a static import"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If the source image is not dynamic, you can statically import to create a responsive image:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "responsive-image-with-aspect-ratio",
			children: "Responsive image with aspect ratio"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "object-fit" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.a, {
				href: "https://image-component.nextjs.gallery/fill",
				children: [
					"Demo the ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "fill" }),
					" prop"
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"For more advanced use cases, you can call ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getImageProps()" }),
			" to get the props that would be passed to the underlying ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "<img>" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "theme-detection-picture",
			children: "Theme Detection Picture"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"If you want to display a different image for light and dark mode, you can use the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
			...
			" element to display a different image based on the user's ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://developer.mozilla.org/en-US/docs/Web/CSS/@media/prefers-color-scheme",
				children: "preferred color scheme"
			}),
			"."
		] }),
		"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "\"(prefers-color-scheme: light)\""
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#6F42C1",
