...
//#region node_modules/.nitro/vite/services/ssr/assets/10-custom-server-h8Y0rnFa.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _10_custom_server_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "Take a look at the following example of a custom server:"
		},
		{
			"heading": void 0,
			"content": "> `server.js` doesn't go through babel or webpack. Make sure the syntax and sources this file requires are compatible with the current node version you are running."
		},
		{
			"heading": void 0,
			"content": "To run the custom server you'll need to update the `scripts` in `package.json` like so:"
		},
		{
			"heading": void 0,
			"content": "The custom server uses the following import to connect the server with the Next.js application:"
		},
		{
			"heading": void 0,
			"content": "The above `next` import is a function that receives an object with the following options:"
		},
		{
			"heading": void 0,
			"content": "Option"
		...
		{
			"heading": void 0,
			"content": "The same object you would use in next.config.js. Defaults to `{}`"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "(*Optional*) Set to false when the server was created by Next.js"
		},
		{
			"heading": void 0,
			"content": "`dev`"
		...
		{
			"heading": void 0,
			"content": "(*Optional*) Whether or not to launch Next.js in dev mode. Defaults to `false`"
		},
		{
			"heading": void 0,
			"content": "`dir`"
		...
		{
			"heading": void 0,
			"content": "(*Optional*) Location of the Next.js project. Defaults to `'.'`"
		},
		{
			"heading": void 0,
			"content": "`quiet`"
		...
		{
			"heading": void 0,
			"content": "(*Optional*) Hide error messages containing server information. Defaults to `false`"
		},
		{
			"heading": void 0,
			"content": "`hostname`"
		...
		{
			"heading": void 0,
			"content": "(*Optional*) The hostname the server is running behind"
		},
		{
			"heading": void 0,
			"content": "`port`"
		...
		{
			"heading": void 0,
			"content": "(*Optional*) The port the server is running behind"
		},
		{
			"heading": void 0,
			"content": "`httpServer`"
		...
		{
			"heading": void 0,
			"content": "`node:http#Server`"
		},
		{
			"heading": void 0,
			"content": "(*Optional*) The HTTP Server that Next.js is running behind"
		},
		{
			"heading": void 0,
		...
		{
			"heading": "disabling-file-system-routing",
			"content": "By default, `Next` will serve each file in the `pages` folder under a pathname matching the filename. If your project uses a custom server, this behavior may result in the same content being served from multiple paths, which can present problems with SEO and UX."
		},
		{
			"heading": "disabling-file-system-routing",
			"content": "To disable this behavior and prevent routing based on files in `pages`, open `next.config.js` and disable the `useFileSystemPublicRoutes` config:"
		},
		{
			"heading": "disabling-file-system-routing",
			"content": "> Note that `useFileSystemPublicRoutes` disables filename routes from SSR; client-side routing may still access those paths. When using this option, you should guard against navigation to routes you do not want programmatically."
		},
		{
			"heading": "disabling-file-system-routing",
			"content": "> You may also wish to configure the client-side router to disallow client-side redirects to filename routes; for that refer to `router.beforePopState`."
		}
	],
	"headings": [{
...
var toc = [{
	depth: 2,
	url: "#disabling-file-system-routing",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Disabling file-system routing" })
}];
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vercel/next.js/tree/canary/examples/custom-server",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.strong, { children: "serverless functions" }),
					" and ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Take a look at the following example of a custom server:" }),
		"\n",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// when using middleware `hostname` and `port` must be provided below"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "      // Be sure to pass `true` as the second argument to `url.parse`."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "      // This tells it to parse the query portion of the URL."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "server.js" }), " doesn't go through babel or webpack. Make sure the syntax and sources this file requires are compatible with the current node version you are running."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "\"NODE_ENV=production node server.js\""
						})
					]
				}),
				"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The custom server uses the following import to connect the server with the Next.js application:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "conf" }) }),
				...
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/pages/api-reference/next-config-js",
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "customServer" }) }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "dev" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Boolean" }) }),
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					"(",
					(0, import_jsx_runtime.jsx)(_components.em, { children: "Optional" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "dir" }) }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "quiet" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Boolean" }) }),
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					"(",
					(0, import_jsx_runtime.jsx)(_components.em, { children: "Optional" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "hostname" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "String" }) }),
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					"(",
					(0, import_jsx_runtime.jsx)(_components.em, { children: "Optional" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "port" }) }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "httpServer" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "node:http#Server" }) }),
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					"(",
					(0, import_jsx_runtime.jsx)(_components.em, { children: "Optional" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" and disable the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "useFileSystemPublicRoutes" }),
			" config:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "  useFileSystemPublicRoutes: "
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#005CC5",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/api-reference/functions/use-router#routerbeforepopstate",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "router.beforePopState" })
				}),
				"."
			] }),
			"\n"
...
//#endregion
export { toc as a, structuredData as i, _10_custom_server_exports as n, frontmatter as r, MDXContent as t };
