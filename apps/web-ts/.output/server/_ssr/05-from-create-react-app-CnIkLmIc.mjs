...
//#region node_modules/.nitro/vite/services/ssr/assets/05-from-create-react-app-CnIkLmIc.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _05_from_create_react_app_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "This guide will help you migrate an existing Create React App site to Next.js."
		},
		{
			"heading": "why-switch",
		...
		},
		{
			...
			"content": "Our goal with this migration is to get a working Next.js application as quickly as possible, so that you can then adopt Next.js features incrementally. To begin with, we'll keep it as a purely client-side application (SPA) without migrating your existing router. This helps minimize the chances of encountering issues during the migration process and reduces merge conflicts."
		},
		{
		...
		},
		{
			...
			"content": "Create a `next.config.mjs` at the root of your project. This file will hold your Next.js configuration options."
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "If you're using TypeScript, you need to update your `tsconfig.json` file with the following changes to make it compatible with Next.js:"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "You can find more information about configuring TypeScript on the Next.js docs."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "A Next.js App Router application must include a root layout file, which is a React Server Component that will wrap all pages in your application. This file is defined at the top level of the `app` directory."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "The closest equivalent to the root layout file in a CRA application is the `index.html` file, which contains your `<html>`, `<head>`, and `<body>` tags."
		},
		{
			"heading": "step-4-create-the-root-layout",
		...
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Copy the content of your `index.html` file into the previously created `<RootLayout>` component while replacing the `body.div#root` and `body.script` tags with `<div id=\"root\">{children}</div>`:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "> **Good to know**: We'll ignore the manifest file, additional iconography other than the favicon, and testing configuration, but if these are requirements, Next.js also supports these options."
		},
		{
			"heading": "step-5-metadata",
			"content": "Next.js already includes by default the meta charset and meta viewport tags, so you can safely remove those from your `<head>`:"
		},
		{
			"heading": "step-5-metadata",
		...
		{
			"heading": "step-6-styles",
			"content": "Like Create React App, Next.js has built-in support for CSS Modules."
		},
		{
			"heading": "step-6-styles",
			"content": "If you're using a global CSS file, import it into your `app/layout.tsx` file:"
		},
		{
			"heading": "step-6-styles",
			"content": "If you're using Tailwind, you'll need to install `postcss` and `autoprefixer`:"
		},
		{
			"heading": "step-6-styles",
			"content": "Then, create a `postcss.config.js` file at the root of your project:"
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
			"content": "On Next.js you declare an entrypoint for your application by creating a `page.tsx` file. The closest equivalent of this file on CRA is your `src/index.tsx` file. In this step, you’ll set up the entry point of your application."
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
		...
		{
			"heading": "step-7-create-the-entrypoint-page",
			"content": "Since this guide is aiming to first set up our Next.js as an SPA (Single Page Application), you need your page entry point to catch all possible routes of your application. For that, create a new `[[...slug]]` directory in your `app` directory."
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
			"content": "This directory is what is called an optional catch-all route segment. Next.js uses a file-system based router where directories are used to define routes. This special directory will make sure that all routes of your application will be directed to its containing `page.tsx` file."
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
		...
		{
			"heading": "step-7-create-the-entrypoint-page",
			"content": "Now, let's move the rest of our CRA application which will run client-only."
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
			"content": "This file is a Client Component, defined by the `'use client'` directive. Client Components are still prerendered to HTML on the server before being sent to the client."
		},
		{
			"heading": "step-7-create-the-entrypoint-page",
		...
		},
		{
			...
			"content": "Next.js handles static image imports slightly different from CRA. With CRA, importing an image file will return its public URL as a string:"
		},
		{
			"heading": "step-8-update-static-image-imports",
		...
		{
			"heading": "step-8-update-static-image-imports",
			"content": "> **Warning:** If you're using TypeScript, you might encounter type errors when accessing the `src` property. You can safely ignore those for now. They will be fixed by the end of this guide."
		},
		{
			"heading": "step-9-migrate-the-environment-variables",
			"content": "Next.js has support for `.env` environment variables similar to CRA."
		},
		{
			"heading": "step-9-migrate-the-environment-variables",
		...
		},
		{
			...
			"content": "You should now be able to run your application to test if you successfully migrated to Next.js. But before that, you need to update your `scripts` in your `package.json` with Next.js related commands, and add `.next`, `next-env.d.ts`, and `dist` to your `.gitignore` file:"
		},
		{
			"heading": "step-10-update-scripts-in-packagejson",
		...
		},
		{
			...
			"content": "You can now clean up your codebase from Create React App related artifacts:"
		},
		{
			"heading": "step-11-clean-up",
			"content": "Delete `src/index.tsx`"
		},
		{
			"heading": "step-11-clean-up",
			"content": "Delete `public/index.html`"
		},
		{
			"heading": "step-11-clean-up",
			"content": "Delete `reportWebVitals` setup"
		},
		{
			"heading": "step-11-clean-up",
			"content": "Uninstall CRA dependencies (`react-scripts`)"
		},
		{
			"heading": "bundler-compatibility",
			"content": "Create React App and Next.js both default to using webpack for bundling."
		},
		{
			"heading": "bundler-compatibility",
			"content": "When migrating your CRA application to Next.js, you might have a custom webpack configuration you're looking to migrate. Next.js supports providing a custom webpack configuration."
		},
		{
			"heading": "bundler-compatibility",
			"content": "Further, Next.js has support for Turbopack through `next dev --turbo` to improve your local dev performance. Turbopack supports some webpack loaders as well for compatibility and incremental adoption."
		},
		{
			"heading": "next-steps",
			"content": "If everything went according to plan, you now have a functioning Next.js application running as a single-page application. However, you aren't yet taking advantage of most of Next.js' benefits, but you can now start making incremental changes to reap all the benefits. Here's what you might want to do next:"
		},
		{
			"heading": "next-steps",
		...
		{
			"heading": "next-steps",
			"content": "> **Good to know:** Using a static export does not currently support using the `useParams` hook."
		}
	],
	"headings": [
		{
		...
		{
			"id": "step-5-metadata",
			"content": "Step 5: Metadata"
		},
		{
			"id": "step-6-styles",
			"content": "Step 6: Styles"
		},
		{
			"id": "step-7-create-the-entrypoint-page",
			"content": "Step 7: Create the Entrypoint Page"
		},
		{
		...
		{
			"id": "step-9-migrate-the-environment-variables",
			"content": "Step 9: Migrate the Environment Variables"
		},
		{
...
var toc = [
	...
	},
	{
		depth: 3,
		url: "#step-5-metadata",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 5: Metadata" })
	},
	{
		depth: 3,
		url: "#step-6-styles",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 6: Styles" })
	},
	{
		depth: 3,
		url: "#step-7-create-the-entrypoint-page",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 7: Create the Entrypoint Page" })
	},
	{
		depth: 3,
	...
	{
		depth: 3,
		url: "#step-9-migrate-the-environment-variables",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 9: Migrate the Environment Variables" })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This guide will help you migrate an existing Create React App site to Next.js." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Create React App uses purely client-side React. Client-side only applications, also known as single-page applications (SPAs), often experience slow initial page loading time. This happens due to a couple of reasons:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Our goal with this migration is to get a working Next.js application as quickly as possible, so that you can then adopt Next.js features incrementally. To begin with, we'll keep it as a purely client-side application (SPA) without migrating your existing router. This helps minimize the chances of encountering issues during the migration process and reduces merge conflicts." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-1-install-the-nextjs-dependency",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The closest equivalent to the root layout file in a CRA application is the ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: "manifest file"
				}),
				", additional iconography other than the favicon, and ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/testing",
					children: "testing configuration"
				}),
				", but if these are requirements, Next.js also supports these options."
			] }),
			"\n"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" tags, so you can safely remove those from your ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "<head>" }),
			":"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-6-styles",
			children: "Step 6: Styles"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Like Create React App, Next.js has built-in support for ",
			(0, import_jsx_runtime.jsx)(_components.a, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"If you're using a global CSS file, import it into your ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"If you're using Tailwind, you'll need to install ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "postcss" }),
			" and ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "autoprefixer" }),
			":"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-7-create-the-entrypoint-page",
			children: "Step 7: Create the Entrypoint Page"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" file. The closest equivalent of this file on CRA is your ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Since this guide is aiming to first set up our Next.js as an SPA (Single Page Application), you need your page entry point to catch all possible routes of your application. For that, create a new ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "[[...slug]]" }),
			" directory in your ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "app" }),
			" directory."
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			". This special directory will make sure that all routes of your application will be directed to its containing ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "page.tsx" }),
			" file."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Now, let's move the rest of our CRA application which will run client-only." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Next.js handles static image imports slightly different from CRA. With CRA, importing an image file will return its public URL as a string:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-9-migrate-the-environment-variables",
			children: "Step 9: Migrate the Environment Variables"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" with Next.js related commands, and add ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: ".next" }),
			", ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can now clean up your codebase from Create React App related artifacts:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "src/index.tsx" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "public/index.html" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Delete ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Create React App and Next.js both default to using webpack for bundling." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"When migrating your CRA application to Next.js, you might have a custom webpack configuration you're looking to migrate. Next.js supports providing a ",
			(0, import_jsx_runtime.jsx)(_components.a, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Further, Next.js has support for ",
			(0, import_jsx_runtime.jsx)(_components.a, {
			...
			" to improve your local dev performance. Turbopack supports some ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/next-config-js/turbo",
				children: "webpack loaders"
			}),
			" as well for compatibility and incremental adoption."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "next-steps",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If everything went according to plan, you now have a functioning Next.js application running as a single-page application. However, you aren't yet taking advantage of most of Next.js' benefits, but you can now start making incremental changes to reap all the benefits. Here's what you might want to do next:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
...
//#endregion
export { toc as a, structuredData as i, _05_from_create_react_app_exports as n, frontmatter as r, MDXContent as t };
