...
//#region node_modules/.nitro/vite/services/ssr/assets/reactStrictMode-KUxrC7R1.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> **Good to know**: Since Next.js 13.4, Strict Mode is `true` by default with `app` router, so the above configuration is only necessary for `pages`. You can still disable Strict Mode by setting `reactStrictMode: false`."
		},
		{
			"heading": void 0,
