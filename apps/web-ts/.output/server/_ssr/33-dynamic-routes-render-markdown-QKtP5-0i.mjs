...
//#region node_modules/.nitro/vite/services/ssr/assets/33-dynamic-routes-render-markdown-QKtP5-0i.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _33_dynamic_routes_render_markdown_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "To render markdown content, we’ll use the `remark` library. First, let’s install it:"
		},
		{
			"heading": void 0,
			"content": "Then, open `lib/posts.js` and add the following imports to the top of the file:"
		},
		{
			"heading": void 0,
			"content": "And update the `getPostData()` function in the same file as follows to use `remark`:"
		},
		{
			"heading": void 0,
			"content": "> **Important*&#x2A;: We added the &#x2A;*`async`** keyword to `getPostData` because we need to use `await` for `remark`. `async`/`await` allow you to fetch data asynchronously."
		},
		{
			"heading": void 0,
			"content": "That means we need to update `getStaticProps` in `pages/posts/[id].js` to use `await` when calling `getPostData`:"
		},
		{
			"heading": void 0,
			"content": "Finally, update the `Post` component in `pages/posts/[id].js` to render `contentHtml` using `dangerouslySetInnerHTML`:"
		},
		{
			"heading": void 0,
			"content": "Try visiting these pages again:"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "You should now see the blog content:"
		},
		{
			"heading": void 0,
			"content": "We’re almost done! Let’s polish each page next."
		}
	],
	"headings": []
};
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsx)(_components.span, {
				className: "line",
				children: (0, import_jsx_runtime.jsx)(_components.span, { children: "npm install remark remark-html" })
			}) })
		}) }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "import { remark } from 'remark';" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "import html from 'remark-html';" })
				})
			] })
		}) }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" function in the same file as follows to use ",
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "export async function getPostData(id) {" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  // Use remark to convert markdown into HTML string" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  const processedContent = await remark()" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "    .use(html)" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "    .process(matterResult.content);" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  const contentHtml = processedContent.toString();" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  // Combine the data with the id and contentHtml" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "    contentHtml," })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				": We added the ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "async" }) }),
				" keyword to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "getPostData" }),
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  // Add the \"await\" keyword like this:" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "  const postData = await getPostData(params.id);" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "pages/posts/[id].js" }),
			" to render ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "contentHtml" }),
			" using ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://reactjs.org/docs/dom-elements.html#dangerouslysetinnerhtml",
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "dangerouslySetInnerHTML" })
			}),
			":"
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Try visiting these pages again:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You should now see the blog content:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: (0, import_jsx_runtime.jsx)(_components.img, {
			src: "https://h8DxKfmAPhn8O0p3.public.blob.vercel-storage.com/learn/pages-router/dynamic-routes/markdown.png",
			alt: "How to Statically Generate Pages with Dynamic Routes"
		}) }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "We’re almost done! Let’s polish each page next." })
	] });
}
...
//#endregion
export { toc as a, structuredData as i, _33_dynamic_routes_render_markdown_exports as n, frontmatter as r, MDXContent as t };
