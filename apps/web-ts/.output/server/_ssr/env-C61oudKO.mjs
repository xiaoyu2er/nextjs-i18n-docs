...
//#region node_modules/.nitro/vite/services/ssr/assets/env-C61oudKO.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> Since the release of Next.js 9.4 we now have a more intuitive and ergonomic experience for adding environment variables. Give it a try!"
		},
		{
			"heading": void 0,
			"content": "> Since the release of Next.js 9.4 we now have a more intuitive and ergonomic experience for adding environment variables. Give it a try!"
		...
		{
			"heading": void 0,
			"content": "> **Good to know**: environment variables specified in this way will **always** be included in the JavaScript bundle, prefixing the environment variable name with `NEXT_PUBLIC_` only has an effect when specifying them through the environment or .env files."
		},
		{
			"heading": void 0,
			"content": "> **Good to know**: environment variables specified in this way will **always** be included in the JavaScript bundle, prefixing the environment variable name with `NEXT_PUBLIC_` only has an effect when specifying them through the environment or .env files."
		...
		{
			"heading": void 0,
			"content": "To add environment variables to the JavaScript bundle, open `next.config.js` and add the `env` config:"
		},
		{
			"heading": void 0,
			"content": "Now you can access `process.env.customKey` in your code. For example:"
		},
		{
			"heading": void 0,
			"content": "Next.js will replace `process.env.customKey` with `'my-value'` at build time. Trying to destructure `process.env` variables won't work due to the nature of webpack DefinePlugin."
		},
		{
			"heading": void 0,
			"content": "For example, the following line:"
		},
		{
			"heading": void 0,
			"content": "Will end up being:"
		}
	],
	"headings": []
};
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vercel/next.js/tree/canary/examples/with-env-from-next-config-js",
				children: "With env"
			}) }),
			"\n"
		] })] }),
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "always" }),
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/configuring/environment-variables",
					children: "through the environment or .env files"
				}),
				"."
			] }),
			"\n"
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.customKey" }),
			" with ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "'my-value'" }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For example, the following line:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Will end up being:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: ">The value of customKey is: {"
					}),
					(0, import_jsx_runtime.jsx)(_components.span, {
						style: {
							"--shiki-light": "#032F62",
...
//#endregion
export { toc as a, structuredData as i, env_exports as n, frontmatter as r, MDXContent as t };
