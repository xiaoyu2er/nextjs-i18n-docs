...
//#region node_modules/.nitro/vite/services/ssr/assets/runtime-configuration-_fBUwntT.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var runtime_configuration_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> **Warning**: This feature is considered legacy and does not work with Automatic Static Optimization, Output File Tracing, or React Server Components. Please use environment variables instead to avoid initialization overhead."
		},
		{
			"heading": void 0,
			"content": "To add runtime configuration to your app, open `next.config.js` and add the `publicRuntimeConfig` and `serverRuntimeConfig` configs:"
		},
		{
			"heading": void 0,
			"content": "Place any server-only runtime config under `serverRuntimeConfig`."
		},
		{
			"heading": void 0,
			"content": "Anything accessible to both client and server-side code should be under `publicRuntimeConfig`."
		},
		{
			"heading": void 0,
			"content": "> A page that relies on `publicRuntimeConfig` **must** use `getInitialProps` or `getServerSideProps` or your application must have a Custom App with `getInitialProps` to opt-out of Automatic Static Optimization. Runtime configuration won't be available to any page (or component in a page) without being server-side rendered."
		},
		{
			"heading": void 0,
			"content": "To get access to the runtime configs in your app use `next/config`, like so:"
		}
	],
	"headings": []
};
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				": This feature is considered legacy and does not work with ",
				...
				", ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/api-reference/next-config-js/output#automatically-copying-traced-files",
				...
				" instead to avoid initialization overhead."
			] }),
			"\n"
		] }),
		"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    secondSecret: process.env."
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#005CC5",
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "// Pass through env variables"
						})
					]
				}),
				"\n",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// Only holds serverRuntimeConfig and publicRuntimeConfig"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// Will be available on both server-side and client-side"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, runtime_configuration_exports as r, MDXContent as t };
