...
//#region node_modules/.nitro/vite/services/ssr/assets/parallel-routes-ffUmwR_o.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "modals",
			"content": "Inside your `@auth` slot, intercept the `/login` route by importing the `<Modal>` component and its children into the `@auth/(.)login/page.tsx` file, and updating the folder name to `/@auth/(.)login/page.tsx`."
		},
		{
			"heading": "modals",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "@auth/(.)login/page.tsx" }),
