...
//#region node_modules/.nitro/vite/services/ssr/assets/route-Cf8_b1Q1.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "A **route** file allows you to create custom request handlers for a given route. The following HTTP methods are supported: `GET`, `POST`, `PUT`, `PATCH`, `DELETE`, `HEAD`, and `OPTIONS`."
		},
		{
			"heading": "request-optional",
			"content": "The `request` object is a NextRequest object, which is an extension of the Web Request API. `NextRequest` gives you further control over the incoming request, including easily accessing `cookies` and an extended, parsed, URL object `nextUrl`."
		},
		{
			"heading": "context-optional",
			"content": "**`params`**: a promise that resolves to an object containing the dynamic route parameters for the current route."
		},
		{
			"heading": "context-optional",
			"content": "Example"
		...
		{
			"heading": "context-optional",
			"content": "`app/dashboard/[team]/route.js`"
		},
		{
			"heading": "context-optional",
			"content": "`/dashboard/1`"
		...
		{
			"heading": "context-optional",
			"content": "`app/shop/[tag]/[item]/route.js`"
		},
		{
			"heading": "context-optional",
			"content": "`/shop/1/2`"
		...
		{
			"heading": "context-optional",
			"content": "`app/blog/[...slug]/route.js`"
		},
		{
			"heading": "context-optional",
			"content": "`/blog/1/2`"
		...
		},
		{
			...
			"content": "You can type the Route Handler context using `RouteContext` to get strongly typed `params` from a route literal. `RouteContext` is a globally available helper."
		},
		{
			"heading": "route-context-helper",
		...
		{
			"heading": "cookies",
			"content": "You can read or set cookies with `cookies` from `next/headers`."
		},
		{
			"heading": "cookies",
		...
		{
			"heading": "headers",
			"content": "You can read headers with `headers` from `next/headers`."
		},
		{
			"heading": "headers",
		...
		},
		{
			...
			"content": "You can revalidate cached data using the `revalidate` route segment config option."
		},
		{
		...
		{
			"heading": "dynamic-route-segments",
			"content": "`Promise<{ slug: 'c' }>`"
		},
		{
			"heading": "url-query-parameters",
			"content": "The request object passed to the Route Handler is a `NextRequest` instance, which includes some additional convenience methods, such as those for more easily handling query parameters."
		},
		{
			"heading": "streaming",
		...
		{
			"heading": "version-history",
			"content": "`context.params` is now a promise. A codemod is available"
		},
		{
			"heading": "version-history",
			"content": "`v15.0.0-RC`"
		...
		{
			"heading": "version-history",
			"content": "The default caching for `GET` handlers was changed from static to dynamic"
		},
		{
			"heading": "version-history",
			"content": "`v13.2.0`"
		...
		{
			"heading": "version-history",
			"content": "Route Handlers are introduced."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		...
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("code", { children: "request" }), " (optional)"] })
	},
	{
		depth: 4,
		url: "#context-optional",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [(0, import_jsx_runtime.jsx)("code", { children: "context" }), " (optional)"] })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// If `OPTIONS` is not defined, Next.js will automatically implement `OPTIONS` and set the appropriate Response `Allow` header depending on the other methods defined in the Route Handler."
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.h4, {
			id: "request-optional",
			children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "request" }), " (optional)"]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
		...
		(0, import_jsx_runtime.jsxs)(_components.h4, {
			id: "context-optional",
			children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "context" }), " (optional)"]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "params" }) }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/dashboard/[team]/route.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/[team]/route.ts",
					children: "app/dashboard/[team]/route.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/[team]/route.js",
					children: "app/dashboard/[team]/route.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/dashboard/[team]/route.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/dashboard/[team]/route.js" }) }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/shop/[tag]/[item]/route.js" }) }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/blog/[...slug]/route.js" }) }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "RouteContext" }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/posts/route.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/posts/route.ts",
					children: "app/posts/route.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/posts/route.js",
					children: "app/posts/route.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/posts/route.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ slug: 'a' }>" }) })
			] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/items/[slug]/route.js" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/items/b" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ slug: 'b' }>" }) })
			] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/items/[slug]/route.js" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/items/c" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ slug: 'c' }>" }) })
			] })
		] })] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " { StreamingTextResponse, streamText } "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/app/api-reference/file-conventions/middleware#cors",
						children: "Middleware"
					}),
					" or the ",
					(0, import_jsx_runtime.jsxs)(_components.a, {
						href: "/docs/app/api-reference/config/next-config-js/headers#cors",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Version" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Changes" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v15.0.0-RC" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v13.2.0" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: "Route Handlers are introduced." })] })
		] })] })
	] });
}
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, route_exports as r, MDXContent as t };
