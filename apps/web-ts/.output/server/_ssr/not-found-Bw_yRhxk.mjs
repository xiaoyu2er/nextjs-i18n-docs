...
//#region node_modules/.nitro/vite/services/ssr/assets/not-found-Bw_yRhxk.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `notFound` function allows you to render the `not-found file` within a route segment as well as inject a `<meta name=\"robots\" content=\"noindex\" />` tag."
		},
		{
			"heading": "notfound",
			"content": "Invoking the `notFound()` function throws a `NEXT_HTTP_ERROR_FALLBACK;404` error and terminates rendering of the route segment in which it was thrown. Specifying a **not-found** file allows you to gracefully handle such errors by rendering a Not Found UI within the segment."
		},
		{
			"heading": "notfound",
			"content": "> **Good to know**: `notFound()` does not require you to use `return notFound()` due to using the TypeScript `never` type."
		},
		{
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "not-found file" })
			}),
			" within a route segment as well as inject a ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "<meta name=\"robots\" content=\"noindex\" />" }),
			" tag."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "notFound()" }),
			" function throws a ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "NEXT_HTTP_ERROR_FALLBACK;404" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/api-reference/file-conventions/not-found",
				children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "not-found" }), " file"]
			}),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "return notFound()" }),
