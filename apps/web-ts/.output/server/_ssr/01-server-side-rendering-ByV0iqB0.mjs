...
//#region node_modules/.nitro/vite/services/ssr/assets/01-server-side-rendering-ByV0iqB0.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _01_server_side_rendering_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> Also referred to as \"SSR\" or \"Dynamic Rendering\"."
		},
		{
			"heading": void 0,
			"content": "If a page uses **Server-side Rendering**, the page HTML is generated on **each request**."
		},
		{
			"heading": void 0,
			"content": "To use Server-side Rendering for a page, you need to `export` an `async` function called `getServerSideProps`. This function will be called by the server on every request."
		},
		{
			"heading": void 0,
			"content": "For example, suppose that your page needs to pre-render frequently updated data (fetched from an external API). You can write `getServerSideProps` which fetches this data and passes it to `Page` like below:"
		},
		{
			"heading": void 0,
			"content": "As you can see, `getServerSideProps` is similar to `getStaticProps`, but the difference is that `getServerSideProps` is run on every request instead of on build time."
		},
		{
			"heading": void 0,
			"content": "To learn more about how `getServerSideProps` works, check out our Data Fetching documentation."
		}
	],
	"headings": []
};
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.p, { children: "Also referred to as \"SSR\" or \"Dynamic Rendering\"." }),
			"\n"
		] }),
		"\n",
...
//#endregion
export { toc as a, structuredData as i, _01_server_side_rendering_exports as n, frontmatter as r, MDXContent as t };
