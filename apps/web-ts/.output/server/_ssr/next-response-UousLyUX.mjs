...
//#region node_modules/.nitro/vite/services/ssr/assets/next-response-UousLyUX.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "next",
			"content": "You can also forward `headers` when producing the response:"
		}
	],
	"headings": [
		{
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// And produce a response with the new headers"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
