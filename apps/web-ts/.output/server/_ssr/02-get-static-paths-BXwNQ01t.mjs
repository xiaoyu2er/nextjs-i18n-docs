...
//#region node_modules/.nitro/vite/services/ssr/assets/02-get-static-paths-BXwNQ01t.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _02_get_static_paths_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "When you export a function called `getStaticPaths` (Static Site Generation) from a page that uses dynamic routes, Next.js will statically pre-render all the paths specified by `getStaticPaths`."
		},
		{
			"heading": void 0,
			"content": "The `getStaticPaths` API reference covers all parameters and props that can be used with `getStaticPaths`."
		},
		{
			"heading": "when-should-i-use-getstaticpaths",
			"content": "You should use `getStaticPaths` if you’re statically pre-rendering pages that use dynamic routes and:"
		},
		{
			"heading": "when-should-i-use-getstaticpaths",
		...
		{
			"heading": "when-should-i-use-getstaticpaths",
			"content": "The data comes from a database"
		},
		{
			"heading": "when-should-i-use-getstaticpaths",
			"content": "The data comes from the filesystem"
		},
		{
			"heading": "when-should-i-use-getstaticpaths",
		...
		{
			"heading": "when-does-getstaticpaths-run",
			"content": "`getStaticPaths` will only run during build in production, it will not be called during runtime. You can validate code written inside `getStaticPaths` is removed from the client-side bundle with this tool."
		},
		{
			"heading": "how-does-getstaticprops-run-with-regards-to-getstaticpaths",
			"content": "`getStaticProps` runs during `next build` for any `paths` returned during build"
		},
		{
			"heading": "how-does-getstaticprops-run-with-regards-to-getstaticpaths",
		...
		{
			"heading": "where-can-i-use-getstaticpaths",
			"content": "`getStaticPaths` **must** be used with `getStaticProps`"
		},
		{
			"heading": "where-can-i-use-getstaticpaths",
			"content": "You **cannot** use `getStaticPaths` with `getServerSideProps`"
		},
		{
			"heading": "where-can-i-use-getstaticpaths",
			"content": "You can export `getStaticPaths` from a Dynamic Route that also uses `getStaticProps`"
		},
		{
			"heading": "where-can-i-use-getstaticpaths",
			"content": "You **cannot** export `getStaticPaths` from non-page file (e.g. your `components` folder)"
		},
		{
			"heading": "where-can-i-use-getstaticpaths",
			"content": "You must export `getStaticPaths` as a standalone function, and not a property of the page component"
		},
		{
			"heading": "runs-on-every-request-in-development",
			"content": "In development (`next dev`), `getStaticPaths` will be called on every request."
		},
		{
			"heading": "generating-paths-on-demand",
			"content": "`getStaticPaths` allows you to control which pages are generated during the build instead of on-demand with `fallback`. Generating more pages during a build will cause slower builds."
		},
		{
			"heading": "generating-paths-on-demand",
			"content": "You can defer generating all pages on-demand by returning an empty array for `paths`. This can be especially helpful when deploying your Next.js application to multiple environments. For example, you can have faster builds by generating all pages on-demand for previews (but not production builds). This is helpful for sites with hundreds/thousands of static pages."
		}
	],
	"headings": [
		{
		...
		},
		{
			...
			"content": "When does getStaticPaths run"
		},
		{
			"id": "how-does-getstaticprops-run-with-regards-to-getstaticpaths",
			"content": "How does getStaticProps run with regards to getStaticPaths"
		},
		{
...
var toc = [
	{
		depth: 2,
		url: "#when-should-i-use-getstaticpaths",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "When should I use getStaticPaths?" })
	},
	{
		depth: 2,
		url: "#when-does-getstaticpaths-run",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "When does getStaticPaths run" })
	},
	{
		depth: 3,
		url: "#how-does-getstaticprops-run-with-regards-to-getstaticpaths",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "How does getStaticProps run with regards to getStaticPaths" })
	},
	{
		depth: 2,
		url: "#where-can-i-use-getstaticpaths",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Where can I use getStaticPaths" })
	},
	{
		depth: 2,
	...
	{
		depth: 2,
		url: "#generating-paths-on-demand",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Generating paths on-demand" })
	}
];
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticPaths" }), " API reference"]
			}),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "when-should-i-use-getstaticpaths",
			children: "When should I use getStaticPaths?"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You should use ",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The data comes from a database" }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The data comes from the filesystem" }),
			"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "when-does-getstaticpaths-run",
			children: "When does getStaticPaths run"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticPaths" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "how-does-getstaticprops-run-with-regards-to-getstaticpaths",
			children: "How does getStaticProps run with regards to getStaticPaths"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "where-can-i-use-getstaticpaths",
			children: "Where can I use getStaticPaths"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "generating-paths-on-demand",
			children: "Generating paths on-demand"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticPaths" }),
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // When this is true (in preview environments) don't"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // prerender any static pages"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // (faster builds, but slower initial page load)"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "SKIP_BUILD_STATIC_GENERATION"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Get the paths we want to prerender based on posts"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // In production environments, prerender all pages"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // (slower builds, but faster initial page load)"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, _02_get_static_paths_exports as n, frontmatter as r, MDXContent as t };
