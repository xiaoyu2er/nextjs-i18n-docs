...
//#region node_modules/.nitro/vite/services/ssr/assets/template-BpL9byJf.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "A **template** file is similar to a layout in that it wraps each child layout or page. Unlike layouts that persist across routes and maintain state, templates create a new instance for each of their children on navigation."
		},
		{
			"heading": void 0,
			"content": "While less common, you might choose a template over a layout if you want:"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "To change the default framework behavior. For example, Suspense Boundaries inside layouts only show the fallback the first time the Layout is loaded and not when switching pages. For templates, the fallback is shown on each navigation."
		},
		{
			"heading": "children-required",
			"content": "Template components should accept and use a `children` prop. `template` is rendered between a layout and its children. For example:"
		},
		{
			"heading": "children-required",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			...
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					...
					value: "app/template.jsx",
					children: "app/template.jsx"
				})] }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "While less common, you might choose a template over a layout if you want:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "To change the default framework behavior. For example, Suspense Boundaries inside layouts only show the fallback the first time the Layout is loaded and not when switching pages. For templates, the fallback is shown on each navigation." }),
			"\n"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" prop. ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "template" }),
