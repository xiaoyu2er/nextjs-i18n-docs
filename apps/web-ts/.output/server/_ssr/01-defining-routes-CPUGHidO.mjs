...
//#region node_modules/.nitro/vite/services/ssr/assets/01-defining-routes-CPUGHidO.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _01_defining_routes_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["app/building-your-application/routing/pages-and-layouts"]
	}
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> We recommend reading the Routing Fundamentals page before continuing."
		},
		{
			"heading": void 0,
			"content": "This page will guide you through how to define and organize routes in your Next.js application."
		},
		{
			"heading": "creating-routes",
			"content": "Next.js uses a file-system based router where **folders** are used to define routes."
		},
		{
			"heading": "creating-routes",
			"content": "Each folder represents a **route** segment that maps to a **URL** segment. To create a nested route, you can nest folders inside each other."
		},
		{
			"heading": "creating-routes",
			"content": "A special `page.js` file is used to make route segments publicly accessible."
		},
		{
			"heading": "creating-routes",
			"content": "In this example, the `/dashboard/analytics` URL path is *not* publicly accessible because it does not have a corresponding `page.js` file. This folder could be used to store components, stylesheets, images, or other colocated files."
		},
		{
			"heading": "creating-routes",
		...
		{
			"heading": "creating-ui",
			"content": "Special file conventions are used to create UI for each route segment. The most common are pages to show UI unique to a route, and layouts to show UI that is shared across multiple routes."
		},
		{
			"heading": "creating-ui",
			"content": "For example, to create your first page, add a `page.js` file inside the `app` directory and export a React component:"
		}
	],
	"headings": [{
		"id": "creating-routes",
...
var toc = [{
	depth: 2,
	url: "#creating-routes",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating Routes" })
}, {
	depth: 2,
	url: "#creating-ui",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating UI" })
}];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This page will guide you through how to define and organize routes in your Next.js application." }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "route" }), " segment"]
			}),
			" that maps to a ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "URL" }),
			" segment. To create a ",
			(0, import_jsx_runtime.jsx)(_components.a, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "page.js" }), " file"]
			}),
...
//#endregion
export { toc as a, structuredData as i, _01_defining_routes_exports as n, frontmatter as r, MDXContent as t };
