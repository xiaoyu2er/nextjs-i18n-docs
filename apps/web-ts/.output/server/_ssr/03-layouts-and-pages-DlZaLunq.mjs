...
//#region node_modules/.nitro/vite/services/ssr/assets/03-layouts-and-pages-DlZaLunq.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_layouts_and_pages_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Next.js uses **file-system based routing**, meaning you can use folders and files to define routes. This page will guide you through how to create layouts and pages, and link between them."
		},
		{
			"heading": "creating-a-page",
			"content": "A **page** is UI that is rendered on a specific route. To create a page, add a `page` file inside the `app` directory and default export a React component. For example, to create an index page (`/`):"
		},
		{
			"heading": "creating-a-layout",
			"content": "A layout is UI that is **shared** between multiple pages. On navigation, layouts preserve state, remain interactive, and do not rerender."
		},
		{
			"heading": "creating-a-layout",
			"content": "You can define a layout by default exporting a React component from a `layout` file. The component should accept a `children` prop which can be a page or another layout."
		},
		{
			"heading": "creating-a-layout",
			"content": "For example, to create a layout that accepts your index page as child, add a `layout` file inside the `app` directory:"
		},
		{
			"heading": "creating-a-layout",
			"content": "The layout above is called a root layout because it's defined at the root of the `app` directory. The root layout is **required** and must contain `html` and `body` tags."
		},
		{
			"heading": "creating-a-nested-route",
			"content": "A nested route is a route composed of multiple URL segments. For example, the `/blog/[slug]` route is composed of three segments:"
		},
		{
			"heading": "creating-a-nested-route",
		...
		{
			"heading": "creating-a-nested-route",
			"content": "`blog` (Segment)"
		},
		{
			"heading": "creating-a-nested-route",
			"content": "`[slug]` (Leaf Segment)"
		},
		{
			"heading": "creating-a-nested-route",
			"content": "In Next.js:"
		...
		{
			"heading": "creating-a-nested-route",
			"content": "**Folders** are used to define the route segments that map to URL segments."
		},
		{
			"heading": "creating-a-nested-route",
			"content": "**Files** (like `page` and `layout`) are used to create UI that is shown for a segment."
		},
		{
			"heading": "creating-a-nested-route",
			"content": "To create nested routes, you can nest folders inside each other. For example, to add a route for `/blog`, create a folder called `blog` in the `app` directory. Then, to make `/blog` publicly accessible, add a `page.tsx` file:"
		},
		{
			"heading": "creating-a-nested-route",
			"content": "You can continue nesting folders to create nested routes. For example, to create a route for a specific blog post, create a new `[slug]` folder inside `blog` and add a `page` file:"
		},
		{
			"heading": "creating-a-nested-route",
			"content": "Wrapping a folder name in square brackets (e.g. `[slug]`) creates a dynamic route segment which is used to generate multiple pages from data. e.g. blog posts, product pages, etc."
		},
		{
			"heading": "nesting-layouts",
			"content": "By default, layouts in the folder hierarchy are also nested, which means they wrap child layouts via their `children` prop. You can nest layouts by adding `layout` inside specific route segments (folders)."
		},
		{
			"heading": "nesting-layouts",
			"content": "For example, to create a layout for the `/blog` route, add a new `layout` file inside the `blog` folder."
		},
		{
			"heading": "nesting-layouts",
			"content": "If you were to combine the two layouts above, the root layout (`app/layout.js`) would wrap the blog layout (`app/blog/layout.js`), which would wrap the blog (`app/blog/page.js`) and blog post page (`app/blog/[slug]/page.js`)."
		},
		{
			"heading": "creating-a-dynamic-segment",
			"content": "Dynamic segments allow you to create routes that are generated from data. For example, instead of manually creating a route for each individual blog post, you can create a dynamic segment to generate the routes based on blog post data."
		},
		{
			"heading": "creating-a-dynamic-segment",
			"content": "To create a dynamic segment, wrap the segment (folder) name in square brackets: `[segmentName]`. For example, in the `app/blog/[slug]/page.tsx` route, the `[slug]` is the dynamic segment."
		},
		{
			"heading": "creating-a-dynamic-segment",
			"content": "Learn more about Dynamic Segments."
		},
		{
			"heading": "linking-between-pages",
			"content": "You can use the `<Link>` component to navigate between routes. `<Link>` is a built-in Next.js component that extends the HTML `<a>` tag to provide prefetching and client-side navigation."
		},
		{
			"heading": "linking-between-pages",
			"content": "For example, to generate a list of blog posts, import `<Link>` from `next/link` and pass a `href` prop to the component:"
		},
		{
			"heading": "linking-between-pages",
			"content": "> **Good to know**: `<Link>` is the primary way to navigate between routes in Next.js. You can also use the `useRouter` hook for more advanced navigation."
		},
		{
...
var toc = [
	{
		depth: 2,
		url: "#creating-a-page",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating a page" })
	},
	{
		depth: 2,
		url: "#creating-a-layout",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating a layout" })
	},
	{
		depth: 2,
		url: "#creating-a-nested-route",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating a nested route" })
	},
	{
		depth: 2,
		url: "#nesting-layouts",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Nesting layouts" })
	},
	{
		depth: 2,
		url: "#creating-a-dynamic-segment",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating a dynamic segment" })
	},
	{
		depth: 2,
		url: "#linking-between-pages",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Linking between pages" })
	},
	{
		depth: 2,
		url: "#api-reference",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Next.js uses ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "file-system based routing" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "page" }), " file"]
			}),
			" inside the ",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "creating-a-layout",
			children: "Creating a layout"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"A layout is UI that is ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "shared" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "layout" }), " file"]
			}),
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "/* Place children where you want to render a page or nested layout */"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "creating-a-nested-route",
			children: "Creating a nested route"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "blog" }), " (Segment)"] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "[slug]" }), " (Leaf Segment)"] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "In Next.js:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Folders" }), " are used to define the route segments that map to URL segments."] }),
			"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "dynamic route segment"
			}),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "creating-a-dynamic-segment",
			children: "Creating a dynamic segment"
		}),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "[segmentName]" }),
			". For example, in the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "app/blog/[slug]/page.tsx" }),
			" route, the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "[slug]" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "linking-between-pages",
			children: "Linking between pages"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can use the ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/ui/post.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/ui/post.tsx",
					children: "app/ui/post.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/ui/post.js",
					children: "app/ui/post.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/ui/post.tsx",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
...
//#endregion
export { toc as a, structuredData as i, _03_layouts_and_pages_exports as n, frontmatter as r, MDXContent as t };
