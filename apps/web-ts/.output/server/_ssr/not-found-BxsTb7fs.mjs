...
//#region node_modules/.nitro/vite/services/ssr/assets/not-found-BxsTb7fs.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "notfound",
			"content": "Invoking the `notFound()` function throws a `NEXT_NOT_FOUND` error and terminates rendering of the route segment in which it was thrown. Specifying a **not-found** file allows you to gracefully handle such errors by rendering a Not Found UI within the segment."
		},
		{
			"heading": "notfound",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "notFound()" }),
			" function throws a ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "NEXT_NOT_FOUND" }),
