...
//#region node_modules/.nitro/vite/services/ssr/assets/use-params-CFYBiLX_.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var use_params_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`useParams` is a **Client Component** hook that lets you read a route's dynamic params filled in by the current URL."
		},
		{
			"heading": "parameters",
			"content": "`useParams` does not take any parameters."
		},
		{
			"heading": "returns",
			"content": "`useParams` returns an object containing the current route's filled in dynamic parameters."
		},
		{
			"heading": "returns",
		...
		{
			"heading": "returns",
			"content": "The properties value will either be a `string` or array of `string`'s depending on the type of dynamic segment."
		},
		{
			"heading": "returns",
		...
		{
			"heading": "returns",
			"content": "If used in Pages Router, `useParams` will return `null` on the initial render and updates with properties following the rules above once the router is ready."
		},
		{
			"heading": "returns",
			"content": "For example:"
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "useParams" }), " does not take any parameters."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "returns",
			children: "Returns"
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Each property in the object is an active dynamic segment." }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The properties name is the segment's name, and the properties value is what the segment is filled in with." }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/file-conventions/dynamic-routes",
					children: "type of dynamic segment"
				}),
				"."
			] }),
			"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.th, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "useParams()" }) })
		] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "app/shop/page.js" }) }),
...
//#endregion
export { use_params_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
