...
//#region node_modules/.nitro/vite/services/ssr/assets/revalidatePath-4CJztmoF.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "parameters",
			"content": "`path`: Either a string representing the filesystem path associated with the data you want to revalidate (for example, `/product/[slug]/page`), or the literal route segment (for example, `/product/123`). Must be less than 1024 characters."
		},
		{
			"heading": "parameters",
			"content": "`type`: (optional) `'page'` or `'layout'` string to change the type of path to revalidate."
		},
		{
			"heading": "returns",
