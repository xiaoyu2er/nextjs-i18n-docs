...
//#region node_modules/.nitro/vite/services/ssr/assets/compress-BJp0CeEO.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "disabling-compression",
			"content": "To disable **compression**, set the `compress` config option to `false`:"
		},
		{
			"heading": "disabling-compression",
			"content": "We do not recommend disabling compression unless you have compression configured on your server, as compression reduces bandwidth usage and improves the performance of your application."
		},
		{
			"heading": "changing-the-compression-algorithm",
			"content": "To change your compression algorithm, you will need to configure your custom server and set the `compress` option to `false` in your `next.config.js` file."
		},
		{
			"heading": "changing-the-compression-algorithm",
			"content": "For example, you're using nginx and want to switch to `brotli`, set the `compress` option to `false` to allow nginx to handle compression."
		},
		{
			"heading": "changing-the-compression-algorithm",
	...
	"headings": [{
		"id": "disabling-compression",
		"content": "Disabling compression"
	}, {
		"id": "changing-the-compression-algorithm",
		"content": "Changing the compression algorithm"
	}]
};
var toc = [{
	depth: 2,
	url: "#disabling-compression",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Disabling compression" })
}, {
	depth: 2,
	url: "#changing-the-compression-algorithm",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Changing the compression algorithm" })
}];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.em, { children: "already" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://vercel.com/docs/edge-network/compression",
						children: "Vercel"
					}),
					", compression uses ",
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						...
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Accept-Encoding" })
					}),
					" (browser accepted options) and ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Encoding",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Content-Encoding" })
					}),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "disabling-compression",
			children: "Disabling compression"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To disable ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "compression" }),
			", set the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "compress" }),
			" config option to ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "We do not recommend disabling compression unless you have compression configured on your server, as compression reduces bandwidth usage and improves the performance of your application." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "changing-the-compression-algorithm",
			children: "Changing the compression algorithm"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To change your compression algorithm, you will need to configure your custom server and set the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "compress" }),
			" option to ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "false" }),
			" in your ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					"For Next.js applications on Vercel, compression is handled by the Vercel's Edge Network and not Next.js. See the ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://vercel.com/docs/edge-network/compression",
...
//#endregion
export { toc as a, structuredData as i, compress_exports as n, frontmatter as r, MDXContent as t };
