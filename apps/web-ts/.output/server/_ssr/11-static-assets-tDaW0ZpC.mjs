...
//#region node_modules/.nitro/vite/services/ssr/assets/11-static-assets-tDaW0ZpC.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _11_static_assets_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Next.js can serve static files, like images, under a folder called `public` in the root directory. Files inside `public` can then be referenced by your code starting from the base URL (`/`)."
		},
		{
			"heading": void 0,
			"content": "For example, the file `public/avatars/me.png` can be viewed by visiting the `/avatars/me.png` path. The code to display that image might look like:"
		},
		{
			"heading": "caching",
			"content": "Next.js cannot safely cache assets in the `public` folder because they may change. The default caching headers applied are:"
		},
		{
			"heading": "robots-favicons-and-others",
			"content": "The folder is also useful for `robots.txt`, `favicon.ico`, Google Site Verification, and any other static files (including `.html`). But make sure to not have a static file with the same name as a file in the `pages/` directory, as this will result in an error. Read more."
		},
		{
			"heading": "robots-favicons-and-others",
			"content": "For static metadata files, such as `robots.txt`, `favicon.ico`, etc, you should use special metadata files inside the `app` folder."
		},
		{
			"heading": "robots-favicons-and-others",
	...
	"headings": [{
		...
		"id": "robots-favicons-and-others",
		"content": "Robots, Favicons, and others"
	}]
};
var toc = [{
	depth: 2,
	...
	depth: 2,
	url: "#robots-favicons-and-others",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Robots, Favicons, and others" })
}];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "public/avatars/me.png" }),
			" can be viewed by visiting the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "/avatars/me.png" }),
		...
		(0, import_jsx_runtime.jsx)(PagesOnly, { children: (0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/messages/conflicting-public-file-page",
				children: "Read more"
			}),
			"."
		] }) }),
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "special metadata files"
			}),
			" inside the ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.p, { children: "Good to know:" }),
			"\n",
...
//#endregion
export { toc as a, structuredData as i, _11_static_assets_exports as n, frontmatter as r, MDXContent as t };
