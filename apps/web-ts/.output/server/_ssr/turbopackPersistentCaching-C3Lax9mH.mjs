...
//#region node_modules/.nitro/vite/services/ssr/assets/turbopackPersistentCaching-C3Lax9mH.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var turbopackPersistentCaching_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": "usage",
			"content": "Turbopack Persistent Caching enables Turbopack to reduce work across `next dev` or `next build` commands. When enabled, Turbopack will save and restore data to the `.next` folder between builds, which can greatly speed up subsequent builds and dev sessions."
		},
		{
			"heading": "usage",
			"content": "> **Warning:** Persistent Caching is still under development and is not yet stable. Users adopting should expect some stability issues."
		},
		{
			"heading": "usage",
			"content": "> **Good to know**: Note that while `next dev` and `next build` can share cached data with each other, most cache entries are command-specific due to different configuration and environment variables."
		},
		{
		...
		{
			"heading": "version-changes",
			"content": "Persistent caching released as experimental"
		}
	],
	"headings": [{
		"id": "usage",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Turbopack Persistent Caching enables Turbopack to reduce work across ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }),
			" or ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }),
			" commands. When enabled, Turbopack will save and restore data to the ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Warning:" }), " Persistent Caching is still under development and is not yet stable. Users adopting should expect some stability issues."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "    turbopackPersistentCaching: "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#005CC5",
...
//#endregion
export { turbopackPersistentCaching_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
