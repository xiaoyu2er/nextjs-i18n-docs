...
//#region node_modules/.nitro/vite/services/ssr/assets/local-development-DUECUfY7.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "Libraries like `@material-ui/icons` or `react-icons` can import thousands of icons, even if you only use a few. Try to import only the icons you need:"
		},
		{
			"heading": "icon-libraries",
		...
		{
			"heading": "turbopack-tracing",
			"content": "You can interpret the file using `next internal trace [path-to-file]`:"
		},
		{
			"heading": "turbopack-tracing",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "next internal trace [path-to-file]" }),
					":"
				] }),
				"\n",
				(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
