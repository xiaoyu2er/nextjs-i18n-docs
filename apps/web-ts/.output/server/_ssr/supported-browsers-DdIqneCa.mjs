...
//#region node_modules/.nitro/vite/services/ssr/assets/supported-browsers-DdIqneCa.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "in-app-router",
			"content": "To include polyfills, you can import them into the `instrumentation-client.js` file."
		},
		{
			"heading": "in-pages-router",
		...
		{
			"heading": "conditionally-loading-polyfills",
			"content": "The best approach is to isolate unsupported features to specific UI sections and conditionally load the polyfill if needed."
		},
		{
	...
	"headings": [
		...
		{
			"id": "in-app-router",
			"content": "In App Router"
		},
		{
			"id": "in-pages-router",
			"content": "In Pages Router"
		},
		{
			"id": "conditionally-loading-polyfills",
...
var toc = [
	...
	},
	{
		depth: 4,
		url: "#in-app-router",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "In App Router" })
	},
	{
		depth: 4,
		url: "#in-pages-router",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "In Pages Router" })
	},
	{
		depth: 4,
		url: "#conditionally-loading-polyfills",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Conditionally loading polyfills" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h4, {
			id: "in-app-router",
			children: "In App Router"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To include polyfills, you can import them into the ",
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/api-reference/file-conventions/instrumentation-client",
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "instrumentation-client.js" }), " file"]
			}),
			"."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h4, {
			id: "conditionally-loading-polyfills",
			children: "Conditionally loading polyfills"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The best approach is to isolate unsupported features to specific UI sections and conditionally load the polyfill if needed." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "hooks/analytics.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "hooks/analytics.ts",
					children: "hooks/analytics.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "hooks/analytics.js",
					children: "hooks/analytics.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "hooks/analytics.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "'polyfills/structured-clone'"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#24292E",
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "        globalThis.structuredClone "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#D73A49",
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "    /* Do some work that uses structured clone */"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
