...
//#region node_modules/.nitro/vite/services/ssr/assets/next-BuZJ2KSb.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "next-dev-options",
			"content": "Starts development mode using Turbopack."
		},
		{
			"heading": "next-dev-options",
		...
		},
		{
			...
			"content": "For certain use cases like webhooks or authentication, it may be required to use HTTPS to have a secure environment on `localhost`. Next.js can generate a self-signed certificate with `next dev` using the `--experimental-https` flag:"
		},
		{
			"heading": "using-https-during-development",
		...
		{
			"heading": "using-https-during-development",
			"content": "> **Good to know**: When deploying to Vercel, HTTPS is automatically configured for your Next.js application."
		},
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Option" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Description" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "--turbo" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Option" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Description" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "--no-lint" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: "Disables linting." })] }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"For certain use cases like webhooks or authentication, it may be required to use HTTPS to have a secure environment on ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }),
				": When deploying to Vercel, HTTPS is ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://vercel.com/docs/security/encryption",
					children: "automatically configured"
				}),
