...
//#region node_modules/.nitro/vite/services/ssr/assets/03-from-vite-95EUr_Gf.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_from_vite_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "step-8-update-scripts-in-packagejson",
			"content": "Now run `npm run dev`, and open `http://localhost:3000`. You should\nhopefully see your application now running on Next.js."
		},
		{
			"heading": "step-8-update-scripts-in-packagejson",
			"content": "If your application followed a conventional Vite configuration, this is all you would need to do\nto have a working version of your application."
		},
		{
			"heading": "step-8-update-scripts-in-packagejson",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Slow initial page loading time" }),
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: "default Vite\nplugin for React"
				}),
				",\nyour application is a purely client-side application. Client-side only applications, also known as\nsingle-page applications (SPAs), often experience slow initial page loading time. This\nhappens due to a couple of reasons:",
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
					"\n",
					(0, import_jsx_runtime.jsx)(_components.li, { children: "The browser needs to wait for the React code and your entire application bundle to download\nand run before your code is able to send requests to load some data." }),
					"\n",
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "No automatic code splitting" }), ": The previous issue of slow loading times can be somewhat managed with code splitting.\nHowever, if you try to do code splitting manually, you'll often make performance worse. It's easy\nto inadvertently introduce network waterfalls when code-splitting manually. Next.js provides\nautomatic code splitting built into its router."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Network waterfalls" }),
				": A common cause of poor performance occurs when applications make\nsequential client-server requests to fetch data. One common pattern for data fetching in an SPA\nis to initially render a placeholder, and then fetch data after the component has mounted.\nUnfortunately, this means that a child component that fetches data can't start fetching until\nthe parent component has finished loading its own data. On Next.js,\n",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/reactjs/rfcs/blob/main/text/0188-server-components.md#no-client-server-waterfalls",
					children: "this issue is resolved"
				}),
				"\nby fetching data in Server Components."
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Fast and intentional loading states" }),
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Choose the data fetching strategy" }), ": Depending on your needs, Next.js allows you to choose your\ndata fetching strategy on a page and component basis. You can decide to fetch at build time, at\nrequest time on the server, or on the client. For example, you can fetch data from your CMS and\nrender your blog posts at build time, which can then be efficiently cached on a CDN."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Middleware" }),
				": ",
				(0, import_jsx_runtime.jsx)(_components.a, {
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Built-in Optimizations" }), ": Images, fonts, and third-party scripts often have significant impact\non an application's performance. Next.js comes with built-in components that automatically\noptimize those for you."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If your application followed a conventional Vite configuration, this is all you would need to do\nto have a working version of your application." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
...
//#endregion
export { toc as a, structuredData as i, _03_from_vite_exports as n, frontmatter as r, MDXContent as t };
