...
//#region node_modules/.nitro/vite/services/ssr/assets/08-next-cli-C8pL9q6I.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _08_next_cli_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The Next.js CLI allows you to start, build, and export your application."
		},
		{
			"heading": void 0,
			"content": "To get a list of the available CLI commands, run the following command inside your project directory:"
		},
		{
			"heading": void 0,
			"content": "*(npx comes with npm 5.2+ and higher)*"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "You can pass any node arguments to `next` commands:"
		},
		{
			"heading": void 0,
			"content": "> **Good to know**: Running `next` without a command is the same as running `next dev`"
		},
		{
			"heading": "build",
			"content": "`next build` creates an optimized production build of your application. The output displays information about each route."
		},
		{
			"heading": "build",
			"content": "**Size** – The number of assets downloaded when navigating to the page client-side. The size for each route only includes its dependencies."
		},
		{
			"heading": "build",
			"content": "**First Load JS** – The number of assets downloaded when visiting the page from the server. The amount of JS shared by all is shown as a separate metric."
		},
		{
			"heading": "build",
		...
		{
			"heading": "build",
			"content": "You can enable production profiling for React with the `--profile` flag in `next build`. This requires Next.js 9.5:"
		},
		{
			"heading": "build",
		...
		{
			"heading": "build",
			"content": "You can enable more verbose build output with the `--debug` flag in `next build`. This requires Next.js 9.5.3:"
		},
		{
			"heading": "build",
			"content": "With this flag enabled additional build output like rewrites, redirects, and headers will be shown."
		},
		{
			"heading": "development",
			"content": "`next dev` starts the application in development mode with hot-code reloading, error reporting, and more:"
		},
		{
			"heading": "development",
			"content": "The application will start at `http://localhost:3000` by default. The default port can be changed with `-p`, like so:"
		},
		{
			"heading": "development",
		...
		{
			"heading": "development",
			"content": "You can also set the hostname to be different from the default of `0.0.0.0`, this can be useful for making the application available for other devices on the network. The default hostname can be changed with `-H`, like so:"
		},
		{
			"heading": "production",
		...
		{
			"heading": "lint",
			"content": "`next lint` runs ESLint for all files in the `pages/`, `app/`, `components/`, `lib/`, and `src/` directories. It also\nprovides a guided setup to install any required dependencies if ESLint is not already configured in\nyour application."
		},
		{
			"heading": "lint",
			"content": "If you have other directories that you would like to lint, you can specify them using the `--dir`\nflag:"
		},
		{
			"heading": "telemetry",
			"content": "Next.js collects **completely anonymous** telemetry data about general usage.\nParticipation in this anonymous program is optional, and you may opt-out if you'd not like to share any information."
		},
		{
			"heading": "telemetry",
			"content": "To learn more about Telemetry, please read this document."
		},
		{
			"heading": "next-info",
			"content": "`next info` prints relevant details about the current system which can be used to report Next.js bugs.\nThis information includes Operating System platform/arch/version, Binaries (Node.js, npm, Yarn, pnpm) and npm package versions (`next`, `react`, `react-dom`)."
		},
		{
			"heading": "next-info",
			"content": "Running the following in your project's root directory:"
		},
		{
			"heading": "next-info",
			"content": "will give you information like this example:"
		},
		{
			"heading": "next-info",
			"content": "This information should then be pasted into GitHub Issues."
		},
		{
			"heading": "next-info",
			"content": "In order to diagnose installation issues, you can run `next info --verbose` to print additional information about system and the installation of next-related packages."
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 2,
		url: "#build",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Build" })
	},
	{
		depth: 2,
		url: "#development",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Development" })
	},
	{
		depth: 2,
		url: "#production",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Production" })
	},
	{
		depth: 3,
		url: "#keep-alive-timeout",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Keep Alive Timeout" })
	},
	{
		depth: 2,
		url: "#lint",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Lint" })
	},
	{
		depth: 2,
		url: "#telemetry",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Telemetry" })
	},
	{
		depth: 2,
		url: "#next-info",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Next Info" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The Next.js CLI allows you to start, build, and export your application." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "To get a list of the available CLI commands, run the following command inside your project directory:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: (0, import_jsx_runtime.jsxs)(_components.em, { children: [
			"(",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }), " creates an optimized production build of your application. The output displays information about each route."] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Size" }), " – The number of assets downloaded when navigating to the page client-side. The size for each route only includes its dependencies."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "First Load JS" }), " – The number of assets downloaded when visiting the page from the server. The amount of JS shared by all is shown as a separate metric."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Both of these values are ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "compressed with gzip" }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "With this flag enabled additional build output like rewrites, redirects, and headers will be shown." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "development",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }), " starts the application in development mode with hot-code reloading, error reporting, and more:"] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "0.0.0.0" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "please read this document"
			}),
			"."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Running the following in your project's root directory:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "will give you information like this example:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: " #22-Ubuntu SMP Fri Nov 5 13:21:36 UTC 2021"
					})]
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This information should then be pasted into GitHub Issues." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In order to diagnose installation issues, you can run ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next info --verbose" }),
...
//#endregion
export { toc as a, structuredData as i, _08_next_cli_exports as n, frontmatter as r, MDXContent as t };
