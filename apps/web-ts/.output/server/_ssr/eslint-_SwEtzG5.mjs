...
//#region node_modules/.nitro/vite/services/ssr/assets/eslint-_SwEtzG5.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var eslint_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "When ESLint is detected in your project, Next.js fails your **production build** (`next build`) when errors are present."
		},
		{
			"heading": void 0,
			"content": "If you'd like Next.js to produce production code even when your application has ESLint errors, you can disable the built-in linting step completely. This is not recommended unless you already have ESLint configured to run in a separate part of your workflow (for example, in CI or a pre-commit hook)."
		},
		{
			"heading": void 0,
			"content": "Open `next.config.js` and enable the `ignoreDuringBuilds` option in the `eslint` config:"
		}
	],
	"headings": []
};
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If you'd like Next.js to produce production code even when your application has ESLint errors, you can disable the built-in linting step completely. This is not recommended unless you already have ESLint configured to run in a separate part of your workflow (for example, in CI or a pre-commit hook)." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Open ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" }),
			" and enable the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "ignoreDuringBuilds" }),
			" option in the ",
...
//#endregion
export { toc as a, structuredData as i, eslint_exports as n, frontmatter as r, MDXContent as t };
