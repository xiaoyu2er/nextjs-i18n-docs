...
//#region node_modules/.nitro/vite/services/ssr/assets/json-ld-DLINYewh.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "JSON-LD is a format for structured data that can be used by search engines and AI to to help them understand the structure of the page beyond pure content. For example, you can use it to describe a person, an event, an organization, a movie, a book, a recipe, and many other types of entities."
		},
		{
			"heading": void 0,
