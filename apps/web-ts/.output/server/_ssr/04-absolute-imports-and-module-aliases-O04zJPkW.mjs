...
//#region node_modules/.nitro/vite/services/ssr/assets/04-absolute-imports-and-module-aliases-O04zJPkW.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _04_absolute_imports_and_module_aliases_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "These options allow you to alias project directories to absolute paths, making it easier to import modules. For example:"
		},
		{
			"heading": void 0,
			"content": "> **Good to know**: `create-next-app` will prompt to configure these options for you."
		},
		{
			"heading": "absolute-imports",
			"content": "The `baseUrl` configuration option allows you to import directly from the root of the project."
		},
		{
			"heading": "absolute-imports",
			"content": "An example of this configuration:"
		},
		{
			"heading": "module-aliases",
		...
		{
			"heading": "module-aliases",
			"content": "Each of the `\"paths\"` are relative to the `baseUrl` location. For example:"
		}
	],
	"headings": [{
		"id": "absolute-imports",
...
var toc = [{
	...
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Absolute Imports" })
}, {
	depth: 2,
	url: "#module-aliases",
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Module Aliases" })
}];
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vercel/next.js/tree/canary/examples/with-absolute-imports",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "These options allow you to alias project directories to absolute paths, making it easier to import modules. For example:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "An example of this configuration:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "components/button.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						...
						children: "components/button.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "components/button.js",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// tsconfig.json or jsconfig.json"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, _04_absolute_imports_and_module_aliases_exports as n, frontmatter as r, MDXContent as t };
