...
//#region node_modules/.nitro/vite/services/ssr/assets/fetch-zBF6Pa3Q.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Next.js extends the native Web `fetch()` API to allow each request on the server to set its own persistent caching semantics."
		},
		{
			"heading": void 0,
			"content": "In the browser, the `cache` option indicates how a fetch request will interact with the *browser's* HTTP cache. With this extension, `cache` indicates how a *server-side* fetch request will interact with the framework's persistent HTTP cache."
		},
		{
			"heading": void 0,
		...
		{
			"heading": "optionscache",
			"content": "**`force-cache`** (default) - Next.js looks for a matching request in its Data Cache."
		},
		{
			"heading": "optionscache",
		...
		{
			"heading": "optionscache",
			"content": "**`no-store`** - Next.js fetches the resource from the remote server on every request without looking in the cache, and it will not update the cache with the downloaded resource."
		},
		{
			"heading": "optionscache",
		...
		},
		{
			...
			"content": "Set the cache lifetime of a resource (in seconds)."
		},
		{
			"heading": "optionsnextrevalidate",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "no-store" }) }), " - Next.js fetches the resource from the remote server on every request without looking in the cache, and it will not update the cache with the downloaded resource."] }),
			"\n"
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Set the cache lifetime of a resource (in seconds)." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "{ revalidate: 0, cache: 'force-cache' }" }),
					" or ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "{ revalidate: 10, cache: 'no-store' }" }),
					" will cause an error."
				] }),
				"\n"
			] }),
