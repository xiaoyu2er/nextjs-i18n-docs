...
//#region node_modules/.nitro/vite/services/ssr/assets/partial-prerendering-C2OD3qWq.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var partial_prerendering_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> **Warning**: Partial Prerendering is an experimental feature and is currently **not suitable for production environments**."
		},
		{
			"heading": void 0,
			"content": "Partial Prerendering is an experimental feature that allows static portions of a route to be prerendered and served from the cache with dynamic holes streamed in, all in a single HTTP request."
		},
		{
			"heading": void 0,
			"content": "Partial Prerendering is available in `next@canary`:"
		},
		{
			"heading": void 0,
			"content": "You can enable Partial Prerendering by setting the experimental `ppr` flag:"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Learn more about Partial Prerendering in the Next.js Learn course."
		}
	],
	"headings": []
};
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "not suitable for production environments" }),
				"."
			] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Partial Prerendering is an experimental feature that allows static portions of a route to be prerendered and served from the cache with dynamic holes streamed in, all in a single HTTP request." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "Partial Prerendering does not yet apply to client-side navigations. We are actively working on this." }),
				"\n",
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, partial_prerendering_exports as r, MDXContent as t };
