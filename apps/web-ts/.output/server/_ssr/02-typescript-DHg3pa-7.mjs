...
//#region node_modules/.nitro/vite/services/ssr/assets/02-typescript-DHg3pa-7.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "route-aware-type-helpers",
			"content": "Next.js generates global helpers for App Router route types. These are available without imports and are generated during `next dev`, `next build`, or via `next typegen`:"
		},
		{
			"heading": "route-aware-type-helpers",
			"content": "`PageProps`"
		...
		{
			"heading": "statically-typed-links",
			"content": "Works in both the Pages and App Router for the `href` prop in `next/link`. In the App Router, it also types `next/navigation` methods like `push`, `replace`, and `prefetch`. It does not type `next/router` methods in Pages Router."
		},
		{
			"heading": "statically-typed-links",
			"content": "Literal `href` strings are validated, while non-literal `href`s may require a cast with `as Route`."
		},
		{
			"heading": "statically-typed-links",
			"content": "To opt-into this feature, `typedRoutes` need to be enabled and the project needs to be using TypeScript."
		},
		{
			"heading": "statically-typed-links",
		...
		{
			"heading": "statically-typed-links",
			"content": "> **Good to know**: If you set up your project without `create-next-app`, ensure the generated Next.js types are included by adding `.next/types/**/*.ts` to the `include` array in your `tsconfig.json`:"
		},
		{
			"heading": "statically-typed-links",
			"content": "Currently, support includes any string literal, including dynamic segments. For non-literal strings, you need to manually cast with `as Route`. The example below shows both `next/link` and `next/navigation` usage:"
		},
		{
			"heading": "statically-typed-links",
			"content": "The same applies for redirecting routes defined by middleware:"
		},
		{
			"heading": "statically-typed-links",
		...
		{
			"heading": "statically-typed-links",
			"content": "You can also type a simple data structure and iterate to render links:"
		},
		{
			"heading": "statically-typed-links",
			"content": "Then, map over the items to render `Link`s:"
		},
		{
			"heading": "statically-typed-links",
		...
		{
			"heading": "type-intellisense-for-environment-variables",
			"content": "During development, Next.js generates a `.d.ts` file in `.next/types` that contains information about the loaded environment variables for your editor's IntelliSense. If the same environment variable key is defined in multiple files, it is deduplicated according to the Environment Variable Load Order."
		},
		{
			"heading": "type-intellisense-for-environment-variables",
			"content": "To opt-into this feature, `experimental.typedEnv` needs to be enabled and the project needs to be using TypeScript."
		},
		{
			"heading": "type-intellisense-for-environment-variables",
			"content": "> **Good to know**: Types are generated based on the environment variables loaded at development runtime, which excludes variables from `.env.production*` files by default. To include production-specific variables, run `next dev` with `NODE_ENV=production`."
		},
		{
		...
		{
			"heading": "custom-tsconfig-path",
			"content": "In some cases, you might want to use a different TypeScript configuration for builds or tooling. To do that, set `typescript.tsconfigPath` in `next.config.ts` to point Next.js to another `tsconfig` file."
		},
		{
			"heading": "custom-tsconfig-path",
			"content": "For example, switch to a different config for production builds:"
		},
		{
			"heading": "custom-tsconfig-path",
			"content": "You might need to relax checks in scenarios like monorepos, where the build also validates shared dependencies that don't match your project's standards, or when loosening checks in CI to continue delivering while migrating locally to stricter TypeScript settings (and still wanting your IDE to highlight misuse)."
		},
		{
			"heading": "custom-tsconfig-path",
			"content": "For example, if your project uses `useUnknownInCatchVariables` but some monorepo dependencies still assume `any`:"
		},
		{
			"heading": "custom-tsconfig-path",
			"content": "This keeps your editor strict via `tsconfig.json` while allowing the production build to use relaxed settings."
		},
		{
			"heading": "custom-tsconfig-path",
...
var toc = [
	...
	{
		depth: 2,
		url: "#route-aware-type-helpers",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Route-Aware Type Helpers" })
	},
	{
		depth: 2,
		url: "#examples",
	...
	{
		depth: 3,
		url: "#type-intellisense-for-environment-variables",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Type IntelliSense for Environment Variables" })
	},
	{
		depth: 3,
	...
	{
		depth: 3,
		url: "#custom-tsconfig-path",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			"Custom ",
			(0, import_jsx_runtime.jsx)("code", { children: "tsconfig" }),
			" path"
		] })
	},
	{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.h2, {
				id: "route-aware-type-helpers",
				children: "Route-Aware Type Helpers"
			}),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"Next.js generates global helpers for App Router route types. These are available without imports and are generated during ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }),
				", ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }),
				", or via ",
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "PageProps" })
				}) }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/file-conventions/layout#layout-props-helper",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "LayoutProps" })
				}) }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Works in both the Pages and App Router for the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "href" }),
			" prop in ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next/link" }),
			". In the App Router, it also types ",
			...
			" methods in Pages Router."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Literal ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "href" }),
			" strings are validated, while non-literal ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "href" }),
			"s may require a cast with ",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }),
				": If you set up your project without ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "create-next-app" }),
				", ensure the generated Next.js types are included by adding ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: ".next/types/**/*.ts" }),
				" to the ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Currently, support includes any string literal, including dynamic segments. For non-literal strings, you need to manually cast with ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "as Route" }),
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "/* Link: literal and dynamic */"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "/* TypeScript error if href is not a valid route */"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "/* Router: literal and dynamic strings are validated */"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "/* For non-literal strings, cast to Route */"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "        Push Non-literal Blog"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The same applies for redirecting routes defined by middleware:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can also type a simple data structure and iterate to render links:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Then, map over the items to render ",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "type-intellisense-for-environment-variables",
			children: "Type IntelliSense for Environment Variables"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"During development, Next.js generates a ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: ".d.ts" }),
			" file in ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: ".next/types" }),
			" that contains information about the loaded environment variables for your editor's IntelliSense. If the same environment variable key is defined in multiple files, it is deduplicated according to the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/guides/environment-variables#environment-variable-load-order",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To opt-into this feature, ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "experimental.typedEnv" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }),
				": Types are generated based on the environment variables loaded at development runtime, which excludes variables from ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: ".env.production*" }),
				" files by default. To include production-specific variables, run ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }),
				" with ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "NODE_ENV=production" }),
				"."
			] }),
			"\n"
		] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			...
			children: [
				"Custom ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig" }),
				" path"
			]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In some cases, you might want to use a different TypeScript configuration for builds or tooling. To do that, set ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "typescript.tsconfigPath" }),
			" in ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.ts" }),
			" to point Next.js to another ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig" }),
			" file."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For example, switch to a different config for production builds:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)("details", { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "You might need to relax checks in scenarios like monorepos, where the build also validates shared dependencies that don't match your project's standards, or when loosening checks in CI to continue delivering while migrating locally to stricter TypeScript settings (and still wanting your IDE to highlight misuse)." }),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"For example, if your project uses ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "useUnknownInCatchVariables" }),
				" but some monorepo dependencies still assume ",
					...
					(0, import_jsx_runtime.jsxs)(_components.span, {
						...
						children: [
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: "    \"useUnknownInCatchVariables\""
							}),
							(0, import_jsx_runtime.jsx)(_components.span, {
								style: {
									"--shiki-light": "#24292E",
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"This keeps your editor strict via ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig.json" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					"IDEs typically read ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig.json" }),
					" for diagnostics and IntelliSense, so you can still see IDE warnings while production builds use the alternate config. Mirror critical options if you want parity in the editor."
				] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					"In development, only ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig.json" }),
					" is watched for changes. If you edit a different file name via ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "typescript.tsconfigPath" }),
					", restart the dev server to apply changes."
				] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					"The configured file is used in ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }),
					", ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }),
					", ",
