...
//#region node_modules/.nitro/vite/services/ssr/assets/permanentRedirect-z8KHllbN.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "When used in a streaming context, this will insert a meta tag to emit the redirect on the client side. Otherwise, it will serve a 308 (Permanent) HTTP redirect response to the caller."
		},
		{
			"heading": void 0,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "When used in a streaming context, this will insert a meta tag to emit the redirect on the client side. Otherwise, it will serve a 308 (Permanent) HTTP redirect response to the caller." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
