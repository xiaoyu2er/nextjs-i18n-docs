...
//#region node_modules/.nitro/vite/services/ssr/assets/dynamicIO-mkztFEDu.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var dynamicIO_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `dynamicIO` flag is an experimental feature in Next.js that causes data fetching operations in the App Router to be excluded from pre-renders unless they are explicitly cached. This can be useful for optimizing the performance of dynamic data fetching in Server Components."
		},
		{
			"heading": void 0,
		...
		{
			"heading": "usage",
			"content": "To enable the `dynamicIO` flag, set it to `true` in the `experimental` section of your `next.config.ts` file:"
		},
		{
			"heading": "usage",
			"content": "When `dynamicIO` is enabled, you can use the following cache functions and configurations:"
		},
		{
			"heading": "usage",
		...
		{
			"heading": "notes",
			"content": "While `dynamicIO` can optimize performance by ensuring fresh data fetching during runtime, it may also introduce additional latency compared to serving pre-rendered content."
		}
	],
	"headings": [{
		"id": "usage",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "dynamicIO" }),
...
//#endregion
export { toc as a, structuredData as i, dynamicIO_exports as n, frontmatter as r, MDXContent as t };
