...
//#region node_modules/.nitro/vite/services/ssr/assets/09-intercepting-routes-6Pp2pX49.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _09_intercepting_routes_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "modals",
			"content": "Intercepting Routes can be used together with Parallel Routes to create modals."
		},
		{
			"heading": "modals",
			"content": "Using this pattern to create modals overcomes some common challenges when working with modals, by allowing you to:"
		},
		{
			"heading": "modals",
			"content": "Make the modal content **shareable through a URL**"
		},
		{
			"heading": "modals",
			"content": "**Preserve context** when the page is refreshed, instead of closing the modal"
		},
		{
			"heading": "modals",
			"content": "**Close the modal on backwards navigation** rather than going to the previous route"
		},
		{
			"heading": "modals",
			"content": "**Reopen the modal on forwards navigation**"
		},
		{
			"heading": "modals",
		...
		{
			"heading": "modals",
			"content": "Other examples could include opening a login modal in a top navbar while also having a dedicated `/login` page, or opening a shopping cart in a side modal."
		},
		{
			"heading": "modals",
			"content": "View an example of modals with Intercepted and Parallel Routes."
		},
		{
			"heading": "next-steps",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Using this pattern to create modals overcomes some common challenges when working with modals, by allowing you to:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Make the modal content ", (0, import_jsx_runtime.jsx)(_components.strong, { children: "shareable through a URL" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Preserve context" }), " when the page is refreshed, instead of closing the modal"] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Close the modal on backwards navigation" }), " rather than going to the previous route"] }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.strong, { children: "Reopen the modal on forwards navigation" }) }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(Image, {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				" and not a ",
				(0, import_jsx_runtime.jsx)(_components.em, { children: "segment" }),
				". This means that the ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "photo" }),
				" route is only one ",
				(0, import_jsx_runtime.jsx)(_components.em, { children: "segment" }),
				" level higher, despite being two ",
				(0, import_jsx_runtime.jsx)(_components.em, { children: "file-system" }),
				" levels higher."
			] }),
			"\n"
		] }),
...
//#endregion
export { toc as a, structuredData as i, _09_intercepting_routes_exports as n, frontmatter as r, MDXContent as t };
