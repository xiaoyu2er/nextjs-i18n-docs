...
//#region node_modules/.nitro/vite/services/ssr/assets/vitest--AIEFtz_.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var vitest_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "> **Good to know:** Since `async` Server Components are new to the React ecosystem, Vitest currently does not support them. While you can still run **unit tests** for synchronous Server and Client Components, we recommend using **E2E tests** for `async` components."
		},
		{
			"heading": "quickstart",
		...
		{
			"heading": "manual-setup",
			"content": "Create a `vitest.config.mts|js` file in the root of your project, and add the following options:"
		},
		{
			"heading": "manual-setup",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Vitest and React Testing Library are frequently used together for ",
...
//#endregion
export { vitest_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
