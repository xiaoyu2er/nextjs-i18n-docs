...
//#region node_modules/.nitro/vite/services/ssr/assets/05-static-assets-Cb1Y8yp2.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _05_static_assets_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "For example, if you add `me.png` inside `public`, the following code will access the image:"
		},
		{
			"heading": void 0,
			"content": "This folder is also useful for `robots.txt`, `favicon.ico`, Google Site Verification, and any other static files (including `.html`). But make sure to not have a static file with the same name as a file in the `pages/` directory, as this will result in an error. Read more."
		},
		{
			"heading": void 0,
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					" directory at ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/app/api-reference/next-cli#build",
						children: "build time"
					}),
...
//#endregion
export { toc as a, structuredData as i, _05_static_assets_exports as n, frontmatter as r, MDXContent as t };
