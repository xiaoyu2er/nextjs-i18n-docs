...
//#region node_modules/.nitro/vite/services/ssr/assets/bundlePagesRouterDependencies-DwBLCd_R.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var bundlePagesRouterDependencies_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Enable automatic server-side dependency bundling for Pages Router applications. Matches the automatic dependency bundling in App Router."
		},
		{
			"heading": void 0,
			"content": "Explicitly opt-out certain packages from being bundled using the `serverExternalPackages` option."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "Moved from experimental to stable. Renamed from `bundlePagesExternals` to `bundlePagesRouterDependencies`"
		}
	],
	"headings": [{
		"id": "version-history",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Enable automatic server-side dependency bundling for Pages Router applications. Matches the automatic dependency bundling in App Router." }),
		"\n",
...
//#endregion
export { toc as a, structuredData as i, bundlePagesRouterDependencies_exports as n, frontmatter as r, MDXContent as t };
