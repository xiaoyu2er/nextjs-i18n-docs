...
//#region node_modules/.nitro/vite/services/ssr/assets/incrementalCacheHandlerPath-DDUfXjDC.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "In Next.js, the default cache handler uses the filesystem cache. This requires no configuration, however, you can customize the cache handler by using the `incrementalCacheHandlerPath` field in `next.config.js`."
		},
		{
			"heading": void 0,
			"content": "Here's an example of a custom cache handler:"
		},
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    incrementalCacheHandlerPath: require."
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#6F42C1",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Here's an example of a custom cache handler:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
