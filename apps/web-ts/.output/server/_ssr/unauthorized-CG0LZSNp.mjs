...
//#region node_modules/.nitro/vite/services/ssr/assets/unauthorized-CG0LZSNp.js
...
var frontmatter = {
	...
	"related": { "links": ["app/api-reference/file-conventions/unauthorized"] }
};
var structuredData = {
	"contents": [
		{
		...
		{
			"heading": void 0,
			"content": "To start using `unauthorized`, enable the experimental `authInterrupts` configuration option in your `next.config.js` file:"
		},
		{
			"heading": void 0,
			"content": "`unauthorized` can be invoked in Server Components, Server Actions, and Route Handlers."
		},
		{
			"heading": "good-to-know",
			"content": "The `unauthorized` function cannot be called in the root layout."
		},
		{
			"heading": "displaying-login-ui-to-unauthenticated-users",
			"content": "You can use `unauthorized` function to display the `unauthorized.js` file with a login UI."
		},
		{
			"heading": "mutations-with-server-actions",
			"content": "You can invoke `unauthorized` in Server Actions to ensure only authenticated users can perform specific mutations."
		},
		{
			"heading": "fetching-data-with-route-handlers",
			"content": "You can use `unauthorized` in Route Handlers to ensure only authenticated users can access the endpoint."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`unauthorized` introduced."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#displaying-login-ui-to-unauthenticated-users",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Displaying login UI to unauthenticated users" })
	},
	{
		depth: 3,
	...
	{
		depth: 3,
		url: "#fetching-data-with-route-handlers",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Fetching data with Route Handlers" })
	},
	{
		depth: 2,
		url: "#version-history",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "unauthorized.js" }), " file"]
			}),
			"."
		] }),
		"\n",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Render the dashboard for authenticated users"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "displaying-login-ui-to-unauthenticated-users",
			children: "Displaying login UI to unauthenticated users"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can use ",
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "unauthorized.js" }),
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			...
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					...
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/unauthorized.tsx",
						children: "app/unauthorized.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/unauthorized.js",
						children: "app/unauthorized.js"
					})
				] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/dashboard/page.tsx",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/actions/update-profile.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/actions/update-profile.ts",
					children: "app/actions/update-profile.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/actions/update-profile.js",
					children: "app/actions/update-profile.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/actions/update-profile.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // If the user is not authenticated, return a 401"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Proceed with mutation"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "fetching-data-with-route-handlers",
			children: "Fetching data with Route Handlers"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can use ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/api/profile/route.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/api/profile/route.ts",
					children: "app/api/profile/route.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/api/profile/route.js",
					children: "app/api/profile/route.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/api/profile/route.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Verify the user's session"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // If no session exists, return a 401 and render unauthorized.tsx"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // If the user is not authenticated, return a 401 and render unauthorized.tsx"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { unauthorized_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
