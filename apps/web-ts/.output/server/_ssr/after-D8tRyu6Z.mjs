...
//#region node_modules/.nitro/vite/services/ssr/assets/after-D8tRyu6Z.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var after_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "It can be used in Server Components (including `generateMetadata`), Server Actions, Route Handlers, and Middleware."
		},
		{
			"heading": void 0,
			"content": "The function accepts a callback that will be executed after the response (or prerender) is finished:"
		},
		{
			"heading": void 0,
			"content": "> **Good to know:** `after` is not a Dynamic API and calling it does not cause a route to become dynamic. If it's used within a static page, the callback will execute at build time, or whenever a page is revalidated."
		},
		{
			"heading": "parameters",
			"content": "A callback function which will be executed after the response (or prerender) is finished."
		},
		{
			"heading": "duration",
			"content": "`after` will run for the platform's default or configured max duration of your route. If your platform supports it, you can configure the timeout limit using the `maxDuration` route segment config."
		},
		{
			"heading": "good-to-know",
			"content": "`after` will be executed even if the response didn't complete successfully. Including when an error is thrown or when `notFound` or `redirect` is called."
		},
		{
			"heading": "good-to-know",
			"content": "You can use React `cache` to deduplicate functions called inside `after`."
		},
		{
			"heading": "good-to-know",
			"content": "`after` can be nested inside other `after` calls, for example, you can create utility functions that wrap `after` calls to add additional functionality."
		},
		{
			"heading": "with-request-apis",
			"content": "You can use request APIs such as `cookies` and `headers` inside `after` in Server Actions and Route Handlers. This is useful for logging activity after a mutation. For example:"
		},
		{
			"heading": "with-request-apis",
			"content": "However, you cannot use these request APIs inside `after` in Server Components. This is because Next.js needs to know which part of the tree access the request APIs to support Partial Prerendering, but `after` runs after React's rendering lifecycle."
		},
		{
		...
		{
			"heading": "platform-support",
			"content": "Learn how to configure `after` when self-hosting Next.js."
		},
		{
			"heading": "platform-support",
			"content": "Using `after` in a serverless context requires waiting for asynchronous tasks to finish after the response has been sent. In Next.js and Vercel, this is achieved using a primitive called `waitUntil(promise)`, which extends the lifetime of a serverless invocation until all promises passed to `waitUntil` have settled."
		},
		{
			"heading": "platform-support",
		...
		{
			"heading": "platform-support",
			"content": "When `after` is called, Next.js will access `waitUntil` like this:"
		},
		{
			"heading": "platform-support",
			"content": "Which means that `globalThis[Symbol.for('@next/request-context')]` is expected to contain an object like this:"
		},
		{
			"heading": "platform-support",
			"content": "Here is an example of the implementation."
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`unstable_after` introduced."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#with-request-apis",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "With request APIs" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The function accepts a callback that will be executed after the response (or prerender) is finished:" }),
		"\n",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// Custom logging function"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "    // Execute after the layout is rendered and sent to the user"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "A callback function which will be executed after the response (or prerender) is finished." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/file-conventions/route-segment-config#maxduration",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Log user activity for analytics"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [(0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "({ sessionCookie, userAgent })"
								})]
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/guides/self-hosting#after",
				children: ["configure ", (0, import_jsx_runtime.jsx)(_components.code, { children: "after" })]
			}),
		...
		(0, import_jsx_runtime.jsxs)("details", {
			id: "after-serverless",
			children: [
				(0, import_jsx_runtime.jsxs)("summary", { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "waitUntil(promise)" }),
					", which extends the lifetime of a serverless invocation until all promises passed to ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://vercel.com/docs/functions/functions-api-reference#waituntil",
						...
						(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							children: [
								...
								(0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: " contextValue?.waitUntil"
								})
							]
						})
					] })
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [
					"Which means that ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "globalThis[Symbol.for('@next/request-context')]" }),
						...
						(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							children: [
								...
								(0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: " NextRequestContextValue"
								}),
								(0, import_jsx_runtime.jsx)(_components.span, {
									style: {
										"--shiki-light": "#D73A49",
				...
				(0, import_jsx_runtime.jsx)(_components.p, { children: "Here is an example of the implementation." }),
				(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
					className: "shiki shiki-themes github-light github-dark",
					style: {
						"--shiki-light": "#24292e",
					...
					children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
						...
						(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							children: [
								...
								(0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: " RequestContextStorage"
								}),
								(0, import_jsx_runtime.jsx)(_components.span, {
									style: {
										"--shiki-light": "#D73A49",
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: (0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: "// Define and inject the accessor that next.js will use"
							})
						}),
						"\n",
						(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, after_exports as n, frontmatter as r, MDXContent as t };
