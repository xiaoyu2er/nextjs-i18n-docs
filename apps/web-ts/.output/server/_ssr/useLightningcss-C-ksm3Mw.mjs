...
//#region node_modules/.nitro/vite/services/ssr/assets/useLightningcss-C-ksm3Mw.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var useLightningcss_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [{
		"heading": void 0,
		"content": "Experimental support for using Lightning CSS, a fast CSS bundler and minifier, written in Rust."
	}],
	"headings": []
};
var toc = [];
...
//#endregion
export { useLightningcss_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
