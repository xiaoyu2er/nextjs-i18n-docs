...
//#region node_modules/.nitro/vite/services/ssr/assets/03-rendering-BGteu00v.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "network-boundary",
			"content": "You can use the React `\"use client\"` convention to define the boundary. There's also a `\"use server\"` convention, which tells React to do some computational work on the server while on the client."
		},
		{
