...
//#region node_modules/.nitro/vite/services/ssr/assets/use-search-params-7_qiEfpl.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "If a route is statically rendered, calling `useSearchParams()` will cause the tree up to the closest `Suspense` boundary to be client-side rendered."
		},
		{
			"heading": "static-rendering",
			"content": "This allows a part of the page to be statically rendered while the dynamic part that uses `searchParams` is client-side rendered."
		},
		{
			"heading": "static-rendering",
			"content": "You can reduce the portion of the route that is client-side rendered by wrapping the component that uses `useSearchParams` in a `Suspense` boundary. For example:"
		},
		{
