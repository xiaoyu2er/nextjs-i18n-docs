...
//#region node_modules/.nitro/vite/services/ssr/assets/staleTimes-D1oK2qKf.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "> **Warning**: The `staleTimes` configuration is an experimental feature. This configuration strategy will likely change in the future."
		},
		{
			"heading": void 0,
			"content": "`staleTimes` is an experimental feature that allows configuring the invalidation period of the client router cache."
		},
		{
			"heading": void 0,
			"content": "This configuration option is available as of v14.2.0-canary.53."
		},
		{
			"heading": void 0,
			"content": "You can enable this experimental feature & provide custom revalidation times by setting the experimental `staleTimes` flag:"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "The `dynamic` property is used when the page is neither statically generated nor fully prefetched (i.e., with prefetch={true})."
		},
		{
			"heading": void 0,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "staleTimes" }),
			" is an experimental feature that allows configuring the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/building-your-application/caching#duration-3",
				children: "invalidation period"
			}),
			" of the client router cache."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This configuration option is available as of v14.2.0-canary.53." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can enable this experimental feature & provide custom revalidation times by setting the experimental ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "staleTimes" }),
			" flag:"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"The ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "dynamic" }),
				" property is used when the page is neither statically generated nor fully prefetched (i.e., with prefetch=",
				true,
				").",
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				", or when calling ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/caching#routerprefetch",
