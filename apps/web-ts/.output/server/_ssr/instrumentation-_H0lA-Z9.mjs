...
//#region node_modules/.nitro/vite/services/ssr/assets/instrumentation-_H0lA-Z9.js
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["app/api-reference/file-conventions/instrumentation"]
	}
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Instrumentation is the process of using code to integrate monitoring and logging tools into your application. This allows you to track the performance and behavior of your application, and to debug issues in production."
		},
		{
			"heading": "convention",
			"content": "To set up instrumentation, create `instrumentation.ts|js` file in the **root directory** of your project (or inside the `src` folder if using one)."
		},
		{
			"heading": "convention",
			"content": "Then, export a `register` function in the file. This function will be called **once** when a new Next.js server instance is initiated."
		},
		{
			"heading": "convention",
			"content": "For example, to use Next.js with OpenTelemetry and @vercel/otel:"
		},
		{
			"heading": "convention",
			"content": "See the Next.js with OpenTelemetry example for a complete implementation."
		},
		{
			"heading": "convention",
		...
		{
			"heading": "importing-files-with-side-effects",
			"content": "Sometimes, it may be useful to import a file in your code because of the side effects it will cause. For example, you might import a file that defines a set of global variables, but never explicitly use the imported file in your code. You would still have access to the global variables the package has declared."
		},
		{
			"heading": "importing-files-with-side-effects",
			"content": "We recommend importing files using JavaScript `import` syntax within your `register` function. The following example demonstrates a basic usage of `import` in a `register` function:"
		},
		{
			"heading": "importing-files-with-side-effects",
		...
		{
			"heading": "importing-runtime-specific-code",
			"content": "Next.js calls `register` in all environments, so it's important to conditionally import any code that doesn't support specific runtimes (e.g. Edge or Node.js). You can use the `NEXT_RUNTIME` environment variable to get the current environment:"
		}
	],
	"headings": [
		{
		...
		{
			"id": "importing-files-with-side-effects",
			"content": "Importing files with side effects"
		},
		{
			"id": "importing-runtime-specific-code",
...
var toc = [
	...
	{
		depth: 3,
		url: "#importing-files-with-side-effects",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Importing files with side effects" })
	},
	{
		depth: 3,
		url: "#importing-runtime-specific-code",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Importing runtime-specific code" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Instrumentation is the process of using code to integrate monitoring and logging tools into your application. This allows you to track the performance and behavior of your application, and to debug issues in production." }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "instrumentation.ts|js" }),
			" file in the ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" and ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/docs/observability/otel-overview",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "Next.js with OpenTelemetry example"
			}),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "importing-files-with-side-effects",
			children: "Importing files with side effects"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Sometimes, it may be useful to import a file in your code because of the side effects it will cause. For example, you might import a file that defines a set of global variables, but never explicitly use the imported file in your code. You would still have access to the global variables the package has declared." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "'package-with-side-effect'"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "importing-runtime-specific-code",
			children: "Importing runtime-specific code"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Next.js calls ",
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "Edge or Node.js"
			}),
			"). You can use the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "NEXT_RUNTIME" }),
