...
//#region node_modules/.nitro/vite/services/ssr/assets/08-turbopack-CwdKdQSW.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "getting-started",
			"content": "Currently, Turbopack for `dev` is stable, while `build` is in beta. We are actively working on production support as Turbopack moves closer to stability."
		},
		{
		...
		{
			"heading": "known-gaps-with-webpack",
			"content": "There are a number of non-trivial behavior differences between webpack and Turbopack that are important to be aware of when migrating an application. Generally, these are less of a concern for new applications."
		},
		{
			"heading": "css-module-ordering",
			"content": "Turbopack will follow JS import order to order CSS modules which are not otherwise ordered. For example:"
		},
		{
			"heading": "css-module-ordering",
			"content": "In this example, Turbopack will ensure that `utils.module.css` will appear before `button.module.css` in the produced CSS chunk, following the import order"
		},
		{
			"heading": "css-module-ordering",
			"content": "Webpack generally does this as well, but there are cases where it will ignore JS inferred ordering, for example if it infers the JS file is side-effect-free."
		},
		{
			"heading": "css-module-ordering",
			"content": "This can lead to subtle rendering changes when adopting Turbopack, if applications have come to rely on an arbitrary ordering. Generally, the solution is easy, e.g. have `button.module.css` `@import utils.module.css` to force the ordering, or identify the conflicting rules and change them to not target the same properties."
		},
		{
			"heading": "bundle-sizes",
			"content": "Turbopack does not yet have an equivalent to the Inner Graph Optimization in webpack. This optimization is useful to tree shake large modules. For example:"
		},
		{
			"heading": "bundle-sizes",
			"content": "If an application only uses `CONSTANT_VALUE` Turbopack will detect this and delete the `usesHeavy` export but not the corresponding `import`. However, with the `optimization.innerGraph = true` option enabled, webpack can delete the `import` too."
		},
		{
			"heading": "bundle-sizes",
			"content": "We are planning to offer an equivalent to the `innerGraph` optimization in Turbopack but it is still under development. If you are affected by this gap, consider manually splitting these modules."
		},
		{
			"heading": "build-caching",
			"content": "Webpack supports disk build caching to speed up builds. We are planning to support an analogous feature in Turbopack but it is not ready yet. On the `next@canary` release you can experiment with our solution by enabling the `experimental.turbopackPersistentCaching` flag."
		},
		{
			"heading": "build-caching",
			"content": "> **Good to know:** For this reason, when comparing webpack and Turbopack performance, make sure to delete the `.next` folder between builds to see a fair comparison."
		},
		{
			"heading": "webpack-plugins",
			"content": "Turbopack does not support webpack plugins. This affects third-party tools that rely on webpack's plugin system for integration. We do support webpack loaders. If you depend on webpack plugins, you'll need to find Turbopack-compatible alternatives or continue using webpack until equivalent functionality is available."
		},
		{
		...
		{
			"heading": "version-changes",
			"content": "Turbopack support for `build` beta"
		},
		{
			"heading": "version-changes",
			"content": "`v15.3.0`"
...
var toc = [
	...
	{
		depth: 2,
		url: "#known-gaps-with-webpack",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Known gaps with webpack" })
	},
	{
		depth: 3,
		url: "#css-module-ordering",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "CSS Module Ordering" })
	},
	{
		depth: 3,
		url: "#bundle-sizes",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Bundle Sizes" })
	},
	{
		depth: 3,
		url: "#build-caching",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Build Caching" })
	},
	{
		depth: 3,
		url: "#webpack-plugins",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Webpack plugins" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" is stable, while ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "build" }),
			" is in beta. We are actively working on production support as Turbopack moves closer to stability."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "supported-features",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "known-gaps-with-webpack",
			children: "Known gaps with webpack"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "There are a number of non-trivial behavior differences between webpack and Turbopack that are important to be aware of when migrating an application. Generally, these are less of a concern for new applications." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "css-module-ordering",
			children: "CSS Module Ordering"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Turbopack will follow JS import order to order ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/getting-started/css#css-modules",
				children: "CSS modules"
			}),
			" which are not otherwise ordered. For example:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "{buttonStyles.primary}>Click me</"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#22863A",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "utils.module.css" }),
			" will appear before ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "button.module.css" }),
			" in the produced CSS chunk, following the import order"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Webpack generally does this as well, but there are cases where it will ignore JS inferred ordering, for example if it infers the JS file is side-effect-free." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"This can lead to subtle rendering changes when adopting Turbopack, if applications have come to rely on an arbitrary ordering. Generally, the solution is easy, e.g. have ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "button.module.css" }),
			" ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "@import utils.module.css" }),
			" to force the ordering, or identify the conflicting rules and change them to not target the same properties."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "bundle-sizes",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Turbopack does not yet have an equivalent to the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://webpack.js.org/configuration/optimization/#optimizationinnergraph",
				children: "Inner Graph Optimization"
			}),
			" in webpack. This optimization is useful to tree shake large modules. For example:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " 'some-heavy-dependency.js'"
						})
					]
				}),
				"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "CONSTANT_VALUE" }),
			" Turbopack will detect this and delete the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "usesHeavy" }),
			" export but not the corresponding ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "import" }),
			". However, with the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "optimization.innerGraph = true" }),
			" option enabled, webpack can delete the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "import" }),
			" too."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "innerGraph" }),
			" optimization in Turbopack but it is still under development. If you are affected by this gap, consider manually splitting these modules."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "build-caching",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Webpack supports ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://webpack.js.org/configuration/cache/#cache",
				children: "disk build caching"
			}),
			" to speed up builds. We are planning to support an analogous feature in Turbopack but it is not ready yet. On the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next@canary" }),
			" release you can experiment with our solution by enabling the ",
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/api-reference/config/next-config-js/turbopackPersistentCaching",
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "experimental.turbopackPersistentCaching" }), " flag"]
			}),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				" For this reason, when comparing webpack and Turbopack performance, make sure to delete the ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: ".next" }),
				" folder between builds to see a fair comparison."
			] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "webpack-plugins",
			children: "Webpack plugins"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Turbopack does not support webpack plugins. This affects third-party tools that rely on webpack's plugin system for integration. We do support ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/config/next-config-js/turbopack#configuring-webpack-loaders",
				children: "webpack loaders"
			}),
			". If you depend on webpack plugins, you'll need to find Turbopack-compatible alternatives or continue using webpack until equivalent functionality is available."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "unsupported-and-unplanned-features",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Version" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Changes" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v15.5.0" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [
				"Turbopack support for ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "build" }),
				" beta"
			] })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v15.3.0" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: ["Experimental support for ", (0, import_jsx_runtime.jsx)(_components.code, { children: "build" })] })] }),
