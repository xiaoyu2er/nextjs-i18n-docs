...
//#region node_modules/.nitro/vite/services/ssr/assets/03-data-fetching-5MJE6C6V.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_data_fetching_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Data fetching in Next.js allows you to render your content in different ways, depending on your application's use case. These include pre-rendering with **Server-side Rendering** or **Static Generation**, and updating or creating content at runtime with **Incremental Static Regeneration**."
		},
		{
			"heading": "examples",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "Incremental Static Regeneration" }),
			"."
		] }),
		"\n",
...
//#endregion
export { toc as a, structuredData as i, _03_data_fetching_exports as n, frontmatter as r, MDXContent as t };
