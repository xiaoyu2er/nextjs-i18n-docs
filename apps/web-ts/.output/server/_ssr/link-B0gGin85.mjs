...
//#region node_modules/.nitro/vite/services/ssr/assets/link-B0gGin85.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "prefetch",
			"content": "Prefetching happens when a `<Link />` component enters the user's viewport (initially or through scroll). Next.js prefetches and loads the linked route (denoted by the `href`) and its data in the background to improve the performance of client-side navigations. Prefetching is only enabled in production."
		},
		{
			"heading": "prefetch",
			"content": "**`null` (default)**: Prefetch behavior depends on whether the route is static or dynamic. For static routes, the full route will be prefetched (including all its data). For dynamic routes, the partial route down to the nearest segment with a `loading.js` boundary will be prefetched."
		},
		{
			"heading": "prefetch",
			"content": "`true`: The full route will be prefetched for both static and dynamic routes."
		},
		{
			"heading": "prefetch",
			"content": "`false`: Prefetching will never happen both on entering the viewport and on hover."
		},
		{
			"heading": "prefetch",
			"content": "Prefetching happens when a `<Link />` component enters the user's viewport (initially or through scroll). Next.js prefetches and loads the linked route (denoted by the `href`) and data in the background to improve the performance of client-side navigations. Prefetching is only enabled in production."
		},
		{
			"heading": "prefetch",
			"content": "**`true` (default)**: The full route and its data will be prefetched."
		},
		{
			"heading": "prefetch",
			"content": "`false`: Prefetching will not happen when entering the viewport, but will happen on hover. If you want to completely remove fetching on hover as well, consider using an `<a>` tag or incrementally adopting the App Router, which enables disabling prefetching on hover too."
		},
		{
		...
		{
			"heading": "middleware",
			"content": "> **Good to know**: If you're using Dynamic Routes, you'll need to adapt your `as` and `href` props. For example, if you have a Dynamic Route like `/dashboard/authed/[user]` that you want to present differently via middleware, you would write: `<Link href={{ pathname: '/dashboard/authed/[user]', query: { user: username } }} as=\"/dashboard/[user]\">Profile</Link>`."
		},
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		"\n",
		(0, import_jsx_runtime.jsx)(PagesOnly, { children: (0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "prefetch={false}" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: "Boolean or null" }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: "-" })
			] })
		] })] }) }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "<Link>" }),
			" ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "is to scroll to the top of a new route or to maintain the scroll position for backwards and forwards navigation." }),
			" When ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "false" }),
			", ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next/link" }),
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "null" }), " (default)"] }),
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/app/building-your-application/routing/loading-ui-and-streaming#instant-loading-states",
						children: (0, import_jsx_runtime.jsx)(_components.code, { children: "loading.js" })
					}),
					" boundary will be prefetched."
				] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }), ": The full route will be prefetched for both static and dynamic routes."] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "false" }), ": Prefetching will never happen both on entering the viewport and on hover."] }),
				"\n"
			] }),
			(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
				defaultValue: "app/page.tsx",
		...
		(0, import_jsx_runtime.jsxs)(PagesOnly, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }), " (default)"] }), ": The full route and its data will be prefetched."] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					(0, import_jsx_runtime.jsx)(_components.code, { children: "false" }),
		...
		(0, import_jsx_runtime.jsx)(PagesOnly, { children: (0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard/authed/[user]" }),
