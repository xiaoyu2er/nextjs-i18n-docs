...
//#region node_modules/.nitro/vite/services/ssr/assets/01-production-checklist-Ck4m6bb4.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "This page provides best practices that you can use as a reference when building your application, before going to production, and after deployment - as well as the automatic Next.js optimizations you should be aware of."
		},
		{
		...
		{
			"heading": "routing-and-rendering",
			"content": "**Composition Patterns:** Follow the recommended composition patterns for Server and Client Components, and check the placement of your `\"use client\"` boundaries to avoid unnecessarily increasing your client-side JavaScript bundle."
		},
		{
			"heading": "routing-and-rendering",
			"content": "**Dynamic Functions:** Be aware that dynamic functions like `cookies()` and the `searchParams` prop will opt the entire route into Dynamic Rendering (or your whole application if used in the Root Layout). Ensure dynamic function usage is intentional and wrap them in `<Suspense>` boundaries where appropriate."
		},
		{
			"heading": "routing-and-rendering",
		...
		{
			"heading": "ui-and-accessibility",
			"content": "**`<Image>` Component:** Optimize images by using the Image Component, which automatically optimizes images, prevents layout shift, and serves them in modern formats like WebP or AVIF."
		},
		{
			"heading": "ui-and-accessibility",
		...
		{
			"heading": "security",
			"content": "**Server Actions:** Ensure users are authorized to call Server Actions. Review the the recommended security practices."
		},
		{
			"heading": "security",
		...
		{
			"heading": "analyzing-bundles",
			"content": "Additionally, the following tools can you understand the impact of adding new dependencies to your application:"
		},
		{
			"heading": "analyzing-bundles",
			"content": "Import Cost"
		...
		},
		{
			...
			"content": "Depending on where you deploy your application, you might have access to additional tools and integrations to help you monitor and improve your application's performance."
		},
		{
			"heading": "after-deployment",
			"content": "For Vercel deployments, we recommend the following:"
		},
		{
			"heading": "after-deployment",
			"content": "**Analytics:** A built-in analytics dashboard to help you understand your application's traffic, including the number of unique visitors, page views, and more."
		},
		{
			"heading": "after-deployment",
			"content": "**Speed Insights:** Real-world performance insights based on visitor data, offering a practical view of how your website is performing in the field."
		},
		{
			"heading": "after-deployment",
			"content": "**Logging:** Runtime and Activity logs to help you debug issues and monitor your application in production. Alternatively, see the integrations page for a list of third-party tools and services."
		},
		{
			"heading": "after-deployment",
		...
		{
			"heading": "after-deployment",
			"content": "Following these recommendations will help you build a faster, more reliable, and secure application for your users."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "After deployment" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			", and ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "#after-deployment",
				children: "after deployment"
			}),
			" - as well as the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsxs)(_components.a, {
					href: "/docs/app/building-your-application/routing/linking-and-navigating#link-component",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.a, {
					href: "/docs/app/building-your-application/rendering/composition-patterns#moving-client-components-down-the-tree",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/rendering/server-components#dynamic-functions",
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/building-your-application/data-fetching/patterns#fetching-data-on-the-server",
				children: "Server Components"
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/data-fetching/patterns#parallel-and-sequential-data-fetching",
					children: "Parallel Data Fetching"
				}), ":"] }),
				" Reduce network waterfalls by fetching data in parallel, where appropriate. Also, consider ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/data-fetching/patterns#preloading-data",
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/building-your-application/data-fetching/server-actions-and-mutations#forms",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			}), ":"] }), " Optimize images by using the Image Component, which automatically optimizes images, prevents layout shift, and serves them in modern formats like WebP or AVIF."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsxs)(_components.a, {
		...
		(0, import_jsx_runtime.jsx)(AppOnly, { children: (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/building-your-application/data-fetching/server-actions-and-mutations#authentication-and-authorization",
					children: "Server Actions"
				}), ":"] }),
				" Ensure users are authorized to call Server Actions. Review the the recommended ",
				(0, import_jsx_runtime.jsx)(_components.a, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Use the ",
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/building-your-application/optimizing/bundle-analyzer",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Additionally, the following tools can you understand the impact of adding new dependencies to your application:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Depending on where you deploy your application, you might have access to additional tools and integrations to help you monitor and improve your application's performance." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For Vercel deployments, we recommend the following:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/analytics?utm_source=next-site&utm_campaign=nextjs-docs&utm_medium=docs",
				children: "Analytics"
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://vercel.com/docs/speed-insights?utm_source=next-site&utm_campaign=nextjs-docs&utm_medium=docs",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://vercel.com/docs/observability/runtime-logs?utm_source=next-site&utm_campaign=nextjs-docs&utm_medium=docs",
					children: "Logging"
				}), ":"] }),
				" Runtime and Activity logs to help you debug issues and monitor your application in production. Alternatively, see the ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://vercel.com/integrations?utm_source=next-site&utm_campaign=nextjs-docs&utm_medium=docs",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"To get a comprehensive understanding of the best practices for production deployments on Vercel, including detailed strategies for improving website performance, refer to the ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://vercel.com/docs/production-checklist?utm_source=next-site&utm_campaign=nextjs-docs&utm_medium=docs",
					children: "Vercel Production Checklist"
				}),
				"."
			] }),
			"\n"
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Following these recommendations will help you build a faster, more reliable, and secure application for your users." })
	] });
}
