...
//#region node_modules/.nitro/vite/services/ssr/assets/sassOptions-SOVhfPlY.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var sassOptions_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [{
		"heading": void 0,
		"content": "`sassOptions` allow you to configure the Sass compiler."
	}, {
		"heading": void 0,
		"content": "> **Good to know:** `sassOptions` are not typed outside of `implementation` because Next.js does not maintain the other possible properties."
	}],
	"headings": []
};
var toc = [];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "sassOptions" }), " allow you to configure the Sass compiler."] }),
		"\n",
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, sassOptions_exports as r, MDXContent as t };
