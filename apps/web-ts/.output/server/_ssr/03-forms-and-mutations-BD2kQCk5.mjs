...
//#region node_modules/.nitro/vite/services/ssr/assets/03-forms-and-mutations-BD2kQCk5.js
...
var toc = [
	...
	{
		depth: 3,
		url: "#server-only-form",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Server-only form" })
	},
	{
		depth: 2,
		url: "#form-validation",
