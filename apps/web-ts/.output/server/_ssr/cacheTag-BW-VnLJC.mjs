...
//#region node_modules/.nitro/vite/services/ssr/assets/cacheTag-BW-VnLJC.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "usage",
			"content": "To use `cacheTag`, enable the `dynamicIO` flag in your `next.config.js` file:"
		},
		{
			"heading": "usage",
			"content": "The `cacheTag` function takes a single string value, or a string array."
		},
		{
			"heading": "usage",
		...
		{
			"heading": "good-to-know",
			"content": "**Multiple Tags**: You can assign multiple tags to a single cache entry by passing an array to `cacheTag`."
		},
		{
