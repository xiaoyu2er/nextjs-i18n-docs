...
//#region node_modules/.nitro/vite/services/ssr/assets/output-DgGHabaQ.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "automatically-copying-traced-files",
			"content": "To copy these manually, you can use the `cp` command-line tool after you `next build`:"
		},
		{
			"heading": "automatically-copying-traced-files",
			"content": "To start your minimal `server.js` file locally, run the following command:"
		},
		{
			"heading": "automatically-copying-traced-files",
		...
		{
			"heading": "caveats",
			"content": "There are some cases in which Next.js might fail to include required files, or might incorrectly include unused files. In those cases, you can leverage `outputFileTracingExcludes` and `outputFileTracingIncludes` respectively in `next.config.js`. Each option accepts an object whose keys are **route globs** (matched with picomatch against the route path, e.g. `/api/hello`) and whose values are **glob patterns resolved from the project root** that specify files to include or exclude in the trace."
		},
		{
			"heading": "caveats",
			"content": "Using a `src/` directory does not change how you write these options:"
		},
		{
			"heading": "caveats",
			"content": "**Keys** still match the route path (`'/api/hello'`, `'/products/[id]'`, etc.)."
		},
		{
			"heading": "caveats",
			"content": "**Values** can reference paths under `src/` since they are resolved relative to the project root."
		},
		{
			"heading": "caveats",
			"content": "You can also target all routes using a global key like `'/*'`:"
		},
		{
			"heading": "caveats",
			"content": "These options are applied to server traces and do not affect routes that do not produce a server trace file:"
		},
		{
			"heading": "caveats",
			"content": "Edge Runtime routes are not affected."
		},
		{
			"heading": "caveats",
			"content": "Fully static pages are not affected."
		},
		{
			"heading": "caveats",
			"content": "In monorepos or when you need to include files outside the app folder, combine `outputFileTracingRoot` with includes:"
		},
		{
			"heading": "caveats",
		...
		{
			"heading": "caveats",
			"content": "Common include patterns for native/runtime assets:"
		}
	],
	"headings": [
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "cp" }),
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsxs)(_components.span, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: " .next/standalone/server.js"
				})]
			}) })
		}) }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				" respectively in ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" }),
				". Each option accepts an object whose keys are ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "route globs" }),
				" (matched with ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://www.npmjs.com/package/picomatch#basic-globbing",
					children: "picomatch"
				}),
				" against the route path, e.g. ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "/api/hello" }),
				") and whose values are ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "glob patterns resolved from the project root" }),
				" that specify files to include or exclude in the trace."
			] }),
			"\n"
		] }),
		"\n",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "      './node_modules/aws-crt/dist/bin/**/*'"
					}), (0, import_jsx_runtime.jsx)(_components.span, {
						style: {
							"--shiki-light": "#24292E",
							"--shiki-dark": "#E1E4E8"
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" directory does not change how you write these options:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Keys" }),
				" still match the route path (",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "'/api/hello'" }),
				", ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "'/products/[id]'" }),
				", etc.)."
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Values" }),
				" can reference paths under ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "src/" }),
				" since they are resolved relative to the project root."
			] }),
			"\n"
		] }),
		"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'src/config/runtime/**/*.json'"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'src/i18n/locales/**/*.json'"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "These options are applied to server traces and do not affect routes that do not produce a server trace file:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Edge Runtime routes are not affected." }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Fully static pages are not affected." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Trace from the monorepo root"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "/" }),
					") in patterns for cross-platform compatibility."
				] }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Common include patterns for native/runtime assets:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
