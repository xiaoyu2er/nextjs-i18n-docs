...
//#region node_modules/.nitro/vite/services/ssr/assets/urlImports-DZ2vvFxm.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "> **Warning**: This feature is experimental. Only use domains that you trust to download and execute on your machine. Please exercise\n> discretion, and caution until the feature is flagged as stable."
		},
		{
			"heading": void 0,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Warning" }), ": This feature is experimental. Only use domains that you trust to download and execute on your machine. Please exercise\ndiscretion, and caution until the feature is flagged as stable."] }),
			"\n"
		] }),
		"\n",
