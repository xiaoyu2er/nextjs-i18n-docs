...
//#region node_modules/.nitro/vite/services/ssr/assets/compress-DRMD6LZv.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "You can check if compression is enabled and which algorithm is used by looking at the `Accept-Encoding` (browser accepted options) and `Content-Encoding` (currently used) headers in the response."
		},
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"We ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "do not recommend disabling compression" }),
