...
//#region node_modules/.nitro/vite/services/ssr/assets/05-next-config-js-DQ7G2Y0i.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _05_next_config_js_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "> Avoid using new JavaScript features not available in your target Node.js version. `next.config.js` will not be parsed by Webpack, Babel or TypeScript."
		},
		{
			"heading": void 0,
...
//#endregion
export { toc as a, structuredData as i, _05_next_config_js_exports as n, frontmatter as r, MDXContent as t };
