...
//#region node_modules/.nitro/vite/services/ssr/assets/create-next-app-CPXN-Sal.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `create-next-app` CLI allow you to quickly create a new Next.js application using the default template or an example from a public Github repository. It is the easiest way to get started with Next.js."
		},
		{
			"heading": void 0,
			"content": "Basic usage:"
		...
		{
			"heading": "reference",
			"content": "Negate default options. E.g. `--no-eslint`"
		},
		{
			"heading": "reference",
		...
		},
		{
			...
			"content": "To create a new app using an official Next.js example, use the `--example` flag with the following command:"
		},
		{
			"heading": "with-an-official-nextjs-example",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" CLI allow you to quickly create a new Next.js application using the default template or an ",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Options" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Description" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "--no-*" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: ["Negate default options. E.g. ", (0, import_jsx_runtime.jsx)(_components.code, { children: "--no-eslint" })] })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsxs)(_components.td, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "--turbo" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: "Enable Turbopack by default for development" })] }),
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "Would you like to use Turbopack for `next dev`?  No / Yes" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: " [your-project-name] [example-name]"
					})
				]
			}) })
		}) }),
