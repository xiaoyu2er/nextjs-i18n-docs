...
//#region node_modules/.nitro/vite/services/ssr/assets/assetPrefix-WKo84Jl0.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "Open `next.config.js` and add the `assetPrefix` config:"
		},
		{
			"heading": void 0,
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Use the CDN in production and localhost for development."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
