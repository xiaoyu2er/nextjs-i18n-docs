...
//#region node_modules/.nitro/vite/services/ssr/assets/image-response-D8fyp4gQ.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "The following options are available for `ImageResponse`:"
		},
		{
			"heading": "supported-css-properties",
	...
	"headings": [{
		"id": "supported-css-properties",
		"content": "Supported CSS Properties"
	}, {
		"id": "version-history",
...
var toc = [{
	...
	title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Supported CSS Properties" })
}, {
	depth: 2,
	url: "#version-history",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "supported-css-properties",
			children: "Supported CSS Properties"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Please refer to ",
