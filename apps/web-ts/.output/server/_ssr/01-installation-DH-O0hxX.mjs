...
//#region node_modules/.nitro/vite/services/ssr/assets/01-installation-DH-O0hxX.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "manual-installation",
			"content": "`next dev`: Starts the development server."
		},
		{
			"heading": "manual-installation",
		...
		{
			"heading": "set-up-eslint",
			"content": "If `Strict` or `Base` are selected, Next.js will automatically install `eslint` and `eslint-config-next` as dependencies in your application and create an `.eslintrc.json` file in the root of your project that includes your selected configuration."
		},
		{
			"heading": "set-up-eslint",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "next dev" }), ": Starts the development server."] }),
			"\n",
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "next lint" }), ": Runs ESLint."] }),
			"\n"
		] }),
		"\n",
