...
//#region node_modules/.nitro/vite/services/ssr/assets/serverComponentsHmrCache-CtR3GApH.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var serverComponentsHmrCache_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "By default, the HMR cache applies to all `fetch` requests, including those with the `cache: 'no-store'` option. This means uncached requests will not show fresh data between HMR refreshes. However, the cache will be cleared on navigation or full-page reloads."
		},
		{
			"heading": void 0,
			"content": "You can disable the HMR cache by setting `serverComponentsHmrCache` to `false` in your `next.config.js` file:"
		},
		{
			"heading": void 0,
			"content": "> **Good to know:** For better observability, we recommend using the `logging.fetches` option which logs fetch cache hits and misses in the console during development."
		}
	],
	"headings": []
};
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "    serverComponentsHmrCache: "
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#005CC5",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "logging.fetches" })
				}),
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, serverComponentsHmrCache_exports as r, MDXContent as t };
