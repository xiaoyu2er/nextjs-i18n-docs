...
//#region node_modules/.nitro/vite/services/ssr/assets/42-deploying-nextjs-app-setup-gflYC92n.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _42_deploying_nextjs_app_setup_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "download-starter-code-optional",
			"content": "You should also update the following files:"
		},
		{
			"heading": "download-starter-code-optional",
			"content": "`public/images/profile.jpg` with your photo (Recommended: 400px width/height)."
		},
		{
			"heading": "download-starter-code-optional",
			"content": "`const name = '[Your Name]'` in `components/layout.js` with your name."
		},
		{
			"heading": "download-starter-code-optional",
			"content": "`<p>[Your Self Introduction]</p>` in `pages/index.js` with your self introduction."
		}
	],
	"headings": [{
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsx)(_components.span, {
				className: "line",
				children: (0, import_jsx_runtime.jsx)(_components.span, { children: "npx create-next-app@latest nextjs-blog --use-npm --example \"https://github.com/vercel/next-learn/tree/main/basics/basics-final\"" })
			}) })
		}) }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You should also update the following files:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "public/images/profile.jpg" }), " with your photo (Recommended: 400px width/height)."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "const name = '[Your Name]'" }),
				" in ",
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "<p>[Your Self Introduction]</p>" }),
				" in ",
...
//#endregion
export { toc as a, structuredData as i, _42_deploying_nextjs_app_setup_exports as n, frontmatter as r, MDXContent as t };
