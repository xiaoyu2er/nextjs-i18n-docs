...
//#region node_modules/.nitro/vite/services/ssr/assets/custom-server-DYlRHyZ1.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var custom_server_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "> `server.js` does not run through the Next.js Compiler or bundling process. Make sure the syntax and source code this file requires are compatible with the current Node.js version you are using. View an example."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Alternatively, you can set up `nodemon` (example). The custom server uses the following import to connect the server with the Next.js application:"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "(*Optional*) Enable Turbopack"
		},
		{
			"heading": void 0,
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Before deciding to use a custom server, keep in mind that it should only be used when the integrated router of Next.js can't meet your app requirements. A custom server will remove important performance optimizations, like ", (0, import_jsx_runtime.jsxs)(_components.strong, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: "    `> Server listening at http://localhost:${"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "nodemon" }),
			" (",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vercel/next.js/tree/canary/examples/custom-server",
				children: "example"
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "turbo" }) }),
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Boolean" }) }),
				(0, import_jsx_runtime.jsxs)(_components.td, { children: [
					"(",
					(0, import_jsx_runtime.jsx)(_components.em, { children: "Optional" }),
...
//#endregion
export { toc as a, structuredData as i, custom_server_exports as n, frontmatter as r, MDXContent as t };
