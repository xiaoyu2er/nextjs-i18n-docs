...
//#region node_modules/.nitro/vite/services/ssr/assets/01-installation-gXI8GgrH.js
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["getting-started/project-structure"]
	}
};
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "macOS, Windows (including WSL), and Linux are supported."
		},
		{
			"heading": "automatic-installation",
			"content": "We recommend starting a new Next.js app using `create-next-app`, which sets up everything automatically for you. To create a project, run:"
		},
		{
			"heading": "automatic-installation",
		...
		{
			"heading": "automatic-installation",
			"content": "If you're new to Next.js, see the project structure docs for an overview of all the possible files and folders in your application."
		},
		{
			"heading": "automatic-installation",
		...
		{
			"heading": "manual-installation",
			"content": "Open your `package.json` file and add the following `scripts`:"
		},
		{
			"heading": "manual-installation",
		...
		{
			"heading": "manual-installation",
			"content": "`dev`: runs `next dev` to start Next.js in development mode."
		},
		{
			"heading": "manual-installation",
			"content": "`build`: runs `next build` to build the application for production usage."
		},
		{
			"heading": "manual-installation",
			"content": "`start`: runs `next start` to start a Next.js production server."
		},
		{
			"heading": "manual-installation",
			"content": "`lint`: runs `next lint` to set up Next.js' built-in ESLint configuration."
		},
		{
		...
		},
		{
			...
			"content": "For new applications, we recommend using the App Router. This router allows you to use React's latest features and is an evolution of the Pages Router based on community feedback."
		},
		{
			"heading": "the-app-directory",
			"content": "Create an `app/` folder, then add a `layout.tsx` and `page.tsx` file. These will be rendered when the user visits the root of your application (`/`)."
		},
		{
			"heading": "the-app-directory",
			"content": "Create a root layout inside `app/layout.tsx` with the required `<html>` and `<body>` tags:"
		},
		{
			"heading": "the-app-directory",
			"content": "Finally, create a home page `app/page.tsx` with some initial content:"
		},
		{
			"heading": "the-app-directory",
			"content": "> **Good to know**: If you forget to create `layout.tsx`, Next.js will automatically create this file when running the development server with `next dev`."
		},
		{
			"heading": "the-app-directory",
			"content": "Learn more about using the App Router."
		},
		{
			"heading": "the-pages-directory-optional",
			"content": "If you prefer to use the Pages Router instead of the App Router, you can create a `pages/` directory at the root of your project."
		},
		{
			"heading": "the-pages-directory-optional",
			"content": "Then, add an `index.tsx` file inside your `pages` folder. This will be your home page (`/`):"
		},
		{
			"heading": "the-pages-directory-optional",
		...
		{
			"heading": "the-pages-directory-optional",
			"content": "Learn more about using the Pages Router."
		},
		{
			"heading": "the-pages-directory-optional",
			"content": "> **Good to know**: Although you can use both routers in the same project, routes in `app` will be prioritized over `pages`. We recommend using only one router in your new project to avoid confusion."
		},
		{
			"heading": "the-public-folder-optional",
			"content": "Create a `public` folder to store static assets such as images, fonts, etc. Files inside `public` directory can then be referenced by your code starting from the base URL (`/`)."
		},
		{
		...
		{
			"heading": "run-the-development-server",
			"content": "Edit `app/page.tsx` (or `pages/index.tsx`) file and save it to see the updated result in your browser."
		},
		{
			"heading": "next-steps",
			"content": "Learn about the files and folders in your Next.js project."
		}
	],
	"headings": [
		{
		...
		{
			"id": "creating-directories",
			"content": "Creating directories"
		},
		{
			"id": "the-app-directory",
			"content": "The `app` directory"
		},
		{
			"id": "the-pages-directory-optional",
			"content": "The `pages` directory (optional)"
		},
		{
			"id": "the-public-folder-optional",
			"content": "The `public` folder (optional)"
		},
		{
...
var toc = [
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Automatic Installation" })
	},
	{
		depth: 2,
	...
	{
		depth: 3,
		url: "#creating-directories",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Creating directories" })
	},
	{
		depth: 4,
		url: "#the-app-directory",
	...
	{
		depth: 4,
		url: "#the-pages-directory-optional",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			"The ",
	...
	{
		depth: 4,
		url: "#the-public-folder-optional",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
			"The ",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.p, { children: "System Requirements:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://nodejs.org/",
				children: "Node.js 18.17"
			}), " or later."] }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "macOS, Windows (including WSL), and Linux are supported." }),
			"\n"
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "Would you like to use `src/` directory? No / Yes" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "Would you like to customize the default import alias (@/*)? No / Yes" })
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"If you're new to Next.js, see the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/getting-started/project-structure",
				children: "project structure"
			}),
			" docs for an overview of all the possible files and folders in your application."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				": runs ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/cli/next#next-start-options",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "next start" })
				}),
				" to start a Next.js production server."
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "lint" }),
				": runs ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/cli/next#next-lint-options",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "next lint" })
				}),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "using the Pages Router"
			}),
			"."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "app/page.tsx" }),
				" (or ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "pages/index.tsx" }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Learn about the files and folders in your Next.js project." })
	] });
}
