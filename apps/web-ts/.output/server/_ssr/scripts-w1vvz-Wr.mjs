...
//#region node_modules/.nitro/vite/services/ssr/assets/scripts-w1vvz-Wr.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "using-custom-partytown-configuration",
			"content": "Although the `worker` strategy does not require any additional configuration to work, Partytown supports the use of a config object to modify some of its settings, including enabling `debug` mode and forwarding events and triggers."
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "If you would like to add additional configuration options, you can include it within the `<Head />` component used in a custom `_document.js`:"
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "In order to modify Partytown's configuration, the following conditions must be met:"
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "The `data-partytown-config` attribute must be used in order to overwrite the default configuration used by Next.js"
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "Unless you decide to save Partytown's library files in a separate directory, the `lib: \"/_next/static/~partytown/\"` property and value must be included in the configuration object in order to let Partytown know where Next.js stores the necessary static files."
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "> **Note**: If you are using an asset prefix and would like to modify Partytown's default configuration, you must include it as part of the `lib` path."
		},
		{
			"heading": "using-custom-partytown-configuration",
			"content": "Take a look at Partytown's configuration options to see the full list of other properties that can be added."
		},
		{
	...
	"headings": [
		...
		{
			"id": "using-custom-partytown-configuration",
...
var toc = [
	...
	{
		depth: 4,
		url: "#using-custom-partytown-configuration",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Using custom Partytown configuration" })
	},
	{
		depth: 3,
		url: "#inline-scripts",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(PagesOnly, { children: [
			(0, import_jsx_runtime.jsx)(_components.h4, {
				id: "using-custom-partytown-configuration",
				children: "Using custom Partytown configuration"
			}),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"Although the ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "worker" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.a, {
					...
					children: ["custom ", (0, import_jsx_runtime.jsx)(_components.code, { children: "_document.js" })]
				}),
				":"
			] }),
			(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
				...
				children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "          data-partytown-config"
						})
					}),
					"\n",
					(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "                lib: \"/_next/static/~partytown/\","
						})
					}),
					"\n",
					(0, import_jsx_runtime.jsx)(_components.span, {
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "In order to modify Partytown's configuration, the following conditions must be met:" }),
			(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					"The ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "data-partytown-config" }),
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.code, { children: "lib: \"/_next/static/~partytown/\"" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.p, { children: [
					...
					": If you are using an ",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/pages/api-reference/config/next-config-js/assetPrefix",
						children: "asset prefix"
					}),
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://partytown.builder.io/configuration",
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, scripts_exports as r, MDXContent as t };
