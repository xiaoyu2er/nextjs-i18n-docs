...
//#region node_modules/.nitro/vite/services/ssr/assets/revalidatePath-CCt5-UzK.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "parameters",
			"content": "`type`: (optional) `'page'` or `'layout'` string to change the type of path to revalidate. If `path` contains a dynamic segment (for example, `/product/[slug]/page`), this parameter is required."
		},
		{
			"heading": "returns",
			"content": "`revalidatePath` does not return any value."
		},
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "revalidatePath" }), " does not return any value."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "examples",
			children: "Examples"
