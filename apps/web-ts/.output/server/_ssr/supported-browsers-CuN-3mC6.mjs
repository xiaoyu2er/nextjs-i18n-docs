...
//#region node_modules/.nitro/vite/services/ssr/assets/supported-browsers-CuN-3mC6.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "javascript-language-features",
			"content": "Class Fields and Static Properties (part of stage 3 proposal)"
		},
		{
			"heading": "javascript-language-features",
			"content": "and more!"
	...
	"headings": [
		...
		{
			"id": "server-side-polyfills",
			"content": "Server-Side Polyfills"
		},
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#server-side-polyfills",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Server-Side Polyfills" })
	},
	{
		depth: 3,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "server-side-polyfills",
			children: "Server-Side Polyfills"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In addition to ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "fetch()" }),
			" on the client-side, Next.js polyfills ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "fetch()" }),
			" in the Node.js environment where it's not yet available. It uses ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "undici" }),
			", the same implementation that Node.js itself uses. You can use ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "fetch()" }),
			" in your server code (such as ",
			...
			") without using polyfills such as ",
