...
//#region node_modules/.nitro/vite/services/ssr/assets/03-get-server-side-props-C4FogPJc.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_get_server_side_props_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "example",
			"content": "You can use `getServerSideProps` by exporting it from a Page Component. The example below shows how you can fetch data from a 3rd party API in `getServerSideProps`, and pass the data to the page as props:"
		},
		{
			"heading": "when-should-i-use-getserversideprops",
			"content": "You should use `getServerSideProps` if you need to render a page that relies on personalized user data, or information that can only be known at request time. For example, `authorization` headers or a geolocation."
		},
		{
			"heading": "when-should-i-use-getserversideprops",
			"content": "If you do not need to fetch the data at request time, or would prefer to cache the data and pre-rendered HTML, we recommend using `getStaticProps`."
		},
		{
			"heading": "behavior",
			"content": "`getServerSideProps` runs on the server."
		},
		{
			"heading": "behavior",
			"content": "`getServerSideProps` can only be exported from a **page**."
		},
		{
			"heading": "behavior",
			"content": "`getServerSideProps` returns JSON."
		},
		{
			"heading": "behavior",
			"content": "When a user visits a page, `getServerSideProps` will be used to fetch data at request time, and the data is used to render the initial HTML of the page."
		},
		{
			"heading": "behavior",
			"content": "`props` passed to the page component can be viewed on the client as part of the initial HTML. This is to allow the page to be hydrated correctly. Make sure that you don't pass any sensitive information that shouldn't be available on the client in `props`."
		},
		{
			"heading": "behavior",
			"content": "When a user visits the page through `next/link` or `next/router`, Next.js sends an API request to the server, which runs `getServerSideProps`."
		},
		{
			"heading": "behavior",
			"content": "You do not have to call a Next.js API Route to fetch data when using `getServerSideProps` since the function runs on the server. Instead, you can call a CMS, database, or other third-party APIs directly from inside `getServerSideProps`."
		},
		{
			"heading": "behavior",
		...
		},
		{
			...
			"content": "If an error is thrown inside `getServerSideProps`, it will show the `pages/500.js` file. Check out the documentation for 500 page to learn more on how to create it. During development, this file will not be used and the development error overlay will be shown instead."
		},
		{
			"heading": "edge-runtime",
			"content": "`getServerSideProps` can be used with both Serverless and Edge Runtimes, and you can set props in both."
		},
		{
			"heading": "edge-runtime",
			"content": "However, currently in the Edge Runtime, you do not have access to the response object. This means that you cannot — for example — add cookies in `getServerSideProps`. To have access to the response object, you should **continue to use the Node.js runtime**, which is the default runtime."
		},
		{
			"heading": "edge-runtime",
			"content": "You can explicitly set the runtime on a per-page basis by modifying the `config`, for example:"
		},
		{
			"heading": "caching-with-server-side-rendering-ssr",
			"content": "You can use caching headers (`Cache-Control`) inside `getServerSideProps` to cache dynamic responses. For example, using `stale-while-revalidate`."
		},
		{
			"heading": "caching-with-server-side-rendering-ssr",
			"content": "However, before reaching for `cache-control`, we recommend seeing if `getStaticProps` with ISR is a better fit for your use case."
		}
	],
	"headings": [
		{
		...
		},
		{
			...
			"content": "Caching with Server-Side Rendering (SSR)"
		}
	]
};
var toc = [
	...
	{
		depth: 2,
		url: "#when-should-i-use-getserversideprops",
	...
	},
	{
		depth: 2,
		url: "#edge-cases",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Edge Cases" })
	},
	{
		depth: 3,
		url: "#edge-runtime",
	...
	{
		depth: 3,
		url: "#caching-with-server-side-rendering-ssr",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Caching with Server-Side Rendering (SSR)" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getServerSideProps" }), " is a Next.js function that can be used to fetch data and render the contents of a page at request time."] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getServerSideProps" }), " runs on the server."] }),
			"\n",
			...
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getServerSideProps" }), " returns JSON."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsxs)(_components.a, {
						...
						children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getServerSideProps" }), " API reference"]
					}),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "Serverless and Edge Runtimes"
			}),
			", and you can set props in both."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"However, currently in the Edge Runtime, you do not have access to the response object. This means that you cannot — for example — add cookies in ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getServerSideProps" }),
			". To have access to the response object, you should ",
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "continue to use the Node.js runtime" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "caching-with-server-side-rendering-ssr",
			children: "Caching with Server-Side Rendering (SSR)"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
...
//#endregion
export { toc as a, structuredData as i, _03_get_server_side_props_exports as n, frontmatter as r, MDXContent as t };
