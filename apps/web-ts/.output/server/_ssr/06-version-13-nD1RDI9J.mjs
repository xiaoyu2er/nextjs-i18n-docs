...
//#region node_modules/.nitro/vite/services/ssr/assets/06-version-13-nD1RDI9J.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _06_version_13_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": "upgrading-from-12-to-13",
		...
		{
			"heading": "v13-summary",
			"content": "The Supported Browsers have been changed to drop Internet Explorer and target modern browsers."
		},
		{
			"heading": "v13-summary",
			"content": "The minimum Node.js version has been bumped from 12.22.0 to 16.14.0, since 12.x and 14.x have reached end-of-life."
		},
		{
			"heading": "v13-summary",
		...
		{
			"heading": "v13-summary",
			"content": "The `target` configuration property has been removed and superseded by Output File Tracing."
		},
		{
			"heading": "migrating-shared-features",
			"content": "Next.js 13 introduces a new `app` directory with new features and conventions. However, upgrading to Next.js 13 does **not** require using the new `app` directory."
		},
		{
			"heading": "migrating-shared-features",
			"content": "You can continue using `pages` with new features that work in both directories, such as the updated Image component, Link component, Script component, and Font optimization."
		},
		{
			"heading": "image-component",
			"content": "Next.js 12 introduced many improvements to the Image Component with a temporary import: `next/future/image`. These improvements included less client-side JavaScript, easier ways to extend and style images, better accessibility, and native browser lazy loading."
		},
		{
			"heading": "image-component",
		...
		{
			"heading": "image-component",
			"content": "next-image-to-legacy-image: This codemod will safely and automatically rename `next/image` imports to `next/legacy/image` to maintain the same behavior as Next.js 12. We recommend running this codemod to quickly update to Next.js 13 automatically."
		},
		{
			"heading": "image-component",
			"content": "next-image-experimental: After running the previous codemod, you can optionally run this experimental codemod to upgrade `next/legacy/image` to the new `next/image`, which will remove unused props and add inline styles. Please note this codemod is experimental and only covers static usage (such as `<Image src={img} layout=\"responsive\" />`) but not dynamic usage (such as `<Image {...props} />`)."
		},
		{
			"heading": "image-component",
			"content": "Alternatively, you can manually update by following the migration guide and also see the legacy comparison."
		},
		{
		...
		},
		{
			...
			"content": "The behavior of `next/script` has been updated to support both `pages` and `app`. If incrementally adopting `app`, read the upgrade guide."
		},
		{
			"heading": "font-optimization",
			"content": "Previously, Next.js helped you optimize fonts by inlining font CSS. Version 13 introduces the new `next/font` module which gives you the ability to customize your font loading experience while still ensuring great performance and privacy."
		},
		{
			"heading": "font-optimization",
			"content": "See Optimizing Fonts to learn how to use `next/font`."
		}
	],
	"headings": [
		{
			"id": "upgrading-from-12-to-13",
...
var toc = [
	{
		depth: 2,
		url: "#upgrading-from-12-to-13",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Upgrading from 12 to 13" })
	},
	{
		depth: 3,
		url: "#v13-summary",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "v13 Summary" })
	},
	{
		depth: 2,
		url: "#migrating-shared-features",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Migrating shared features" })
	},
	{
		depth: 3,
		url: "#image-component",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "upgrading-from-12-to-13",
			children: "Upgrading from 12 to 13"
		}),
		"\n",
			...
			children: (0, import_jsx_runtime.jsx)(_components.code, { children: (0, import_jsx_runtime.jsxs)(_components.span, {
				...
				children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: " eslint-config-next@13"
					})
				]
			}) })
		}) }),
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The minimum Node.js version has been bumped from 12.22.0 to 16.14.0, since 12.x and 14.x have reached end-of-life." }),
			"\n",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				". A ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/upgrading/codemods#next-image-to-legacy-image",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				" to upgrade. A ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/upgrading/codemods#new-link",
					children: "codemod is available"
				}),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "migrating-shared-features",
			children: "Migrating shared features"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/building-your-application/routing#the-app-router",
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "app" }), " directory"]
			}),
			"."
		] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/upgrading/codemods#next-image-experimental",
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "<Image src={img} layout=\"responsive\" />" }),
				") but not dynamic usage (such as ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "<Image {...props} />" }),
				")."
			] }),
			"\n"
		] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" and also see the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/pages/api-reference/components/image-legacy#comparison",
				children: "legacy comparison"
			}),
			"."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The behavior of ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/pages/api-reference/components/script",
...
//#endregion
export { toc as a, structuredData as i, _06_version_13_exports as n, frontmatter as r, MDXContent as t };
