...
//#region node_modules/.nitro/vite/services/ssr/assets/intercepting-routes-oDmBbJc3.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var intercepting_routes_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "convention",
			"content": "Intercepting routes can be defined with the `(..)` convention, which is similar to relative path convention `../` but for route segments."
		},
		{
			"heading": "convention",
			"content": "You can use:"
		...
		{
			"heading": "convention",
			"content": "> **Good to know:** The `(..)` convention is based on *route segments*, not the file-system. For example, it does not consider `@slot` folders in Parallel Routes."
		},
		{
			"heading": "modals",
		...
		{
			"heading": "next-steps",
			"content": "Learn how to create modals with Intercepted and Parallel Routes."
		}
	],
	"headings": [
		{
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"See the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/file-conventions/parallel-routes#modals",
				children: "Parallel Routes"
			}),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Learn how to create modals with Intercepted and Parallel Routes." })
	] });
}
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, intercepting_routes_exports as r, MDXContent as t };
