...
//#region node_modules/.nitro/vite/services/ssr/assets/image-legacy-CVBvbzI5.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Legacy Image Component"
		},
		{
			"heading": void 0,
		...
		{
			"heading": "loading",
			"content": "> **Attention**: This property is only meant for advanced usage. Switching an\n> image to load with `eager` will normally **hurt performance**.\n>\n> We recommend using the `priority` property instead, which\n> properly loads the image eagerly for nearly all use cases."
		},
		{
			"heading": "loading",
		...
		{
			"heading": "remote-patterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/legacy/image` must start with `https://example.com/account123/`. Any other protocol, hostname, port, or unmatched path will respond with 400 Bad Request."
		},
		{
			"heading": "remote-patterns",
			"content": "Below is another example of the `remotePatterns` property in the `next.config.js` file:"
		},
		{
			"heading": "remote-patterns",
			"content": "> **Good to know**: The example above will ensure the `src` property of `next/legacy/image` must start with `https://img1.example.com` or `https://me.avatar.example.com` or any number of subdomains. Any other protocol or unmatched hostname will respond with 400 Bad Request."
		},
		{
			"heading": "remote-patterns",
		...
		{
			"heading": "domains",
			"content": "> **Warning**: We recommend configuring strict `remotePatterns` instead of `domains` in order to protect your application from malicious users. Only use `domains` if you own all the content served from the domain."
		},
		{
			"heading": "domains",
		...
		{
			"heading": "built-in-loaders",
			"content": "> The `next/legacy/image` component's default loader uses `squoosh` because it is quick to install and suitable for a development environment. When using `next start` in your production environment, it is strongly recommended that you install `sharp` by running `npm i sharp` in your project directory. This is not necessary for Vercel deployments, as `sharp` is installed automatically."
		},
		{
			"heading": "advanced",
		...
		{
			"heading": "acceptable-formats",
			"content": "> **Good to know**: AVIF generally takes 20% longer to encode but it compresses 20% smaller compared to WebP. This means that the first time an image is requested, it will typically be slower and then subsequent requests that are cached will be faster."
		},
		{
		...
		{
			"heading": "dangerously-allow-svg",
			"content": "If you need to serve SVG images with the default Image Optimization API, you can set `dangerouslyAllowSVG` inside your `next.config.js`:"
		},
		{
			"heading": "dangerously-allow-svg",
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vercel/next.js/tree/canary/examples/image-legacy-component",
				children: "Legacy Image Component"
			}) }),
			"\n"
		] })] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"A ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/optimizing/images#local-images",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				": We recommend configuring strict ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "#remote-patterns",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://www.npmjs.com/package/@squoosh/lib",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "squoosh" })
				}),
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "sharp" })
				}),
				" by running ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "npm i sharp" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }), ": AVIF generally takes 20% longer to encode but it compresses 20% smaller compared to WebP. This means that the first time an image is requested, it will typically be slower and then subsequent requests that are cached will be faster."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
