...
//#region node_modules/.nitro/vite/services/ssr/assets/htmlLimitedBots-CC9cdslM.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "Next.js includes a default list of HTML limited bots."
		},
		{
			"heading": "default-list",
			"content": "Specifying a `htmlLimitedBots` config will override the Next.js' default list, allowing you full control over what user agents should opt into this behavior. However, this is advanced behavior, and the default should be sufficient for most cases."
		},
		{
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "a default list of HTML limited bots"
			}),
			"."
		] }),
		"\n",
