...
//#region node_modules/.nitro/vite/services/ssr/assets/01-get-static-props--qo53KP8.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _01_get_static_props_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "If you export a function called `getStaticProps` (Static Site Generation) from a page, Next.js will pre-render this page at build time using the props returned by `getStaticProps`."
		},
		{
			"heading": void 0,
			"content": "> Note that irrespective of rendering type, any `props` will be passed to the page component and can be viewed on the client-side in the initial HTML. This is to allow the page to be hydrated correctly. Make sure that you don't pass any sensitive information that shouldn't be available on the client in `props`."
		},
		{
			"heading": void 0,
			"content": "The `getStaticProps` API reference covers all parameters and props that can be used with `getStaticProps`."
		},
		{
		...
		{
			"heading": "when-should-i-use-getstaticprops",
			"content": "The data can be publicly cached (not user-specific). This condition can be bypassed in certain specific situation by using a Middleware to rewrite the path."
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` always runs on the server and never on the client. You can validate code written inside `getStaticProps` is removed from the client-side bundle with this tool."
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` always runs during `next build`"
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` runs in the background when using `fallback: true`"
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` is called before initial render when using `fallback: blocking`"
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` runs in the background when using `revalidate`"
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` runs on-demand in the background when using `revalidate()`"
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "When combined with Incremental Static Regeneration, `getStaticProps` will run in the background while the stale page is being revalidated, and the fresh page served to the browser."
		},
		{
			"heading": "when-does-getstaticprops-run",
			"content": "`getStaticProps` does not have access to the incoming request (such as query parameters or HTTP headers) as it generates static HTML. If you need access to the request for your page, consider using Middleware in addition to `getStaticProps`."
		},
		{
			"heading": "using-getstaticprops-to-fetch-data-from-a-cms",
			"content": "The following example shows how you can fetch a list of blog posts from a CMS."
		},
		{
			"heading": "using-getstaticprops-to-fetch-data-from-a-cms",
			"content": "The `getStaticProps` API reference covers all parameters and props that can be used with `getStaticProps`."
		...
		{
			"heading": "write-server-side-code-directly",
			"content": "As `getStaticProps` runs only on the server-side, it will never run on the client-side. It won’t even be included in the JS bundle for the browser, so you can write direct database queries without them being sent to browsers."
		},
		{
			"heading": "write-server-side-code-directly",
			"content": "This means that instead of fetching an **API route** from `getStaticProps` (that itself fetches data from an external source), you can write the server-side code directly in `getStaticProps`."
		},
		{
			"heading": "write-server-side-code-directly",
		...
		{
			"heading": "write-server-side-code-directly",
			"content": "Alternatively, if you are **not** using API routes to fetch data, then the `fetch()` API *can* be used directly in `getStaticProps` to fetch data."
		},
		{
			"heading": "write-server-side-code-directly",
			"content": "To verify what Next.js eliminates from the client-side bundle, you can use the next-code-elimination tool."
		},
		{
			"heading": "statically-generates-both-html-and-json",
			"content": "When a page with `getStaticProps` is pre-rendered at build time, in addition to the page HTML file, Next.js generates a JSON file holding the result of running `getStaticProps`."
		},
		{
			"heading": "statically-generates-both-html-and-json",
			"content": "This JSON file will be used in client-side routing through `next/link` or `next/router`. When you navigate to a page that’s pre-rendered using `getStaticProps`, Next.js fetches this JSON file (pre-computed at build time) and uses it as the props for the page component. This means that client-side page transitions will **not** call `getStaticProps` as only the exported JSON is used."
		},
		{
			"heading": "statically-generates-both-html-and-json",
			"content": "When using Incremental Static Generation, `getStaticProps` will be executed in the background to generate the JSON needed for client-side navigation. You may see this in the form of multiple requests being made for the same page, however, this is intended and has no impact on end-user performance."
		},
		{
			"heading": "where-can-i-use-getstaticprops",
			"content": "`getStaticProps` can only be exported from a **page**. You **cannot** export it from non-page files, `_app`, `_document`, or `_error`."
		},
		{
			"heading": "where-can-i-use-getstaticprops",
		...
		{
			"heading": "where-can-i-use-getstaticprops",
			"content": "Also, you must use export `getStaticProps` as a standalone function — it will **not** work if you add `getStaticProps` as a property of the page component."
		},
		{
			"heading": "where-can-i-use-getstaticprops",
			"content": "> **Good to know**: if you have created a custom app, ensure you are passing the `pageProps` to the page component as shown in the linked document, otherwise the props will be empty."
		},
		{
			"heading": "runs-on-every-request-in-development",
			"content": "In development (`next dev`), `getStaticProps` will be called on every request."
		},
		{
			"heading": "preview-mode",
			"content": "You can temporarily bypass static generation and render the page at **request time** instead of build time using **Preview Mode**. For example, you might be using a headless CMS and want to preview drafts before they're published."
		}
	],
	"headings": [
		{
...
var toc = [
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "When should I use getStaticProps?" })
	},
	{
		depth: 2,
		url: "#when-does-getstaticprops-run",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "When does getStaticProps run" })
	},
	{
		depth: 2,
		url: "#using-getstaticprops-to-fetch-data-from-a-cms",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Using getStaticProps to fetch data from a CMS" })
	},
	{
		depth: 2,
		url: "#write-server-side-code-directly",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Write server-side code directly" })
	},
	{
		depth: 2,
		url: "#statically-generates-both-html-and-json",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Statically generates both HTML and JSON" })
	},
	{
		depth: 2,
		url: "#where-can-i-use-getstaticprops",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Where can I use getStaticProps" })
	},
	{
		depth: 2,
		url: "#runs-on-every-request-in-development",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Runs on every request in development" })
	},
	{
		depth: 2,
		url: "#preview-mode",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Preview Mode" })
	}
];
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticProps" }), " API reference"]
			}),
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The data can be publicly cached (not user-specific). This condition can be bypassed in certain specific situation by using a Middleware to rewrite the path." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "when-does-getstaticprops-run",
			children: "When does getStaticProps run"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticProps" }),
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://next-code-elimination.vercel.app/",
				children: "with this tool"
			}),
			"."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "using-getstaticprops-to-fetch-data-from-a-cms",
			children: "Using getStaticProps to fetch data from a CMS"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The following example shows how you can fetch a list of blog posts from a CMS." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "write-server-side-code-directly",
			children: "Write server-side code directly"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"As ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "API route" }),
			" from ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticProps" }),
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// The following function is shared"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// with getStaticProps and API routes"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// This function runs only on the server side"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Instead of fetching your `/api` route you can call the same"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // function directly in `getStaticProps`"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Props returned will be passed to the page component"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://next-code-elimination.vercel.app/",
				children: "next-code-elimination tool"
			}),
			"."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "statically-generates-both-html-and-json",
			children: "Statically generates both HTML and JSON"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"When a page with ",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "where-can-i-use-getstaticprops",
			children: "Where can I use getStaticProps"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticProps" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "pageProps" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "runs-on-every-request-in-development",
			children: "Runs on every request in development"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In development (",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.strong, { children: "Preview Mode" })
			}),
...
//#endregion
export { toc as a, structuredData as i, _01_get_static_props_exports as n, frontmatter as r, MDXContent as t };
