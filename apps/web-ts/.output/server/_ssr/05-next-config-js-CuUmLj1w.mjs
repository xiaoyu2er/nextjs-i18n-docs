...
//#region node_modules/.nitro/vite/services/ssr/assets/05-next-config-js-CuUmLj1w.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Next.js can be configured through a `next.config.js` file in the root of your project directory (for example, by `package.json`)."
		},
		{
			"heading": void 0,
