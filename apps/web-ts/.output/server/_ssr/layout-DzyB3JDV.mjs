...
//#region node_modules/.nitro/vite/services/ssr/assets/layout-DzyB3JDV.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "A promise that resolves to an object containing the dynamic route parameters object from the root segment down to that layout."
		},
		{
			"heading": "params-optional",
		...
		{
			"heading": "params-optional",
			"content": "`Promise<{ slug: ['1', '2'] }>`"
		},
		{
			"heading": "params-optional",
			"content": "Since the `params` prop is a promise. You must use `async/await` or React's `use` function to access the values."
		},
		{
			"heading": "params-optional",
			"content": "In version 14 and earlier, `params` was a synchronous prop. To help with backwards compatibility, you can still access it synchronously in Next.js 15, but this behavior will be deprecated in the future."
		},
		{
			"heading": "root-layout",
		...
		},
		{
			...
			"content": "Layouts are cached in the client during navigation to avoid unnecessary server requests."
		},
		{
			"heading": "request-object",
		...
		{
			"heading": "request-object",
			"content": "To access the request object, you can use `headers` and `cookies` APIs in Server Components and Functions."
		},
		{
			"heading": "query-params",
			"content": "Layouts do not rerender on navigation, so they cannot access search params which would otherwise become stale."
		},
		{
			"heading": "query-params",
			"content": "To access updated query parameters, you can use the Page `searchParams` prop, or read them inside a Client Component using the `useSearchParams` hook. Since Client Components re-render on navigation, they have access to the latest query parameters."
		},
		{
			"heading": "pathname",
			"content": "Layouts do not re-render on navigation, so they do not access pathname which would otherwise become stale."
		},
		{
			"heading": "pathname",
			"content": "To access the current pathname, you can read it inside a Client Component using the `usePathname` hook. Since Client Components re-render during navigation, they have access to the latest pathname."
		},
		{
			"heading": "fetching-data",
			"content": "Layouts cannot pass data to their `children`. However, you can fetch the same data in a route more than once, and use React `cache` to dedupe the requests without affecting performance."
		},
		{
			"heading": "fetching-data",
			"content": "Alternatively, when using `fetch`in Next.js, requests are automatically deduped."
		},
		{
			"heading": "accessing-child-segments",
			"content": "Layouts do not have access to the route segments below itself. To access all route segments, you can use `useSelectedLayoutSegment` or `useSelectedLayoutSegments` in a Client Component."
		},
		{
			"heading": "metadata",
			"content": "You can modify the `<head>` HTML elements such as `title` and `meta` using the `metadata` object or `generateMetadata` function."
		},
		{
			"heading": "metadata",
			"content": "> **Good to know**: You should **not** manually add `<head>` tags such as `<title>` and `<meta>` to root layouts. Instead, use the Metadata APIs which automatically handles advanced requirements such as streaming and de-duplicating `<head>` elements."
		},
		{
			"heading": "active-nav-links",
			"content": "You can use the `usePathname` hook to determine if a nav link is active."
		},
		{
			"heading": "active-nav-links",
			"content": "Since `usePathname` is a client hook, you need to extract the nav links into a Client Component, which can be imported into your layout:"
		},
		{
			"heading": "displaying-content-based-on-params",
			"content": "Using dynamic route segments, you can display or fetch specific content based on the `params` prop."
		},
		{
			"heading": "reading-params-in-client-components",
			"content": "To use `params` in a Client Component (which cannot be `async`), you can use React's `use` function to read the promise:"
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`params` is now a promise. A codemod is available."
		},
		{
			"heading": "version-history",
			"content": "`v13.0.0`"
...
var toc = [
	...
	},
	{
		depth: 3,
		url: "#root-layout",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Root Layout" })
	},
	{
		depth: 2,
		url: "#caveats",
	...
	},
	{
		depth: 3,
		url: "#request-object",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Request Object" })
	},
	{
		depth: 3,
		url: "#query-params",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Query params" })
	},
	{
		depth: 3,
		url: "#pathname",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Pathname" })
	},
	{
		depth: 3,
		url: "#fetching-data",
	...
	{
		depth: 3,
		url: "#accessing-child-segments",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Accessing child segments" })
	},
	{
		depth: 2,
		url: "#examples",
	...
	{
		depth: 3,
		url: "#active-nav-links",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Active Nav Links" })
	},
	{
		depth: 3,
		url: "#displaying-content-based-on-params",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Displaying content based on ", (0, import_jsx_runtime.jsx)("code", { children: "params" })] })
	},
	{
		depth: 3,
		url: "#reading-params-in-client-components",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/dashboard/[team]/layout.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/[team]/layout.tsx",
					children: "app/dashboard/[team]/layout.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/dashboard/[team]/layout.js",
					children: "app/dashboard/[team]/layout.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/dashboard/[team]/layout.tsx",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			(0, import_jsx_runtime.jsx)(_components.th, { children: "Example Route" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ team: '1' }>" }) })
			] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ tag: '1', item: '2' }>" }) })
			] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Promise<{ slug: ['1', '2'] }>" }) })
			] })
		] })] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"You can use ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/file-conventions/route-groups",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Layouts are cached in the client during navigation to avoid unnecessary server requests." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/shop/layout.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/shop/layout.tsx",
					children: "app/shop/layout.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/shop/layout.js",
					children: "app/shop/layout.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/shop/layout.tsx",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Layouts do not rerender on navigation, so they cannot access search params which would otherwise become stale." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Layouts do not re-render on navigation, so they do not access pathname which would otherwise become stale." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To access the current pathname, you can read it inside a Client Component using the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://nextjs.org/docs/app/api-reference/functions/use-pathname",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/ui/breadcrumbs.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/breadcrumbs.tsx",
						children: "app/ui/breadcrumbs.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/breadcrumbs.js",
						children: "app/ui/breadcrumbs.js"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/docs/layout.tsx",
						children: "app/docs/layout.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/docs/layout.js",
						children: "app/docs/layout.js"
					})
				] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/ui/breadcrumbs.tsx",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// Simplified breadcrumbs logic"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "accessing-child-segments",
			children: "Accessing child segments"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			...
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					...
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/blog/layout.js",
						children: "app/blog/layout.js"
					})
				] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/ui/nav-link.tsx",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "      // Change style depending on whether the link is active"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/api-reference/functions/generate-metadata#the-metadata-object",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/ui/nav-links.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/nav-links.tsx",
						children: "app/ui/nav-links.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/ui/nav-links.js",
						children: "app/ui/nav-links.js"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/layout.tsx",
						children: "app/layout.tsx"
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			id: "displaying-content-based-on-params",
			children: ["Displaying content based on ", (0, import_jsx_runtime.jsx)(_components.code, { children: "params" })]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Using ",
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: ">Welcome to {team}'s Dashboard</"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#22863A",
		...
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "Version" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Changes" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v15.0.0-RC" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [
			...
			" is available."
		] })] }), (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "v13.0.0" }) }), (0, import_jsx_runtime.jsxs)(_components.td, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "layout" }), " introduced."] })] })] })] })
	] });
}
