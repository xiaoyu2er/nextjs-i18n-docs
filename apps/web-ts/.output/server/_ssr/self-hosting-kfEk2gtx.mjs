...
//#region node_modules/.nitro/vite/services/ssr/assets/self-hosting-kfEk2gtx.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "When using a CDN in front on your Next.js application, the page will include `Cache-Control: private` response header when dynamic APIs are accessed. This ensures that the resulting HTML page is marked as non-cachable. If the page is fully prerendered to static, it will include `Cache-Control: public` to allow the page to be cached on the CDN."
		},
		{
			"heading": "usage-with-cdns",
