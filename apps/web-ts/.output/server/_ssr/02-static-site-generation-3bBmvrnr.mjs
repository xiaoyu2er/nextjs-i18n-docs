...
//#region node_modules/.nitro/vite/services/ssr/assets/02-static-site-generation-3bBmvrnr.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _02_static_site_generation_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "Builder.io Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "DotCMS Example (Demo)"
		},
		{
			"heading": void 0,
			"content": "Drupal Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Keystone Example (Demo)"
		},
		{
			"heading": void 0,
			"content": "Kontent.ai Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Sitecore XM Cloud Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Tina Example (Demo)"
		},
		{
			"heading": void 0,
			"content": "Umbraco Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "Blog Starter Example (Demo)"
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "In Next.js, you can statically generate pages **with or without data**. Let's take a look at each case."
		},
		{
			"heading": "static-generation-without-data",
			"content": "By default, Next.js pre-renders pages using Static Generation without fetching data. Here's an example:"
		},
		{
			"heading": "static-generation-without-data",
			"content": "Note that this page does not need to fetch any external data to be pre-rendered. In cases like this, Next.js generates a single HTML file per page during build time."
		},
		{
			"heading": "static-generation-with-data",
			"content": "Some pages require fetching external data for pre-rendering. There are two scenarios, and one or both might apply. In each case, you can use these functions that Next.js provides:"
		},
		{
			"heading": "static-generation-with-data",
			"content": "Your page **content** depends on external data: Use `getStaticProps`."
		},
		{
			"heading": "static-generation-with-data",
			"content": "Your page **paths** depend on external data: Use `getStaticPaths` (usually in addition to `getStaticProps`)."
		},
		{
			"heading": "scenario-1-your-page-content-depends-on-external-data",
			"content": "**Example**: Your blog page might need to fetch the list of blog posts from a CMS (content management system)."
		},
		{
			"heading": "scenario-1-your-page-content-depends-on-external-data",
			"content": "To fetch this data on pre-render, Next.js allows you to `export` an `async` function called `getStaticProps` from the same file. This function gets called at build time and lets you pass fetched data to the page's `props` on pre-render."
		},
		{
			"heading": "scenario-1-your-page-content-depends-on-external-data",
			"content": "To learn more about how `getStaticProps` works, check out the Data Fetching documentation."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "Next.js allows you to create pages with **dynamic routes**. For example, you can create a file called `pages/posts/[id].js` to show a single blog post based on `id`. This will allow you to show a blog post with `id: 1` when you access `posts/1`."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "> To learn more about dynamic routing, check the Dynamic Routing documentation."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "However, which `id` you want to pre-render at build time might depend on external data."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "**Example**: suppose that you've only added one blog post (with `id: 1`) to the database. In this case, you'd only want to pre-render `posts/1` at build time."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "Later, you might add the second post with `id: 2`. Then you'd want to pre-render `posts/2` as well."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "So your page **paths** that are pre-rendered depend on external data. To handle this, Next.js lets you `export` an `async` function called `getStaticPaths` from a dynamic page (`pages/posts/[id].js` in this case). This function gets called at build time and lets you specify which paths you want to pre-render."
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "Also in `pages/posts/[id].js`, you need to export `getStaticProps` so that you can fetch the data about the post with this `id` and use it to pre-render the page:"
		},
		{
			"heading": "scenario-2-your-page-paths-depend-on-external-data",
			"content": "To learn more about how `getStaticPaths` works, check out the Data Fetching documentation."
		},
		{
			"heading": "when-should-i-use-static-generation",
		...
		{
			"heading": "when-should-i-use-static-generation",
			"content": "Blog posts and portfolios"
		},
		{
			"heading": "when-should-i-use-static-generation",
		...
		{
			"heading": "when-should-i-use-static-generation",
			"content": "Use Static Generation with &#x2A;*Client-side data fetching:** You can skip pre-rendering some parts of a page and then use client-side JavaScript to populate them. To learn more about this approach, check out the Data Fetching documentation."
		},
		{
			"heading": "when-should-i-use-static-generation",
			"content": "Use &#x2A;*Server-Side Rendering:** Next.js pre-renders a page on each request. It will be slower because the page cannot be cached by a CDN, but the pre-rendered page will always be up-to-date. We'll talk about this approach below."
		}
	],
	"headings": [
		{
...
var toc = [
	{
		depth: 3,
		url: "#static-generation-without-data",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Static Generation without data" })
	},
	{
		depth: 3,
		url: "#static-generation-with-data",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Static Generation with data" })
	},
	{
		depth: 4,
		url: "#scenario-1-your-page-content-depends-on-external-data",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Scenario 1: Your page content depends on external data" })
	},
	{
		depth: 4,
		url: "#scenario-2-your-page-paths-depend-on-external-data",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Scenario 2: Your page paths depend on external data" })
	},
	{
		depth: 3,
		url: "#when-should-i-use-static-generation",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "When should I use Static Generation?" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)("details", { children: [(0, import_jsx_runtime.jsx)("summary", { children: "Examples" }), (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-builder-io",
					children: "Builder.io Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://app-router-contentful.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-dotcms",
					children: "DotCMS Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://nextjs-dotcms-blog.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-keystonejs-embedded",
					children: "Keystone Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://nextjs-keystone-demo.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://next-blog.sanity.build/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-sitecore-xmcloud",
					children: "Sitecore XM Cloud Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://vercel-sitecore-xmcloud-demo.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-tina",
					children: "Tina Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://cms-tina-example.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-umbraco",
					children: "Umbraco Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://nextjs-umbraco-sample-blog.vercel.app/",
					children: "Demo"
				}),
				")"
			] }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/vercel/next.js/tree/canary/examples/cms-webiny",
					children: "Webiny Example"
				}),
				" (",
				(0, import_jsx_runtime.jsx)(_components.a, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "with or without data" }),
			". Let's take a look at each case."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "static-generation-without-data",
			children: "Static Generation without data"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "By default, Next.js pre-renders pages using Static Generation without fetching data. Here's an example:" }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Note that this page does not need to fetch any external data to be pre-rendered. In cases like this, Next.js generates a single HTML file per page during build time." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "static-generation-with-data",
			children: "Static Generation with data"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Some pages require fetching external data for pre-rendering. There are two scenarios, and one or both might apply. In each case, you can use these functions that Next.js provides:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Your page ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "content" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Your page ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "paths" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h4, {
			id: "scenario-1-your-page-content-depends-on-external-data",
			children: "Scenario 1: Your page content depends on external data"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Example" }), ": Your blog page might need to fetch the list of blog posts from a CMS (content management system)."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// TODO: Need to fetch `posts` (by calling some API endpoint)"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "//       before this page can be pre-rendered."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(_components.h4, {
			id: "scenario-2-your-page-paths-depend-on-external-data",
			children: "Scenario 2: Your page paths depend on external data"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "id: 1" }),
			" when you access ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "id: 2" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "when-should-i-use-static-generation",
			children: "When should I use Static Generation?"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"We recommend using ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can use Static Generation for many types of pages, including:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Marketing pages" }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Blog posts and portfolios" }),
			"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "In cases like this, you can do one of the following:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Use Static Generation with ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Client-side data fetching:" }),
...
//#endregion
export { toc as a, structuredData as i, _02_static_site_generation_exports as n, frontmatter as r, MDXContent as t };
