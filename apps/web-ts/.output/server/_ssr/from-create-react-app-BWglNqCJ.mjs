...
//#region node_modules/.nitro/vite/services/ssr/assets/from-create-react-app-BWglNqCJ.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "Create React App uses purely client-side React. Client-side only applications, also known as single-page applications (SPAs), often experience slow initial page loading time. This happens due to a couple of reasons:"
		},
		{
			"heading": "slow-initial-page-loading-time",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Create React App uses purely client-side React. Client-side only applications, also known as ",
