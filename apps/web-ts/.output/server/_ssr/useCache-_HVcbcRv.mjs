...
//#region node_modules/.nitro/vite/services/ssr/assets/useCache-_HVcbcRv.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var useCache_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `useCache` flag is an experimental feature in Next.js that enables the `use cache` directive to be used independently of `dynamicIO`. When enabled, you can use `use cache` in your application even if `dynamicIO` is turned off."
		},
		{
			"heading": "usage",
			"content": "To enable the `useCache` flag, set it to `true` in the `experimental` section of your `next.config.ts` file:"
		},
		{
			"heading": "usage",
			"content": "When `useCache` is enabled, you can use the following cache functions and configurations:"
		},
		{
			"heading": "usage",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"The ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "useCache" }),
...
//#endregion
export { useCache_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
