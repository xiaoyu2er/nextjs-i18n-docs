...
//#region node_modules/.nitro/vite/services/ssr/assets/self-hosting-BM7sU2kK.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var self_hosting_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "When deploying your Next.js app, you may want to configure how different features are handled based on your infrastructure."
		},
		{
			"heading": void 0,
			"content": "> **🎥 Watch:** Learn more about self-hosting Next.js → YouTube (45 minutes)."
		},
		{
		...
		{
			"heading": "middleware",
			"content": "Middleware uses the Edge runtime, a subset of all available Node.js APIs to help ensure low latency, since it may run in front of every route or asset in your application. If you do not want this, you can use the full Node.js runtime to run Middleware."
		},
		{
			"heading": "middleware",
		...
		{
			"heading": "environment-variables",
			"content": "You safely read environment variables on the server during dynamic rendering."
		},
		{
			"heading": "environment-variables",
		...
		{
			"heading": "caching-and-isr",
			"content": "Caching and revalidating pages (with Incremental Static Regeneration) use the **same shared cache**. By default, this cache is stored to the filesystem (on disk) on your Next.js server. **This works automatically when self-hosting** using both the Pages and App Router."
		},
		{
			"heading": "caching-and-isr",
		...
		{
			"heading": "partial-prerendering",
			"content": "Partial Prerendering (experimental) works by default with Next.js and is not a CDN-only feature. This includes deployment as a Node.js server (through `next start`) and when used with a Docker container."
		},
		{
			"heading": "usage-with-cdns",
			"content": "When using a CDN in front on your Next.js application, the page will include `Cache-Control: private` response header when dynamic APIs are accessed. This ensures that the resulting HTML page is marked as non-cacheable. If the page is fully prerendered to static, it will include `Cache-Control: public` to allow the page to be cached on the CDN."
		},
		{
			"heading": "usage-with-cdns",
			"content": "If you don't need a mix of both static and dynamic components, you can make your entire route static and cache the output HTML on a CDN. This Automatic Static Optimization is the default behavior when running `next build` if dynamic APIs are not used."
		},
		{
			"heading": "usage-with-cdns",
			"content": "As Partial Prerendering moves to stable, we will provide support through the Deployment Adapters API."
		},
		{
			"heading": "after",
			"content": "`after` is fully supported when self-hosting with `next start`."
		},
		{
			"heading": "after",
			"content": "When stopping the server, ensure a graceful shutdown by sending `SIGINT` or `SIGTERM` signals and waiting. This allows the Next.js server to wait until after pending callback functions or promises used inside `after` have finished."
		},
		{
...
var toc = [
	...
	{
		depth: 2,
		url: "#partial-prerendering",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Partial Prerendering" })
	},
	{
		depth: 2,
		url: "#usage-with-cdns",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Usage with CDNs" })
	},
	{
		depth: 2,
		url: "#after",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)("code", { children: "after" }) })
	},
	{
		depth: 2,
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://www.youtube.com/watch?v=sIVL4JMqRfc",
					children: "YouTube (45 minutes)"
				}),
				"."
			] }),
			"\n"
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/guides/static-exports#image-optimization",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "/docs/app/api-reference/components/image#minimumcachettl",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" or ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/config/next-config-js/rewrites#header-cookie-and-query-matching",
				children: "rewrite"
			}),
			" through ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.js" }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [(0, import_jsx_runtime.jsx)(_components.p, { children: "You safely read environment variables on the server during dynamic rendering." }), (0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/config/next-config-js/assetPrefix",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "    // tags is either a string or an array of strings"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // If you want to have temporary in memory cache for a single request that is reset"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // before the next request you can leverage this method"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.h2, {
				id: "usage-with-cdns",
				children: "Usage with CDNs"
			}),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"When using a CDN in front on your Next.js application, the page will include ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "Cache-Control: private" }),
				" response header when dynamic APIs are accessed. This ensures that the resulting HTML page is marked as non-cacheable. If the page is fully prerendered to static, it will include ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "Cache-Control: public" }),
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "As Partial Prerendering moves to stable, we will provide support through the Deployment Adapters API." })
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			(0, import_jsx_runtime.jsx)(_components.h2, {
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, self_hosting_exports as r, MDXContent as t };
