...
//#region node_modules/.nitro/vite/services/ssr/assets/01-static-exports-Ddi41tRf.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _01_static_exports_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		{
			"heading": void 0,
			"content": "Since Next.js supports this static export, it can be deployed and hosted on any web server that can serve HTML/CSS/JS static assets."
		},
		{
			"heading": void 0,
			"content": "> **Good to know**: We recommend using the App Router for enhanced static export support."
		},
		{
			"heading": "configuration",
			"content": "To enable a static export, change the output mode inside `next.config.js`:"
		},
		{
			"heading": "configuration",
			"content": "After running `next build`, Next.js will produce an `out` folder which contains the HTML/CSS/JS assets for your application."
		},
		{
			"heading": "configuration",
			"content": "You can utilize `getStaticProps` and `getStaticPaths` to generate an HTML file for each page in your `pages` directory (or more for dynamic routes)."
		},
		{
			"heading": "supported-features",
			"content": "The core of Next.js has been designed to support static exports."
		},
		{
			"heading": "server-components",
			"content": "When you run `next build` to generate a static export, Server Components consumed inside the `app` directory will run during the build, similar to traditional static-site generation."
		},
		{
			"heading": "server-components",
			"content": "The resulting component will be rendered into static HTML for the initial page load and a static payload for client navigation between routes. No changes are required for your Server Components when using the static export, unless they consume dynamic server functions."
		},
		{
			"heading": "client-components",
			"content": "If you want to perform data fetching on the client, you can use a Client Component with SWR to memoize requests."
		},
		{
			"heading": "client-components",
			"content": "Since route transitions happen client-side, this behaves like a traditional SPA. For example, the following index route allows you to navigate to different posts on the client:"
		},
		{
			"heading": "supported-features-1",
			"content": "The majority of core Next.js features needed to build a static site are supported, including:"
		},
		{
			"heading": "supported-features-1",
			"content": "Dynamic Routes when using `getStaticPaths`"
		},
		{
			"heading": "supported-features-1",
			"content": "Prefetching with `next/link`"
		},
		{
			"heading": "supported-features-1",
			"content": "Preloading JavaScript"
		},
		{
			"heading": "supported-features-1",
		...
		{
			"heading": "supported-features-1",
			"content": "Any styling options (e.g. CSS Modules, styled-jsx)"
		},
		{
			"heading": "supported-features-1",
		...
		},
		{
			...
			"content": "Image Optimization through `next/image` can be used with a static export by defining a custom image loader in `next.config.js`. For example, you can optimize images with a service like Cloudinary:"
		},
		{
			"heading": "image-optimization",
			"content": "This custom loader will define how to fetch images from a remote source. For example, the following loader will construct the URL for Cloudinary:"
		},
		{
			"heading": "image-optimization",
			"content": "You can then use `next/image` in your application, defining relative paths to the image in Cloudinary:"
		},
		{
			"heading": "route-handlers",
			"content": "Route Handlers will render a static response when running `next build`. Only the `GET` HTTP verb is supported. This can be used to generate static HTML, JSON, TXT, or other files from cached or uncached data. For example:"
		},
		{
			"heading": "route-handlers",
			"content": "The above file `app/data.json/route.ts` will render to a static file during `next build`, producing `data.json` containing `{ name: 'Lee' }`."
		},
		{
			"heading": "route-handlers",
			"content": "If you need to read dynamic values from the incoming request, you cannot use a static export."
		},
		{
			"heading": "browser-apis",
			"content": "Client Components are pre-rendered to HTML during `next build`. Because Web APIs like `window`, `localStorage`, and `navigator` are not available on the server, you need to safely access these APIs only when running in the browser. For example:"
		},
		{
			"heading": "unsupported-features",
			"content": "Features that require a Node.js server, or dynamic logic that cannot be computed during the build process, are **not** supported:"
		},
		{
			"heading": "unsupported-features",
			"content": "Dynamic Routes with `dynamicParams: true`"
		},
		{
			"heading": "unsupported-features",
			"content": "Dynamic Routes without `generateStaticParams()`"
		},
		{
			"heading": "unsupported-features",
			"content": "Route Handlers that rely on Request"
		},
		{
			"heading": "unsupported-features",
			"content": "Cookies"
		...
		{
			"heading": "unsupported-features",
			"content": "Image Optimization with the default `loader`"
		},
		{
			"heading": "unsupported-features",
			"content": "Draft Mode"
		...
		{
			"heading": "unsupported-features",
			"content": "Attempting to use any of these features with `next dev` will result in an error, similar to setting the `dynamic` option to `error` in the root layout."
		},
		{
			"heading": "unsupported-features",
		...
		{
			"heading": "unsupported-features",
			"content": "`getStaticPaths` with `fallback: true`"
		},
		{
			"heading": "unsupported-features",
			"content": "`getStaticPaths` with `fallback: 'blocking'`"
		},
		{
			"heading": "unsupported-features",
		...
		{
			"heading": "deploying",
			"content": "With a static export, Next.js can be deployed and hosted on any web server that can serve HTML/CSS/JS static assets."
		},
		{
			"heading": "deploying",
			"content": "When running `next build`, Next.js generates the static export into the `out` folder. Using `next export` is no longer needed. For example, let's say you have the following routes:"
		},
		{
			"heading": "deploying",
			"content": "`/`"
		...
		{
			"heading": "deploying",
			"content": "After running `next build`, Next.js will generate the following files:"
		},
		{
			"heading": "deploying",
		...
		{
			"heading": "deploying",
			"content": "`/out/404.html`"
		},
		{
			"heading": "deploying",
			"content": "`/out/blog/post-1.html`"
		},
		{
			"heading": "deploying",
			"content": "`/out/blog/post-2.html`"
		},
		{
			"heading": "deploying",
			"content": "If you are using a static host like Nginx, you can configure rewrites from incoming requests to the correct files:"
		},
		{
		...
		{
			"heading": "version-history",
			"content": "App Router (Stable) adds enhanced static export support, including using React Server Components and Route Handlers."
		},
		{
			"heading": "version-history",
			"content": "`v13.3.0`"
		...
		{
			"heading": "version-history",
			"content": "`next export` is deprecated and replaced with `\"output\": \"export\"`"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		depth: 3,
		url: "#browser-apis",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Browser APIs" })
	},
	{
		depth: 2,
	...
	},
	{
		depth: 2,
		url: "#deploying",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Deploying" })
	},
	{
		depth: 2,
		url: "#version-history",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Since Next.js supports this static export, it can be deployed and hosted on any web server that can serve HTML/CSS/JS static assets." }),
		"\n",
		(0, import_jsx_runtime.jsx)(PagesOnly, { children: (0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Good to know" }), ": We recommend using the App Router for enhanced static export support."] }),
			"\n"
		] }) }),
		"\n",
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Optional: Change links `/me` -> `/me/` and emit `/me.html` -> `/me/index.html`"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Optional: Prevent automatic `/me` -> `/me/`, instead preserve `href`"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // skipTrailingSlashRedirect: true,"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, { className: "line" }),
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  // Optional: Change the output directory `out` -> `dist`"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "The core of Next.js has been designed to support static exports." }),
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: "dynamic server functions"
				}),
				"."
			] }),
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // This fetch will run on the server during `next build`"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "Since route transitions happen client-side, this behaves like a traditional SPA. For example, the following index route allows you to navigate to different posts on the client:" }),
			(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
				defaultValue: "app/page.tsx",
				children: [
					(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
		...
		(0, import_jsx_runtime.jsxs)(PagesOnly, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.p, { children: "The majority of core Next.js features needed to build a static site are supported, including:" }),
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.a, {
					href: "/docs/app/building-your-application/routing/dynamic-routes",
					children: ["Dynamic Routes when using ", (0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticPaths" })]
				}) }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Prefetching with ", (0, import_jsx_runtime.jsx)(_components.code, { children: "next/link" })] }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "Preloading JavaScript" }),
				"\n",
				...
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "Any styling options (e.g. CSS Modules, styled-jsx)" }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/data-fetching/client-side",
					children: "Client-side data fetching"
				}) }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/pages/building-your-application/data-fetching/get-static-props",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This custom loader will define how to fetch images from a remote source. For example, the following loader will construct the URL for Cloudinary:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "my-loader.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "my-loader.ts",
					children: "my-loader.ts"
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " `https://res.cloudinary.com/demo/image/upload/${"
									}),
									(0, import_jsx_runtime.jsx)(_components.span, {
										style: {
											"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
				defaultValue: "app/data.json/route.ts",
				children: [
					(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/data.json/route.ts",
						children: "app/data.json/route.ts"
					}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/data.json/route.js",
						children: "app/data.json/route.js"
					})] }),
					(0, import_jsx_runtime.jsx)(CodeBlockTab, {
						value: "app/data.json/route.ts",
						children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"The above file ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "app/data.json/route.ts" }),
				" will render to a static file during ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }),
				", producing ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "data.json" }),
				" containing ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "{ name: 'Lee' }" }),
				"."
			] }),
			(0, import_jsx_runtime.jsx)(_components.p, { children: "If you need to read dynamic values from the incoming request, you cannot use a static export." }),
			(0, import_jsx_runtime.jsx)(_components.h3, {
				id: "browser-apis",
				children: "Browser APIs"
			}),
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				", and ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "navigator" }),
				...
				children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: (0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    // You now have access to `window`"
						})
					}),
					"\n",
					(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(PagesOnly, { children: (0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/pages/api-reference/functions/get-static-paths#fallback-blocking",
				children: [
					(0, import_jsx_runtime.jsx)(_components.code, { children: "getStaticPaths" }),
					" with ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "With a static export, Next.js can be deployed and hosted on any web server that can serve HTML/CSS/JS static assets." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"When running ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "next build" }),
			...
			" is no longer needed. For example, let's say you have the following routes:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/blog/[id]" }) }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/out/index.html" }) }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/out/404.html" }) }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/out/blog/post-1.html" }) }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/out/blog/post-2.html" }) }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If you are using a static host like Nginx, you can configure rewrites from incoming requests to the correct files:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  # This is necessary when `trailingSlash: false`."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "  # You can omit this when `trailingSlash: true`."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, _01_static_exports_exports as n, frontmatter as r, MDXContent as t };
