...
//#region node_modules/.nitro/vite/services/ssr/assets/use-pathname-Cz7UZpyE.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var use_pathname_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "`usePathname` is a **Client Component** hook that lets you read the current URL's **pathname**."
		},
		{
			"heading": void 0,
			"content": "`usePathname` intentionally requires using a Client Component. It's important to note Client Components are not a de-optimization. They are an integral part of the Server Components architecture."
		},
		{
			"heading": void 0,
			"content": "For example, a Client Component with `usePathname` will be rendered into HTML on the initial page load. When navigating to a new route, this component does not need to be re-fetched. Instead, the component is downloaded once (in the client JavaScript bundle), and re-renders based on the current state."
		},
		{
			"heading": void 0,
		...
		{
			"heading": "parameters",
			"content": "`usePathname` does not take any parameters."
		},
		{
			"heading": "returns",
			"content": "`usePathname` returns a string of the current URL's pathname. For example:"
		},
		{
			"heading": "returns",
			"content": "URL"
		...
		{
			"heading": "avoid-hydration-mismatch-with-rewrites",
			"content": "When a page is pre-rendered, the HTML is generated for the source pathname. If the page is then reached through a rewrite using `next.config` or `Middleware`, the browser URL may differ, and `usePathname()` will read the rewritten pathname on the client."
		},
		{
			"heading": "avoid-hydration-mismatch-with-rewrites",
			"content": "To avoid hydration mismatches, design the UI so that only a small, isolated part depends on the client pathname. Render a stable fallback on the server and update that part after mount."
		},
		{
			"heading": "avoid-hydration-mismatch-with-rewrites",
			"content": "Version"
		...
		{
			"heading": "avoid-hydration-mismatch-with-rewrites",
			"content": "`usePathname` introduced."
		}
	],
	"headings": [
		{
		...
		{
			"id": "do-something-in-response-to-a-route-change",
			"content": "Do something in response to a route change"
		},
		{
			"id": "avoid-hydration-mismatch-with-rewrites",
...
var toc = [
	...
	{
		depth: 3,
		url: "#do-something-in-response-to-a-route-change",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Do something in response to a route change" })
	},
	{
		depth: 3,
		url: "#avoid-hydration-mismatch-with-rewrites",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Avoid hydration mismatch with rewrites" })
	}
];
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "pathname" }),
			"."
		] }),
		"\n",
					...
					(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
						...
						(0, import_jsx_runtime.jsxs)(_components.li, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.a, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.code, { children: "next.config" })
							}),
							" or ",
							(0, import_jsx_runtime.jsx)(_components.a, {
								href: "/docs/app/api-reference/file-conventions/middleware",
								children: (0, import_jsx_runtime.jsx)(_components.code, { children: "Middleware" })
							}),
							", ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "usePathname" }), " does not take any parameters."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "returns",
			children: "Returns"
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "usePathname" }), " returns a string of the current URL's pathname. For example:"] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.th, { children: "URL" }), (0, import_jsx_runtime.jsx)(_components.th, { children: "Returned value" })] }) }), (0, import_jsx_runtime.jsxs)(_components.tbody, { children: [
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "'/'" }) })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "'/dashboard'" }) })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/dashboard?v=2" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "'/dashboard'" }) })] }),
			(0, import_jsx_runtime.jsxs)(_components.tr, { children: [(0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "/blog/hello-world" }) }), (0, import_jsx_runtime.jsx)(_components.td, { children: (0, import_jsx_runtime.jsx)(_components.code, { children: "'/blog/hello-world'" }) })] })
		] })] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "examples",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "do-something-in-response-to-a-route-change",
			children: "Do something in response to a route change"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/example-client-component.tsx",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "avoid-hydration-mismatch-with-rewrites",
			children: "Avoid hydration mismatch with rewrites"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "To avoid hydration mismatches, design the UI so that only a small, isolated part depends on the client pathname. Render a stable fallback on the server and update that part after mount." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/example-client-component.tsx",
			children: [
...
//#endregion
export { use_pathname_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
