...
//#region node_modules/.nitro/vite/services/ssr/assets/redirect-BX0MEI8f.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "behavior",
			"content": "In Server Actions and Route Handlers, `redirect` should be called after the `try/catch` block."
		},
		{
			"heading": "behavior",
		...
		{
			"heading": "behavior",
			"content": "`redirect` internally throws an error so it should be called outside of `try/catch` blocks."
		},
		{
			"heading": "behavior",
