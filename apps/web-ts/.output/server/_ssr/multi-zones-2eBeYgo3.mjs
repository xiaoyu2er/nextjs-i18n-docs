...
//#region node_modules/.nitro/vite/services/ssr/assets/multi-zones-2eBeYgo3.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var multi_zones_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "A zone is a normal Next.js application where you also configure an assetPrefix to avoid conflicts with pages and static files in other zones."
		},
		{
			"heading": "how-to-define-a-zone",
			"content": "Next.js assets, such as JavaScript and CSS, will be prefixed with `assetPrefix` to make sure that they don't conflict with assets from other zones. These assets will be served under `/assetPrefix/_next/...` for each of the zones."
		},
		{
			"heading": "how-to-define-a-zone",
			"content": "The default application handling all paths not routed to another more specific zone does not need an `assetPrefix`."
		},
		{
			"heading": "how-to-define-a-zone",
			"content": "In versions older than Next.js 15, you may also need an additional rewrite to handle the static assets. This is no longer necessary in Next.js 15."
		},
		{
		...
		{
			"heading": "how-to-route-requests-to-the-right-zone",
			"content": "To route to the correct zone using a Next.js application, you can use `rewrites`. For each path served by a different zone, you would add a rewrite rule to send that path to the domain of the other zone, and you also need to rewrite the requests for the static assets. For example:"
		},
		{
			"heading": "how-to-route-requests-to-the-right-zone",
		...
		{
			"heading": "routing-requests-using-middleware",
			"content": "Routing requests through `rewrites` is recommended to minimize latency overhead for the requests, but middleware can also be used when there is a need for a dynamic decision when routing. For example, if you are using a feature flag to decide where a path should be routed such as during a migration, you can use middleware."
		},
		{
		...
		},
		{
			...
			"content": "When using Server Actions with Multi-Zones, you must explicitly allow the user-facing origin since your user facing domain may serve multiple applications. In your `next.config.js` file, add the following lines:"
		},
		{
			"heading": "server-actions",
			"content": "See `serverActions.allowedOrigins` for more information."
		}
	],
	"headings": [
		{
		...
		{
			"id": "routing-requests-using-middleware",
			"content": "Routing requests using middleware"
		},
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#routing-requests-using-middleware",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Routing requests using middleware" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "/assetPrefix/_next/..." }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "In versions older than Next.js 15, you may also need an additional rewrite to handle the static assets. This is no longer necessary in Next.js 15." }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "'/blog-static/_next/:path+'"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "routing-requests-using-middleware",
			children: "Routing requests using middleware"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(AppOnly, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				" with Multi-Zones, you must explicitly allow the user-facing origin since your user facing domain may serve multiple applications. In your ",
					...
					(0, import_jsx_runtime.jsxs)(_components.span, {
						...
						children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: "'your-production-domain.com'"
							}),
							(0, import_jsx_runtime.jsx)(_components.span, {
								style: {
									"--shiki-light": "#24292E",
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				"See ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "/docs/app/api-reference/config/next-config-js/serverActions#allowedorigins",
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, multi_zones_exports as r, MDXContent as t };
