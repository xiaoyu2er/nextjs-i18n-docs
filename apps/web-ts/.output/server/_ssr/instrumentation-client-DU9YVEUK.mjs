...
//#region node_modules/.nitro/vite/services/ssr/assets/instrumentation-client-DU9YVEUK.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var instrumentation_client_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `instrumentation-client.js|ts` file allows you to add monitoring and analytics code that runs before your application's frontend code starts executing. This is useful for setting up performance tracking, error monitoring, or any other client-side observability tools."
		},
		{
			"heading": void 0,
			"content": "To use it, place the file in the **root** of your application or inside a `src` folder."
		},
		{
			"heading": "usage",
			"content": "Unlike server-side instrumentation, you do not need to export any specific functions. You can write your monitoring code directly in the file:"
		},
		{
		...
		{
			"heading": "version-history",
			"content": "`instrumentation-client` introduced"
		}
	],
	"headings": [{
		"id": "usage",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "instrumentation-client.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "instrumentation-client.ts",
					children: "instrumentation-client.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "instrumentation-client.js",
					children: "instrumentation-client.js"
				})] }),
...
//#endregion
export { toc as a, structuredData as i, frontmatter as n, instrumentation_client_exports as r, MDXContent as t };
