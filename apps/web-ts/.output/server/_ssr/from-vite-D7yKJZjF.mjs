...
//#region node_modules/.nitro/vite/services/ssr/assets/from-vite-D7yKJZjF.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var from_vite_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "This guide will help you migrate an existing Vite application to Next.js."
		},
		{
			"heading": "why-switch",
			"content": "There are several reasons why you might want to switch from Vite to Next.js:"
		},
		{
			"heading": "slow-initial-page-loading-time",
			"content": "If you have built your application with the default Vite plugin for React, your application is a purely client-side application. Client-side only applications, also known as single-page applications (SPAs), often experience slow initial page loading time. This happens due to a couple of reasons:"
		},
		{
			"heading": "slow-initial-page-loading-time",
			"content": "The browser needs to wait for the React code and your entire application bundle to download and run before your code is able to send requests to load some data."
		},
		{
			"heading": "slow-initial-page-loading-time",
			"content": "Your application code grows with every new feature and extra dependency you add."
		},
		{
			"heading": "no-automatic-code-splitting",
			"content": "The previous issue of slow loading times can be somewhat managed with code splitting. However, if you try to do code splitting manually, you'll often make performance worse. It's easy to inadvertently introduce network waterfalls when code-splitting manually. Next.js provides automatic code splitting built into its router."
		},
		{
		...
		{
			"heading": "network-waterfalls",
			"content": "While fetching data on the client is supported with Next.js, it also gives you the option to shift data fetching to the server, which can eliminate client-server waterfalls."
		},
		{
			"heading": "fast-and-intentional-loading-states",
			"content": "With built-in support for streaming through React Suspense, you can be more intentional about which parts of your UI you want to load first and in what order without introducing network waterfalls."
		},
		{
			"heading": "fast-and-intentional-loading-states",
		...
		},
		{
			...
			"content": "Depending on your needs, Next.js allows you to choose your data fetching strategy on a page and component basis. You can decide to fetch at build time, at request time on the server, or on the client. For example, you can fetch data from your CMS and render your blog posts at build time, which can then be efficiently cached on a CDN."
		},
		{
			"heading": "middleware",
			"content": "Next.js Middleware allows you to run code on the server before a request is completed. This is especially useful to avoid having a flash of unauthenticated content when the user visits an authenticated-only page by redirecting the user to a login page. The middleware is also useful for experimentation and internationalization."
		},
		{
			"heading": "built-in-optimizations",
			"content": "Images, fonts, and third-party scripts often have significant impact on an application's performance. Next.js comes with built-in components that automatically optimize those for you."
		},
		{
			"heading": "migration-steps",
			"content": "Our goal with this migration is to get a working Next.js application as quickly as possible, so that\nyou can then adopt Next.js features incrementally. To begin with, we'll keep it as a purely\nclient-side application (SPA) without migrating your existing router. This helps minimize the\nchances of encountering issues during the migration process and reduces merge conflicts."
		},
		{
			"heading": "step-1-install-the-nextjs-dependency",
			"content": "The first thing you need to do is to install `next` as a dependency:"
		},
		{
			"heading": "step-2-create-the-nextjs-configuration-file",
			"content": "Create a `next.config.mjs` at the root of your project. This file will hold your\nNext.js configuration options."
		},
		{
			"heading": "step-2-create-the-nextjs-configuration-file",
			"content": "> **Good to know:** You can use either `.js` or `.mjs` for your Next.js configuration file."
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "If you're using TypeScript, you need to update your `tsconfig.json` file with the following changes\nto make it compatible with Next.js. If you're not using TypeScript, you can skip this step."
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Remove the project reference to `tsconfig.node.json`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Add `./dist/types/**/*.ts` and `./next-env.d.ts` to the `include` array"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Add `./node_modules` to the `exclude` array"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Add `{ \"name\": \"next\" }` to the `plugins` array in `compilerOptions`: `\"plugins\": [{ \"name\": \"next\" }]`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Set `esModuleInterop` to `true`: `\"esModuleInterop\": true`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Set `jsx` to `preserve`: `\"jsx\": \"preserve\"`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Set `allowJs` to `true`: `\"allowJs\": true`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Set `forceConsistentCasingInFileNames` to `true`: `\"forceConsistentCasingInFileNames\": true`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "Set `incremental` to `true`: `\"incremental\": true`"
		},
		{
			"heading": "step-3-update-typescript-configuration",
		...
		{
			"heading": "step-3-update-typescript-configuration",
			"content": "You can find more information about configuring TypeScript on the\nNext.js docs."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "A Next.js App Router application must include a\nroot layout\nfile, which is a React Server Component\nthat will wrap all pages in your application. This file is defined at the top level of the `app`\ndirectory."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "The closest equivalent to the root layout file in a Vite application is the\n`index.html` file, which contains your\n`<html>`, `<head>`, and `<body>` tags."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "In this step, you'll convert your `index.html` file into a root layout file:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Create a new `app` directory in your `src` folder."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Create a new `layout.tsx` file inside that `app` directory:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "> **Good to know**: `.js`, `.jsx`, or `.tsx` extensions can be used for Layout files."
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Copy the content of your `index.html` file into the previously created `<RootLayout>` component while\nreplacing the `body.div#root` and `body.script` tags with `<div id=\"root\">{children}</div>`:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Next.js already includes by default the\nmeta charset and\nmeta viewport tags, so you\ncan safely remove those from your `<head>`:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Any metadata files\nsuch as `favicon.ico`, `icon.png`, `robots.txt` are automatically added to the application\n`<head>` tag as long as you have them placed into the top level of the `app` directory. After\nmoving\nall supported files\ninto the `app` directory you can safely delete their `<link>` tags:"
		},
		{
			"heading": "step-4-create-the-root-layout",
			"content": "Finally, Next.js can manage your last `<head>` tags with the\nMetadata API. Move your final metadata\ninfo into an exported\n`metadata` object:"
		},
		{
			"heading": "step-4-create-the-root-layout",
		...
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "On Next.js you declare an entrypoint for your application by creating a `page.tsx` file. The\nclosest equivalent of this file on Vite is your `main.tsx` file. In this step, you’ll set up the\nentrypoint of your application."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "**Create a `[[...slug]]` directory in your `app` directory.**"
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "Since in this guide we're aiming first to set up our Next.js as an SPA (Single Page Application), you need your page entrypoint to catch all possible routes of your application. For that, create a new `[[...slug]]` directory in your `app` directory."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "This directory is what is called an optional catch-all route segment. Next.js uses a file-system based router where folders are used to define routes. This special directory will make sure that all routes of your application will be directed to its containing `page.tsx` file."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "**Create a new `page.tsx` file inside the `app/[[...slug]]` directory with the following content:**"
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "> **Good to know**: `.js`, `.jsx`, or `.tsx` extensions can be used for Page files."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "This file is a Server Component. When you run `next build`, the file is prerendered into a static asset. It does *not* require any dynamic code."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "This file imports our global CSS and tells `generateStaticParams` we are only going to generate one route, the index route at `/`."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "Now, let's move the rest of our Vite application which will run client-only."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "This file is a Client Component, defined by the `'use client'`\ndirective. Client Components are still prerendered to HTML on the server before being sent to the client."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "Since we want a client-only application to start, we can configure Next.js to disable prerendering from the `App` component down."
		},
		{
			"heading": "step-5-create-the-entrypoint-page",
			"content": "Now, update your entrypoint page to use the new component:"
		},
		{
			"heading": "step-6-update-static-image-imports",
			"content": "Next.js handles static image imports slightly different from Vite. With Vite, importing an image\nfile will return its public URL as a string:"
		},
		{
			"heading": "step-6-update-static-image-imports",
			"content": "With Next.js, static image imports return an object. The object can then be used directly with the\nNext.js `<Image>` component, or you can use the object's\n`src` property with your existing `<img>` tag."
		},
		{
			"heading": "step-6-update-static-image-imports",
			"content": "The `<Image>` component has the added benefits of\nautomatic image optimization. The `<Image>`\ncomponent automatically sets the `width` and `height` attributes of the resulting `<img>` based on\nthe image's dimensions. This prevents layout shifts when the image loads. However, this can cause\nissues if your app contains images with only one of their dimensions being styled without the other\nstyled to `auto`. When not styled to `auto`, the dimension will default to the `<img>` dimension\nattribute's value, which can cause the image to appear distorted."
		},
		{
			"heading": "step-6-update-static-image-imports",
		...
		{
			"heading": "step-6-update-static-image-imports",
			"content": "> **Warning:** If you're using TypeScript, you might encounter type errors when accessing the `src`\n> property. You can safely ignore those for now. They will be fixed by the end of this guide."
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "Next.js has support for `.env`\nenvironment variables\nsimilar to Vite. The main difference is the prefix used to expose environment variables on the\nclient-side."
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "Change all environment variables with the `VITE_` prefix to `NEXT_PUBLIC_`."
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "Vite exposes a few built-in environment variables on the special `import.meta.env` object which\naren’t supported by Next.js. You need to update their usage as follows:"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "`import.meta.env.MODE` ⇒ `process.env.NODE_ENV`"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "`import.meta.env.PROD` ⇒ `process.env.NODE_ENV === 'production'`"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "`import.meta.env.DEV` ⇒ `process.env.NODE_ENV !== 'production'`"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "`import.meta.env.SSR` ⇒ `typeof window !== 'undefined'`"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "Next.js also doesn't provide a built-in `BASE_URL` environment variable. However, you can still\nconfigure one, if you need it:"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "**Add the following to your `.env` file:**"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "**Set `basePath` to `process.env.NEXT_PUBLIC_BASE_PATH` in your `next.config.mjs` file:**"
		},
		{
			"heading": "step-7-migrate-the-environment-variables",
			"content": "**Update `import.meta.env.BASE_URL` usages to `process.env.NEXT_PUBLIC_BASE_PATH`**"
		},
		{
			"heading": "step-8-update-scripts-in-packagejson",
			"content": "You should now be able to run your application to test if you successfully migrated to Next.js. But\nbefore that, you need to update your `scripts` in your `package.json` with Next.js related commands,\nand add `.next` and `next-env.d.ts` to your `.gitignore`:"
		},
		{
			"heading": "step-8-update-scripts-in-packagejson",
			"content": "Now run `npm run dev`, and open `http://localhost:3000`. You should see your application now running on Next.js."
		},
		{
			"heading": "step-8-update-scripts-in-packagejson",
			"content": "> **Example:** Check out this pull request for a\n> working example of a Vite application migrated to Next.js."
		},
		{
			"heading": "step-9-clean-up",
			"content": "You can now clean up your codebase from Vite related artifacts:"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Delete `main.tsx`"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Delete `index.html`"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Delete `vite-env.d.ts`"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Delete `tsconfig.node.json`"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Delete `vite.config.ts`"
		},
		{
			"heading": "step-9-clean-up",
			"content": "Uninstall Vite dependencies"
		},
		{
			"heading": "next-steps",
			"content": "If everything went according to plan, you now have a functioning Next.js application running as a\nsingle-page application. However, you aren't yet taking advantage of most of Next.js' benefits, but\nyou can now start making incremental changes to reap all the benefits. Here's what you might want to\ndo next:"
		},
		{
			"heading": "next-steps",
			"content": "Migrate from React Router to the Next.js App Router to get:"
		},
		{
			"heading": "next-steps",
		...
		{
			"heading": "next-steps",
			"content": "Update your ESLint configuration to support Next.js rules"
		}
	],
	"headings": [
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#step-3-update-typescript-configuration",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 3: Update TypeScript Configuration" })
	},
	{
		depth: 3,
		url: "#step-4-create-the-root-layout",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 4: Create the Root Layout" })
	},
	{
		depth: 3,
		url: "#step-5-create-the-entrypoint-page",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 5: Create the Entrypoint Page" })
	},
	{
		depth: 3,
		url: "#step-6-update-static-image-imports",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 6: Update Static Image Imports" })
	},
	{
		depth: 3,
		url: "#step-7-migrate-the-environment-variables",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 7: Migrate the Environment Variables" })
	},
	{
		depth: 3,
		url: "#step-8-update-scripts-in-packagejson",
		title: (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: ["Step 8: Update Scripts in ", (0, import_jsx_runtime.jsx)("code", { children: "package.json" })] })
	},
	{
		depth: 3,
		url: "#step-9-clean-up",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 9: Clean Up" })
	},
	{
		depth: 2,
		url: "#next-steps",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsx)(_components.p, { children: "This guide will help you migrate an existing Vite application to Next.js." }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "There are several reasons why you might want to switch from Vite to Next.js:" }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react",
				children: "default Vite plugin for React"
			}),
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The browser needs to wait for the React code and your entire application bundle to download and run before your code is able to send requests to load some data." }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Your application code grows with every new feature and extra dependency you add." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "The previous issue of slow loading times can be somewhat managed with code splitting. However, if you try to do code splitting manually, you'll often make performance worse. It's easy to inadvertently introduce network waterfalls when code-splitting manually. Next.js provides automatic code splitting built into its router." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "network-waterfalls",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "A common cause of poor performance occurs when applications make sequential client-server requests to fetch data. One common pattern for data fetching in an SPA is to initially render a placeholder, and then fetch data after the component has mounted. Unfortunately, this means that a child component that fetches data can't start fetching until the parent component has finished loading its own data." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "While fetching data on the client is supported with Next.js, it also gives you the option to shift data fetching to the server, which can eliminate client-server waterfalls." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "fast-and-intentional-loading-states",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Depending on your needs, Next.js allows you to choose your data fetching strategy on a page and component basis. You can decide to fetch at build time, at request time on the server, or on the client. For example, you can fetch data from your CMS and render your blog posts at build time, which can then be efficiently cached on a CDN." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "middleware",
			children: "Middleware"
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Our goal with this migration is to get a working Next.js application as quickly as possible, so that\nyou can then adopt Next.js features incrementally. To begin with, we'll keep it as a purely\nclient-side application (SPA) without migrating your existing router. This helps minimize the\nchances of encountering issues during the migration process and reduces merge conflicts." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-1-install-the-nextjs-dependency",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "// Changes the build output directory to `./dist/`."
						})
					]
				}),
				"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-3-update-typescript-configuration",
			children: "Step 3: Update TypeScript Configuration"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Remove the ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://www.typescriptlang.org/tsconfig#references",
					children: "project reference"
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig.node.json" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Add ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "./dist/types/**/*.ts" }),
				" and ",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				" to the ",
				(0, import_jsx_runtime.jsxs)(_components.a, {
					href: "https://www.typescriptlang.org/tsconfig#exclude",
					children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "exclude" }), " array"]
				})
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Add ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "{ \"name\": \"next\" }" }),
				" to the ",
				(0, import_jsx_runtime.jsxs)(_components.a, {
					href: "https://www.typescriptlang.org/tsconfig#plugins",
					children: [
						(0, import_jsx_runtime.jsx)(_components.code, { children: "plugins" }),
						" array in ",
						(0, import_jsx_runtime.jsx)(_components.code, { children: "compilerOptions" })
					]
				}),
				": ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "\"plugins\": [{ \"name\": \"next\" }]" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Set ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "esModuleInterop" })
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }),
				": ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "\"esModuleInterop\": true" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Set ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "jsx" })
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "preserve" }),
				": ",
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "allowJs" })
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }),
				": ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "\"allowJs\": true" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Set ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://www.typescriptlang.org/tsconfig#forceConsistentCasingInFileNames",
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "forceConsistentCasingInFileNames" })
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }),
				": ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "\"forceConsistentCasingInFileNames\": true" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Set ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.code, { children: "incremental" })
				}),
				" to ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "true" }),
				": ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "\"incremental\": true" })
			] }),
			"\n"
		] }),
		"\n",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    \"useDefineForClassFields\""
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    \"allowImportingTsExtensions\""
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "    \"noFallthroughCasesInSwitch\""
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#24292E",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/config/typescript#ide-plugin",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-4-create-the-root-layout",
			children: "Step 4: Create the Root Layout"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"A Next.js ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "index.html" }), " file"]
			}),
			", which contains your\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					" and ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "body.script" }),
					" tags with ",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [
					...
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/HTML/Element/meta#charset",
						children: "meta charset"
					}),
					" and\n",
					(0, import_jsx_runtime.jsx)(_components.a, {
						href: "https://developer.mozilla.org/docs/Web/HTML/Viewport_meta_tag",
						children: "meta viewport"
					}),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-5-create-the-entrypoint-page",
			children: "Step 5: Create the Entrypoint Page"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "main.tsx" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "optional catch-all route segment"
			}),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Now, let's move the rest of our Vite application which will run client-only." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Now, update your entrypoint page to use the new component:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/[[...slug]]/page.tsx",
			children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-6-update-static-image-imports",
			children: "Step 6: Update Static Image Imports"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Next.js handles static image imports slightly different from Vite. With Vite, importing an image\nfile will return its public URL as a string:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: " // `image` will be '/assets/img.2d8efhg.png' in production"
						})
					]
				}),
				"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-7-migrate-the-environment-variables",
			children: "Step 7: Migrate the Environment Variables"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.code, { children: "VITE_" }),
				" prefix to ",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env" }),
			" object which\naren’t supported by Next.js. You need to update their usage as follows:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env.MODE" }),
				" ⇒ ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.NODE_ENV" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env.PROD" }),
				" ⇒ ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.NODE_ENV === 'production'" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env.DEV" }),
				" ⇒ ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.NODE_ENV !== 'production'" })
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env.SSR" }),
				" ⇒ ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "typeof window !== 'undefined'" })
			] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "BASE_URL" }),
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "NEXT_PUBLIC_BASE_PATH"
						}),
						(0, import_jsx_runtime.jsx)(_components.span, {
							style: {
								"--shiki-light": "#D73A49",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.strong, { children: [
					...
					" to ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.NEXT_PUBLIC_BASE_PATH" }),
					" in your ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "next.config.mjs" }),
					" file:"
				] }) }),
				...
				(0, import_jsx_runtime.jsxs)(_components.span, {
					...
					children: [
						...
						(0, import_jsx_runtime.jsx)(_components.span, {
							...
							children: "// Sets the base path to `/some-base-path`."
						})
					]
				}),
				"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.ol, {
			...
			children: [
				...
				(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.strong, { children: [
					"Update ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "import.meta.env.BASE_URL" }),
					" usages to ",
					(0, import_jsx_runtime.jsx)(_components.code, { children: "process.env.NEXT_PUBLIC_BASE_PATH" })
				] }) }),
				"\n"
		...
		(0, import_jsx_runtime.jsxs)(_components.h3, {
			id: "step-8-update-scripts-in-packagejson",
			children: ["Step 8: Update Scripts in ", (0, import_jsx_runtime.jsx)(_components.code, { children: "package.json" })]
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
		...
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					className: "line",
					children: (0, import_jsx_runtime.jsx)(_components.span, { children: "dist" })
				})
			] })
		}) }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "Example:" }),
				" Check out ",
				(0, import_jsx_runtime.jsx)(_components.a, {
					href: "https://github.com/inngest/vite-to-nextjs/pull/1",
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "step-9-clean-up",
			children: "Step 9: Clean Up"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You can now clean up your codebase from Vite related artifacts:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "main.tsx" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "index.html" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "vite-env.d.ts" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "tsconfig.node.json" })] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: ["Delete ", (0, import_jsx_runtime.jsx)(_components.code, { children: "vite.config.ts" })] }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Uninstall Vite dependencies" }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "If everything went according to plan, you now have a functioning Next.js application running as a\nsingle-page application. However, you aren't yet taking advantage of most of Next.js' benefits, but\nyou can now start making incremental changes to reap all the benefits. Here's what you might want to\ndo next:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/api-reference/components/font",
				children: ["Optimize fonts with ", (0, import_jsx_runtime.jsx)(_components.code, { children: "next/font" })]
			}) }),
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsxs)(_components.a, {
				href: "/docs/app/guides/scripts",
			...
			(0, import_jsx_runtime.jsx)(_components.li, { children: (0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: "Update your ESLint configuration to support Next.js rules"
			}) }),
			"\n"
		] })
	] });
...
//#endregion
export { toc as a, structuredData as i, from_vite_exports as n, frontmatter as r, MDXContent as t };
