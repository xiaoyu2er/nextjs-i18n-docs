...
//#region node_modules/.nitro/vite/services/ssr/assets/redirect-DmPCzlm-.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `redirect` function allows you to redirect the user to another URL. `redirect` can be used in Server Components, Client Components, Route Handlers, and Server Actions."
		},
		{
			"heading": void 0,
			"content": "When used in a streaming context, this will insert a meta tag to emit the redirect on the client side. Otherwise, it will serve a 307 HTTP redirect response to the caller."
		},
		{
			"heading": void 0,
		...
		{
			"heading": void 0,
			"content": "> **Good to know**: If you prefer to return a 308 (Permanent) HTTP redirect instead of 307 (Temporary), you can use the `permanentRedirect` function instead."
		},
		{
			"heading": "parameters",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			", this will insert a meta tag to emit the redirect on the client side. Otherwise, it will serve a 307 HTTP redirect response to the caller."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
