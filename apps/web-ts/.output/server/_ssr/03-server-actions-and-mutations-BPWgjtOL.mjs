...
//#region node_modules/.nitro/vite/services/ssr/assets/03-server-actions-and-mutations-BPWgjtOL.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var _03_server_actions_and_mutations_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["app/api-reference/config/next-config-js/serverActions"]
	}
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "Server Actions are **asynchronous functions** that are executed on the server. They can be called in Server and Client Components to handle form submissions and data mutations in Next.js applications."
		},
		{
			"heading": void 0,
			"content": "> **🎥 Watch:** Learn more about mutations with Server Actions → YouTube (10 minutes)."
		},
		{
			"heading": "convention",
		...
		},
		{
			...
			"content": "To call a Server Function in a Client Component, create a new file and add the `\"use server\"` directive at the top of it. All exported functions within the file will be marked as Server Functions that can be reused in both Client and Server Components:"
		},
		{
		...
		},
		{
			...
			"content": "While it's common to use Server Actions within `<form>` elements, they can also be invoked with event handlers such as `onClick`. For example, to increment a like count:"
		},
		{
			"heading": "event-handlers",
		...
		},
		{
			...
			"content": "When an error is thrown, it'll be caught by the nearest `error.js` or `<Suspense>` boundary on the client. See Error Handling for more information."
		},
		{
			"heading": "error-handling",
		...
		{
			"heading": "security",
			"content": "By default, when a Server Action is created and exported, it creates a public HTTP endpoint\nand should be treated with the same security assumptions and authorization checks. This means, even if a Server Action or utility function is not imported elsewhere in your code, it’s still publicly accessible."
		},
		{
			"heading": "security",
			"content": "To improve security, Next.js has the following built-in features:"
		},
		{
			"heading": "security",
			"content": "**Secure action IDs:** Next.js creates encrypted, non-deterministic IDs to allow the client to reference and call the Server Action. These IDs are periodically recalculated between builds for enhanced security."
		},
		{
			"heading": "security",
			"content": "**Dead code elimination:** Unused Server Actions (referenced by their IDs) are removed from client bundle to avoid public access by third-party."
		},
		{
			"heading": "security",
		...
		},
		{
			...
			"content": "You should ensure that the user is authorized to perform the action. For example:"
		},
		{
		...
		},
		{
			...
			"content": "For more information, check out the following React docs:"
		},
		{
			"heading": "additional-resources",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" that are executed on the server. They can be called in Server and Client Components to handle form submissions and data mutations in Next.js applications."
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.p, { children: [
				...
				" Learn more about mutations with Server Actions → ",
				(0, import_jsx_runtime.jsx)(_components.a, {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"To call a ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/getting-started/updating-data#server-functions",
				children: "Server Function"
			}),
			" in a Client Component, create a new file and add the ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "\"use server\"" }),
			" directive at the top of it. All exported functions within the file will be marked as Server Functions that can be reused in both Client and Server Components:"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"Usually, the Next.js TypeScript plugin would flag ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "updateItemAction" }),
			" in ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "client-component.tsx" }),
			" since it is a function which generally can't be serialized across client-server boundaries.\nHowever, props named ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "action" }),
			" or ending with ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "Action" }),
			" are assumed to receive Server Actions.\nThis is only a heuristic since the TypeScript plugin doesn't actually know if it receives a Server Action or an ordinary function.\nRuntime type-checking will still ensure you don't accidentally pass a function to a Client Component."
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "behavior",
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "Server Actions inherit the runtime from the page or layout they are used on." }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "<form>" }),
			" elements, they can also be invoked with event handlers such as ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "By default, when a Server Action is created and exported, it creates a public HTTP endpoint\nand should be treated with the same security assumptions and authorization checks. This means, even if a Server Action or utility function is not imported elsewhere in your code, it’s still publicly accessible." }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "To improve security, Next.js has the following built-in features:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Secure action IDs:" }), " Next.js creates encrypted, non-deterministic IDs to allow the client to reference and call the Server Action. These IDs are periodically recalculated between builds for enhanced security."] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Dead code elimination:" }), " Unused Server Actions (referenced by their IDs) are removed from client bundle to avoid public access by third-party."] }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.p, { children: "The IDs are created during compilation and are cached for a maximum of 14 days. They will be regenerated when a new build is initiated or when the build cache is invalidated.\nThis security improvement reduces the risk in cases where an authentication layer is missing. However, you should still treat Server Actions like public HTTP endpoints." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// This action **is** used in our application, so Next.js"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// will create a secure ID to allow the client to reference"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// and call the Server Action."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
				...
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// This action **is not** used in our application, so Next.js"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// will automatically remove this code during `next build`"
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.span, {
					...
					children: (0, import_jsx_runtime.jsx)(_components.span, {
						...
						children: "// and will not create a public endpoint."
					})
				}),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "You should ensure that the user is authorized to perform the action. For example:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/app/api-reference/config/next-config-js/serverActions",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For more information, check out the following React docs:" }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
...
//#endregion
export { toc as a, structuredData as i, _03_server_actions_and_mutations_exports as n, frontmatter as r, MDXContent as t };
