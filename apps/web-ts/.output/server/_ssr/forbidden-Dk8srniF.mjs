...
//#region node_modules/.nitro/vite/services/ssr/assets/forbidden-Dk8srniF.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var forbidden_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"related": { "links": ["app/api-reference/file-conventions/forbidden"] }
};
var structuredData = {
	"contents": [
		{
		...
		{
			"heading": void 0,
			"content": "To start using `forbidden`, enable the experimental `authInterrupts` configuration option in your `next.config.js` file:"
		},
		{
			"heading": void 0,
			"content": "`forbidden` can be invoked in Server Components, Server Actions, and Route Handlers."
		},
		{
			"heading": "good-to-know",
			"content": "The `forbidden` function cannot be called in the root layout."
		},
		{
			"heading": "role-based-route-protection",
			"content": "You can use `forbidden` to restrict access to certain routes based on user roles. This ensures that users who are authenticated but lack the required permissions cannot access the route."
		},
		{
			"heading": "mutations-with-server-actions",
			"content": "When implementing mutations in Server Actions, you can use `forbidden` to only allow users with a specific role to update sensitive data."
		},
		{
...
var toc = [
	...
	{
		depth: 3,
		url: "#role-based-route-protection",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Role-based route protection" })
	},
	{
		depth: 3,
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.a, {
				...
				children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "forbidden.js" }), " file"]
			}),
			"."
		] }),
		"\n",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/auth/page.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Render the admin page for authorized users"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "role-based-route-protection",
			children: "Role-based route protection"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"You can use ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/admin/page.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/admin/page.tsx",
					children: "app/admin/page.tsx"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/admin/page.js",
					children: "app/admin/page.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/admin/page.tsx",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/actions/update-role.ts",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/actions/update-role.ts",
					children: "app/actions/update-role.ts"
				}), (0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					value: "app/actions/update-role.js",
					children: "app/actions/update-role.js"
				})] }),
				(0, import_jsx_runtime.jsx)(CodeBlockTab, {
					value: "app/actions/update-role.ts",
					children: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Ensure only admins can update roles"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Perform the role update for authorized users"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsx)(_components.span, {
...
//#endregion
export { toc as a, structuredData as i, forbidden_exports as n, frontmatter as r, MDXContent as t };
