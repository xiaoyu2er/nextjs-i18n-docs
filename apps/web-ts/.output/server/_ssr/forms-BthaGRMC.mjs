...
//#region node_modules/.nitro/vite/services/ssr/assets/forms-BthaGRMC.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "React extends the HTML `<form>` element to allow Server Actions to be invoked with the `action` attribute."
		},
		{
			"heading": "how-it-works",
			"content": "When used in a form, the function automatically receives the `FormData` object. You can then extract the data using the native `FormData` methods:"
		},
		{
			"heading": "how-it-works",
			"content": "> **Good to know:** When working with forms that have multiple fields, use JavaScript's `Object.fromEntries()`. For example: `const rawFormData = Object.fromEntries(formData)`. Note that this object will contain extra properties prefixed with `$ACTION_`."
		},
		{
			"heading": "passing-additional-arguments",
			"content": "Outside of form fields, you can pass additional arguments to a Server Function using the JavaScript `bind` method. For example, to pass the `userId` argument to the `updateUser` Server Function:"
		},
		{
			"heading": "passing-additional-arguments",
			"content": "The Server Function will receive the `userId` as an additional argument:"
		},
		{
			"heading": "passing-additional-arguments",
		...
		},
		{
			...
			"content": "Forms can be validated on the client or server."
		},
		{
			"heading": "form-validation",
			"content": "For **client-side validation**, you can use the HTML attributes like `required` and `type=\"email\"` for basic validation."
		},
		{
			"heading": "form-validation",
			"content": "For **server-side validation**, you can use a library like zod to validate the form fields. For example:"
		},
		{
			"heading": "validation-errors",
			"content": "To display validation errors or messages, turn the component that defines the `<form>` into a Client Component and use React `useActionState`."
		},
		{
			"heading": "validation-errors",
			"content": "When using `useActionState`, the Server function signature will change to receive a new `prevState` or `initialState` parameter as its first argument."
		},
		{
			"heading": "validation-errors",
			"content": "You can then conditionally render the error message based on the `state` object."
		},
		{
			"heading": "pending-states",
			"content": "The `useActionState` hook exposes a `pending` boolean that can be used to show a loading indicator or disable the submit button while the action is being executed."
		},
		{
			"heading": "pending-states",
			"content": "Alternatively, you can use the `useFormStatus` hook to show a loading indicator while the action is being executed. When using this hook, you'll need to create a separate component to render the loading indicator. For example, to disable the button when the action is pending:"
		},
		{
			"heading": "pending-states",
			"content": "You can then nest the `SubmitButton` component inside the form:"
		},
		{
			"heading": "pending-states",
			"content": "> **Good to know:** In React 19, `useFormStatus` includes additional keys on the returned object, like data, method, and action. If you are not using React 19, only the `pending` key is available."
		},
		{
			"heading": "optimistic-updates",
			"content": "You can use the React `useOptimistic` hook to optimistically update the UI before the Server Function finishes executing, rather than waiting for the response:"
		},
		{
			"heading": "nested-form-elements",
			"content": "You can call Server Actions in elements nested inside `<form>` such as `<button>`, `<input type=\"submit\">`, and `<input type=\"image\">`. These elements accept the `formAction` prop or event handlers."
		},
		{
			"heading": "nested-form-elements",
		...
		},
		{
			...
			"content": "You can trigger a form submission programmatically using the `requestSubmit()` method. For example, when the user submits a form using the `⌘` + `Enter` keyboard shortcut, you can listen for the `onKeyDown` event:"
		},
		{
			"heading": "programmatic-form-submission",
			"content": "This will trigger the submission of the nearest `<form>` ancestor, which will invoke the Server Function."
		}
	],
	"headings": [
		{
...
var toc = [
	...
	},
	{
		...
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Validation errors" })
	},
	{
		depth: 2,
		url: "#pending-states",
	...
	{
		depth: 2,
		url: "#nested-form-elements",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Nested form elements" })
	},
	{
		depth: 2,
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/form#action",
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "action" })
			}),
			" attribute."
		] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			...
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
					...
					value: "app/invoices/page.js",
					children: "app/invoices/page.js"
				})] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.a, {
				...
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "bind" })
			}),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "bind" }), " works in both Server and Client Components and supports progressive enhancement."] }),
				"\n"
			] }),
			"\n"
		] }),
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "Forms can be validated on the client or server." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"For ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "client-side validation" }),
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"For ",
				(0, import_jsx_runtime.jsx)(_components.strong, { children: "server-side validation" }),
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "SubmitButton" }),
...
//#endregion
export { toc as a, structuredData as i, forms_exports as n, frontmatter as r, MDXContent as t };
