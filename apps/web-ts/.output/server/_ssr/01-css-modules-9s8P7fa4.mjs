...
//#region node_modules/.nitro/vite/services/ssr/assets/01-css-modules-9s8P7fa4.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "example",
			"content": "CSS Modules are an *optional feature* and are **only enabled for files with the `.module.css` extension**.\nRegular `<link>` stylesheets and global CSS files are still supported."
		},
		{
			"heading": "example",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"CSS Modules are an ",
			(0, import_jsx_runtime.jsx)(_components.em, { children: "optional feature" }),
			" and are ",
