...
//#region node_modules/.nitro/vite/services/ssr/assets/11-draft-mode-BdL1OaaL.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "step-1-create-and-access-the-api-route",
			"content": "> Take a look at the API Routes documentation first if you’re not familiar with Next.js API Routes."
		},
		{
			"heading": "step-1-create-and-access-the-api-route",
			"content": "First, create the **API route**. It can have any name - e.g. `pages/api/draft.ts`"
		},
		{
			"heading": "step-1-create-and-access-the-api-route",
			"content": "In this API route, you need to call `setDraftMode` on the response object."
		},
		{
			"heading": "step-1-create-and-access-the-api-route",
		...
		{
			"heading": "step-1-create-and-access-the-api-route",
			"content": "If you open your browser’s developer tools and visit `/api/draft`, you’ll notice a `Set-Cookie` response header with a cookie named `__prerender_bypass`."
		},
		{
		...
		{
			"heading": "securely-accessing-it-from-your-headless-cms",
			"content": "**Second**, if your headless CMS supports setting custom draft URLs, specify the following as the draft URL. This assumes that your draft API route is located at `pages/api/draft.ts`."
		},
		{
			"heading": "securely-accessing-it-from-your-headless-cms",
		...
		{
			"heading": "securely-accessing-it-from-your-headless-cms",
			"content": "**Finally**, in the draft API route:"
		},
		{
			"heading": "securely-accessing-it-from-your-headless-cms",
		...
		},
		{
			...
			"content": "The next step is to update `getStaticProps` to support draft mode."
		},
		{
			"heading": "step-2-update-getstaticprops",
			"content": "If you request a page which has `getStaticProps` with the cookie set (via `res.setDraftMode`), then `getStaticProps` will be called at **request time** (instead of at build time)."
		},
		{
			"heading": "step-2-update-getstaticprops",
			"content": "Furthermore, it will be called with a `context` object where `context.draftMode` will be `true`."
		},
		{
			"heading": "step-2-update-getstaticprops",
			"content": "We used `res.setDraftMode` in the draft API route, so `context.draftMode` will be `true`."
		},
		{
			"heading": "step-2-update-getstaticprops",
		...
		{
			"heading": "fetch-draft-data",
			"content": "You can update `getStaticProps` to fetch different data based on `context.draftMode`."
		},
		{
			"heading": "fetch-draft-data",
			"content": "For example, your headless CMS might have a different API endpoint for draft posts. If so, you can modify the API endpoint URL like below:"
		},
		{
			"heading": "fetch-draft-data",
			"content": "That’s it! If you access the draft API route (with `secret` and `slug`) from your headless CMS or manually, you should now be able to see the draft content. And if you update your draft without publishing, you should be able to view the draft."
		},
		{
			"heading": "fetch-draft-data",
		...
		{
			"heading": "clear-the-draft-mode-cookie",
			"content": "To clear the Draft Mode cookie manually, create an API route that calls `setDraftMode({ enable: false })`:"
		},
		{
			"heading": "clear-the-draft-mode-cookie",
			"content": "Then, send a request to `/api/disable-draft` to invoke the API Route. If calling this route using `next/link`, you must pass `prefetch={false}` to prevent accidentally deleting the cookie on prefetch."
		},
		{
			"heading": "works-with-getserversideprops",
			"content": "Draft Mode works with `getServerSideProps`, and is available as a `draftMode` key in the `context` object."
		},
		{
			"heading": "works-with-getserversideprops",
			"content": "> **Good to know**: You shouldn't set the `Cache-Control` header when using Draft Mode because it cannot be bypassed. Instead, we recommend using ISR."
		},
		{
			"heading": "works-with-api-routes",
			"content": "API Routes will have access to `draftMode` on the request object. For example:"
		},
		{
	...
	"headings": [
		{
			"id": "step-1-create-and-access-the-api-route",
...
var toc = [
	{
		depth: 2,
		url: "#step-1-create-and-access-the-api-route",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Step 1: Create and access the API route" })
	},
	{
		depth: 3,
	...
	{
		depth: 3,
		url: "#fetch-draft-data",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Fetch draft data" })
	},
	{
		depth: 2,
		url: "#more-details",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "step-1-create-and-access-the-api-route",
			children: "Step 1: Create and access the API route"
		}),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "pages/api/draft.ts" })
		] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			"In this API route, you need to call ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "setDraftMode" }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.strong, { children: "Finally" }), ", in the draft API route:"] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
				"Call ",
				(0, import_jsx_runtime.jsx)(_components.code, { children: "res.setDraftMode" }),
				"."
			] }),
			"\n",
			(0, import_jsx_runtime.jsxs)(_components.li, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" object where ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "context.draftMode" }),
			" will be ",
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "For example, your headless CMS might have a different API endpoint for draft posts. If so, you can modify the API endpoint URL like below:" }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			className: "shiki shiki-themes github-light github-dark",
			style: {
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "setDraftMode({ enable: false })" }),
			":"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: (0, import_jsx_runtime.jsx)(_components.pre, {
			...
			tabIndex: "0",
			title: "pages/api/disable-draft.ts",
			icon: "<svg viewBox=\"0 0 24 24\"><path d=\"M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z\" fill=\"currentColor\" /></svg>",
			children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
				(0, import_jsx_runtime.jsxs)(_components.span, {
					className: "line",
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			" key in the ",
			(0, import_jsx_runtime.jsx)(_components.a, {
				href: "/docs/pages/api-reference/functions/get-server-side-props#context-parameter",
				children: (0, import_jsx_runtime.jsx)(_components.code, { children: "context" })
			}),
			" object."
		] }),
		"\n",
