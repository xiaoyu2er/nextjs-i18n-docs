...
//#region node_modules/.nitro/vite/services/ssr/assets/layout-CtNM6JEr.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "layouts-do-not-receive-searchparams",
			"content": "When navigating from `/dashboard/settings` to `/dashboard/analytics`, `page.tsx` in `/dashboard/analytics` will rerender on the server, while `dashboard/layout.tsx` will **not** rerender because it's a common UI shared between the two routes."
		},
		{
			"heading": "layouts-do-not-receive-searchparams",
