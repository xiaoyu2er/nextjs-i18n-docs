...
//#region node_modules/.nitro/vite/services/ssr/assets/forms-C-oGGgrS.js
...
var structuredData = {
	"contents": [
		...
		},
		{
			...
			"content": "To handle form submissions on the server, create an API endpoint securely mutate data."
		},
		{
			"heading": "server-forms",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "To handle form submissions on the server, create an API endpoint securely mutate data." }),
		"\n",
