...
//#region node_modules/.nitro/vite/services/ssr/assets/use-link-status-nogbc1ki.js
var import_jsx_runtime = /* @__PURE__ */ __toESM(require_jsx_runtime());
var use_link_status_exports = /* @__PURE__ */ __exportAll({
	default: () => MDXContent,
...
var frontmatter = {
	...
	"related": {
		...
		"links": ["app/api-reference/components/link", "app/api-reference/file-conventions/loading"]
	}
};
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `useLinkStatus` hook lets you tracks the **pending** state of a `<Link>`. You can use it to show inline visual feedback to the user (like spinners or text glimmers) while a navigation to a new route completes."
		},
		{
			"heading": void 0,
			"content": "`useLinkStatus` is useful when:"
		},
		{
			"heading": void 0,
			"content": "Prefetching is disabled or in progress meaning navigation is blocked."
		},
		{
			"heading": void 0,
			"content": "The destination route is dynamic **and** doesn't include a `loading.js` file that would allow an instant navigation."
		},
		{
			"heading": void 0,
		...
		{
			"heading": "parameters",
			"content": "`useLinkStatus` does not take any parameters."
		},
		{
			"heading": "returns",
			"content": "`useLinkStatus` returns an object with a single property:"
		},
		{
			"heading": "returns",
			"content": "Property"
		...
		{
			"heading": "returns",
			"content": "`true` before history updates, `false` after"
		},
		{
			"heading": "inline-loading-indicator",
			"content": "It's helpful to add visual feedback that navigation is happening in case the user clicks a link before prefetching is complete."
		},
		{
			"heading": "gracefully-handling-fast-navigation",
			"content": "If the navigation to a new route is fast, users may see an unnecessary flash of the loading indicator. One way to improve the user experience and only show the loading indicator when the navigation takes time to complete is to add an initial animation delay (e.g. 100ms) and start the animation as invisible (e.g. `opacity: 0`)."
		},
		{
			"heading": "gracefully-handling-fast-navigation",
			"content": "Version"
		...
		{
			"heading": "gracefully-handling-fast-navigation",
			"content": "`useLinkStatus` introduced."
		},
		{
			"heading": "next-steps",
	...
	"headings": [
		...
		{
			"id": "inline-loading-indicator",
			"content": "Inline loading indicator"
		},
		{
			"id": "gracefully-handling-fast-navigation",
...
var toc = [
	...
	{
		depth: 3,
		url: "#inline-loading-indicator",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Inline loading indicator" })
	},
	{
		depth: 2,
		url: "#gracefully-handling-fast-navigation",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Gracefully handling fast navigation" })
	},
	{
		depth: 2,
		url: "#next-steps",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.strong, { children: "pending" }),
			" state of a ",
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "useLinkStatus" }), " is useful when:"] }),
		"\n",
		...
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/loading-indicator.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/loading-indicator.tsx",
						children: "app/loading-indicator.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/loading-indicator.js",
						children: "app/loading-indicator.js"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/header.tsx",
						children: "app/header.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/header.js",
						children: "app/header.js"
					})
				] }),
		...
		(0, import_jsx_runtime.jsxs)(_components.blockquote, { children: [
			...
			(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
				...
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "If the linked route has been prefetched, the pending state will be skipped" }),
				"\n",
				(0, import_jsx_runtime.jsx)(_components.li, { children: "When clicking multiple links in quick succession, only the last link's pending state is shown" }),
				"\n",
				(0, import_jsx_runtime.jsxs)(_components.li, { children: ["This hook is not supported in the Pages Router and will always return ", (0, import_jsx_runtime.jsx)(_components.code, { children: "{ pending: false }" })] }),
				"\n"
			] }),
			"\n"
		] }),
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "useLinkStatus" }), " does not take any parameters."] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "returns",
			children: "Returns"
		...
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [(0, import_jsx_runtime.jsx)(_components.code, { children: "useLinkStatus" }), " returns an object with a single property:"] }),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.table, { children: [(0, import_jsx_runtime.jsx)(_components.thead, { children: (0, import_jsx_runtime.jsxs)(_components.tr, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.td, { children: "pending" }),
		...
		(0, import_jsx_runtime.jsx)(_components.h3, {
			id: "inline-loading-indicator",
			children: "Inline loading indicator"
		}),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.p, { children: "It's helpful to add visual feedback that navigation is happening in case the user clicks a link before prefetching is complete." }),
		"\n",
		(0, import_jsx_runtime.jsxs)(CodeBlockTabs, {
			defaultValue: "app/components/loading-indicator.tsx",
			children: [
				(0, import_jsx_runtime.jsxs)(CodeBlockTabsList, { children: [
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/components/loading-indicator.tsx",
						children: "app/components/loading-indicator.tsx"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
						value: "app/components/loading-indicator.js",
						children: "app/components/loading-indicator.js"
					}),
					(0, import_jsx_runtime.jsx)(CodeBlockTabsTrigger, {
							...
							(0, import_jsx_runtime.jsxs)(_components.span, {
								...
								children: [
									...
									(0, import_jsx_runtime.jsx)(_components.span, {
										...
										children: " './components/loading-indicator'"
									})
								]
							}),
							"\n",
		...
		(0, import_jsx_runtime.jsx)(_components.h2, {
			id: "gracefully-handling-fast-navigation",
			children: "Gracefully handling fast navigation"
		}),
		"\n",
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
...
//#endregion
export { use_link_status_exports as a, toc as i, frontmatter as n, structuredData as r, MDXContent as t };
