...
//#region node_modules/.nitro/vite/services/ssr/assets/connection-BWkh5zJx.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `connection()` function allows you to indicate rendering should wait for an incoming user request before continuing."
		},
		{
			"heading": void 0,
			"content": "It's useful when a component doesn’t use Dynamic APIs, but you want it to be dynamically rendered at runtime and not statically rendered at build time. This usually occurs when you access external information that you intentionally want to change the result of a render, such as `Math.random()` or `new Date()`."
		},
		{
			"heading": "parameters",
			"content": "The function does not accept any parameters."
		},
		{
			"heading": "returns",
			"content": "The function returns a `void` Promise. It is not meant to be consumed."
		},
		{
			"heading": "good-to-know",
			"content": "`connection` replaces `unstable_noStore` to better align with the future of Next.js."
		},
		{
			"heading": "good-to-know",
			"content": "The function is only necessary when dynamic rendering is required and common Dynamic APIs are not used."
		},
		{
...
var toc = [
	...
	},
	{
		depth: 3,
		url: "#type",
		title: (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: "Type" })
	},
	{
		depth: 3,
		url: "#parameters",
...
function _createMdxContent(props) {
	...
	return (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		(0, import_jsx_runtime.jsxs)(_components.p, { children: [
			...
			(0, import_jsx_runtime.jsx)(_components.code, { children: "Math.random()" }),
			" or ",
			(0, import_jsx_runtime.jsx)(_components.code, { children: "new Date()" }),
			"."
		] }),
		"\n",
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "  // Everything below will be excluded from prerendering"
								})
							}),
							"\n",
							(0, import_jsx_runtime.jsxs)(_components.span, {
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The function does not accept any parameters." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
		...
		(0, import_jsx_runtime.jsxs)(_components.ul, { children: [
			...
			"\n",
			(0, import_jsx_runtime.jsx)(_components.li, { children: "The function is only necessary when dynamic rendering is required and common Dynamic APIs are not used." }),
			"\n"
		] }),
		"\n",
		(0, import_jsx_runtime.jsx)(_components.h3, {
...
//#endregion
export { toc as a, structuredData as i, connection_exports as n, frontmatter as r, MDXContent as t };
