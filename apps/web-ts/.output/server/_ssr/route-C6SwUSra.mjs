...
//#region node_modules/.nitro/vite/services/ssr/assets/route-C6SwUSra.js
...
var structuredData = {
	"contents": [
		...
		{
			"heading": "http-methods",
			"content": "> **Good to know**: Route Handlers are only available inside the `app` directory. You **do not** need to use API Routes (`pages`) and Route Handlers (`app`) together, as Route Handlers should be able to handle all use cases."
		},
		{
		...
		},
		{
			...
			"content": "Currently, the only value of `context` is `params`, which is an object containing the dynamic route parameters for the current route."
		},
		{
			"heading": "context-optional",
			"content": "Example"
		...
		},
		{
			...
			"content": "Route Handlers can extend the Web Response API by returning a `NextResponse` object. This allows you to easily set cookies, headers, redirect, and rewrite. View the API reference."
		},
		{
						...
						children: (0, import_jsx_runtime.jsxs)(_components.code, { children: [
							...
							(0, import_jsx_runtime.jsx)(_components.span, {
								...
								children: (0, import_jsx_runtime.jsx)(_components.span, {
									...
									children: "// Define params type according to your route parameters (see table below)"
								})
							})
						] })
					}) })
