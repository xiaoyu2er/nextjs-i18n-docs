...
//#region node_modules/.nitro/vite/services/ssr/assets/useCache-BKy3H1xX.js
...
var structuredData = {
	"contents": [
		{
			"heading": void 0,
			"content": "The `useCache` flag is an experimental feature in Next.js that enables the `use cache` directive to be used independently of `cacheComponents`. When enabled, you can use `use cache` in your application even if `cacheComponents` is turned off."
		},
		{
			"heading": "usage",
