import{r as e}from"./chunk-DECur_0Z.js";import{t}from"./jsx-runtime-Cns_S3nq.js";var n=e(t()),r={title:`Fast Refresh`,description:`Fast Refresh is a hot module reloading experience that gives you instantaneous feedback on edits made to your React components.`},i={contents:[{heading:void 0,content:`Fast refresh is a React feature integrated into Next.js that allows you live reload the browser page while maintaining temporary client-side state when you save changes to a file. It's enabled by default in all Next.js applications on **9.4 or newer**. With Fast Refresh enabled, most edits should be visible within a second.`},{heading:`how-it-works`,content:`If you edit a file that &#x2A;*only exports React component(s)**, Fast Refresh will
...
`,(0,n.jsxs)(t.li,{children:[`Anonymous arrow functions like `,(0,n.jsx)(t.code,{children:`export default () => <div />;`}),` cause Fast Refresh to not preserve local component state. For large codebases you can use our `,(0,n.jsxs)(t.a,{href:`/docs/pages/guides/upgrading/codemods#name-default-component`,children:[(0,n.jsx)(t.code,{children:`name-default-component`}),` codemod`]}),`.`]}),`
`]}),`
...
without Fast Refresh. It will make it easier for you to introduce new dependencies to it later on
and it's enforced by `,(0,n.jsx)(t.a,{href:`/docs/pages/api-reference/config/next-config-js/reactStrictMode`,children:`React Strict Mode`}),`,
