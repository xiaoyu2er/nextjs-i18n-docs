...
> Para aprender más sobre enrutamiento dinámico, consulta la [documentación de Enrutamiento Dinámico](/docs/pages/building-your-application/routing/dynamic-routes).
...
Si solo tienes un layout para toda tu aplicación, puedes crear una [App Personalizada](/docs/pages/building-your-application/routing/custom-app) y envolver tu aplicación con el layout. Como el componente `<Layout />` se reutiliza al cambiar de páginas, su estado se conservará (ej. valores de inputs).
