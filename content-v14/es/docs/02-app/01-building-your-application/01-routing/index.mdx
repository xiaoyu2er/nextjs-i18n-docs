...
| [`page`](/docs/app/building-your-application/routing/pages-and-layouts#pages)         | UI única de una ruta y hace las rutas accesibles públicamente                                  |
...
| [`template`](/docs/app/building-your-application/routing/pages-and-layouts#templates) | UI de Diseño re-renderizada especializada                                                      |
...
Aprende más sobre [Organización de Proyecto y Colocación Conjunta](/docs/app/building-your-application/routing/colocation).
...
- [Rutas Paralelas](/docs/app/building-your-application/routing/parallel-routes): Te permiten mostrar simultáneamente dos o más páginas en la misma vista que pueden navegarse independientemente. Puedes usarlas para vistas divididas que tienen su propia sub-navegación. Ej. Dashboards.
