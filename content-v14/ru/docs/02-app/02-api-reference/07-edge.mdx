...
translation-updated-at: 2025-06-06T16:45:59.617Z
title: Edge Runtime
...
| [`clearTimeout`](https://developer.mozilla.org/docs/Web/API/WindowOrWorkerGlobalScope/clearTimeout)                   | Отменяет отложенное действие, установленное вызовом `setTimeout()`                                                                                                                                 |
| [`console`](https://developer.mozilla.org/docs/Web/API/Console)                                                       | Предоставляет доступ к консоли отладки браузера                                                                                                                                                     |
| [`DataView`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/DataView)                     | Представляет обобщённое представление `ArrayBuffer`                                                                                                                                                |
...
| [`encodeURI`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/encodeURI)                   | Кодирует URI, заменяя определённые символы escape-последовательностями UTF-8                                                                                                                       |
| [`encodeURIComponent`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/encodeURIComponent) | Кодирует компонент URI, заменяя определённые символы escape-последовательностями UTF-8                                                                                                             |
...
| [`parseFloat`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/parseFloat)                 | Парсит строку и возвращает число с плавающей точкой                                                                                                                                                 |
| [`parseInt`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/parseInt)                     | Парсит строку и возвращает целое число указанной системы счисления                                                                                                                                 |
...
| [`RegExp`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/RegExp)                         | Представляет регулярное выражение для сопоставления символов                                                                                                                                        |
...
| [`structuredClone`](https://developer.mozilla.org/docs/Web/API/Web_Workers_API/Structured_clone_algorithm)            | Создаёт глубокую копию значения                                                                                                                                                                     |
...
| [`SyntaxError`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/SyntaxError)               | Представляет ошибку при интерпретации синтаксически неверного кода                                                                                                                                 |
...
| [`new Function(evalString)`](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/Function)               | Создает новую функцию с кодом, переданным в качестве аргумента    |
...
`unstable_allowDynamic` — это [glob](https://github.com/micromatch/micromatch#matching-features) или массив glob-шаблонов, игнорирующих динамическую оценку кода для определенных файлов. Glob-шаблоны указываются относительно корневой папки вашего приложения.
