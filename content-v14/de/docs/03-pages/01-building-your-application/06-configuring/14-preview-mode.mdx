...
> **Hinweis**: Diese Funktion wurde durch [Draft Mode](/docs/pages/building-your-application/configuring/draft-mode) ersetzt.
...
> **Gut zu wissen**: Sie sollten den `Cache-Control`-Header nicht setzen, wenn Sie den Vorschaumodus verwenden, da er nicht umgangen werden kann. Wir empfehlen stattdessen die Verwendung von [ISR](/docs/pages/building-your-application/data-fetching/incremental-static-regeneration).
