...
> **Wichtig**: Sie können [`getStaticProps`](/docs/pages/building-your-application/data-fetching/get-static-props) in dieser Seite verwenden, wenn Sie Daten während des Builds abrufen müssen.
...
- `_error` ist, wie `_app`, ein reservierter Pfadname. `_error` wird verwendet, um das Layout und Verhalten von Fehlerseiten zu definieren. `/_error` rendert 404, wenn direkt über [Routing](/docs/pages/building-your-application/routing) oder in einem [Custom Server](/docs/pages/building-your-application/configuring/custom-server) aufgerufen.