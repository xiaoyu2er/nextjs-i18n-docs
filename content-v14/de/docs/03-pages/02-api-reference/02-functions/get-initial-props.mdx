...
- `getInitialProps` kann nur in `pages/`-Top-Level-Dateien verwendet werden, nicht in verschachtelten Komponenten. Für verschachtelte Datenabfragen auf Komponentenebene sollten Sie den [App Router](/docs/app/building-your-application/data-fetching) in Betracht ziehen.
