...
| الاسم            | الوصف                                                                                                                                                                                                           |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `params`        | إذا كانت هذه الصفحة تستخدم [مسار ديناميكي](/docs/pages/building-your-application/routing/dynamic-routes)، فإن `params` يحتوي على معلمات المسار. إذا كان اسم الصفحة `[id].js`، فإن `params` سيبدو مثل `{ id: ... }`. |
