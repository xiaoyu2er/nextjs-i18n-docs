...
يسمح نموذج React بتفكيك [الصفحة](/docs/pages/building-your-application/routing/pages-and-layouts) إلى سلسلة من المكونات. العديد من هذه المكونات غالبًا ما يتم إعادة استخدامها بين الصفحات. على سبيل المثال، قد يكون لديك نفس شريط التنقل والتذييل في كل صفحة.
...
داخل التخطيط الخاص بك، يمكنك جلب البيانات على جانب العميل باستخدام `useEffect` أو مكتبة مثل [SWR](https://swr.vercel.app/). لأن هذا الملف ليس [صفحة](/docs/pages/building-your-application/routing/pages-and-layouts)، لا يمكنك استخدام `getStaticProps` أو `getServerSideProps` حاليًا.
