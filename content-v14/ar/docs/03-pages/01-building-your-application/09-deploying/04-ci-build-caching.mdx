...
translation-updated-at: 2025-06-06T17:23:16.586Z
title: التكامل المستمر (CI) - تخزين البناء المؤقت
description: تعلم كيفية تكوين التكامل المستمر (CI) لتخزين بناء Next.js مؤقتًا
---
...
استخدم [إضافات Netlify](https://www.netlify.com/products/build/plugins/) مع [`@netlify/plugin-nextjs`](https://www.npmjs.com/package/@netlify/plugin-nextjs).
...
باستخدام [ذاكرة التخزين المؤقت المخصصة](https://devcenter.heroku.com/articles/nodejs-support#custom-caching) من Heroku، أضف مصفوفة `cacheDirectories` في ملف package.json الرئيسي:
...
باستخدام [مهمة التخزين المؤقت](https://docs.microsoft.com/en-us/azure/devops/pipelines/tasks/utility/cache) من Azure Pipelines، أضف المهمة التالية إلى ملف خط الأنابيب yaml في مكان ما قبل المهمة التي تنفذ `next build`:
...
باستخدام [إضافة Job Cacher](https://www.jenkins.io/doc/pipeline/steps/jobcacher/) لـ Jenkins، أضف خطوة البناء التالية إلى ملف `Jenkinsfile` حيث تقوم عادةً بتنفيذ `next build` أو `npm install`:
