...
translation-updated-at: 2025-06-06T17:25:05.942Z
title: جلب البيانات من جانب العميل (Client-side Fetching)
description: تعرف على جلب البيانات من جانب العميل، وكيفية استخدام SWR، وهي مكتبة خطافات React لجلب البيانات التي تعالج التخزين المؤقت، إعادة التحقق، تتبع التركيز، إعادة الجلب على فترات والمزيد.
---
...
قام فريق Next.js بإنشاء مكتبة خطافات React لجلب البيانات تسمى [**SWR**](https://swr.vercel.app/). يوصى بها بشدة إذا كنت تقوم بجلب البيانات من جانب العميل. فهي تعالج التخزين المؤقت، إعادة التحقق، تتبع التركيز، إعادة الجلب على فترات، والمزيد.
