...
Ces deux valeurs sont [**compressées avec gzip**](/docs/app/api-reference/next-config-js/compress). Le premier chargement est indiqué par du vert, jaune ou rouge. Visez le vert pour des applications performantes.
