...
translation-updated-at: 2025-05-25T21:32:09.360Z
title: useAmp
...
> AMP 支援是我們的高級功能之一，您可以[在此閱讀更多關於 AMP 的資訊](/docs/pages/building-your-application/configuring/amp)。
...
該頁面使用 `useAmp` 來區分模式，它是一個 [React Hook](https://react.dev/reference/react)，如果頁面正在使用 AMP 則返回 `true`，否則返回 `false`。