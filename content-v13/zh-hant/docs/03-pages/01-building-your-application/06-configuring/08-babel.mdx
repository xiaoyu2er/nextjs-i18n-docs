...
translation-updated-at: 2025-05-25T21:34:24.363Z
title: Babel
description: 使用自己的配置來擴展 Next.js 加入的 babel 預設集。
---
...
若要加入 **帶有自訂配置** 的預設集/外掛程式，請在 `next/babel` 預設集中這樣設定：
