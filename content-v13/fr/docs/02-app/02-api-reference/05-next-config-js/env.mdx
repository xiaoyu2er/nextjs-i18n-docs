...
translation-updated-at: 2025-06-06T17:32:44.705Z
title: env
...
> Depuis la sortie de [Next.js 9.4](https://nextjs.org/blog/next-9-4), nous offrons une expérience plus intuitive et ergonomique pour [ajouter des variables d'environnement](/docs/app/building-your-application/configuring/environment-variables). Essayez-la !

</AppOnly>

<PagesOnly>

> Depuis la sortie de [Next.js 9.4](https://nextjs.org/blog/next-9-4), nous offrons une expérience plus intuitive et ergonomique pour [ajouter des variables d'environnement](/docs/pages/building-your-application/configuring/environment-variables). Essayez-la !
