...
translation-updated-at: 2025-06-06T17:34:22.926Z
...
Vous pouvez gérer les résultats de ces métriques séparément :
...
[Vercel Speed Insights](https://vercel.com/docs/concepts/speed-insights) est automatiquement configuré sur les déploiements Vercel et ne nécessite pas l'utilisation de `useReportWebVitals`. Ce hook est utile en développement local ou si vous utilisez un autre service d'analytique.

## Envoi des résultats à des systèmes externes

Vous pouvez envoyer les résultats à n'importe quel endpoint pour mesurer et suivre la performance réelle des utilisateurs sur votre site. Par exemple :
