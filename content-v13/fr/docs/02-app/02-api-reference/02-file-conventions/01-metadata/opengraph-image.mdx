...
translation-updated-at: 2025-06-06T17:49:13.909Z
...
Le moyen le plus simple de générer une image est d'utiliser l'API [ImageResponse](/docs/app/api-reference/functions/image-response) de `next/server`.
...
export default async function Image() {
  ...
  return new ImageResponse(
    ...
    // Options ImageResponse
    {
      ...
      // de opengraph-image pour également définir la largeur et la hauteur de ImageResponse.
      ...size,
      fonts: [
        {
          name: 'Inter',
...
Un objet contenant les [paramètres de route dynamique](/docs/app/building-your-application/routing/dynamic-routes) depuis le segment racine jusqu'au segment où `opengraph-image` ou `twitter-image` est colocalisé.
