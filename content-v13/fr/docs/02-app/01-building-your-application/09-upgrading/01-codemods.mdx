...
translation-updated-at: 2025-06-06T17:37:14.591Z
title: Codemods
...
C'est un cas parmi d'autres. Tous les cas transformés (et testés) peuvent être trouvés dans le [répertoire `__testfixtures__`](https://github.com/vercel/next.js/tree/canary/packages/next-codemod/transforms/__testfixtures__/url-to-withrouter).