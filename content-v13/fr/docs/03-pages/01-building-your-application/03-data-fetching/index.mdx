...
translation-updated-at: 2025-06-06T17:28:24.378Z
...
La récupération de données dans Next.js vous permet d'afficher votre contenu de différentes manières, selon le cas d'utilisation de votre application. Cela inclut le pré-rendu avec le **Rendu côté serveur (SSR)** ou la **Génération statique (SSG)**, ainsi que la mise à jour ou la création de contenu à l'exécution avec la **Régénération statique incrémentielle (ISR)**.
