...
translation-updated-at: 2025-06-06T17:12:55.526Z
...
Por ejemplo, en el caso del Cambio Acumulativo de Diseño (CLS), podríamos querer conocer el primer elemento que se desplazó cuando ocurrió el mayor cambio de diseño.
...
Si el elemento LCP es una imagen, conocer la URL del recurso de imagen puede ayudarnos a localizar el recurso que necesitamos optimizar.
...
La atribución está desactivada por defecto en Next.js pero puede activarse **por métrica** especificando lo siguiente en `next.config.js`.
