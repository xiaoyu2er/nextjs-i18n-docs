...
translation-updated-at: 2025-06-06T17:55:35.142Z
...
> **Wichtig zu wissen**
>
> - `getInitialProps` in `_document` wird während clientseitiger Navigationen nicht aufgerufen.
> - Das `ctx`-Objekt für `_document` entspricht dem in [`getInitialProps`](/docs/pages/api-reference/functions/get-initial-props#context-object) empfangenen Objekt, mit der Ergänzung von `renderPage`.