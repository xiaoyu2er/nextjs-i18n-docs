...
translation-updated-at: 2025-06-06T17:54:30.621Z
...
Wie Sie sehen können, ähnelt `getServerSideProps` `getStaticProps`, der Unterschied besteht jedoch darin, dass `getServerSideProps` bei jeder Anfrage und nicht während der Build-Zeit ausgeführt wird.
