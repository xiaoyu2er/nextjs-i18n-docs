...
translation-updated-at: 2025-06-06T17:53:00.991Z
title: AMP
...
- Nur CSS-in-JS wird unterstützt. [CSS-Module](/docs/pages/building-your-application/styling) werden von AMP-Seiten derzeit nicht unterstützt. Sie können [Unterstützung für CSS-Module zu Next.js beitragen](https://github.com/vercel/next.js/issues/10549).

## AMP-Komponenten hinzufügen

Die AMP-Community stellt [viele Komponenten](https://amp.dev/documentation/components/) bereit, um AMP-Seiten interaktiver zu gestalten. Next.js importiert automatisch alle auf einer Seite verwendeten Komponenten, und es ist nicht erforderlich, AMP-Komponentenskripts manuell zu importieren:
